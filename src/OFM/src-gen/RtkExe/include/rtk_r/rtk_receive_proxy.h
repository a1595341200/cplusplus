...
#include "rtk_r/Rtk_Receive_proxy_update_manager.h"
...
using GgaData_receive =
    ::amsr::socal::events::ProxyEvent<::SOMEIP::ValidationKey::GgaData>;
 ...
 * \trace SPEC-4980344
 */
class Rtk_ReceiveProxy : public ::amsr::socal::Proxy<rtk_r::Rtk_Receive, rtk_r::internal::Rtk_ReceiveProxyBackendInterface, rtk_r::internal::Rtk_ReceiveHandleType> {
 public:
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Proxy<rtk_r::Rtk_Receive, ProxyBackendInterface, rtk_r::internal::Rtk_ReceiveHandleType>;
   ...
   */
  rtk_r::internal::Rtk_ReceiveProxyUpdateManager proxy_update_manager_;
