 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/ipc_binding_transformation_layer/internal/perceptionsi_out/PerceptionSideSI_Out_proxy_xf_ipc_binding.cpp
...
void PerceptionSideSI_OutProxyXf::EmplaceEventBackends() {
  static_cast<void>(event_backend_table_.emplace(event_backend_FLCam_Bus_VisnObj_.GetEventId(), &event_backend_FLCam_Bus_VisnObj_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_FRCam_Bus_VisnObj_.GetEventId(), &event_backend_FRCam_Bus_VisnObj_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_RLCam_Bus_VisnObj_.GetEventId(), &event_backend_RLCam_Bus_VisnObj_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_RRCam_Bus_VisnObj_.GetEventId(), &event_backend_RRCam_Bus_VisnObj_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_FLCam_Bus_CamSts_.GetEventId(), &event_backend_FLCam_Bus_CamSts_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_FRCam_Bus_CamSts_.GetEventId(), &event_backend_FRCam_Bus_CamSts_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_RLCam_Bus_CamSts_.GetEventId(), &event_backend_RLCam_Bus_CamSts_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_RRCam_Bus_CamSts_.GetEventId(), &event_backend_RRCam_Bus_CamSts_ ));

}

void PerceptionSideSI_OutProxyXf::Start() noexcept { is_active_ = true; }

void PerceptionSideSI_OutProxyXf::Stop() noexcept { is_active_ = false; }
...
::ara::core::Result<void> PerceptionSideSI_OutProxyXf::RequestService() noexcept {
  if(++proxy_count_ == 1) {
...
// VECTOR NC AutosarC++17_10-A15.4.2: MD_IPCBINDING_AutosarC++17_10-A15.4.2_STL_exceptions
// VECTOR NC AutosarC++17_10-A15.5.3: MD_IPCBINDING_AutosarC++17_10-A15.5.3_STL_exceptions
void  PerceptionSideSI_OutProxyXf::ReleaseService() noexcept {
  if(--proxy_count_ == 0) {
    IpcProxyBindingIdentity const proxy_instance_identity{
          kDeployment.service_id_, instance_id_, kDeployment.service_interface_version_.major_version_, client_id_};
...
::amsr::ipc_binding_core::internal::ForwardOutput  PerceptionSideSI_OutProxyXf::RouteRequest(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSideSI_OutProxyXf::OnResponseReceived(::amsr::ipc_binding_core::internal::ipc_protocol::ResponseMessage&& response) {
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSideSI_OutProxyXf::OnNotificationReceived(::amsr::ipc_binding_core::internal::ipc_protocol::NotificationMessagePtr notification) {
  ::amsr::ipc_binding_core::internal::ForwardOutput forwarded{false};
...
void PerceptionSideSI_OutProxyXf::OnServiceInstanceDown() {
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSideSI_OutProxyXf::OnSubscribeAckReceived(::amsr::ipc_binding_core::internal::ipc_protocol::SubscribeEventAckMessageHeader const& ack_response) {
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSideSI_OutProxyXf::OnSubscribeNAckReceived(::amsr::ipc_binding_core::internal::ipc_protocol::SubscribeEventNAckMessageHeader const& nack_response) {
  ::amsr::ipc_binding_core::internal::ForwardOutput accepted{false};
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSideSI_OutProxyXf::OnApplicationErrorReceived(::amsr::ipc_binding_core::internal::ipc_protocol::ApplicationErrorMessage&& message) {
  ::amsr::ipc_binding_core::internal::ForwardOutput forwarded{false};
  // Get method ID from response header for dispatching.
...
void PerceptionSideSI_OutProxyXf::OnErrorResponseReceived(::amsr::ipc_binding_core::internal::ipc_protocol::ErrorResponseMessage&& message) {
  // Get method ID from response header for dispatching.
  ::amsr::ipc_binding_core::internal::ipc_protocol::MethodId const method_id{message.GetMessageHeader().method_id_};
