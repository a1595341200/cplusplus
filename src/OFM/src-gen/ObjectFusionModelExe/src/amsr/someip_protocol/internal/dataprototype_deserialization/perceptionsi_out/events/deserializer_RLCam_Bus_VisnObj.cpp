 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsi_out/events/deserializer_RLCam_Bus_VisnObj.cpp
...
deserialization::Result DeserializerRLCam_Bus_VisnObj::Deserialize(deserialization::Reader &reader, ::VisObjs::VisObjs &data) {
