 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/radaradaptorsi_out/events/deserializer_FourDRadarObjStsGAPGrp04_FourDRadarObjStsGrp04.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/FourDRadarObjStsGrp04/deserializer_FourDRadarObjStsGrp31_40.h"
...
deserialization::Result DeserializerFourDRadarObjStsGAPGrp04_FourDRadarObjStsGrp04::Deserialize(deserialization::Reader &reader, ::FourDRadarObjStsGrp04::FourDRadarObjStsGrp31_40 &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/RadarAdaptorSI_Out/FourDRadarObjStsGAPGrp04_FourDRadarObjStsGrp04
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::FourDRadarObjStsGrp04::FourDRadarObjStsGrp31_40>{})};
