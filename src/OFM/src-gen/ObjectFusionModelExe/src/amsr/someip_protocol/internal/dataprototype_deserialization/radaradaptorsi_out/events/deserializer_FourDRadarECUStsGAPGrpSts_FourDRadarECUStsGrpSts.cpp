 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/radaradaptorsi_out/events/deserializer_FourDRadarECUStsGAPGrpSts_FourDRadarECUStsGrpSts.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/FourDRadarECUStsGrpSts/deserializer_FourDRadarECUStsGrpSts.h"
...
deserialization::Result DeserializerFourDRadarECUStsGAPGrpSts_FourDRadarECUStsGrpSts::Deserialize(deserialization::Reader &reader, ::FourDRadarECUStsGrpSts::FourDRadarECUStsGrpSts &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/RadarAdaptorSI_Out/FourDRadarECUStsGAPGrpSts_FourDRadarECUStsGrpSts
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::FourDRadarECUStsGrpSts::FourDRadarECUStsGrpSts>{})};
