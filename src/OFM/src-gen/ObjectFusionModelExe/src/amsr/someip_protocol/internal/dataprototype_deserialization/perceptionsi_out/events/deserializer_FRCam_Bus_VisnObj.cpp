 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsi_out/events/deserializer_FRCam_Bus_VisnObj.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/VisObj/deserializer_VisObj.h"
...
deserialization::Result DeserializerFRCam_Bus_VisnObj::Deserialize(deserialization::Reader &reader, ::VisObjs::VisObjs &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionSideSI_Out/FRCam_Bus_VisnObj
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::VisObjs::VisObjs>{})};
