 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/someip_binding/internal/life_cycle_manager.cpp
...
void LifeCycleManager::RegisterServiceInstances() noexcept {
  {
    ...
    {
      // Map R-Port /JICA/SWC/ObjectFusionModelExe/ObjectFusionModel/ObjectFusionModelInfoSIR to instance /JICA/Service/RequiredSomeipToSOCA_InfomationSI/RequiredSomeipToSOCA_InfomationSI 
      ::ara::core::InstanceSpecifier const instance_specifier{"ObjectFusionModelExe/ObjectFusionModel/ObjectFusionModelInfoSIR"_sv};
  ...
  }
  {
    ...
    {
      // Map P-Port /JICA/SWC/ObjectFusionModelExe/ObjectFusionModel/ObjectFusionModelSIP to instance /JICA/Service/ProvidedSomeipObjectFusionModelSI_Out/ProvidedSomeipObjectFusionModelSI_Out
      ::ara::core::InstanceSpecifier const instance_specifier{"ObjectFusionModelExe/ObjectFusionModel/ObjectFusionModelSIP"_sv};
      ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1045"_sv};
...
// VECTOR NC AutosarC++17_10-M9.3.3, VectorC++-V5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-M9.3.3_Method_can_be_declared_const
 void LifeCycleManager::InitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/ObjectFusionModelSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::objectfusionmodelsi_out::
      AraComSomeIpBindingInitializeSkeletonSomeIpEventBackendsObjectFusionModelSI_Out(aracom_someip_binding_->GetServerManager());
}
...
void LifeCycleManager::DeInitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/ObjectFusionModelSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::objectfusionmodelsi_out::
      AraComSomeIpBindingDeInitializeSkeletonSomeIpEventBackendsObjectFusionModelSI_Out();
}
...
void LifeCycleManager::InitializeProvidedServiceInstances() noexcept {
    // Register provided service for instance /JICA/Service/ProvidedSomeipObjectFusionModelSI_Out/ProvidedSomeipObjectFusionModelSI_Out
    {
      ::amsr::someip_binding::internal::ProvidedServiceInstanceId const ObjectFusionModelSI_Out_provided_service_instance_id{ static_cast<::amsr::someip_protocol::internal::ServiceId>(0x20),
                                                                                                                                                        1, 0, 0x415 };
      aracom_someip_binding_->GetServerManager().RegisterProvidedServiceInstance(ObjectFusionModelSI_Out_provided_service_instance_id);
    }
}
...
void LifeCycleManager::InitializeServiceDiscoverySkeletonXfs() noexcept {
  ...
  // Instantiate ServiceDiscoverySkeletonXfs for instance /JICA/Service/ProvidedSomeipObjectFusionModelSI_Out/ProvidedSomeipObjectFusionModelSI_Out
  {
    // Types.
    using SkeletonXfType =
        ::amsr::someip_binding_transformation_layer::internal::objectfusionmodelsi_out::ObjectFusionModelSI_OutSkeletonSomeIpBinding;
    ...
    // Variables.
    ::amsr::someip_binding::internal::ProvidedServiceInstanceId const provided_service_instance_id{static_cast<::amsr::someip_protocol::internal::ServiceId>(0x20),
         1, 0, 0x415 };
    ...
    ::amsr::generic::Singleton<::amsr::socal::internal::service_discovery::ServiceDiscovery<
        ::objectfusionmodelsi_out::skeleton::ObjectFusionModelSI_OutSkeleton>*>& service_discovery {
...
void LifeCycleManager::CleanInstanceSpecifierToInstanceIdMapping() noexcept {
  {
    // Remove mapping R-Port /JICA/SWC/ObjectFusionModelExe/ObjectFusionModel/ObjectFusionModelInfoSIR to instance /JICA/Service/RequiredSomeipToSOCA_InfomationSI/RequiredSomeipToSOCA_InfomationSI 
    ::ara::core::InstanceSpecifier const instance_specifier{"ObjectFusionModelExe/ObjectFusionModel/ObjectFusionModelInfoSIR"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1132"_sv};
  ...
  {
    // Remove mapping P-Port /JICA/SWC/ObjectFusionModelExe/ObjectFusionModel/ObjectFusionModelSIP to instance /JICA/Service/ProvidedSomeipObjectFusionModelSI_Out/ProvidedSomeipObjectFusionModelSI_Out
    ::ara::core::InstanceSpecifier const instance_specifier{"ObjectFusionModelExe/ObjectFusionModel/ObjectFusionModelSIP"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1045"_sv};
