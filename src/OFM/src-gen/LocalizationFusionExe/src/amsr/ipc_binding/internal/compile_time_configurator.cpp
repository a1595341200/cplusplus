 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/src/amsr/ipc_binding/internal/compile_time_configurator.cpp
...
void CompileTimeConfigurator<BindingCoreType>::RegisterInstanceSpecifierMappings(RuntimeInterface& runtime, BindingCoreType const& binding_core) noexcept {
  ...
  {
    // Map R-Port /JICA/SWC/LocalizationFusionExe/LocalizationFusion/LocalizationFusionCamStsSIR to instance /JICA/Service/RequiredIpcPerceptionSI_CamStsOut/RequiredIpcPerceptionSI_CamStsOut 
    ::ara::core::InstanceSpecifier const instance_specifier{"LocalizationFusionExe/LocalizationFusion/LocalizationFusionCamStsSIR"_sv};
  ...
  {
    // Map R-Port /JICA/SWC/LocalizationFusionExe/LocalizationFusion/LocalizationFusionLaneSIR to instance /JICA/Service/RequiredIpcPerceptionSI_LaneOut/RequiredIpcPerceptionSI_LaneOut 
    ::ara::core::InstanceSpecifier const instance_specifier{"LocalizationFusionExe/LocalizationFusion/LocalizationFusionLaneSIR"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"Ipc:1085"_sv};
    runtime.MapRequiredInstanceSpecifierToInstanceId(binding_core.GetName(), instance_specifier, instance_identifier,
                                             "/JICA/Service/Interface/PerceptionSI_LaneOut"_sv);
  }
  {
    // Map R-Port /JICA/SWC/LocalizationFusionExe/LocalizationFusion/LocalizationFusionPerceptionSIR to instance /JICA/Service/RequiredIpcPerceptionSI_Out/RequiredIpcPerceptionSI_Out 
    ::ara::core::InstanceSpecifier const instance_specifier{"LocalizationFusionExe/LocalizationFusion/LocalizationFusionPerceptionSIR"_sv};
...
void CompileTimeConfigurator<BindingCoreType>::Cleanup(RuntimeInterface& runtime) const noexcept {
  ...
  {
    // Remove mapping R-Port /JICA/SWC/LocalizationFusionExe/LocalizationFusion/LocalizationFusionCamStsSIR to instance /JICA/Service/RequiredIpcPerceptionSI_CamStsOut/RequiredIpcPerceptionSI_CamStsOut 
    ::ara::core::InstanceSpecifier const instance_specifier{"LocalizationFusionExe/LocalizationFusion/LocalizationFusionCamStsSIR"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"Ipc:1086"_sv};
    runtime.RemoveRequiredInstanceSpecifierEntry(instance_specifier, instance_identifier);
  }
  {
    // Remove mapping R-Port /JICA/SWC/LocalizationFusionExe/LocalizationFusion/LocalizationFusionLaneSIR to instance /JICA/Service/RequiredIpcPerceptionSI_LaneOut/RequiredIpcPerceptionSI_LaneOut 
    ::ara::core::InstanceSpecifier const instance_specifier{"LocalizationFusionExe/LocalizationFusion/LocalizationFusionLaneSIR"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"Ipc:1085"_sv};
    runtime.RemoveRequiredInstanceSpecifierEntry(instance_specifier, instance_identifier);
  }
  {
    // Remove mapping R-Port /JICA/SWC/LocalizationFusionExe/LocalizationFusion/LocalizationFusionPerceptionSIR to instance /JICA/Service/RequiredIpcPerceptionSI_Out/RequiredIpcPerceptionSI_Out 
    ::ara::core::InstanceSpecifier const instance_specifier{"LocalizationFusionExe/LocalizationFusion/LocalizationFusionPerceptionSIR"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"Ipc:1060"_sv};
    runtime.RemoveRequiredInstanceSpecifierEntry(instance_specifier, instance_identifier);
  }
...
void CompileTimeConfigurator<BindingCoreType>::InitializeRequiredServiceDeployments(BindingCoreType& binding_core) noexcept {
  ...
  {
    // Instantiate required service instances for service deployment '/JICA/Service/DeploymentIpc/IpcPerceptionSI_LaneOut'.
    {
      ::amsr::ipc_binding_core::internal::ipc_protocol::ServiceDiscoveryServiceInstanceIdentifier sd_service_identifer{};
      sd_service_identifer.service_id_ = 98;
      sd_service_identifer.instance_id_ =  1085U;
      sd_service_identifer.major_version_ =  1;
      sd_service_identifer.minor_version_  =  ::amsr::ipc_binding_core::internal::ipc_protocol::kMinorVersionAny;

      // Required service instance '/JICA/Service/RequiredIpcPerceptionSI_LaneOut/RequiredIpcPerceptionSI_LaneOut'
      binding_core.GetClientManager().EmplaceRequiredServiceInstance(sd_service_identifer, ::perceptionsi_laneout::PerceptionSI_LaneOut::ServiceIdentifier);
    }
  }
  {
