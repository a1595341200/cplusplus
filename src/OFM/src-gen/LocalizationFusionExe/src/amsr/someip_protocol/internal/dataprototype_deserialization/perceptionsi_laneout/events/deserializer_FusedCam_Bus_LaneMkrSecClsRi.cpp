 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsi_laneout/events/deserializer_FusedCam_Bus_LaneMkrSecClsRi.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/LaneMkrCam1SecClsRi/deserializer_LaneMkrCam1SecClsRi.h"
...
deserialization::Result DeserializerFusedCam_Bus_LaneMkrSecClsRi::Deserialize(deserialization::Reader &reader, ::LaneMkrCam1SecClsRi::LaneMkrCam1SecClsRi &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionSI_LaneOut/FusedCam_Bus_LaneMkrSecClsRi
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::LaneMkrCam1SecClsRi::LaneMkrCam1SecClsRi>{})};
