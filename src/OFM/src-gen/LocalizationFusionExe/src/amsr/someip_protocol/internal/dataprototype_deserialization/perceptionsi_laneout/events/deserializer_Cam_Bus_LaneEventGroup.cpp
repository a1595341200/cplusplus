 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsi_laneout/events/deserializer_Cam_Bus_LaneEventGroup.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/LaneEventGroup/deserializer_LaneEventGroup.h"
...
deserialization::Result DeserializerCam_Bus_LaneEventGroup::Deserialize(deserialization::Reader &reader, ::LaneEventGroups::LaneEventGroups &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionSI_LaneOut/Cam_Bus_LaneEventGroup
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::LaneEventGroups::LaneEventGroups>{})};
