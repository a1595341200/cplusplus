 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsi_laneout/events/deserializer_FusedCam_Bus_LaneMkrRi.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/LaneMkrCam1Ri/deserializer_LaneMkrCam1Ri.h"
...
deserialization::Result DeserializerFusedCam_Bus_LaneMkrRi::Deserialize(deserialization::Reader &reader, ::LaneMkrCam1Ri::LaneMkrCam1Ri &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionSI_LaneOut/FusedCam_Bus_LaneMkrRi
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::LaneMkrCam1Ri::LaneMkrCam1Ri>{})};
