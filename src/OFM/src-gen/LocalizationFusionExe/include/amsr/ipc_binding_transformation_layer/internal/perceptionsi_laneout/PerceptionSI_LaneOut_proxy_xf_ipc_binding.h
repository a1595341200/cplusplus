 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/amsr/ipc_binding_transformation_layer/internal/perceptionsi_laneout/PerceptionSI_LaneOut_proxy_xf_ipc_binding.h
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_LANEOUT_PERCEPTIONSI_LANEOUT_PROXY_XF_IPC_BINDING_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_LANEOUT_PERCEPTIONSI_LANEOUT_PROXY_XF_IPC_BINDING_H_
...
#include <map>
#include <utility>
#include "amsr/ipc_binding_transformation_layer/internal/perceptionsi_laneout/PerceptionSI_LaneOut_proxy_xf_ipc_events.h"
...
/*!
 * \brief Parameterization of the IPC deployment information for service interface 'PerceptionSI_LaneOutProxy'.
 */
using PerceptionSI_LaneOutRequiredIpcDeployment =
    ::amsr::ipc_binding_transformation_layer::internal::IpcServiceInterfaceDeploymentElement<// Abstract service interface reference
                                         ::perceptionsi_laneout::proxy::PerceptionSI_LaneOutProxy,
                                         // Service ID
...
/*!
 * \brief Required service interface deployment of service interface 'PerceptionSI_LaneOut'.
 */
class PerceptionSI_LaneOutProxyXf final
    : public ::perceptionsi_laneout::internal::PerceptionSI_LaneOutProxyBackendInterface,
      public ::amsr::ipc_binding_core::internal::LocalClientSink,
      public std::enable_shared_from_this< PerceptionSI_LaneOutProxyXf> {
 public:

  /*!
   * \brief         Constructor of ProxyXf for service 'PerceptionSI_LaneOut'.
   ...
   */
   PerceptionSI_LaneOutProxyXf(
      ...
      , event_backend_FusedCam_Bus_LaneMkrLe_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4607}, timer_manager, runtime_processing_mode}
      , event_backend_FusedCam_Bus_LaneMkrRi_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4608}, timer_manager, runtime_processing_mode}
      , event_backend_FrntCam_Bus_RoadEdgeLe_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4610}, timer_manager, runtime_processing_mode}
      , event_backend_FrntCam_Bus_RoadEdgeRi_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4611}, timer_manager, runtime_processing_mode}
      , event_backend_Cam_Bus_LaneEvent_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4617}, timer_manager, runtime_processing_mode}
      , event_backend_Cam_Bus_LaneEventGroup_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4618}, timer_manager, runtime_processing_mode}
      , event_backend_Cam_Bus_LaneMkrTemp_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4619}, timer_manager, runtime_processing_mode}
      , event_backend_FusedCam_Bus_LaneMkrSecClsLe_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4622}, timer_manager, runtime_processing_mode}
      , event_backend_FusedCam_Bus_LaneMkrSecClsRi_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4623}, timer_manager, runtime_processing_mode}
 {
  ...
  */
  ...
  /*!
   * \brief       Getter function for the event 'FusedCam_Bus_LaneMkrLe'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_LaneOutProxyXfEventBackendFusedCam_Bus_LaneMkrLe& GetEventBackendFusedCam_Bus_LaneMkrLe() noexcept final {
    return event_backend_FusedCam_Bus_LaneMkrLe_;
  }

  /*!
   * \brief       Getter function for the event 'FusedCam_Bus_LaneMkrRi'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_LaneOutProxyXfEventBackendFusedCam_Bus_LaneMkrRi& GetEventBackendFusedCam_Bus_LaneMkrRi() noexcept final {
    return event_backend_FusedCam_Bus_LaneMkrRi_;
  }

  /*!
   * \brief       Getter function for the event 'FrntCam_Bus_RoadEdgeLe'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_LaneOutProxyXfEventBackendFrntCam_Bus_RoadEdgeLe& GetEventBackendFrntCam_Bus_RoadEdgeLe() noexcept final {
    return event_backend_FrntCam_Bus_RoadEdgeLe_;
  }

  /*!
   * \brief       Getter function for the event 'FrntCam_Bus_RoadEdgeRi'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_LaneOutProxyXfEventBackendFrntCam_Bus_RoadEdgeRi& GetEventBackendFrntCam_Bus_RoadEdgeRi() noexcept final {
    return event_backend_FrntCam_Bus_RoadEdgeRi_;
  }

  /*!
   * \brief       Getter function for the event 'Cam_Bus_LaneEvent'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_LaneOutProxyXfEventBackendCam_Bus_LaneEvent& GetEventBackendCam_Bus_LaneEvent() noexcept final {
    return event_backend_Cam_Bus_LaneEvent_;
  }

  /*!
   * \brief       Getter function for the event 'Cam_Bus_LaneEventGroup'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_LaneOutProxyXfEventBackendCam_Bus_LaneEventGroup& GetEventBackendCam_Bus_LaneEventGroup() noexcept final {
    return event_backend_Cam_Bus_LaneEventGroup_;
  }

  /*!
   * \brief       Getter function for the event 'Cam_Bus_LaneMkrTemp'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_LaneOutProxyXfEventBackendCam_Bus_LaneMkrTemp& GetEventBackendCam_Bus_LaneMkrTemp() noexcept final {
    return event_backend_Cam_Bus_LaneMkrTemp_;
  }

  /*!
   * \brief       Getter function for the event 'FusedCam_Bus_LaneMkrSecClsLe'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_LaneOutProxyXfEventBackendFusedCam_Bus_LaneMkrSecClsLe& GetEventBackendFusedCam_Bus_LaneMkrSecClsLe() noexcept final {
    return event_backend_FusedCam_Bus_LaneMkrSecClsLe_;
  }

  /*!
   * \brief       Getter function for the event 'FusedCam_Bus_LaneMkrSecClsRi'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_LaneOutProxyXfEventBackendFusedCam_Bus_LaneMkrSecClsRi& GetEventBackendFusedCam_Bus_LaneMkrSecClsRi() noexcept final {
    return event_backend_FusedCam_Bus_LaneMkrSecClsRi_;
  }
 ...
 private:
   ...
   */
  static constexpr IpcServiceInterfaceDeployment kDeployment{PerceptionSI_LaneOutRequiredIpcDeployment::kDeployment};
  ...
  /*!
   * \brief Event backend for proxy event 'FusedCam_Bus_LaneMkrLe'.
   */
  PerceptionSI_LaneOutProxyXfEventBackendFusedCam_Bus_LaneMkrLe event_backend_FusedCam_Bus_LaneMkrLe_;

  /*!
   * \brief Event backend for proxy event 'FusedCam_Bus_LaneMkrRi'.
   */
  PerceptionSI_LaneOutProxyXfEventBackendFusedCam_Bus_LaneMkrRi event_backend_FusedCam_Bus_LaneMkrRi_;

  /*!
   * \brief Event backend for proxy event 'FrntCam_Bus_RoadEdgeLe'.
   */
  PerceptionSI_LaneOutProxyXfEventBackendFrntCam_Bus_RoadEdgeLe event_backend_FrntCam_Bus_RoadEdgeLe_;

  /*!
   * \brief Event backend for proxy event 'FrntCam_Bus_RoadEdgeRi'.
   */
  PerceptionSI_LaneOutProxyXfEventBackendFrntCam_Bus_RoadEdgeRi event_backend_FrntCam_Bus_RoadEdgeRi_;

  /*!
   * \brief Event backend for proxy event 'Cam_Bus_LaneEvent'.
   */
  PerceptionSI_LaneOutProxyXfEventBackendCam_Bus_LaneEvent event_backend_Cam_Bus_LaneEvent_;

  /*!
   * \brief Event backend for proxy event 'Cam_Bus_LaneEventGroup'.
   */
  PerceptionSI_LaneOutProxyXfEventBackendCam_Bus_LaneEventGroup event_backend_Cam_Bus_LaneEventGroup_;

  /*!
   * \brief Event backend for proxy event 'Cam_Bus_LaneMkrTemp'.
   */
  PerceptionSI_LaneOutProxyXfEventBackendCam_Bus_LaneMkrTemp event_backend_Cam_Bus_LaneMkrTemp_;

  /*!
   * \brief Event backend for proxy event 'FusedCam_Bus_LaneMkrSecClsLe'.
   */
  PerceptionSI_LaneOutProxyXfEventBackendFusedCam_Bus_LaneMkrSecClsLe event_backend_FusedCam_Bus_LaneMkrSecClsLe_;

  /*!
   * \brief Event backend for proxy event 'FusedCam_Bus_LaneMkrSecClsRi'.
   */
  PerceptionSI_LaneOutProxyXfEventBackendFusedCam_Bus_LaneMkrSecClsRi event_backend_FusedCam_Bus_LaneMkrSecClsRi_;
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_LANEOUT_PERCEPTIONSI_LANEOUT_PROXY_XF_IPC_BINDING_H_
