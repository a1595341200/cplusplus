 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/MainType/impl_type_maintype.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_MAINTYPE_IMPL_TYPE_MAINTYPE_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_MAINTYPE_IMPL_TYPE_MAINTYPE_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_MAINTYPE_IMPL_TYPE_MAINTYPE_H_
