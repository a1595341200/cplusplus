 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/LaneMkrCam1SecClsLe/impl_type_lanemkrcam1secclsle.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_LANEMKRCAM1SECCLSLE_IMPL_TYPE_LANEMKRCAM1SECCLSLE_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_LANEMKRCAM1SECCLSLE_IMPL_TYPE_LANEMKRCAM1SECCLSLE_H_
...
/*!
 * \brief Type LaneMkrCam1SecClsLe.
 * \remark generated
 * \trace SPEC-5951372
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/LaneMkrCam1SecClsLe
 */
struct LaneMkrCam1SecClsLe {
...
/*!
 * \brief Compare for equality with another LaneMkrCam1SecClsLe instance.
 */
inline bool operator==(LaneMkrCam1SecClsLe const& l,
                       LaneMkrCam1SecClsLe const& r) noexcept {
...
/*!
 * \brief Compare for inequality with another LaneMkrCam1SecClsLe instance.
 */
inline bool operator!=(LaneMkrCam1SecClsLe const& l,
                       LaneMkrCam1SecClsLe const& r) noexcept {
  return !(l == r);
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_LANEMKRCAM1SECCLSLE_IMPL_TYPE_LANEMKRCAM1SECCLSLE_H_
