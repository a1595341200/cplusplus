 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/TypeRoadSign/impl_type_typeroadsign.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_TYPEROADSIGN_IMPL_TYPE_TYPEROADSIGN_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_TYPEROADSIGN_IMPL_TYPE_TYPEROADSIGN_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_TYPEROADSIGN_IMPL_TYPE_TYPEROADSIGN_H_
