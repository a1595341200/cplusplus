 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/RoadEdge1VccRi/impl_type_roadedge1vccri.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_ROADEDGE1VCCRI_IMPL_TYPE_ROADEDGE1VCCRI_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_ROADEDGE1VCCRI_IMPL_TYPE_ROADEDGE1VCCRI_H_
...
/*!
 * \brief Type RoadEdge1VccRi.
 * \remark generated
 * \trace SPEC-5951372
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/RoadEdge1VccRi
 */
struct RoadEdge1VccRi {
...
/*!
 * \brief Compare for equality with another RoadEdge1VccRi instance.
 */
inline bool operator==(RoadEdge1VccRi const& l,
                       RoadEdge1VccRi const& r) noexcept {
...
/*!
 * \brief Compare for inequality with another RoadEdge1VccRi instance.
 */
inline bool operator!=(RoadEdge1VccRi const& l,
                       RoadEdge1VccRi const& r) noexcept {
  return !(l == r);
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_ROADEDGE1VCCRI_IMPL_TYPE_ROADEDGE1VCCRI_H_
