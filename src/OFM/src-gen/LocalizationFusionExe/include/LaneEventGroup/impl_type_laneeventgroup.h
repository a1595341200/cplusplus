 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/LaneEventGroup/impl_type_laneeventgroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_LANEEVENTGROUP_IMPL_TYPE_LANEEVENTGROUP_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_LANEEVENTGROUP_IMPL_TYPE_LANEEVENTGROUP_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_LANEEVENTGROUP_IMPL_TYPE_LANEEVENTGROUP_H_
