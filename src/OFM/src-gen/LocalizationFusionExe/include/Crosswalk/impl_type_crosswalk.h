 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/Crosswalk/impl_type_crosswalk.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_CROSSWALK_IMPL_TYPE_CROSSWALK_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_CROSSWALK_IMPL_TYPE_CROSSWALK_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_CROSSWALK_IMPL_TYPE_CROSSWALK_H_
