 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_proxy_update_manager.h
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
