 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/tosoca_locsensorinfosi/tosoca_locsensorinfosi_proxy.h
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_H_
...
#include "tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_proxy_update_manager.h"
...
using OSM2_Bus_LocSensorInfo =
    ::amsr::socal::events::ProxyEvent<::LocSensorInfo1VCC::LocSensorInfo1VCC>;
 ...
 * \trace SPEC-4980344
 */
class ToSOCA_LocSensorInfoSIProxy : public ::amsr::socal::Proxy<tosoca_locsensorinfosi::ToSOCA_LocSensorInfoSI, tosoca_locsensorinfosi::internal::ToSOCA_LocSensorInfoSIProxyBackendInterface, tosoca_locsensorinfosi::internal::ToSOCA_LocSensorInfoSIHandleType> {
 public:
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Proxy<tosoca_locsensorinfosi::ToSOCA_LocSensorInfoSI, ProxyBackendInterface, tosoca_locsensorinfosi::internal::ToSOCA_LocSensorInfoSIHandleType>;
   ...
   */
  tosoca_locsensorinfosi::internal::ToSOCA_LocSensorInfoSIProxyUpdateManager proxy_update_manager_;
 ...
 public:
   ...
   * \details
   * Data of type ::LocSensorInfo1VCC::LocSensorInfo1VCC 
   * \vpublic
   */
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_H_
