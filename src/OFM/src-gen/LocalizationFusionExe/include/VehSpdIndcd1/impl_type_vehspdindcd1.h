 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/VehSpdIndcd1/impl_type_vehspdindcd1.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_VEHSPDINDCD1_IMPL_TYPE_VEHSPDINDCD1_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_VEHSPDINDCD1_IMPL_TYPE_VEHSPDINDCD1_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_VEHSPDINDCD1_IMPL_TYPE_VEHSPDINDCD1_H_
