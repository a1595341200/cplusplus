 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/TrfcSign/impl_type_trfcsign.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_TRFCSIGN_IMPL_TYPE_TRFCSIGN_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_TRFCSIGN_IMPL_TYPE_TRFCSIGN_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_TRFCSIGN_IMPL_TYPE_TRFCSIGN_H_
