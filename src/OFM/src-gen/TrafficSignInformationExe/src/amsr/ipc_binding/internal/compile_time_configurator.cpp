 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/ipc_binding/internal/compile_time_configurator.cpp
...
void CompileTimeConfigurator<BindingCoreType>::RegisterInstanceSpecifierMappings(RuntimeInterface& runtime, BindingCoreType const& binding_core) noexcept {
  ...
  {
    // Map R-Port /JICA/SWC/TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationCamStsSIR to instance /JICA/Service/RequiredIpcPerceptionSI_CamStsOut/RequiredIpcPerceptionSI_CamStsOut 
    ::ara::core::InstanceSpecifier const instance_specifier{"TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationCamStsSIR"_sv};
  ...
  {
    // Map R-Port /JICA/SWC/TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationPerceptionSIR to instance /JICA/Service/RequiredIpcPerceptionSI_Out/RequiredIpcPerceptionSI_Out 
    ::ara::core::InstanceSpecifier const instance_specifier{"TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationPerceptionSIR"_sv};
...
void CompileTimeConfigurator<BindingCoreType>::Cleanup(RuntimeInterface& runtime) const noexcept {
  ...
  {
    // Remove mapping R-Port /JICA/SWC/TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationCamStsSIR to instance /JICA/Service/RequiredIpcPerceptionSI_CamStsOut/RequiredIpcPerceptionSI_CamStsOut 
    ::ara::core::InstanceSpecifier const instance_specifier{"TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationCamStsSIR"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"Ipc:1086"_sv};
    runtime.RemoveRequiredInstanceSpecifierEntry(instance_specifier, instance_identifier);
  }
  {
    // Remove mapping R-Port /JICA/SWC/TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationPerceptionSIR to instance /JICA/Service/RequiredIpcPerceptionSI_Out/RequiredIpcPerceptionSI_Out 
    ::ara::core::InstanceSpecifier const instance_specifier{"TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationPerceptionSIR"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"Ipc:1060"_sv};
    runtime.RemoveRequiredInstanceSpecifierEntry(instance_specifier, instance_identifier);
  }
