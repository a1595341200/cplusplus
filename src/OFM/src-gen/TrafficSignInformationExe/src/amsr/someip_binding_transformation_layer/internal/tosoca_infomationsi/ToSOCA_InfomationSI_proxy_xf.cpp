 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_binding_transformation_layer/internal/tosoca_infomationsi/ToSOCA_InfomationSI_proxy_xf.cpp
...
void ToSOCA_InfomationSIProxyXf::Start() noexcept { is_active_ = true; }

void ToSOCA_InfomationSIProxyXf::Stop() noexcept { is_active_ = false; }
...
::ara::core::Result<void> ToSOCA_InfomationSIProxyXf::RequestService() noexcept {
...
void ToSOCA_InfomationSIProxyXf::ReleaseService() noexcept {
  std::lock_guard<std::mutex> const request_service_guard{request_service_mutex_};
...
bool ToSOCA_InfomationSIProxyXf::SendMethodRequest(::vac::memory::MemoryBufferPtr<osabstraction::io::MutableIOBuffer> packet) {
  return client_manager_.SendMethodRequest(instance_id_, std::move(packet));
}

void ToSOCA_InfomationSIProxyXf::HandleMethodResponse(
...
void ToSOCA_InfomationSIProxyXf::OnServiceDown() {
}
