 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_binding/internal/life_cycle_manager.cpp
...
void LifeCycleManager::RegisterServiceInstances() noexcept {
  {
    ...
    {
      // Map R-Port /JICA/SWC/TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationInfoSIR to instance /JICA/Service/RequiredSomeipToSOCA_InfomationSI/RequiredSomeipToSOCA_InfomationSI 
      ::ara::core::InstanceSpecifier const instance_specifier{"TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationInfoSIR"_sv};
  ...
  }
  {
    ...
    {
      // Map P-Port /JICA/SWC/TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationSIP to instance /JICA/Service/ProvidedSomeipTrafficSignInformationSI_Out/ProvidedSomeipTrafficSignInformationSI_Out
      ::ara::core::InstanceSpecifier const instance_specifier{"TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationSIP"_sv};
      ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1051"_sv};

      runtime_->MapProvidedInstanceSpecifierToInstanceId(
            vac::container::CStringView{"SomeIp"_sv}, instance_specifier, instance_identifier,
            "/JICA/Service/Interface/TrafficSignInformationSI_Out"_sv);
    }
  }
}
...
// VECTOR NC AutosarC++17_10-M9.3.3, VectorC++-V5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-M9.3.3_Method_can_be_declared_const
 void LifeCycleManager::InitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/TrafficSignInformationSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::trafficsigninformationsi_out::
      AraComSomeIpBindingInitializeSkeletonSomeIpEventBackendsTrafficSignInformationSI_Out(aracom_someip_binding_->GetServerManager());
}
...
void LifeCycleManager::DeInitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/TrafficSignInformationSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::trafficsigninformationsi_out::
      AraComSomeIpBindingDeInitializeSkeletonSomeIpEventBackendsTrafficSignInformationSI_Out();
}
...
void LifeCycleManager::InitializeProvidedServiceInstances() noexcept {
    // Register provided service for instance /JICA/Service/ProvidedSomeipTrafficSignInformationSI_Out/ProvidedSomeipTrafficSignInformationSI_Out
    {
      ::amsr::someip_binding::internal::ProvidedServiceInstanceId const TrafficSignInformationSI_Out_provided_service_instance_id{ static_cast<::amsr::someip_protocol::internal::ServiceId>(0x2C),
                                                                                                                                                        1, 0, 0x41B };
      aracom_someip_binding_->GetServerManager().RegisterProvidedServiceInstance(TrafficSignInformationSI_Out_provided_service_instance_id);
    }
}
...
void LifeCycleManager::InitializeServiceDiscoverySkeletonXfs() noexcept {
  ...
  // Instantiate ServiceDiscoverySkeletonXfs for instance /JICA/Service/ProvidedSomeipTrafficSignInformationSI_Out/ProvidedSomeipTrafficSignInformationSI_Out
  {
    // Types.
    using SkeletonXfType =
        ::amsr::someip_binding_transformation_layer::internal::trafficsigninformationsi_out::TrafficSignInformationSI_OutSkeletonSomeIpBinding;
    ...
    // Variables.
    ::amsr::someip_binding::internal::ProvidedServiceInstanceId const provided_service_instance_id{static_cast<::amsr::someip_protocol::internal::ServiceId>(0x2C),
         1, 0, 0x41B };
    ...
    ::amsr::generic::Singleton<::amsr::socal::internal::service_discovery::ServiceDiscovery<
        ::trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton>*>& service_discovery {
            ::trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton::GetServiceDiscovery()};
...
void LifeCycleManager::CleanInstanceSpecifierToInstanceIdMapping() noexcept {
  {
    // Remove mapping R-Port /JICA/SWC/TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationInfoSIR to instance /JICA/Service/RequiredSomeipToSOCA_InfomationSI/RequiredSomeipToSOCA_InfomationSI 
    ::ara::core::InstanceSpecifier const instance_specifier{"TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationInfoSIR"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1132"_sv};
  ...
  {
    // Remove mapping P-Port /JICA/SWC/TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationSIP to instance /JICA/Service/ProvidedSomeipTrafficSignInformationSI_Out/ProvidedSomeipTrafficSignInformationSI_Out
    ::ara::core::InstanceSpecifier const instance_specifier{"TrafficSignInformationExe/TrafficSignInformation/TrafficSignInformationSIP"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1051"_sv};
