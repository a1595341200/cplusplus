 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsi_out/events/deserializer_FrntCam_Bus_StopLine.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/StopLine/deserializer_StopLine.h"
...
deserialization::Result DeserializerFrntCam_Bus_StopLine::Deserialize(deserialization::Reader &reader, ::StopLine::StopLine &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionSI_Out/FrntCam_Bus_StopLine
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::StopLine::StopLine>{})};
