 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/VehBattU1Vcc/impl_type_vehbattu1vcc.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHBATTU1VCC_IMPL_TYPE_VEHBATTU1VCC_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHBATTU1VCC_IMPL_TYPE_VEHBATTU1VCC_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHBATTU1VCC_IMPL_TYPE_VEHBATTU1VCC_H_
