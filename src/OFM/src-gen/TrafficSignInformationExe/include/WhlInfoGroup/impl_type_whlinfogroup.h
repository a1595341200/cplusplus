 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/WhlInfoGroup/impl_type_whlinfogroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
