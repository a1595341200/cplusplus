 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/ExtInfo/impl_type_extinfo.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTINFO_IMPL_TYPE_EXTINFO_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTINFO_IMPL_TYPE_EXTINFO_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTINFO_IMPL_TYPE_EXTINFO_H_
