 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/WipgInfoGroup/impl_type_wipginfogroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
