 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/AmbTRaw/impl_type_ambtraw.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
