 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/StopLine/impl_type_stopline.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_STOPLINE_IMPL_TYPE_STOPLINE_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_STOPLINE_IMPL_TYPE_STOPLINE_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_STOPLINE_IMPL_TYPE_STOPLINE_H_
