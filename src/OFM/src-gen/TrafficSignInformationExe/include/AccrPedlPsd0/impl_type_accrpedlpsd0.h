 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/AccrPedlPsd0/impl_type_accrpedlpsd0.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_ACCRPEDLPSD0_IMPL_TYPE_ACCRPEDLPSD0_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_ACCRPEDLPSD0_IMPL_TYPE_ACCRPEDLPSD0_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_ACCRPEDLPSD0_IMPL_TYPE_ACCRPEDLPSD0_H_
