 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/EpbSts/impl_type_epbsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
