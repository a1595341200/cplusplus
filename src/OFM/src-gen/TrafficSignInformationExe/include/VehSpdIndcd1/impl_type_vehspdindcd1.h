 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/VehSpdIndcd1/impl_type_vehspdindcd1.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHSPDINDCD1_IMPL_TYPE_VEHSPDINDCD1_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHSPDINDCD1_IMPL_TYPE_VEHSPDINDCD1_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHSPDINDCD1_IMPL_TYPE_VEHSPDINDCD1_H_
