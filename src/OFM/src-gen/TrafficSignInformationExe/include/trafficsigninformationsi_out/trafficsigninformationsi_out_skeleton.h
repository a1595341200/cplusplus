 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/trafficsigninformationsi_out/trafficsigninformationsi_out_skeleton.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRAFFICSIGNINFORMATIONSI_OUT_TRAFFICSIGNINFORMATIONSI_OUT_SKELETON_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRAFFICSIGNINFORMATIONSI_OUT_TRAFFICSIGNINFORMATIONSI_OUT_SKELETON_H_
...
#include "trafficsigninformationsi_out/TrafficSignInformationSI_Out_skeleton_impl_interface.h"
 ...
 */
class TrafficSignInformationSI_OutSkeleton;
...
/*!
 * \brief Type alias for service event 'TSI_Bus_HMIData', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using TSI_Bus_HMIData = ::amsr::socal::events::SkeletonEvent<
    trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton,
    ::TsiHmiData1Vcc::TsiHmiData1Vcc,
    trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::TsiHmiData1Vcc::TsiHmiData1Vcc>,
    &trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonImplInterface::GetEventManagerTSI_Bus_HMIData>;
...
/*!
 * \brief Skeleton interface class for the service 'TrafficSignInformationSI_Out'.
 *
 * \vpublic
 * \trace SPEC-4980341
 */
class TrafficSignInformationSI_OutSkeleton
    : public ::amsr::socal::Skeleton<trafficsigninformationsi_out::TrafficSignInformationSI_Out,
                                          trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonImplInterface> {
 public:
// ---- Constructors / Destructors -----------------------------------------------------------------------------------
/*!
 * \brief Exception-less pre-construction of TrafficSignInformationSI_Out.
 *
...
/*!
 * \brief Exception-less pre-construction of TrafficSignInformationSI_OutSkeleton.
 *
...
/*!
 * \brief Exception-less constructor of TrafficSignInformationSI_OutSkeleton.
 ...
 * \trace SPEC-8053555
 */
explicit TrafficSignInformationSI_OutSkeleton(ConstructionToken&& token) noexcept;

  /*!
   * \brief Delete default constructor.
   */
  TrafficSignInformationSI_OutSkeleton() = delete;
  /*!
   * \brief Delete copy constructor.
   */
  TrafficSignInformationSI_OutSkeleton(TrafficSignInformationSI_OutSkeleton const &) = delete;
  /*!
   * \brief Delete move constructor.
   */
  TrafficSignInformationSI_OutSkeleton(TrafficSignInformationSI_OutSkeleton &&) = delete;
  /*!
   * \brief Delete copy assignment.
   */
  TrafficSignInformationSI_OutSkeleton &operator=(TrafficSignInformationSI_OutSkeleton const &) & = delete;
  /*!
   * \brief Delete move assignment.
   */
  TrafficSignInformationSI_OutSkeleton &operator=(TrafficSignInformationSI_OutSkeleton &&) & = delete;

  /*!
   * \brief Constructor of TrafficSignInformationSI_OutSkeleton.
   *
   ...
   * \trace SPEC-4980356
   */
   explicit TrafficSignInformationSI_OutSkeleton(
   ...
   * \trace SPEC-4980351
   */
  ~TrafficSignInformationSI_OutSkeleton() noexcept override;

  /*!
   * \brief Type alias for ServiceDiscovery.
   */
  using ServiceDiscovery = ::amsr::socal::internal::service_discovery::ServiceDiscovery<TrafficSignInformationSI_OutSkeleton>;
  ...
  /*!
   * \brief The skeleton event 'TSI_Bus_HMIData' which can be used by application developer.
   * \details 
   * Data of type ::TsiHmiData1Vcc::TsiHmiData1Vcc
   * \vpublic
   */
  events::TSI_Bus_HMIData TSI_Bus_HMIData;
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<trafficsigninformationsi_out::TrafficSignInformationSI_Out, trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonImplInterface>;

  /*!
   * \copydoc amsr::socal::Skeleton<trafficsigninformationsi_out::TrafficSignInformationSI_Out,trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonImplInterface>::DoFieldInitializationChecks()
   */
  void DoFieldInitializationChecks() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<trafficsigninformationsi_out::TrafficSignInformationSI_Out,trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonImplInterface>::SendInitialFieldNotifications()
   */
  void SendInitialFieldNotifications() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<trafficsigninformationsi_out::TrafficSignInformationSI_Out,trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonImplInterface>::OfferServiceInternal()
   */
  void OfferServiceInternal(::ara::com::InstanceIdentifier const& instance_id) noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<trafficsigninformationsi_out::TrafficSignInformationSI_Out,trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonImplInterface>::StopOfferServiceInternal()
   */
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRAFFICSIGNINFORMATIONSI_OUT_TRAFFICSIGNINFORMATIONSI_OUT_SKELETON_H_
