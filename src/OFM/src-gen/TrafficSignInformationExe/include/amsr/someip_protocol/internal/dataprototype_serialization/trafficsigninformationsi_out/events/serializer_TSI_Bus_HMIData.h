 ...
 * \details Top-Level data type: /CppImplementationDataTypes/TsiHmiData1Vcc
...
class SerializerTSI_Bus_HMIData {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/TsiHmiData1Vcc.
   *
   ...
   * \synchronous TRUE
   */
  constexpr static std::size_t GetRequiredBufferSize(::TsiHmiData1Vcc::TsiHmiData1Vcc const &data) noexcept {
   ...
   * \synchronous TRUE
   */
  static void Serialize(serialization::Writer &writer, ::TsiHmiData1Vcc::TsiHmiData1Vcc const &data);
