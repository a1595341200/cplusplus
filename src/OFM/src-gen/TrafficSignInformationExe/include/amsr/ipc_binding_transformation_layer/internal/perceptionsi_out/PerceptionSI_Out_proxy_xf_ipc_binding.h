 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/ipc_binding_transformation_layer/internal/perceptionsi_out/PerceptionSI_Out_proxy_xf_ipc_binding.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_PROXY_XF_IPC_BINDING_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_PROXY_XF_IPC_BINDING_H_
...
/*!
 * \brief Parameterization of the IPC deployment information for service interface 'PerceptionSI_OutProxy'.
 */
using PerceptionSI_OutRequiredIpcDeployment =
    ::amsr::ipc_binding_transformation_layer::internal::IpcServiceInterfaceDeploymentElement<// Abstract service interface reference
                                         ::perceptionsi_out::proxy::PerceptionSI_OutProxy,
                                         // Service ID
...
class PerceptionSI_OutProxyXf final
    : public ::perceptionsi_out::internal::PerceptionSI_OutProxyBackendInterface,
      ...
      public std::enable_shared_from_this< PerceptionSI_OutProxyXf> {
 public:
   ...
   */
   PerceptionSI_OutProxyXf(
      ...
      , event_backend_FrntCam_Bus_RoadSign_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4609}, timer_manager, runtime_processing_mode}
      , event_backend_FrntCam_Bus_TrfcSign_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4612}, timer_manager, runtime_processing_mode}
      , event_backend_FrntCam_Bus_StopLine_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4613}, timer_manager, runtime_processing_mode}
      , event_backend_FrntCam_Bus_Crosswalk_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4614}, timer_manager, runtime_processing_mode}
      , event_backend_FrntCam_Bus_TrfcLi_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4616}, timer_manager, runtime_processing_mode}
      , event_backend_FrntCam_Bus_ExtInfo_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4620}, timer_manager, runtime_processing_mode}
      , event_backend_FrntCam_Bus_LsrObj_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4621}, timer_manager, runtime_processing_mode}
 {
  ...
  */
  ...
  /*!
   * \brief       Getter function for the event 'FrntCam_Bus_RoadSign'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_OutProxyXfEventBackendFrntCam_Bus_RoadSign& GetEventBackendFrntCam_Bus_RoadSign() noexcept final {
    return event_backend_FrntCam_Bus_RoadSign_;
  }

  /*!
   * \brief       Getter function for the event 'FrntCam_Bus_TrfcSign'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_OutProxyXfEventBackendFrntCam_Bus_TrfcSign& GetEventBackendFrntCam_Bus_TrfcSign() noexcept final {
    return event_backend_FrntCam_Bus_TrfcSign_;
  }

  /*!
   * \brief       Getter function for the event 'FrntCam_Bus_StopLine'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_OutProxyXfEventBackendFrntCam_Bus_StopLine& GetEventBackendFrntCam_Bus_StopLine() noexcept final {
    return event_backend_FrntCam_Bus_StopLine_;
  }

  /*!
   * \brief       Getter function for the event 'FrntCam_Bus_Crosswalk'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_OutProxyXfEventBackendFrntCam_Bus_Crosswalk& GetEventBackendFrntCam_Bus_Crosswalk() noexcept final {
    return event_backend_FrntCam_Bus_Crosswalk_;
  }
  ...
  /*!
   * \brief       Getter function for the event 'FrntCam_Bus_LsrObj'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_OutProxyXfEventBackendFrntCam_Bus_LsrObj& GetEventBackendFrntCam_Bus_LsrObj() noexcept final {
    return event_backend_FrntCam_Bus_LsrObj_;
  }
 ...
 private:
   ...
   */
  static constexpr IpcServiceInterfaceDeployment kDeployment{PerceptionSI_OutRequiredIpcDeployment::kDeployment};
  ...
  /*!
   * \brief Event backend for proxy event 'FrntCam_Bus_RoadSign'.
   */
  PerceptionSI_OutProxyXfEventBackendFrntCam_Bus_RoadSign event_backend_FrntCam_Bus_RoadSign_;

  /*!
   * \brief Event backend for proxy event 'FrntCam_Bus_TrfcSign'.
   */
  PerceptionSI_OutProxyXfEventBackendFrntCam_Bus_TrfcSign event_backend_FrntCam_Bus_TrfcSign_;

  /*!
   * \brief Event backend for proxy event 'FrntCam_Bus_StopLine'.
   */
  PerceptionSI_OutProxyXfEventBackendFrntCam_Bus_StopLine event_backend_FrntCam_Bus_StopLine_;

  /*!
   * \brief Event backend for proxy event 'FrntCam_Bus_Crosswalk'.
   */
  PerceptionSI_OutProxyXfEventBackendFrntCam_Bus_Crosswalk event_backend_FrntCam_Bus_Crosswalk_;
  ...
  /*!
   * \brief Event backend for proxy event 'FrntCam_Bus_LsrObj'.
   */
  PerceptionSI_OutProxyXfEventBackendFrntCam_Bus_LsrObj event_backend_FrntCam_Bus_LsrObj_;
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_PROXY_XF_IPC_BINDING_H_
