 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/someip_binding_transformation_layer/internal/trafficsigninformationsi_out/TrafficSignInformationSI_Out_skeleton_someip_binding.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_TRAFFICSIGNINFORMATIONSI_OUT_TRAFFICSIGNINFORMATIONSI_OUT_SKELETON_SOMEIP_BINDING_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_TRAFFICSIGNINFORMATIONSI_OUT_TRAFFICSIGNINFORMATIONSI_OUT_SKELETON_SOMEIP_BINDING_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/someip_binding_transformation_layer/internal/trafficsigninformationsi_out/TrafficSignInformationSI_Out_skeleton_someip_event_manager.h"
#include "amsr/someip_binding_transformation_layer/internal/trafficsigninformationsi_out/TrafficSignInformationSI_Out_skeleton_someip_methods.h"
 ...
 * \remark generated
 */
class TrafficSignInformationSI_OutSkeletonSomeIpBinding final :
 ...
 public:
   ...
   */
  using SkeletonFrontend = ::trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton;
  /*!
   * \brief Generated SOME/IP related service ID.
   */
  static constexpr ::amsr::someip_protocol::internal::ServiceId kServiceId{0x2CU};
  ...
  /*!
   * \brief Constructor of TrafficSignInformationSI_OutSkeletonSomeIpBinding.
   ...
   * \synchronous TRUE
   */
  TrafficSignInformationSI_OutSkeletonSomeIpBinding(::amsr::someip_protocol::internal::InstanceId const instance_id,
                                                         ::amsr::someip_binding::internal::ServerManagerInterface& someip_binding_server_manager,
                                                         ::trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton& skeleton);
  ...
  ~TrafficSignInformationSI_OutSkeletonSomeIpBinding() noexcept override  = default;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  TrafficSignInformationSI_OutSkeletonSomeIpEventManagerTSI_Bus_HMIData* GetEventManagerTSI_Bus_HMIData() noexcept override;
 ...
 private:
  ...
  ::trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton& skeleton_;

  // ---- Methods ------------------------------------------------------------------------------------------

  // ---- Event manager --------------------------------------------------------------------------------------------

  // Event manager for skeleton event 'TSI_Bus_HMIData'
  TrafficSignInformationSI_OutSkeletonSomeIpEventManagerTSI_Bus_HMIData event_manager_TSI_Bus_HMIData_;
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_TRAFFICSIGNINFORMATIONSI_OUT_TRAFFICSIGNINFORMATIONSI_OUT_SKELETON_SOMEIP_BINDING_H_
