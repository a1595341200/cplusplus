 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/perceptionsi_camstsout/PerceptionSI_CamStsOut_proxy_backend_interface.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_PROXY_BACKEND_INTERFACE_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_PROXY_BACKEND_INTERFACE_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_PROXY_BACKEND_INTERFACE_H_
