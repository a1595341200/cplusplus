...
void EHRSI_OutProxyXf::EmplaceEventBackends() {
  static_cast<void>(event_backend_table_.emplace(event_backend_EHR_Bus_NOAInfo_.GetEventId(), &event_backend_EHR_Bus_NOAInfo_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_EHR_Bus_LaneConnectivitys_.GetEventId(), &event_backend_EHR_Bus_LaneConnectivitys_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_EHR_Bus_Nodes_.GetEventId(), &event_backend_EHR_Bus_Nodes_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_EHR_Bus_TrafficSigns_.GetEventId(), &event_backend_EHR_Bus_TrafficSigns_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_EHR_Bus_GeoFences_.GetEventId(), &event_backend_EHR_Bus_GeoFences_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_EHR_Bus_LinkCurvatures_.GetEventId(), &event_backend_EHR_Bus_LinkCurvatures_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_EHR_Bus_LinkSlopes_.GetEventId(), &event_backend_EHR_Bus_LinkSlopes_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_EHR_Bus_LaneSpeedLimits_.GetEventId(), &event_backend_EHR_Bus_LaneSpeedLimits_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_EHR_Bus_LinkInfos_.GetEventId(), &event_backend_EHR_Bus_LinkInfos_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_EHR_Bus_MergePoints_.GetEventId(), &event_backend_EHR_Bus_MergePoints_ ));
  static_cast<void>(event_backend_table_.emplace(event_backend_EHR_Bus_GeofennceJudge_.GetEventId(), &event_backend_EHR_Bus_GeofennceJudge_ ));

}

void EHRSI_OutProxyXf::Start() noexcept { is_active_ = true; }

void EHRSI_OutProxyXf::Stop() noexcept { is_active_ = false; }
...
::ara::core::Result<void> EHRSI_OutProxyXf::RequestService() noexcept {
  if(++proxy_count_ == 1) {
...
// VECTOR NC AutosarC++17_10-A15.4.2: MD_IPCBINDING_AutosarC++17_10-A15.4.2_STL_exceptions
// VECTOR NC AutosarC++17_10-A15.5.3: MD_IPCBINDING_AutosarC++17_10-A15.5.3_STL_exceptions
void  EHRSI_OutProxyXf::ReleaseService() noexcept {
  if(--proxy_count_ == 0) {
    IpcProxyBindingIdentity const proxy_instance_identity{
          kDeployment.service_id_, instance_id_, kDeployment.service_interface_version_.major_version_, client_id_};
...
::amsr::ipc_binding_core::internal::ForwardOutput  EHRSI_OutProxyXf::RouteRequest(
...
::amsr::ipc_binding_core::internal::ForwardOutput EHRSI_OutProxyXf::OnResponseReceived(::amsr::ipc_binding_core::internal::ipc_protocol::ResponseMessage&& response) {
...
::amsr::ipc_binding_core::internal::ForwardOutput EHRSI_OutProxyXf::OnNotificationReceived(::amsr::ipc_binding_core::internal::ipc_protocol::NotificationMessagePtr notification) {
  ::amsr::ipc_binding_core::internal::ForwardOutput forwarded{false};
...
void EHRSI_OutProxyXf::OnServiceInstanceDown() {
...
::amsr::ipc_binding_core::internal::ForwardOutput EHRSI_OutProxyXf::OnSubscribeAckReceived(::amsr::ipc_binding_core::internal::ipc_protocol::SubscribeEventAckMessageHeader const& ack_response) {
...
::amsr::ipc_binding_core::internal::ForwardOutput EHRSI_OutProxyXf::OnSubscribeNAckReceived(::amsr::ipc_binding_core::internal::ipc_protocol::SubscribeEventNAckMessageHeader const& nack_response) {
  ::amsr::ipc_binding_core::internal::ForwardOutput accepted{false};
...
::amsr::ipc_binding_core::internal::ForwardOutput EHRSI_OutProxyXf::OnApplicationErrorReceived(::amsr::ipc_binding_core::internal::ipc_protocol::ApplicationErrorMessage&& message) {
  ::amsr::ipc_binding_core::internal::ForwardOutput forwarded{false};
  // Get method ID from response header for dispatching.
...
void EHRSI_OutProxyXf::OnErrorResponseReceived(::amsr::ipc_binding_core::internal::ipc_protocol::ErrorResponseMessage&& message) {
  // Get method ID from response header for dispatching.
  ::amsr::ipc_binding_core::internal::ipc_protocol::MethodId const method_id{message.GetMessageHeader().method_id_};
