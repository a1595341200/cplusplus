...
#include "amsr/someip_protocol/internal/datatype_deserialization/PathNode/deserializer_PathNode.h"
...
deserialization::Result DeserializerEHR_Bus_Nodes::Deserialize(deserialization::Reader &reader, ::Nodes::Nodes &data) {
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      TpPackAlias,
        // Config of vector length field and max. container size (/CppImplementationDataTypes/Nodes)
      ...
      >(deserialization::SizeToken<::Nodes::Nodes>{})};
