 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/src/amsr/someip_protocol/internal/dataprototype_serialization/roadmodelfusionsi_out/events/serializer_RMF_Bus_ExtractedMapInf.cpp
...
void SerializerRMF_Bus_ExtractedMapInf::Serialize(serialization::Writer
&writer, ::ExtractedMapInf::ExtractedMapInf const &data) {
