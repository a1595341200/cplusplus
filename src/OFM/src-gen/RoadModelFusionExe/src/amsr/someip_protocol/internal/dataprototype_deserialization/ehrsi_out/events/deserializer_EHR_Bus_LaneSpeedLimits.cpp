...
#include "amsr/someip_protocol/internal/datatype_deserialization/LaneSpeedLimit/deserializer_LaneSpeedLimit.h"
...
deserialization::Result DeserializerEHR_Bus_LaneSpeedLimits::Deserialize(deserialization::Reader &reader, ::LaneSpeedLimits::LaneSpeedLimits &data) {
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      TpPackAlias,
        // Config of vector length field and max. container size (/CppImplementationDataTypes/LaneSpeedLimits)
      ...
      >(deserialization::SizeToken<::LaneSpeedLimits::LaneSpeedLimits>{})};
