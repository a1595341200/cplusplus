...
/*!
 * \brief Parameterization of the IPC deployment information for service interface 'EHRSI_OutProxy'.
 */
using EHRSI_OutRequiredIpcDeployment =
    ::amsr::ipc_binding_transformation_layer::internal::IpcServiceInterfaceDeploymentElement<// Abstract service interface reference
                                         ::ehrsi_out::proxy::EHRSI_OutProxy,
                                         // Service ID
...
class EHRSI_OutProxyXf final
    : public ::ehrsi_out::internal::EHRSI_OutProxyBackendInterface,
      ...
      public std::enable_shared_from_this< EHRSI_OutProxyXf> {
 public:
   ...
   EHRSI_OutProxyXf(
      ...
      , event_backend_EHR_Bus_NOAInfo_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4714}, timer_manager, runtime_processing_mode}
      , event_backend_EHR_Bus_LaneConnectivitys_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4715}, timer_manager, runtime_processing_mode}
      , event_backend_EHR_Bus_Nodes_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4716}, timer_manager, runtime_processing_mode}
      , event_backend_EHR_Bus_TrafficSigns_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4717}, timer_manager, runtime_processing_mode}
      , event_backend_EHR_Bus_GeoFences_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4718}, timer_manager, runtime_processing_mode}
      , event_backend_EHR_Bus_LinkCurvatures_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4719}, timer_manager, runtime_processing_mode}
      , event_backend_EHR_Bus_LinkSlopes_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4720}, timer_manager, runtime_processing_mode}
      , event_backend_EHR_Bus_LaneSpeedLimits_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4721}, timer_manager, runtime_processing_mode}
      , event_backend_EHR_Bus_LinkInfos_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4722}, timer_manager, runtime_processing_mode}
      , event_backend_EHR_Bus_MergePoints_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4723}, timer_manager, runtime_processing_mode}
      , event_backend_EHR_Bus_GeofennceJudge_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4726}, timer_manager, runtime_processing_mode}
 {
  ...
  */
  ...
  /*!
   * \brief       Getter function for the event 'EHR_Bus_MergePoints'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  EHRSI_OutProxyXfEventBackendEHR_Bus_MergePoints& GetEventBackendEHR_Bus_MergePoints() noexcept final {
    return event_backend_EHR_Bus_MergePoints_;
  }

  /*!
   * \brief       Getter function for the event 'EHR_Bus_GeofennceJudge'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  EHRSI_OutProxyXfEventBackendEHR_Bus_GeofennceJudge& GetEventBackendEHR_Bus_GeofennceJudge() noexcept final {
    return event_backend_EHR_Bus_GeofennceJudge_;
  }
 ...
 private:
   ...
   */
  static constexpr IpcServiceInterfaceDeployment kDeployment{EHRSI_OutRequiredIpcDeployment::kDeployment};
  ...
  /*!
   * \brief Event backend for proxy event 'EHR_Bus_MergePoints'.
   */
  EHRSI_OutProxyXfEventBackendEHR_Bus_MergePoints event_backend_EHR_Bus_MergePoints_;

  /*!
   * \brief Event backend for proxy event 'EHR_Bus_GeofennceJudge'.
   */
  EHRSI_OutProxyXfEventBackendEHR_Bus_GeofennceJudge event_backend_EHR_Bus_GeofennceJudge_;
