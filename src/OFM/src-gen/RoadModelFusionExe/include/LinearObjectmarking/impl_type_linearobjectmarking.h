 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LinearObjectmarking/impl_type_linearobjectmarking.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTMARKING_IMPL_TYPE_LINEAROBJECTMARKING_H_
#define ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTMARKING_IMPL_TYPE_LINEAROBJECTMARKING_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTMARKING_IMPL_TYPE_LINEAROBJECTMARKING_H_
