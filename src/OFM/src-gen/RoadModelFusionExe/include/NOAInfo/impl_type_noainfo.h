 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/NOAInfo/impl_type_noainfo.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_NOAINFO_IMPL_TYPE_NOAINFO_H_
#define ROADMODELFUSIONEXE_INCLUDE_NOAINFO_IMPL_TYPE_NOAINFO_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_NOAINFO_IMPL_TYPE_NOAINFO_H_
