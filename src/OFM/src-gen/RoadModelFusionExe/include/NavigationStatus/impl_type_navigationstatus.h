 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/NavigationStatus/impl_type_navigationstatus.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_NAVIGATIONSTATUS_IMPL_TYPE_NAVIGATIONSTATUS_H_
#define ROADMODELFUSIONEXE_INCLUDE_NAVIGATIONSTATUS_IMPL_TYPE_NAVIGATIONSTATUS_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_NAVIGATIONSTATUS_IMPL_TYPE_NAVIGATIONSTATUS_H_
