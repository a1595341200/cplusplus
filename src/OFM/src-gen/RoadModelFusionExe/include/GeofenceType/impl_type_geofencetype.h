 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/GeofenceType/impl_type_geofencetype.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_GEOFENCETYPE_IMPL_TYPE_GEOFENCETYPE_H_
#define ROADMODELFUSIONEXE_INCLUDE_GEOFENCETYPE_IMPL_TYPE_GEOFENCETYPE_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_GEOFENCETYPE_IMPL_TYPE_GEOFENCETYPE_H_
