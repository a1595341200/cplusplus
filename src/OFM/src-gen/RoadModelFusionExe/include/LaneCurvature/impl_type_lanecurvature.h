 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LaneCurvature/impl_type_lanecurvature.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LANECURVATURE_IMPL_TYPE_LANECURVATURE_H_
#define ROADMODELFUSIONEXE_INCLUDE_LANECURVATURE_IMPL_TYPE_LANECURVATURE_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LANECURVATURE_IMPL_TYPE_LANECURVATURE_H_
