 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/GeometryPoint/impl_type_geometrypoint.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_GEOMETRYPOINT_IMPL_TYPE_GEOMETRYPOINT_H_
#define ROADMODELFUSIONEXE_INCLUDE_GEOMETRYPOINT_IMPL_TYPE_GEOMETRYPOINT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_GEOMETRYPOINT_IMPL_TYPE_GEOMETRYPOINT_H_
