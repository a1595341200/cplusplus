 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LaneType/impl_type_lanetype.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LANETYPE_IMPL_TYPE_LANETYPE_H_
#define ROADMODELFUSIONEXE_INCLUDE_LANETYPE_IMPL_TYPE_LANETYPE_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LANETYPE_IMPL_TYPE_LANETYPE_H_
