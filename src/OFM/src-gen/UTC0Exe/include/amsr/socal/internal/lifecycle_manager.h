 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  UTC0Exe/include/amsr/socal/internal/lifecycle_manager.h
...
#ifndef UTC0EXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
#define UTC0EXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
...
class LifecycleManager final {
 public:
  ...
  static void Initialize() noexcept {
    ...
    utc0si_out::skeleton::UTC0SI_OutSkeleton::CreateSingletons();
  }
  ...
  static void Deinitialize() noexcept {
    ...
    utc0si_out::skeleton::UTC0SI_OutSkeleton::DestroySingletons();
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    utc0si_in::proxy::UTC0SI_InProxy::RegisterServiceDiscovery(&utc0si_in_proxy_sd_);
    
    utc0si_out::skeleton::UTC0SI_OutSkeleton::RegisterServiceDiscovery(&utc0si_out_skeleton_sd_);
  }
  ...
  void DeInitializeServiceDiscovery() noexcept {
    ...
    utc0si_out::skeleton::UTC0SI_OutSkeleton::DeRegisterServiceDiscovery();
  }
   ...
   *        used for the service interface UTC0SI_In.
   */
  using UTC0SI_InProxyServiceDiscovery = ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      utc0si_in::internal::UTC0SI_InProxyBackendInterface>;

  /*!
   * \brief Service discovery instance used on proxy side for the service interface UTC0SI_In.
   */
  UTC0SI_InProxyServiceDiscovery utc0si_in_proxy_sd_;


 
  /*!
   * \brief Type alias for the service discovery type on skeleton side
   *        used for the service interface UTC0SI_Out.
   */
  using UTC0SI_OutSkeletonSdType = utc0si_out::skeleton::UTC0SI_OutSkeleton::ServiceDiscovery;

  /*!
   * \brief Service discovery instance used on skeleton side for the service interface UTC0SI_Out.
   */
  UTC0SI_OutSkeletonSdType utc0si_out_skeleton_sd_;
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr

#endif  // UTC0EXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
