...
using UTC0_Bus_VehTiAndData = ::amsr::socal::events::SkeletonEvent<
    ...
    ::DateTi30_2::DateTi30_2,
    utc0si_out::internal::UTC0SI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::DateTi30_2::DateTi30_2>,
...
explicit UTC0SI_OutSkeleton(ConstructionToken&& token) noexcept;
   ...
   * \details 
   * Data of type ::DateTi30_2::DateTi30_2
   * \vpublic
   */
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<utc0si_out::UTC0SI_Out, utc0si_out::internal::UTC0SI_OutSkeletonImplInterface>;

  /*!
   * \copydoc amsr::socal::Skeleton<utc0si_out::UTC0SI_Out,utc0si_out::internal::UTC0SI_OutSkeletonImplInterface>::DoFieldInitializationChecks()
   */
  void DoFieldInitializationChecks() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<utc0si_out::UTC0SI_Out,utc0si_out::internal::UTC0SI_OutSkeletonImplInterface>::SendInitialFieldNotifications()
   */
  void SendInitialFieldNotifications() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<utc0si_out::UTC0SI_Out,utc0si_out::internal::UTC0SI_OutSkeletonImplInterface>::OfferServiceInternal()
   */
  void OfferServiceInternal(::ara::com::InstanceIdentifier const& instance_id) noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<utc0si_out::UTC0SI_Out,utc0si_out::internal::UTC0SI_OutSkeletonImplInterface>::StopOfferServiceInternal()
   */
