 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  UTC0Exe/src/amsr/someip_binding_transformation_layer/internal/utc0si_out/UTC0SI_Out_skeleton_someip_binding.cpp
 ...
 */
::amsr::someip_protocol::internal::ServiceId constexpr UTC0SI_OutSkeletonSomeIpBinding::kServiceId;

/*!
 * \brief SOME/IP major version of this service interface deployment.
 */
constexpr ::amsr::someip_protocol::internal::MajorVersion UTC0SI_OutSkeletonSomeIpBinding::kMajorVersion;

UTC0SI_OutSkeletonSomeIpBinding::UTC0SI_OutSkeletonSomeIpBinding(
    ...
    : instance_id_(instance_id),
      ...
      skeleton_(skeleton) ,
      event_manager_UTC0_Bus_VehTiAndData_(instance_id){
}

void UTC0SI_OutSkeletonSomeIpBinding::HandleMethodRequest(
...
void UTC0SI_OutSkeletonSomeIpBinding::SendMethodResponse(::vac::memory::MemoryBufferPtr<osabstraction::io::MutableIOBuffer> packet) {
...
UTC0SI_OutSkeletonSomeIpEventManagerUTC0_Bus_VehTiAndData* UTC0SI_OutSkeletonSomeIpBinding::GetEventManagerUTC0_Bus_VehTiAndData() noexcept {
