 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/amsr/someip_binding_transformation_layer/internal/perceptionsi_out/PerceptionSideSI_Out_skeleton_someip_binding.h
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_OUT_PERCEPTIONSIDESI_OUT_SKELETON_SOMEIP_BINDING_H_
#define PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_OUT_PERCEPTIONSIDESI_OUT_SKELETON_SOMEIP_BINDING_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/someip_binding_transformation_layer/internal/perceptionsi_out/PerceptionSideSI_Out_skeleton_someip_event_manager.h"
#include "amsr/someip_binding_transformation_layer/internal/perceptionsi_out/PerceptionSideSI_Out_skeleton_someip_methods.h"
 ...
 * \remark generated
 */
class PerceptionSideSI_OutSkeletonSomeIpBinding final :
 ...
 public:
   ...
   */
  using SkeletonFrontend = ::perceptionsi_out::skeleton::PerceptionSideSI_OutSkeleton;
  /*!
   * \brief Generated SOME/IP related service ID.
   */
  static constexpr ::amsr::someip_protocol::internal::ServiceId kServiceId{0x75U};
  ...
  /*!
   * \brief Constructor of PerceptionSideSI_OutSkeletonSomeIpBinding.
   ...
   * \synchronous TRUE
   */
  PerceptionSideSI_OutSkeletonSomeIpBinding(::amsr::someip_protocol::internal::InstanceId const instance_id,
  ...
  ~PerceptionSideSI_OutSkeletonSomeIpBinding() noexcept override  = default;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  PerceptionSideSI_OutSkeletonSomeIpEventManagerFLCam_Bus_VisnObj* GetEventManagerFLCam_Bus_VisnObj() noexcept override;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  PerceptionSideSI_OutSkeletonSomeIpEventManagerFRCam_Bus_VisnObj* GetEventManagerFRCam_Bus_VisnObj() noexcept override;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  PerceptionSideSI_OutSkeletonSomeIpEventManagerRLCam_Bus_VisnObj* GetEventManagerRLCam_Bus_VisnObj() noexcept override;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  PerceptionSideSI_OutSkeletonSomeIpEventManagerRRCam_Bus_VisnObj* GetEventManagerRRCam_Bus_VisnObj() noexcept override;

  /*!
   * \brief Get the event manager object for the SOME/IP binding service event 'FLCam_Bus_CamSts'.
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  PerceptionSideSI_OutSkeletonSomeIpEventManagerFLCam_Bus_CamSts* GetEventManagerFLCam_Bus_CamSts() noexcept override;

  /*!
   * \brief Get the event manager object for the SOME/IP binding service event 'FRCam_Bus_CamSts'.
   * \details Event sample type: ::CamSts1Vcc::CamSts1Vcc.
   * \return The SOME/IP binding specific event management object/interface supporting event transmission.
   *
   * \pre         -
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  PerceptionSideSI_OutSkeletonSomeIpEventManagerFRCam_Bus_CamSts* GetEventManagerFRCam_Bus_CamSts() noexcept override;

  /*!
   * \brief Get the event manager object for the SOME/IP binding service event 'RLCam_Bus_CamSts'.
   * \details Event sample type: ::CamSts1Vcc::CamSts1Vcc.
   * \return The SOME/IP binding specific event management object/interface supporting event transmission.
   *
   * \pre         -
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  PerceptionSideSI_OutSkeletonSomeIpEventManagerRLCam_Bus_CamSts* GetEventManagerRLCam_Bus_CamSts() noexcept override;

  /*!
   * \brief Get the event manager object for the SOME/IP binding service event 'RRCam_Bus_CamSts'.
   * \details Event sample type: ::CamSts1Vcc::CamSts1Vcc.
   * \return The SOME/IP binding specific event management object/interface supporting event transmission.
   *
   * \pre         -
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  PerceptionSideSI_OutSkeletonSomeIpEventManagerRRCam_Bus_CamSts* GetEventManagerRRCam_Bus_CamSts() noexcept override;
 ...
 private:
  ...
  ::perceptionsi_out::skeleton::PerceptionSideSI_OutSkeleton& skeleton_;

  // ---- Methods ------------------------------------------------------------------------------------------

  // ---- Event manager --------------------------------------------------------------------------------------------

  // Event manager for skeleton event 'FLCam_Bus_VisnObj'
  PerceptionSideSI_OutSkeletonSomeIpEventManagerFLCam_Bus_VisnObj event_manager_FLCam_Bus_VisnObj_;

  // Event manager for skeleton event 'FRCam_Bus_VisnObj'
  PerceptionSideSI_OutSkeletonSomeIpEventManagerFRCam_Bus_VisnObj event_manager_FRCam_Bus_VisnObj_;

  // Event manager for skeleton event 'RLCam_Bus_VisnObj'
  PerceptionSideSI_OutSkeletonSomeIpEventManagerRLCam_Bus_VisnObj event_manager_RLCam_Bus_VisnObj_;

  // Event manager for skeleton event 'RRCam_Bus_VisnObj'
  PerceptionSideSI_OutSkeletonSomeIpEventManagerRRCam_Bus_VisnObj event_manager_RRCam_Bus_VisnObj_;

  // Event manager for skeleton event 'FLCam_Bus_CamSts'
  PerceptionSideSI_OutSkeletonSomeIpEventManagerFLCam_Bus_CamSts event_manager_FLCam_Bus_CamSts_;

  // Event manager for skeleton event 'FRCam_Bus_CamSts'
  PerceptionSideSI_OutSkeletonSomeIpEventManagerFRCam_Bus_CamSts event_manager_FRCam_Bus_CamSts_;

  // Event manager for skeleton event 'RLCam_Bus_CamSts'
  PerceptionSideSI_OutSkeletonSomeIpEventManagerRLCam_Bus_CamSts event_manager_RLCam_Bus_CamSts_;

  // Event manager for skeleton event 'RRCam_Bus_CamSts'
  PerceptionSideSI_OutSkeletonSomeIpEventManagerRRCam_Bus_CamSts event_manager_RRCam_Bus_CamSts_;
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_OUT_PERCEPTIONSIDESI_OUT_SKELETON_SOMEIP_BINDING_H_
