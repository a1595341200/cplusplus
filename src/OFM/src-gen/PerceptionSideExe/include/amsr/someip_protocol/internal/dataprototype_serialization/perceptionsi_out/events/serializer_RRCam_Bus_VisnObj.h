 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/amsr/someip_protocol/internal/dataprototype_serialization/perceptionsi_out/events/serializer_RRCam_Bus_VisnObj.h
 *        \brief  SOME/IP protocol serializer implementation for data prototype '/JICA/Service/Interface/PerceptionSideSI_Out/RRCam_Bus_VisnObj
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_OUT_EVENTS_serializer_RRCam_Bus_VisnObj_h_
#define PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_OUT_EVENTS_serializer_RRCam_Bus_VisnObj_h_
...
/*!
 * \brief Serializer for service event /JICA/Service/Interface/PerceptionSideSI_Out/RRCam_Bus_VisnObj
 ...
 */
class SerializerRRCam_Bus_VisnObj {
 public:
  /*!
   * \brief Returns the required buffer size for the data prototype service event /JICA/Service/Interface/PerceptionSideSI_Out/RRCam_Bus_VisnObj.
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/VisObjs.
   *
   ...
   * \synchronous TRUE
   */
  constexpr static std::size_t GetRequiredBufferSize(::VisObjs::VisObjs const &data) noexcept {
  ...
  /*!
   * \brief Serialize the data prototype service event /JICA/Service/Interface/PerceptionSideSI_Out/RRCam_Bus_VisnObj.
   *
   ...
   * \synchronous TRUE
   */
  static void Serialize(serialization::Writer &writer, ::VisObjs::VisObjs const &data);
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_OUT_EVENTS_serializer_RRCam_Bus_VisnObj_h_
