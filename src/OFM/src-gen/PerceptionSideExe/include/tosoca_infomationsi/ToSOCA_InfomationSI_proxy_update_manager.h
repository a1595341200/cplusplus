 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_proxy_update_manager.h
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
#define PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
