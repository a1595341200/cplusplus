 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/RoadSgnInfoActv0/impl_type_roadsgninfoactv0.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_ROADSGNINFOACTV0_IMPL_TYPE_ROADSGNINFOACTV0_H_
#define PERCEPTIONSIDEEXE_INCLUDE_ROADSGNINFOACTV0_IMPL_TYPE_ROADSGNINFOACTV0_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_ROADSGNINFOACTV0_IMPL_TYPE_ROADSGNINFOACTV0_H_
