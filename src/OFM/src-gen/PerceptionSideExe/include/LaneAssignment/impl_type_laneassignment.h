 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/LaneAssignment/impl_type_laneassignment.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_LANEASSIGNMENT_IMPL_TYPE_LANEASSIGNMENT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_LANEASSIGNMENT_IMPL_TYPE_LANEASSIGNMENT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_LANEASSIGNMENT_IMPL_TYPE_LANEASSIGNMENT_H_
