 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RadarAdaptorExe/include/FrontFourDRadarSts1Vcc/impl_type_frontfourdradarsts1vcc.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RADARADAPTOREXE_INCLUDE_FRONTFOURDRADARSTS1VCC_IMPL_TYPE_FRONTFOURDRADARSTS1VCC_H_
#define RADARADAPTOREXE_INCLUDE_FRONTFOURDRADARSTS1VCC_IMPL_TYPE_FRONTFOURDRADARSTS1VCC_H_
...
#endif  // RADARADAPTOREXE_INCLUDE_FRONTFOURDRADARSTS1VCC_IMPL_TYPE_FRONTFOURDRADARSTS1VCC_H_
