 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/EgoMotion/impl_type_egomotion.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
#define PERCEPTIONEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
