 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/WipgSpdInfo/impl_type_wipgspdinfo.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
#define PERCEPTIONEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
