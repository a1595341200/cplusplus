 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/NearestSide/impl_type_nearestside.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_NEARESTSIDE_IMPL_TYPE_NEARESTSIDE_H_
#define PERCEPTIONEXE_INCLUDE_NEARESTSIDE_IMPL_TYPE_NEARESTSIDE_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_NEARESTSIDE_IMPL_TYPE_NEARESTSIDE_H_
