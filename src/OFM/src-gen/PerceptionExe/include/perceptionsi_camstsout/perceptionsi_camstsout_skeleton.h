 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/perceptionsi_camstsout/perceptionsi_camstsout_skeleton.h
...
#ifndef PERCEPTIONEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_SKELETON_H_
#define PERCEPTIONEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_SKELETON_H_
 ...
 */
class PerceptionSI_CamStsOutSkeleton;
...
/*!
 * \brief Type alias for service event 'FrntCam_Bus_CamSts', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using FrntCam_Bus_CamSts = ::amsr::socal::events::SkeletonEvent<
    perceptionsi_camstsout::skeleton::PerceptionSI_CamStsOutSkeleton,
    ::CamSts1Vcc::CamSts1Vcc,
    perceptionsi_camstsout::internal::PerceptionSI_CamStsOutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::CamSts1Vcc::CamSts1Vcc>,
    &perceptionsi_camstsout::internal::PerceptionSI_CamStsOutSkeletonImplInterface::GetEventManagerFrntCam_Bus_CamSts>;
...
/*!
 * \brief Skeleton interface class for the service 'PerceptionSI_CamStsOut'.
 *
 * \vpublic
 * \trace SPEC-4980341
 */
class PerceptionSI_CamStsOutSkeleton
    : public ::amsr::socal::Skeleton<perceptionsi_camstsout::PerceptionSI_CamStsOut,
                                          perceptionsi_camstsout::internal::PerceptionSI_CamStsOutSkeletonImplInterface> {
 public:
// ---- Constructors / Destructors -----------------------------------------------------------------------------------
/*!
 * \brief Exception-less pre-construction of PerceptionSI_CamStsOut.
 *
...
/*!
 * \brief Exception-less pre-construction of PerceptionSI_CamStsOutSkeleton.
 *
...
/*!
 * \brief Exception-less constructor of PerceptionSI_CamStsOutSkeleton.
 ...
 * \trace SPEC-8053555
 */
explicit PerceptionSI_CamStsOutSkeleton(ConstructionToken&& token) noexcept;

  /*!
   * \brief Delete default constructor.
   */
  PerceptionSI_CamStsOutSkeleton() = delete;
  /*!
   * \brief Delete copy constructor.
   */
  PerceptionSI_CamStsOutSkeleton(PerceptionSI_CamStsOutSkeleton const &) = delete;
  /*!
   * \brief Delete move constructor.
   */
  PerceptionSI_CamStsOutSkeleton(PerceptionSI_CamStsOutSkeleton &&) = delete;
  /*!
   * \brief Delete copy assignment.
   */
  PerceptionSI_CamStsOutSkeleton &operator=(PerceptionSI_CamStsOutSkeleton const &) & = delete;
  /*!
   * \brief Delete move assignment.
   */
  PerceptionSI_CamStsOutSkeleton &operator=(PerceptionSI_CamStsOutSkeleton &&) & = delete;

  /*!
   * \brief Constructor of PerceptionSI_CamStsOutSkeleton.
   *
   ...
   * \trace SPEC-4980356
   */
   explicit PerceptionSI_CamStsOutSkeleton(
   ...
   * \trace SPEC-4980351
   */
  ~PerceptionSI_CamStsOutSkeleton() noexcept override;

  /*!
   * \brief Type alias for ServiceDiscovery.
   */
  using ServiceDiscovery = ::amsr::socal::internal::service_discovery::ServiceDiscovery<PerceptionSI_CamStsOutSkeleton>;
  ...
  /*!
   * \brief The skeleton event 'FrntCam_Bus_CamSts' which can be used by application developer.
   * \details 
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<perceptionsi_camstsout::PerceptionSI_CamStsOut, perceptionsi_camstsout::internal::PerceptionSI_CamStsOutSkeletonImplInterface>;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_camstsout::PerceptionSI_CamStsOut,perceptionsi_camstsout::internal::PerceptionSI_CamStsOutSkeletonImplInterface>::DoFieldInitializationChecks()
   */
  void DoFieldInitializationChecks() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_camstsout::PerceptionSI_CamStsOut,perceptionsi_camstsout::internal::PerceptionSI_CamStsOutSkeletonImplInterface>::SendInitialFieldNotifications()
   */
  void SendInitialFieldNotifications() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_camstsout::PerceptionSI_CamStsOut,perceptionsi_camstsout::internal::PerceptionSI_CamStsOutSkeletonImplInterface>::OfferServiceInternal()
   */
  void OfferServiceInternal(::ara::com::InstanceIdentifier const& instance_id) noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_camstsout::PerceptionSI_CamStsOut,perceptionsi_camstsout::internal::PerceptionSI_CamStsOutSkeletonImplInterface>::StopOfferServiceInternal()
   */
...
#endif  // PERCEPTIONEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_SKELETON_H_
