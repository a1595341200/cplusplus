 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/ExtInfo/impl_type_extinfo.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_EXTINFO_IMPL_TYPE_EXTINFO_H_
#define PERCEPTIONEXE_INCLUDE_EXTINFO_IMPL_TYPE_EXTINFO_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_EXTINFO_IMPL_TYPE_EXTINFO_H_
