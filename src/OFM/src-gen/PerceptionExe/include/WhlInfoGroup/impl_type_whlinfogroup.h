 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/WhlInfoGroup/impl_type_whlinfogroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
#define PERCEPTIONEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
