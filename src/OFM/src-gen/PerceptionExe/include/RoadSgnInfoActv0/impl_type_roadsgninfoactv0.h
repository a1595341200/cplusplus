 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/RoadSgnInfoActv0/impl_type_roadsgninfoactv0.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_ROADSGNINFOACTV0_IMPL_TYPE_ROADSGNINFOACTV0_H_
#define PERCEPTIONEXE_INCLUDE_ROADSGNINFOACTV0_IMPL_TYPE_ROADSGNINFOACTV0_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_ROADSGNINFOACTV0_IMPL_TYPE_ROADSGNINFOACTV0_H_
