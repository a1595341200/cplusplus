 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/VehModMngtGlbSafe1/impl_type_vehmodmngtglbsafe1.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1_IMPL_TYPE_VEHMODMNGTGLBSAFE1_H_
#define PERCEPTIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1_IMPL_TYPE_VEHMODMNGTGLBSAFE1_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1_IMPL_TYPE_VEHMODMNGTGLBSAFE1_H_
