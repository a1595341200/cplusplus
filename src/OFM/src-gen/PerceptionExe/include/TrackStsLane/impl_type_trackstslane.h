 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/TrackStsLane/impl_type_trackstslane.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_TRACKSTSLANE_IMPL_TYPE_TRACKSTSLANE_H_
#define PERCEPTIONEXE_INCLUDE_TRACKSTSLANE_IMPL_TYPE_TRACKSTSLANE_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_TRACKSTSLANE_IMPL_TYPE_TRACKSTSLANE_H_
