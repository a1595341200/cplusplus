 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LaneAssignmentTL/impl_type_laneassignmenttl.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LANEASSIGNMENTTL_IMPL_TYPE_LANEASSIGNMENTTL_H_
#define PERCEPTIONEXE_INCLUDE_LANEASSIGNMENTTL_IMPL_TYPE_LANEASSIGNMENTTL_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LANEASSIGNMENTTL_IMPL_TYPE_LANEASSIGNMENTTL_H_
