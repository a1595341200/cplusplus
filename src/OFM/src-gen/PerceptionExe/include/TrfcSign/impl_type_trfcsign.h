 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/TrfcSign/impl_type_trfcsign.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_TRFCSIGN_IMPL_TYPE_TRFCSIGN_H_
#define PERCEPTIONEXE_INCLUDE_TRFCSIGN_IMPL_TYPE_TRFCSIGN_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_TRFCSIGN_IMPL_TYPE_TRFCSIGN_H_
