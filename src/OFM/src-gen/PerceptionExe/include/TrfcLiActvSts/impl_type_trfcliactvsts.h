 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/TrfcLiActvSts/impl_type_trfcliactvsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_TRFCLIACTVSTS_IMPL_TYPE_TRFCLIACTVSTS_H_
#define PERCEPTIONEXE_INCLUDE_TRFCLIACTVSTS_IMPL_TYPE_TRFCLIACTVSTS_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_TRFCLIACTVSTS_IMPL_TYPE_TRFCLIACTVSTS_H_
