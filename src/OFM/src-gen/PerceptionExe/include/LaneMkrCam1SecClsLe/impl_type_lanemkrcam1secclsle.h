 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LaneMkrCam1SecClsLe/impl_type_lanemkrcam1secclsle.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LANEMKRCAM1SECCLSLE_IMPL_TYPE_LANEMKRCAM1SECCLSLE_H_
#define PERCEPTIONEXE_INCLUDE_LANEMKRCAM1SECCLSLE_IMPL_TYPE_LANEMKRCAM1SECCLSLE_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LANEMKRCAM1SECCLSLE_IMPL_TYPE_LANEMKRCAM1SECCLSLE_H_
