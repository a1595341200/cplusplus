 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/TypeRoadSign/impl_type_typeroadsign.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_TYPEROADSIGN_IMPL_TYPE_TYPEROADSIGN_H_
#define PERCEPTIONEXE_INCLUDE_TYPEROADSIGN_IMPL_TYPE_TYPEROADSIGN_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_TYPEROADSIGN_IMPL_TYPE_TYPEROADSIGN_H_
