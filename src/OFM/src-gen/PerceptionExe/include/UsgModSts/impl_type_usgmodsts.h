 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/UsgModSts/impl_type_usgmodsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_USGMODSTS_IMPL_TYPE_USGMODSTS_H_
#define PERCEPTIONEXE_INCLUDE_USGMODSTS_IMPL_TYPE_USGMODSTS_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_USGMODSTS_IMPL_TYPE_USGMODSTS_H_
