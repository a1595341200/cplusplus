 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/WipgInfoGroup/impl_type_wipginfogroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
#define PERCEPTIONEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
