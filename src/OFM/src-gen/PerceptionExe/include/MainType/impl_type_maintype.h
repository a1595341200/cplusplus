 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/MainType/impl_type_maintype.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_MAINTYPE_IMPL_TYPE_MAINTYPE_H_
#define PERCEPTIONEXE_INCLUDE_MAINTYPE_IMPL_TYPE_MAINTYPE_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_MAINTYPE_IMPL_TYPE_MAINTYPE_H_
