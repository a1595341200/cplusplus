 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_protocol/internal/dataprototype_serialization/perceptionsi_camstsout/events/serializer_FrntCam_Bus_CamSts.h
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_CAMSTSOUT_EVENTS_serializer_FrntCam_Bus_CamSts_h_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_CAMSTSOUT_EVENTS_serializer_FrntCam_Bus_CamSts_h_
...
/*!
 * \brief Serializer for service event /JICA/Service/Interface/PerceptionSI_CamStsOut/FrntCam_Bus_CamSts
 ...
 */
class SerializerFrntCam_Bus_CamSts {
 public:
  /*!
   * \brief Returns the required buffer size for the data prototype service event /JICA/Service/Interface/PerceptionSI_CamStsOut/FrntCam_Bus_CamSts.
   *
  ...
  /*!
   * \brief Serialize the data prototype service event /JICA/Service/Interface/PerceptionSI_CamStsOut/FrntCam_Bus_CamSts.
   *
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_CAMSTSOUT_EVENTS_serializer_FrntCam_Bus_CamSts_h_
