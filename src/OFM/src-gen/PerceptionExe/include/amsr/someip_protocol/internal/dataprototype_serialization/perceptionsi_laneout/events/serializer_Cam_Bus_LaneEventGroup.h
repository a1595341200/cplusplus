 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_protocol/internal/dataprototype_serialization/perceptionsi_laneout/events/serializer_Cam_Bus_LaneEventGroup.h
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_LANEOUT_EVENTS_serializer_Cam_Bus_LaneEventGroup_h_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_LANEOUT_EVENTS_serializer_Cam_Bus_LaneEventGroup_h_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "LaneEventGroups/impl_type_laneeventgroups.h"
...
/*!
 * \brief Serializer for service event /JICA/Service/Interface/PerceptionSI_LaneOut/Cam_Bus_LaneEventGroup
 *        of service interface /JICA/Service/Interface/PerceptionSI_LaneOut.
 * \details Top-Level data type: /CppImplementationDataTypes/LaneEventGroups
 ...
 */
class SerializerCam_Bus_LaneEventGroup {
 public:
  /*!
   * \brief Returns the required buffer size for the data prototype service event /JICA/Service/Interface/PerceptionSI_LaneOut/Cam_Bus_LaneEventGroup.
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/LaneEventGroups.
   *
   ...
   * \synchronous TRUE
   */
  constexpr static std::size_t GetRequiredBufferSize(::LaneEventGroups::LaneEventGroups const &data) noexcept {
  ...
  /*!
   * \brief Serialize the data prototype service event /JICA/Service/Interface/PerceptionSI_LaneOut/Cam_Bus_LaneEventGroup.
   *
   ...
   * \synchronous TRUE
   */
  static void Serialize(serialization::Writer &writer, ::LaneEventGroups::LaneEventGroups const &data);
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_LANEOUT_EVENTS_serializer_Cam_Bus_LaneEventGroup_h_
