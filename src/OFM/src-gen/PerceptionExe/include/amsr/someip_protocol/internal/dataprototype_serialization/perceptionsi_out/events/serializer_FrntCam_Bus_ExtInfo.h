...
#include "amsr/someip_protocol/internal/datatype_serialization/ExtInfo/serializer_ExtInfo.h"
...
class SerializerFrntCam_Bus_ExtInfo {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/ExtInfo.
   *
   ...
   * \synchronous TRUE
   */
  constexpr static std::size_t GetRequiredBufferSize(::ExtInfo::ExtInfo const &data) noexcept {
   ...
   * \synchronous TRUE
   */
  static void Serialize(serialization::Writer &writer, ::ExtInfo::ExtInfo const &data);
