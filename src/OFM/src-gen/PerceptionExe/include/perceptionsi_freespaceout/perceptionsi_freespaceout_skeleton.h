...
using FusedCam_Bus_FreeSpace = ::amsr::socal::events::SkeletonEvent<
    ...
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::FreeSpaces::FreeSpaces>,
...
explicit PerceptionSI_FreeSpaceOutSkeleton(ConstructionToken&& token) noexcept;
   ...
   * \details 
   * Data of type ::FreeSpaces::FreeSpaces
   * \vpublic
   */
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<perceptionsi_freespaceout::PerceptionSI_FreeSpaceOut, perceptionsi_freespaceout::internal::PerceptionSI_FreeSpaceOutSkeletonImplInterface>;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_freespaceout::PerceptionSI_FreeSpaceOut,perceptionsi_freespaceout::internal::PerceptionSI_FreeSpaceOutSkeletonImplInterface>::DoFieldInitializationChecks()
   */
  void DoFieldInitializationChecks() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_freespaceout::PerceptionSI_FreeSpaceOut,perceptionsi_freespaceout::internal::PerceptionSI_FreeSpaceOutSkeletonImplInterface>::SendInitialFieldNotifications()
   */
  void SendInitialFieldNotifications() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_freespaceout::PerceptionSI_FreeSpaceOut,perceptionsi_freespaceout::internal::PerceptionSI_FreeSpaceOutSkeletonImplInterface>::OfferServiceInternal()
   */
  void OfferServiceInternal(::ara::com::InstanceIdentifier const& instance_id) noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_freespaceout::PerceptionSI_FreeSpaceOut,perceptionsi_freespaceout::internal::PerceptionSI_FreeSpaceOutSkeletonImplInterface>::StopOfferServiceInternal()
   */
