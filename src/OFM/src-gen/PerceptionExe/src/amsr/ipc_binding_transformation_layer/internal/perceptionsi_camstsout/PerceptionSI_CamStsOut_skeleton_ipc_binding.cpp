 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/src/amsr/ipc_binding_transformation_layer/internal/perceptionsi_camstsout/PerceptionSI_CamStsOut_skeleton_ipc_binding.cpp
 *        \brief  IpcBinding skeleton binding of service 'PerceptionSI_CamStsOut'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_CamStsOutProvidedIpcServiceInstance::OnRequestReceived(::amsr::ipc_binding_core::internal::ipc_protocol::RemoteRequestMessage&& request) {
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_CamStsOutProvidedIpcServiceInstance::OnRequestNoReturnReceived(::amsr::ipc_binding_core::internal::ipc_protocol::RequestNoReturnMessage&& request) {
  ::amsr::ipc_binding_core::internal::ForwardOutput forwarded{false};
...
::amsr::ipc_binding_core::internal::ForwardSubscribeEventOutput PerceptionSI_CamStsOutProvidedIpcServiceInstance::OnSubscribeEventReceived(::amsr::ipc_binding_core::internal::ipc_protocol::SubscribeEventMessageHeader const& subscribe_request) {
  ...
  // clang-format on
  switch (event_id) {
    case PerceptionSI_CamStsOutSkeletonIpcEventManagerFrntCam_Bus_CamSts::kEventId: {
      ack = true;
      break;
    }
    default: {
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_CamStsOutProvidedIpcServiceInstance::OnUnsubscribeEventReceived(::amsr::ipc_binding_core::internal::ipc_protocol::UnsubscribeEventMessageHeader const& unsubscribe_request) {
...
PerceptionSI_CamStsOutSkeletonIpcEventManagerFrntCam_Bus_CamSts* PerceptionSI_CamStsOutProvidedIpcServiceInstance::GetEventManagerFrntCam_Bus_CamSts() noexcept {
  return &event_FrntCam_Bus_CamSts_;
}
