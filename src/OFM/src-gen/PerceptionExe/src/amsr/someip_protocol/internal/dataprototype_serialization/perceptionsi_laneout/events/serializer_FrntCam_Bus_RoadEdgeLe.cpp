 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/src/amsr/someip_protocol/internal/dataprototype_serialization/perceptionsi_laneout/events/serializer_FrntCam_Bus_RoadEdgeLe.cpp
...
void SerializerFrntCam_Bus_RoadEdgeLe::Serialize(serialization::Writer
&writer, ::RoadEdge1VccLe::RoadEdge1VccLe const &data) {
