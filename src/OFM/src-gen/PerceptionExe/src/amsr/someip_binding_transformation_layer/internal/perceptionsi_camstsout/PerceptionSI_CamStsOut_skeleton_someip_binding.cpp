 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/src/amsr/someip_binding_transformation_layer/internal/perceptionsi_camstsout/PerceptionSI_CamStsOut_skeleton_someip_binding.cpp
 ...
 */
::amsr::someip_protocol::internal::ServiceId constexpr PerceptionSI_CamStsOutSkeletonSomeIpBinding::kServiceId;

/*!
 * \brief SOME/IP major version of this service interface deployment.
 */
constexpr ::amsr::someip_protocol::internal::MajorVersion PerceptionSI_CamStsOutSkeletonSomeIpBinding::kMajorVersion;

PerceptionSI_CamStsOutSkeletonSomeIpBinding::PerceptionSI_CamStsOutSkeletonSomeIpBinding(
    ...
    : instance_id_(instance_id),
      ...
      skeleton_(skeleton) ,
      event_manager_FrntCam_Bus_CamSts_(instance_id){
}

void PerceptionSI_CamStsOutSkeletonSomeIpBinding::HandleMethodRequest(
...
void PerceptionSI_CamStsOutSkeletonSomeIpBinding::SendMethodResponse(::vac::memory::MemoryBufferPtr<osabstraction::io::MutableIOBuffer> packet) {
...
PerceptionSI_CamStsOutSkeletonSomeIpEventManagerFrntCam_Bus_CamSts* PerceptionSI_CamStsOutSkeletonSomeIpBinding::GetEventManagerFrntCam_Bus_CamSts() noexcept {
  return &event_manager_FrntCam_Bus_CamSts_;
}
