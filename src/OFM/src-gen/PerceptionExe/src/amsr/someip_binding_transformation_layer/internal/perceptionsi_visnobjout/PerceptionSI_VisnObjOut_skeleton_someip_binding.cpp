 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/src/amsr/someip_binding_transformation_layer/internal/perceptionsi_visnobjout/PerceptionSI_VisnObjOut_skeleton_someip_binding.cpp
 ...
 */
::amsr::someip_protocol::internal::ServiceId constexpr PerceptionSI_VisnObjOutSkeletonSomeIpBinding::kServiceId;

/*!
 * \brief SOME/IP major version of this service interface deployment.
 */
constexpr ::amsr::someip_protocol::internal::MajorVersion PerceptionSI_VisnObjOutSkeletonSomeIpBinding::kMajorVersion;

PerceptionSI_VisnObjOutSkeletonSomeIpBinding::PerceptionSI_VisnObjOutSkeletonSomeIpBinding(
    ...
    : instance_id_(instance_id),
      ...
      skeleton_(skeleton) ,
      event_manager_FrntCam_Bus_VisnObj_(instance_id){
}

void PerceptionSI_VisnObjOutSkeletonSomeIpBinding::HandleMethodRequest(
...
void PerceptionSI_VisnObjOutSkeletonSomeIpBinding::SendMethodResponse(::vac::memory::MemoryBufferPtr<osabstraction::io::MutableIOBuffer> packet) {
...
PerceptionSI_VisnObjOutSkeletonSomeIpEventManagerFrntCam_Bus_VisnObj* PerceptionSI_VisnObjOutSkeletonSomeIpBinding::GetEventManagerFrntCam_Bus_VisnObj() noexcept {
  return &event_manager_FrntCam_Bus_VisnObj_;
}
