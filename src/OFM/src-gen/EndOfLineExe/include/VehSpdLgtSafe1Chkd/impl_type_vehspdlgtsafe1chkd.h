 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/VehSpdLgtSafe1Chkd/impl_type_vehspdlgtsafe1chkd.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_VEHSPDLGTSAFE1CHKD_IMPL_TYPE_VEHSPDLGTSAFE1CHKD_H_
#define ENDOFLINEEXE_INCLUDE_VEHSPDLGTSAFE1CHKD_IMPL_TYPE_VEHSPDLGTSAFE1CHKD_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_VEHSPDLGTSAFE1CHKD_IMPL_TYPE_VEHSPDLGTSAFE1CHKD_H_
