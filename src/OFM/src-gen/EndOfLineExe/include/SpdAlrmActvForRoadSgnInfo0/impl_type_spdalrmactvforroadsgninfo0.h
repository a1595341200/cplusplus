 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/SpdAlrmActvForRoadSgnInfo0/impl_type_spdalrmactvforroadsgninfo0.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0_H_
#define ENDOFLINEEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0_H_
