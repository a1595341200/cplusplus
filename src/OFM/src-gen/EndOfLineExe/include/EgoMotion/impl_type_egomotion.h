 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/EgoMotion/impl_type_egomotion.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
#define ENDOFLINEEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
