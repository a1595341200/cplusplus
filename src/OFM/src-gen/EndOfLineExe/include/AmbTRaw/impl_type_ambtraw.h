 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/AmbTRaw/impl_type_ambtraw.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
#define ENDOFLINEEXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
