 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/LaneChgstatus/impl_type_lanechgstatus.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_LANECHGSTATUS_IMPL_TYPE_LANECHGSTATUS_H_
#define PERCEPTIONREAREXE_INCLUDE_LANECHGSTATUS_IMPL_TYPE_LANECHGSTATUS_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_LANECHGSTATUS_IMPL_TYPE_LANECHGSTATUS_H_
