 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/PinionSteerAgGroup/impl_type_pinionsteeraggroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
#define PERCEPTIONREAREXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
