 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/VehModMngtGlbSafe1/impl_type_vehmodmngtglbsafe1.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_VEHMODMNGTGLBSAFE1_IMPL_TYPE_VEHMODMNGTGLBSAFE1_H_
#define PERCEPTIONREAREXE_INCLUDE_VEHMODMNGTGLBSAFE1_IMPL_TYPE_VEHMODMNGTGLBSAFE1_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_VEHMODMNGTGLBSAFE1_IMPL_TYPE_VEHMODMNGTGLBSAFE1_H_
