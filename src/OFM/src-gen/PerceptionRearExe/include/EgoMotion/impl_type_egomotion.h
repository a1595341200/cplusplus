 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/EgoMotion/impl_type_egomotion.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
#define PERCEPTIONREAREXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
