 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/SpdAlrmActvForRoadSgnInfo0/impl_type_spdalrmactvforroadsgninfo0.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0_H_
#define PERCEPTIONREAREXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0_H_
