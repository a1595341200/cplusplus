 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/AmbTRaw/impl_type_ambtraw.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
#define PERCEPTIONREAREXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
