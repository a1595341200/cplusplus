 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/TrfcLiActvSts/impl_type_trfcliactvsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_TRFCLIACTVSTS_IMPL_TYPE_TRFCLIACTVSTS_H_
#define PERCEPTIONREAREXE_INCLUDE_TRFCLIACTVSTS_IMPL_TYPE_TRFCLIACTVSTS_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_TRFCLIACTVSTS_IMPL_TYPE_TRFCLIACTVSTS_H_
