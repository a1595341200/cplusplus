 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Soc2LidarExe/include/EpbSts/impl_type_epbsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef SOC2LIDAREXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
#define SOC2LIDAREXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
...
#endif  // SOC2LIDAREXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
