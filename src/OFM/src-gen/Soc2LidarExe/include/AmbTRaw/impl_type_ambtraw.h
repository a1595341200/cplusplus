 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Soc2LidarExe/include/AmbTRaw/impl_type_ambtraw.h
 *        \brief
 *
 *      \details
 *
...
#ifndef SOC2LIDAREXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
#define SOC2LIDAREXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
...
#endif  // SOC2LIDAREXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
