 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Soc2LidarExe/include/LppLaneChgSts/impl_type_lpplanechgsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef SOC2LIDAREXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
#define SOC2LIDAREXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
...
#endif  // SOC2LIDAREXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
