 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Soc2LidarExe/include/soc2lidarsid_out/soc2lidarsi_out_skeleton.h
...
#ifndef SOC2LIDAREXE_INCLUDE_SOC2LIDARSID_OUT_SOC2LIDARSI_OUT_SKELETON_H_
#define SOC2LIDAREXE_INCLUDE_SOC2LIDARSID_OUT_SOC2LIDARSI_OUT_SKELETON_H_
...
#include "soc2lidarsid_out/Soc2LidarSI_Out_skeleton_impl_interface.h"
...
/*!
 * \brief Type alias for service event 'Soc2L_Bus_VehicleInfo2Lidar', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using Soc2L_Bus_VehicleInfo2Lidar = ::amsr::socal::events::SkeletonEvent<
    soc2lidarsid_out::skeleton::Soc2LidarSI_OutSkeleton,
    ::VehicleInfo2Lidar::VehicleInfo2Lidar,
    soc2lidarsid_out::internal::Soc2LidarSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::VehicleInfo2Lidar::VehicleInfo2Lidar>,
    &soc2lidarsid_out::internal::Soc2LidarSI_OutSkeletonImplInterface::GetEventManagerSoc2L_Bus_VehicleInfo2Lidar>;
...
/*!
 * \brief Skeleton interface class for the service 'Soc2LidarSI_Out'.
 *
 * \vpublic
 * \trace SPEC-4980341
 */
class Soc2LidarSI_OutSkeleton
    : public ::amsr::socal::Skeleton<soc2lidarsid_out::Soc2LidarSI_Out,
                                          soc2lidarsid_out::internal::Soc2LidarSI_OutSkeletonImplInterface> {
 public:
// ---- Constructors / Destructors -----------------------------------------------------------------------------------
/*!
 * \brief Exception-less pre-construction of Soc2LidarSI_Out.
 *
...
/*!
 * \brief Exception-less pre-construction of Soc2LidarSI_OutSkeleton.
 *
...
/*!
 * \brief Exception-less constructor of Soc2LidarSI_OutSkeleton.
 ...
 * \trace SPEC-8053555
 */
explicit Soc2LidarSI_OutSkeleton(ConstructionToken&& token) noexcept;

  /*!
   * \brief Delete default constructor.
   */
  Soc2LidarSI_OutSkeleton() = delete;
  /*!
   * \brief Delete copy constructor.
   */
  Soc2LidarSI_OutSkeleton(Soc2LidarSI_OutSkeleton const &) = delete;
  /*!
   * \brief Delete move constructor.
   */
  Soc2LidarSI_OutSkeleton(Soc2LidarSI_OutSkeleton &&) = delete;
  /*!
   * \brief Delete copy assignment.
   */
  Soc2LidarSI_OutSkeleton &operator=(Soc2LidarSI_OutSkeleton const &) & = delete;
  /*!
   * \brief Delete move assignment.
   */
  Soc2LidarSI_OutSkeleton &operator=(Soc2LidarSI_OutSkeleton &&) & = delete;

  /*!
   * \brief Constructor of Soc2LidarSI_OutSkeleton.
   *
   ...
   * \trace SPEC-4980356
   */
   explicit Soc2LidarSI_OutSkeleton(
   ...
   * \trace SPEC-4980351
   */
  ~Soc2LidarSI_OutSkeleton() noexcept override;

  /*!
   * \brief Type alias for ServiceDiscovery.
   */
  using ServiceDiscovery = ::amsr::socal::internal::service_discovery::ServiceDiscovery<Soc2LidarSI_OutSkeleton>;
  ...
  /*!
   * \brief The skeleton event 'Soc2L_Bus_VehicleInfo2Lidar' which can be used by application developer.
   * \details 
   * Data of type ::VehicleInfo2Lidar::VehicleInfo2Lidar
   * \vpublic
   */
  events::Soc2L_Bus_VehicleInfo2Lidar Soc2L_Bus_VehicleInfo2Lidar;
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<soc2lidarsid_out::Soc2LidarSI_Out, soc2lidarsid_out::internal::Soc2LidarSI_OutSkeletonImplInterface>;

  /*!
   * \copydoc amsr::socal::Skeleton<soc2lidarsid_out::Soc2LidarSI_Out,soc2lidarsid_out::internal::Soc2LidarSI_OutSkeletonImplInterface>::DoFieldInitializationChecks()
   */
  void DoFieldInitializationChecks() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<soc2lidarsid_out::Soc2LidarSI_Out,soc2lidarsid_out::internal::Soc2LidarSI_OutSkeletonImplInterface>::SendInitialFieldNotifications()
   */
  void SendInitialFieldNotifications() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<soc2lidarsid_out::Soc2LidarSI_Out,soc2lidarsid_out::internal::Soc2LidarSI_OutSkeletonImplInterface>::OfferServiceInternal()
   */
  void OfferServiceInternal(::ara::com::InstanceIdentifier const& instance_id) noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<soc2lidarsid_out::Soc2LidarSI_Out,soc2lidarsid_out::internal::Soc2LidarSI_OutSkeletonImplInterface>::StopOfferServiceInternal()
   */
...
#endif  // SOC2LIDAREXE_INCLUDE_SOC2LIDARSID_OUT_SOC2LIDARSI_OUT_SKELETON_H_
