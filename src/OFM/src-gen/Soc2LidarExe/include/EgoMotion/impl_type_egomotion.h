 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Soc2LidarExe/include/EgoMotion/impl_type_egomotion.h
 *        \brief
 *
 *      \details
 *
...
#ifndef SOC2LIDAREXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
#define SOC2LIDAREXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
...
#endif  // SOC2LIDAREXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
