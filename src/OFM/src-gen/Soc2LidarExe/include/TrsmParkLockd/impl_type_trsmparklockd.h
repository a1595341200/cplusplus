 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Soc2LidarExe/include/TrsmParkLockd/impl_type_trsmparklockd.h
 *        \brief
 *
 *      \details
 *
...
#ifndef SOC2LIDAREXE_INCLUDE_TRSMPARKLOCKD_IMPL_TYPE_TRSMPARKLOCKD_H_
#define SOC2LIDAREXE_INCLUDE_TRSMPARKLOCKD_IMPL_TYPE_TRSMPARKLOCKD_H_
...
#endif  // SOC2LIDAREXE_INCLUDE_TRSMPARKLOCKD_IMPL_TYPE_TRSMPARKLOCKD_H_
