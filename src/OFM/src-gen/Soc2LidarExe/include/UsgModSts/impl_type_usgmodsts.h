 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Soc2LidarExe/include/UsgModSts/impl_type_usgmodsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef SOC2LIDAREXE_INCLUDE_USGMODSTS_IMPL_TYPE_USGMODSTS_H_
#define SOC2LIDAREXE_INCLUDE_USGMODSTS_IMPL_TYPE_USGMODSTS_H_
...
#endif  // SOC2LIDAREXE_INCLUDE_USGMODSTS_IMPL_TYPE_USGMODSTS_H_
