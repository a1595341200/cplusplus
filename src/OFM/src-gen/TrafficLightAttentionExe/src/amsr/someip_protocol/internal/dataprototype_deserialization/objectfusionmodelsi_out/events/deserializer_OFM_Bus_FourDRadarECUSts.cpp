 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/objectfusionmodelsi_out/events/deserializer_OFM_Bus_FourDRadarECUSts.cpp
...
deserialization::Result DeserializerOFM_Bus_FourDRadarECUSts::Deserialize(deserialization::Reader &reader, ::FourDRadarECUSts::FourDRadarECUSts &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/ObjectFusionModelSI_Out/OFM_Bus_FourDRadarECUSts
