 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/WhlInfoGroup/impl_type_whlinfogroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
