 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/ObjGroup2Vcc/impl_type_objgroup2vcc.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_OBJGROUP2VCC_IMPL_TYPE_OBJGROUP2VCC_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_OBJGROUP2VCC_IMPL_TYPE_OBJGROUP2VCC_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_OBJGROUP2VCC_IMPL_TYPE_OBJGROUP2VCC_H_
