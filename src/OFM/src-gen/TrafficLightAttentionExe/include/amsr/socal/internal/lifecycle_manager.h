...
class LifecycleManager final {
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    objectfusionmodelsi_out::proxy::ObjectFusionModelSI_OutProxy::RegisterServiceDiscovery(&objectfusionmodelsi_out_proxy_sd_);
    ...
    trafficlightattentionsi_out::skeleton::TrafficLightAttentionSI_OutSkeleton::RegisterServiceDiscovery(&trafficlightattentionsi_out_skeleton_sd_);
  }
   ...
   */
  using ObjectFusionModelSI_OutProxyServiceDiscovery = ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutProxyBackendInterface>;

  /*!
   * \brief Service discovery instance used on proxy side for the service interface ObjectFusionModelSI_Out.
   */
  ObjectFusionModelSI_OutProxyServiceDiscovery objectfusionmodelsi_out_proxy_sd_;
   ...
   *        used for the service interface TrafficLightAttentionSI_Out.
   */
  using TrafficLightAttentionSI_OutSkeletonSdType = trafficlightattentionsi_out::skeleton::TrafficLightAttentionSI_OutSkeleton::ServiceDiscovery;

  /*!
   * \brief Service discovery instance used on skeleton side for the service interface TrafficLightAttentionSI_Out.
   */
  TrafficLightAttentionSI_OutSkeletonSdType trafficlightattentionsi_out_skeleton_sd_;
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr
