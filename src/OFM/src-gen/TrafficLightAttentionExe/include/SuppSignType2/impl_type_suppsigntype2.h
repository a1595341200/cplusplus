 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/SuppSignType2/impl_type_suppsigntype2.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_SUPPSIGNTYPE2_IMPL_TYPE_SUPPSIGNTYPE2_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_SUPPSIGNTYPE2_IMPL_TYPE_SUPPSIGNTYPE2_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_SUPPSIGNTYPE2_IMPL_TYPE_SUPPSIGNTYPE2_H_
