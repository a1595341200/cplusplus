 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/VehBattU1Vcc/impl_type_vehbattu1vcc.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_VEHBATTU1VCC_IMPL_TYPE_VEHBATTU1VCC_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_VEHBATTU1VCC_IMPL_TYPE_VEHBATTU1VCC_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_VEHBATTU1VCC_IMPL_TYPE_VEHBATTU1VCC_H_
