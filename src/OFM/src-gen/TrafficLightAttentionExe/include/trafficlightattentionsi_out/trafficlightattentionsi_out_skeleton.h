 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/trafficlightattentionsi_out/trafficlightattentionsi_out_skeleton.h
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRAFFICLIGHTATTENTIONSI_OUT_TRAFFICLIGHTATTENTIONSI_OUT_SKELETON_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRAFFICLIGHTATTENTIONSI_OUT_TRAFFICLIGHTATTENTIONSI_OUT_SKELETON_H_
 ...
 */
class TrafficLightAttentionSI_OutSkeleton;
...
/*!
 * \brief Type alias for service event 'TLA_Bus_HMIDataTrfcLi', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using TLA_Bus_HMIDataTrfcLi = ::amsr::socal::events::SkeletonEvent<
    trafficlightattentionsi_out::skeleton::TrafficLightAttentionSI_OutSkeleton,
    ::HMIDataTrfcLi1Vcc::HMIDataTrfcLi1Vcc,
    trafficlightattentionsi_out::internal::TrafficLightAttentionSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::HMIDataTrfcLi1Vcc::HMIDataTrfcLi1Vcc>,
    &trafficlightattentionsi_out::internal::TrafficLightAttentionSI_OutSkeletonImplInterface::GetEventManagerTLA_Bus_HMIDataTrfcLi>;
...
/*!
 * \brief Skeleton interface class for the service 'TrafficLightAttentionSI_Out'.
 *
 * \vpublic
 * \trace SPEC-4980341
 */
class TrafficLightAttentionSI_OutSkeleton
    : public ::amsr::socal::Skeleton<trafficlightattentionsi_out::TrafficLightAttentionSI_Out,
                                          trafficlightattentionsi_out::internal::TrafficLightAttentionSI_OutSkeletonImplInterface> {
 public:
// ---- Constructors / Destructors -----------------------------------------------------------------------------------
/*!
 * \brief Exception-less pre-construction of TrafficLightAttentionSI_Out.
 *
...
/*!
 * \brief Exception-less pre-construction of TrafficLightAttentionSI_OutSkeleton.
 *
...
/*!
 * \brief Exception-less constructor of TrafficLightAttentionSI_OutSkeleton.
 ...
 * \trace SPEC-8053555
 */
explicit TrafficLightAttentionSI_OutSkeleton(ConstructionToken&& token) noexcept;

  /*!
   * \brief Delete default constructor.
   */
  TrafficLightAttentionSI_OutSkeleton() = delete;
  /*!
   * \brief Delete copy constructor.
   */
  TrafficLightAttentionSI_OutSkeleton(TrafficLightAttentionSI_OutSkeleton const &) = delete;
  /*!
   * \brief Delete move constructor.
   */
  TrafficLightAttentionSI_OutSkeleton(TrafficLightAttentionSI_OutSkeleton &&) = delete;
  /*!
   * \brief Delete copy assignment.
   */
  TrafficLightAttentionSI_OutSkeleton &operator=(TrafficLightAttentionSI_OutSkeleton const &) & = delete;
  /*!
   * \brief Delete move assignment.
   */
  TrafficLightAttentionSI_OutSkeleton &operator=(TrafficLightAttentionSI_OutSkeleton &&) & = delete;

  /*!
   * \brief Constructor of TrafficLightAttentionSI_OutSkeleton.
   *
   ...
   * \trace SPEC-4980356
   */
   explicit TrafficLightAttentionSI_OutSkeleton(
   ...
   * \trace SPEC-4980351
   */
  ~TrafficLightAttentionSI_OutSkeleton() noexcept override;

  /*!
   * \brief Type alias for ServiceDiscovery.
   */
  using ServiceDiscovery = ::amsr::socal::internal::service_discovery::ServiceDiscovery<TrafficLightAttentionSI_OutSkeleton>;
  ...
  /*!
   * \brief The skeleton event 'TLA_Bus_HMIDataTrfcLi' which can be used by application developer.
   * \details 
   * Data of type ::HMIDataTrfcLi1Vcc::HMIDataTrfcLi1Vcc
   * \vpublic
   */
  events::TLA_Bus_HMIDataTrfcLi TLA_Bus_HMIDataTrfcLi;
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<trafficlightattentionsi_out::TrafficLightAttentionSI_Out, trafficlightattentionsi_out::internal::TrafficLightAttentionSI_OutSkeletonImplInterface>;

  /*!
   * \copydoc amsr::socal::Skeleton<trafficlightattentionsi_out::TrafficLightAttentionSI_Out,trafficlightattentionsi_out::internal::TrafficLightAttentionSI_OutSkeletonImplInterface>::DoFieldInitializationChecks()
   */
  void DoFieldInitializationChecks() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<trafficlightattentionsi_out::TrafficLightAttentionSI_Out,trafficlightattentionsi_out::internal::TrafficLightAttentionSI_OutSkeletonImplInterface>::SendInitialFieldNotifications()
   */
  void SendInitialFieldNotifications() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<trafficlightattentionsi_out::TrafficLightAttentionSI_Out,trafficlightattentionsi_out::internal::TrafficLightAttentionSI_OutSkeletonImplInterface>::OfferServiceInternal()
   */
  void OfferServiceInternal(::ara::com::InstanceIdentifier const& instance_id) noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<trafficlightattentionsi_out::TrafficLightAttentionSI_Out,trafficlightattentionsi_out::internal::TrafficLightAttentionSI_OutSkeletonImplInterface>::StopOfferServiceInternal()
   */
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRAFFICLIGHTATTENTIONSI_OUT_TRAFFICLIGHTATTENTIONSI_OUT_SKELETON_H_
