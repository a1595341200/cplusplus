 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/EgoMotion/impl_type_egomotion.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
