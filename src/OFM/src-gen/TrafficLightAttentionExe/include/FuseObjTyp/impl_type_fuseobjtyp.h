 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/FuseObjTyp/impl_type_fuseobjtyp.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_FUSEOBJTYP_IMPL_TYPE_FUSEOBJTYP_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_FUSEOBJTYP_IMPL_TYPE_FUSEOBJTYP_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_FUSEOBJTYP_IMPL_TYPE_FUSEOBJTYP_H_
