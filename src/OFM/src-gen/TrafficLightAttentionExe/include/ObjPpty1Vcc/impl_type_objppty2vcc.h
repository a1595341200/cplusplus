 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/ObjPpty1Vcc/impl_type_objppty2vcc.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_OBJPPTY1VCC_IMPL_TYPE_OBJPPTY2VCC_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_OBJPPTY1VCC_IMPL_TYPE_OBJPPTY2VCC_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_OBJPPTY1VCC_IMPL_TYPE_OBJPPTY2VCC_H_
