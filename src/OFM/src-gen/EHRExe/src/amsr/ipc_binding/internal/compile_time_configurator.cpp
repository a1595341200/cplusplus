 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/src/amsr/ipc_binding/internal/compile_time_configurator.cpp
...
void CompileTimeConfigurator<BindingCoreType>::RegisterInstanceSpecifierMappings(RuntimeInterface& runtime, BindingCoreType const& binding_core) noexcept {
  ...
  {
    // Map P-Port /JICA/SWC/EHRExe/EHR/EHRSIP to instance /JICA/Service/ProvidedIpcEHRSI_Out/ProvidedIpcEHRSI_Out
    ::ara::core::InstanceSpecifier const instance_specifier{"EHRExe/EHR/EHRSIP"_sv};
...
void CompileTimeConfigurator<BindingCoreType>::Cleanup(RuntimeInterface& runtime) const noexcept {
  ...
  {
    // Remove mapping P-Port /JICA/SWC/EHRExe/EHR/EHRSIP to instance /JICA/Service/ProvidedIpcEHRSI_Out/ProvidedIpcEHRSI_Out
    ::ara::core::InstanceSpecifier const instance_specifier{"EHRExe/EHR/EHRSIP"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"Ipc:1062"_sv};
...
void CompileTimeConfigurator<BindingCoreType>::InitializeProvidedServiceDeployments(BindingCoreType& binding_core) noexcept {
  {
    // Instantiate provided service instances for service deployment '/JICA/Service/DeploymentIpc/IpcEHRSI_Out'.
    {
      ...
      sd_service_identifer.instance_id_ =  1062;
      sd_service_identifer.major_version_ =  1;
      sd_service_identifer.minor_version_  =  0;

      // Provided service instance '/JICA/Service/ProvidedIpcEHRSI_Out/ProvidedIpcEHRSI_Out'
      ...
      params.ipc_unicast_address_.ipc_unicast_domain_ = 6;
      params.ipc_unicast_address_.ipc_unicast_port_ = 6;

      binding_core.GetServerManager().EmplaceProvidedServiceInstance(sd_service_identifer, params, ::ehrsi_out::EHRSI_Out::ServiceIdentifier);
    }
  }
}
