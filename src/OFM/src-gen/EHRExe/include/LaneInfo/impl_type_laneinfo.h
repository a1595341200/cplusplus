 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LaneInfo/impl_type_laneinfo.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LANEINFO_IMPL_TYPE_LANEINFO_H_
#define EHREXE_INCLUDE_LANEINFO_IMPL_TYPE_LANEINFO_H_
...
#endif  // EHREXE_INCLUDE_LANEINFO_IMPL_TYPE_LANEINFO_H_
