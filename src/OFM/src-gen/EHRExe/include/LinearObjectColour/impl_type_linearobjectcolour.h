 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LinearObjectColour/impl_type_linearobjectcolour.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LINEAROBJECTCOLOUR_IMPL_TYPE_LINEAROBJECTCOLOUR_H_
#define EHREXE_INCLUDE_LINEAROBJECTCOLOUR_IMPL_TYPE_LINEAROBJECTCOLOUR_H_
...
#endif  // EHREXE_INCLUDE_LINEAROBJECTCOLOUR_IMPL_TYPE_LINEAROBJECTCOLOUR_H_
