 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/PathNode/impl_type_pathnode.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_PATHNODE_IMPL_TYPE_PATHNODE_H_
#define EHREXE_INCLUDE_PATHNODE_IMPL_TYPE_PATHNODE_H_
...
#endif  // EHREXE_INCLUDE_PATHNODE_IMPL_TYPE_PATHNODE_H_
