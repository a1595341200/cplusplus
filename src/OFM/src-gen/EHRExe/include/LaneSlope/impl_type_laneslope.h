 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LaneSlope/impl_type_laneslope.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LANESLOPE_IMPL_TYPE_LANESLOPE_H_
#define EHREXE_INCLUDE_LANESLOPE_IMPL_TYPE_LANESLOPE_H_
...
#endif  // EHREXE_INCLUDE_LANESLOPE_IMPL_TYPE_LANESLOPE_H_
