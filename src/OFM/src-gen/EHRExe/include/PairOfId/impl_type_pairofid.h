 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/PairOfId/impl_type_pairofid.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_PAIROFID_IMPL_TYPE_PAIROFID_H_
#define EHREXE_INCLUDE_PAIROFID_IMPL_TYPE_PAIROFID_H_
...
#endif  // EHREXE_INCLUDE_PAIROFID_IMPL_TYPE_PAIROFID_H_
