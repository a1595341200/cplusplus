 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LinkInfo/impl_type_linkinfo.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LINKINFO_IMPL_TYPE_LINKINFO_H_
#define EHREXE_INCLUDE_LINKINFO_IMPL_TYPE_LINKINFO_H_
...
#endif  // EHREXE_INCLUDE_LINKINFO_IMPL_TYPE_LINKINFO_H_
