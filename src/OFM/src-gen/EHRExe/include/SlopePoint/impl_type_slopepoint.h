 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/SlopePoint/impl_type_slopepoint.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_SLOPEPOINT_IMPL_TYPE_SLOPEPOINT_H_
#define EHREXE_INCLUDE_SLOPEPOINT_IMPL_TYPE_SLOPEPOINT_H_
...
#endif  // EHREXE_INCLUDE_SLOPEPOINT_IMPL_TYPE_SLOPEPOINT_H_
