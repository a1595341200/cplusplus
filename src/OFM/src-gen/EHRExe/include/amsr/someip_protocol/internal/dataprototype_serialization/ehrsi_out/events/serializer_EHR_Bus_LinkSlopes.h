...
class SerializerEHR_Bus_LinkSlopes {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/LinkSlopes.
   *
   ...
   * \synchronous TRUE
   */
  constexpr static std::size_t GetRequiredBufferSize(::LinkSlopes::LinkSlopes const &data) noexcept {
   ...
   * \synchronous TRUE
   */
  static void Serialize(serialization::Writer &writer, ::LinkSlopes::LinkSlopes const &data);
