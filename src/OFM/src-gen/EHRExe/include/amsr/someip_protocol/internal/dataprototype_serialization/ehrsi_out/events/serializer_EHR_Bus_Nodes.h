 ...
 *  INCLUDES
 *********************************************************************************************************************/
#include "Nodes/impl_type_nodes.h"
 ...
 * \details Top-Level data type: /CppImplementationDataTypes/Nodes
...
class SerializerEHR_Bus_Nodes {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/Nodes.
   *
   ...
   * \synchronous TRUE
   */
  constexpr static std::size_t GetRequiredBufferSize(::Nodes::Nodes const &data) noexcept {
   ...
   * \synchronous TRUE
   */
  static void Serialize(serialization::Writer &writer, ::Nodes::Nodes const &data);
