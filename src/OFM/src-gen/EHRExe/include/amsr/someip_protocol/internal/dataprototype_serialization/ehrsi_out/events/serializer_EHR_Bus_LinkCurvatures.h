...
#include "amsr/someip_protocol/internal/datatype_serialization/LinkCurvature/serializer_LinkCurvature.h"
...
class SerializerEHR_Bus_LinkCurvatures {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/LinkCurvatures.
   *
   ...
   * \synchronous TRUE
   */
  constexpr static std::size_t GetRequiredBufferSize(::LinkCurvatures::LinkCurvatures const &data) noexcept {
    return serialization::GetRequiredBufferSize<
      TpPackDataPrototype,
      // Config of vector length field and max. container size based on 'arraySize=null' model configuration. (/CppImplementationDataTypes/LinkCurvatures)
   ...
   * \synchronous TRUE
   */
  static void Serialize(serialization::Writer &writer, ::LinkCurvatures::LinkCurvatures const &data);
