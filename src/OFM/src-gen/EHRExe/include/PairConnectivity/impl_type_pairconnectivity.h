 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/PairConnectivity/impl_type_pairconnectivity.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_PAIRCONNECTIVITY_IMPL_TYPE_PAIRCONNECTIVITY_H_
#define EHREXE_INCLUDE_PAIRCONNECTIVITY_IMPL_TYPE_PAIRCONNECTIVITY_H_
...
#endif  // EHREXE_INCLUDE_PAIRCONNECTIVITY_IMPL_TYPE_PAIRCONNECTIVITY_H_
