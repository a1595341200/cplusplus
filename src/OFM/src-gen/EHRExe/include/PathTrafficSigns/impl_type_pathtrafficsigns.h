 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/PathTrafficSigns/impl_type_pathtrafficsigns.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_PATHTRAFFICSIGNS_IMPL_TYPE_PATHTRAFFICSIGNS_H_
#define EHREXE_INCLUDE_PATHTRAFFICSIGNS_IMPL_TYPE_PATHTRAFFICSIGNS_H_
...
#endif  // EHREXE_INCLUDE_PATHTRAFFICSIGNS_IMPL_TYPE_PATHTRAFFICSIGNS_H_
