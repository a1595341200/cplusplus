 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LaneSpeedLimit/impl_type_lanespeedlimit.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LANESPEEDLIMIT_IMPL_TYPE_LANESPEEDLIMIT_H_
#define EHREXE_INCLUDE_LANESPEEDLIMIT_IMPL_TYPE_LANESPEEDLIMIT_H_
...
#endif  // EHREXE_INCLUDE_LANESPEEDLIMIT_IMPL_TYPE_LANESPEEDLIMIT_H_
