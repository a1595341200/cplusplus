 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LinkCurvature/impl_type_linkcurvature.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LINKCURVATURE_IMPL_TYPE_LINKCURVATURE_H_
#define EHREXE_INCLUDE_LINKCURVATURE_IMPL_TYPE_LINKCURVATURE_H_
...
#endif  // EHREXE_INCLUDE_LINKCURVATURE_IMPL_TYPE_LINKCURVATURE_H_
