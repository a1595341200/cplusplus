 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/MergePoint/impl_type_mergepoint.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_MERGEPOINT_IMPL_TYPE_MERGEPOINT_H_
#define EHREXE_INCLUDE_MERGEPOINT_IMPL_TYPE_MERGEPOINT_H_
...
#endif  // EHREXE_INCLUDE_MERGEPOINT_IMPL_TYPE_MERGEPOINT_H_
