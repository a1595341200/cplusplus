...
: Base{std::move(token)}
, RMF_Bus_RMFInfo(this)
, RMF_Bus_MapInfo(this)
, RMF_Bus_VectorMapInfo(this)
, RMF_Bus_Position(this)
{}
...
RoadModelFusionSI_OutSkeleton::RoadModelFusionSI_OutSkeleton(::ara::com::InstanceIdentifier instance,
     ...
     : RoadModelFusionSI_OutSkeleton{Preconstruct(instance, mode).Value()} {}  // VCA_SOCAL_COPY_CTOR_WITH_CTOR_ARGUMENT

RoadModelFusionSI_OutSkeleton::RoadModelFusionSI_OutSkeleton(::ara::core::InstanceSpecifier instance,
                                               ::ara::com::MethodCallProcessingMode mode) noexcept
     : RoadModelFusionSI_OutSkeleton{Preconstruct(instance, mode).Value()} {}
...
RoadModelFusionSI_OutSkeleton::RoadModelFusionSI_OutSkeleton(::ara::com::InstanceIdentifierContainer instance_identifiers,
     ...
     : RoadModelFusionSI_OutSkeleton{Preconstruct(instance_identifiers, mode).Value()} {}
...
void RoadModelFusionSI_OutSkeleton::SendInitialFieldNotifications(SkeletonImplInterfacePtr const concrete_impl_interface) const noexcept {
...
void RoadModelFusionSI_OutSkeleton::PrepareEventsAndFieldNotifiers(SkeletonImplInterfacePtr const concrete_impl_interface) noexcept {
   RMF_Bus_RMFInfo.InitializePreallocatedValue(concrete_impl_interface);
   RMF_Bus_MapInfo.InitializePreallocatedValue(concrete_impl_interface);
   RMF_Bus_VectorMapInfo.InitializePreallocatedValue(concrete_impl_interface);
   RMF_Bus_Position.InitializePreallocatedValue(concrete_impl_interface);
