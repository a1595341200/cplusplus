...
#include "amsr/someip_protocol/internal/datatype_deserialization/LinkSlopeIDT/deserializer_LinkSlopeIDT.h"
...
deserialization::Result DeserializerEHR_Bus_LinkSlopes::Deserialize(deserialization::Reader &reader, ::Array_LinkSlopeIDT_Vector::Array_LinkSlopeIDT_Vector &data) noexcept {
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      TpPackAlias,
        // Config of vector length field and max. container size (/CppImplementationDataTypes/Array_LinkSlopeIDT_Vector)
      ...
      >(deserialization::SizeToken<::Array_LinkSlopeIDT_Vector::Array_LinkSlopeIDT_Vector>{})};
