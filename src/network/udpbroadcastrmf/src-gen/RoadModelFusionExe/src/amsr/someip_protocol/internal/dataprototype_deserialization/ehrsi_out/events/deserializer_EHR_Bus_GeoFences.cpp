...
#include "amsr/someip_protocol/internal/datatype_deserialization/GeoFenceIDT/deserializer_GeoFenceIDT.h"
...
deserialization::Result DeserializerEHR_Bus_GeoFences::Deserialize(deserialization::Reader &reader, ::Array_GeoFenceIDT_Vector::Array_GeoFenceIDT_Vector &data) noexcept {
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      TpPackAlias,
        // Config of vector length field and max. container size (/CppImplementationDataTypes/Array_GeoFenceIDT_Vector)
      ...
      >(deserialization::SizeToken<::Array_GeoFenceIDT_Vector::Array_GeoFenceIDT_Vector>{})};
