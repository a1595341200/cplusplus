...
#include "amsr/someip_protocol/internal/datatype_deserialization/PathTrafficSignsIDT/deserializer_PathTrafficSignsIDT.h"
...
deserialization::Result DeserializerEHR_Bus_TrafficSigns::Deserialize(deserialization::Reader &reader, ::Array_PathTrafficSignsIDT_Vector::Array_PathTrafficSignsIDT_Vector &data) noexcept {
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      TpPackAlias,
        // Config of vector length field and max. container size (/CppImplementationDataTypes/Array_PathTrafficSignsIDT_Vector)
      ...
      >(deserialization::SizeToken<::Array_PathTrafficSignsIDT_Vector::Array_PathTrafficSignsIDT_Vector>{})};
