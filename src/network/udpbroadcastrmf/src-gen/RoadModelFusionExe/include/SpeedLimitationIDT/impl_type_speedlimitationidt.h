 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/SpeedLimitationIDT/impl_type_speedlimitationidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_SPEEDLIMITATIONIDT_IMPL_TYPE_SPEEDLIMITATIONIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_SPEEDLIMITATIONIDT_IMPL_TYPE_SPEEDLIMITATIONIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_SPEEDLIMITATIONIDT_IMPL_TYPE_SPEEDLIMITATIONIDT_H_
