 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/AreaIDT/impl_type_areaidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_AREAIDT_IMPL_TYPE_AREAIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_AREAIDT_IMPL_TYPE_AREAIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_AREAIDT_IMPL_TYPE_AREAIDT_H_
