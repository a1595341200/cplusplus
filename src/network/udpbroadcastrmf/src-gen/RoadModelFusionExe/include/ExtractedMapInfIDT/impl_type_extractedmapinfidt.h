 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/ExtractedMapInfIDT/impl_type_extractedmapinfidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_EXTRACTEDMAPINFIDT_IMPL_TYPE_EXTRACTEDMAPINFIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_EXTRACTEDMAPINFIDT_IMPL_TYPE_EXTRACTEDMAPINFIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_EXTRACTEDMAPINFIDT_IMPL_TYPE_EXTRACTEDMAPINFIDT_H_
