 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/TrafficSignTypeIDT/impl_type_trafficsigntypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_TRAFFICSIGNTYPEIDT_IMPL_TYPE_TRAFFICSIGNTYPEIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_TRAFFICSIGNTYPEIDT_IMPL_TYPE_TRAFFICSIGNTYPEIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_TRAFFICSIGNTYPEIDT_IMPL_TYPE_TRAFFICSIGNTYPEIDT_H_
