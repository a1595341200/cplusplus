 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/MatchingStatusIDT/impl_type_matchingstatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_MATCHINGSTATUSIDT_IMPL_TYPE_MATCHINGSTATUSIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_MATCHINGSTATUSIDT_IMPL_TYPE_MATCHINGSTATUSIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_MATCHINGSTATUSIDT_IMPL_TYPE_MATCHINGSTATUSIDT_H_
