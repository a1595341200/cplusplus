 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/ReSideRdrRiObj1IDT/impl_type_residerdrriobj1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_RESIDERDRRIOBJ1IDT_IMPL_TYPE_RESIDERDRRIOBJ1IDT_H_
#define EDREXE_INCLUDE_RESIDERDRRIOBJ1IDT_IMPL_TYPE_RESIDERDRRIOBJ1IDT_H_
...
/*!
 * \brief Type ReSideRdrRiObj1IDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/ReSideRdrRiObj1IDT
 */
struct ReSideRdrRiObj1IDT {
...
/*!
 * \brief   Compare for equality with another ReSideRdrRiObj1IDT instance.
 ...
 *          use your own.
 */
inline bool operator==(ReSideRdrRiObj1IDT const& l,
                       ReSideRdrRiObj1IDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another ReSideRdrRiObj1IDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // EDREXE_INCLUDE_RESIDERDRRIOBJ1IDT_IMPL_TYPE_RESIDERDRRIOBJ1IDT_H_
