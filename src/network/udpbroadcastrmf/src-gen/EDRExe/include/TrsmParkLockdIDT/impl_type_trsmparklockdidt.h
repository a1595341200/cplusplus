 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/TrsmParkLockdIDT/impl_type_trsmparklockdidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_TRSMPARKLOCKDIDT_IMPL_TYPE_TRSMPARKLOCKDIDT_H_
#define EDREXE_INCLUDE_TRSMPARKLOCKDIDT_IMPL_TYPE_TRSMPARKLOCKDIDT_H_
...
#endif  // EDREXE_INCLUDE_TRSMPARKLOCKDIDT_IMPL_TYPE_TRSMPARKLOCKDIDT_H_
