 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/AsyLineRi2PahIDT/impl_type_asylineri2pahidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_ASYLINERI2PAHIDT_IMPL_TYPE_ASYLINERI2PAHIDT_H_
#define EDREXE_INCLUDE_ASYLINERI2PAHIDT_IMPL_TYPE_ASYLINERI2PAHIDT_H_
...
/*!
 * \brief Type AsyLineRi2PahIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/AsyLineRi2PahIDT
 */
struct AsyLineRi2PahIDT {
...
/*!
 * \brief   Compare for equality with another AsyLineRi2PahIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(AsyLineRi2PahIDT const& l,
                       AsyLineRi2PahIDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another AsyLineRi2PahIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // EDREXE_INCLUDE_ASYLINERI2PAHIDT_IMPL_TYPE_ASYLINERI2PAHIDT_H_
