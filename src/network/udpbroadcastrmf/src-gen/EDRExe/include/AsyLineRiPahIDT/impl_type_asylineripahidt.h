 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/AsyLineRiPahIDT/impl_type_asylineripahidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_ASYLINERIPAHIDT_IMPL_TYPE_ASYLINERIPAHIDT_H_
#define EDREXE_INCLUDE_ASYLINERIPAHIDT_IMPL_TYPE_ASYLINERIPAHIDT_H_
...
/*!
 * \brief Type AsyLineRiPahIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/AsyLineRiPahIDT
 */
struct AsyLineRiPahIDT {
...
/*!
 * \brief   Compare for equality with another AsyLineRiPahIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(AsyLineRiPahIDT const& l,
                       AsyLineRiPahIDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another AsyLineRiPahIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // EDREXE_INCLUDE_ASYLINERIPAHIDT_IMPL_TYPE_ASYLINERIPAHIDT_H_
