 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/EscWarnIndcnReq1VccIDT/impl_type_escwarnindcnreq1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_ESCWARNINDCNREQ1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQ1VCCIDT_H_
#define EDREXE_INCLUDE_ESCWARNINDCNREQ1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQ1VCCIDT_H_
...
#endif  // EDREXE_INCLUDE_ESCWARNINDCNREQ1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQ1VCCIDT_H_
