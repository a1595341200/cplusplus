 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/PinionSteerAgGroupIDT/impl_type_pinionsteeraggroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
#define EDREXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
...
#endif  // EDREXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
