 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/AsyIndcrDispSts1VccIDT/impl_type_asyindcrdispsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
#define EDREXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
...
#endif  // EDREXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
