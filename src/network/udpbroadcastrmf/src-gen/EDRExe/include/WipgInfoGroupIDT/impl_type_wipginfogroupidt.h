 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/WipgInfoGroupIDT/impl_type_wipginfogroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
#define EDREXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
...
#endif  // EDREXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
