 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/src/amsr/ipc_binding_transformation_layer/internal/edrsi_out/EDRSI_Out_skeleton_ipc_binding.cpp
 *        \brief  IpcBinding skeleton binding of service 'EDRSI_Out'
 *
 *      \details
 *
 *********************************************************************************************************************/
 ...
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/ipc_binding_transformation_layer/internal/edrsi_out/EDRSI_Out_skeleton_ipc_binding.h"
#include <utility>
...
void EDRSI_OutProvidedIpcServiceInstance::OnRequestReceived(
...
// VECTOR NC AutosarC++17_10-M0.1.8: MD_IPCBINDING_AutosarC++17_10_M0.1.8_config_variant
// VECTOR NC AutosarC++17_10-M7.1.2: MD_IPCBINDING_AutosarC++17_10-M7.1.2_config_variant
void EDRSI_OutProvidedIpcServiceInstance::OnRequestNoReturnReceived(
...
::amsr::ipc_binding_core::internal::ForwardNotificationMessage EDRSI_OutProvidedIpcServiceInstance::OnSubscribeEventReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput EDRSI_OutProvidedIpcServiceInstance::OnUnsubscribeEventReceived(
...
EDRSI_OutSkeletonIpcEventManagerEDR_Bus_EDRInfo* EDRSI_OutProvidedIpcServiceInstance::GetEventManagerEDR_Bus_EDRInfo() noexcept {
  return &event_EDR_Bus_EDRInfo_;
}
