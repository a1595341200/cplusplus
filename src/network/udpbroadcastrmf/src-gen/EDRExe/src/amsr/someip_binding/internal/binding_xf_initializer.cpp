 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/src/amsr/someip_binding/internal/binding_xf_initializer.cpp
...
void BindingXfInitializer::InitializeServiceDiscoveryProxyXfs(
  ...
  { // Instantiate ServiceDiscoveryProxyXfs for Service EDRSI_In
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/EDRSI_In"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
    ...
    SomeIpBindingProxyXfInitializer::InitializeSdProxyXfs<
        ::edrsi_in::proxy::EDRSI_InProxy,
        ::edrsi_in::internal::EDRSI_InProxyBackendInterface,
        ::amsr::someip_binding_xf::internal::gen_edrsi_in::EDRSI_InProxyXf>(
        // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
...
void BindingXfInitializer::DeInitializeServiceDiscoveryProxyXfs(
    configuration::ServiceConfigWrapperInterface const& services_config) noexcept {
  {  // Deinitialize ServiceDiscoveryProxyXf for Service EDRSI_In
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/EDRSI_In"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
