 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/src/amsr/socal/internal/runtime_gen.cpp
...
void Runtime::InitializeInstanceSpecifierLookupTables() noexcept {
  ...
  // Add R-Port InstanceSpecifier 'EDRExe/EDR/EDR_EDRSI_In_R' to the lookup table.
  // VCA_SOCAL_UNDEFINED_RUNTIME_ADD_INSTANCE_SPECIFIER_FUNCTION
  AddInstanceSpecifier(required_instance_specifier_table_, "EDRExe/EDR/EDR_EDRSI_In_R"_sv);

  // Add R-Port InstanceSpecifier 'EDRExe/EDR/EDR_ToSOCA_InfomationSI_R' to the lookup table.
  // VCA_SOCAL_UNDEFINED_RUNTIME_ADD_INSTANCE_SPECIFIER_FUNCTION
  AddInstanceSpecifier(required_instance_specifier_table_, "EDRExe/EDR/EDR_ToSOCA_InfomationSI_R"_sv);

  // Add R-Port InstanceSpecifier 'EDRExe/EDR/EDR_UTC0SI_In_R' to the lookup table.
  // VCA_SOCAL_UNDEFINED_RUNTIME_ADD_INSTANCE_SPECIFIER_FUNCTION
  AddInstanceSpecifier(required_instance_specifier_table_, "EDRExe/EDR/EDR_UTC0SI_In_R"_sv);

  // Add P-Port InstanceSpecifier 'EDRExe/EDR/EDR_EDRSI_Out_P' to the lookup table.
  // VCA_SOCAL_UNDEFINED_RUNTIME_ADD_INSTANCE_SPECIFIER_FUNCTION
  AddInstanceSpecifier(provided_instance_specifier_table_, "EDRExe/EDR/EDR_EDRSI_Out_P"_sv);
}
