 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  amsr_vector_fs_sm/src/ara/core/initialization.cpp
...
#include "amsr/phm/internal/lifecycle.h"
...
ara::core::Result<void> ara::core::Initialize() noexcept {
  return CheckPreCondition()
      ...
      .AndThen([]() { return amsr::phm::internal::InitializeComponent(); }) // VCA_APPLICATIONBASE_VALID_FUNCTION_CALL, VCA_APPLICATIONBASE_FUNCTION_CALL_VERIFIED
      .Inspect([]() {
...
ara::core::Result<void> ara::core::Deinitialize() noexcept {
  ...
  if (ara::core::details::g_initialization_state == ara::core::details::InitializationState::kInitialized) {
    ...
    res = amsr::phm::internal::DeinitializeComponent() // VCA_APPLICATIONBASE_FUNCTION_CALL_VERIFIED
