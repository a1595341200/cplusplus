 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/AccTarSeln1RecIDT/impl_type_acctarseln1recidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
