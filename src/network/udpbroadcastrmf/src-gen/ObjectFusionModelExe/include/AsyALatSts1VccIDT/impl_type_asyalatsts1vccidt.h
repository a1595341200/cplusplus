 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/AsyALatSts1VccIDT/impl_type_asyalatsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
