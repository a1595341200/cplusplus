 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/StopLineIDT/impl_type_stoplineidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
