 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/tosoca_siderdrfusedtargetssi/TOSOCA_SideRdrFusedTargetsSI_datatypes.h
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_SIDERDRFUSEDTARGETSSI_TOSOCA_SIDERDRFUSEDTARGETSSI_DATATYPES_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_SIDERDRFUSEDTARGETSSI_TOSOCA_SIDERDRFUSEDTARGETSSI_DATATYPES_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_SIDERDRFUSEDTARGETSSI_TOSOCA_SIDERDRFUSEDTARGETSSI_DATATYPES_H_
