 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/LineSignGroupIDT/impl_type_linesigngroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
