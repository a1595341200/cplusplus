 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/VehBattU1VccIDT/impl_type_vehbattu1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
