 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/perceptionrearsi_out/PerceptionRearSI_Out_types.h
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_TYPES_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_TYPES_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_TYPES_H_
