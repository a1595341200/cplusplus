 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/CamObjTyp1IDT/impl_type_camobjtyp1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
