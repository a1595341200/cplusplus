...
/*!
 * \brief Type alias for service event 'FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp', that is part of the proxy.
 *
 * \trace SPEC-4980345
 */

using FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp =
    ::amsr::socal::events::ProxyEvent<::FourDRadarObjStsGrp01_42IDT::FourDRadarObjStsGrp01_42IDT, ::amsr::socal::kRuntimeProcessingMode>;
 ...
 */
class RadarAdaptorSI_OutProxy : public ::amsr::socal::ThreadDrivenProxy<radaradaptorsi_out::RadarAdaptorSI_Out, radaradaptorsi_out::internal::RadarAdaptorSI_OutProxyBackendInterface, radaradaptorsi_out::internal::RadarAdaptorSI_OutHandleType>{
 public:
  ...
  */
   ...
   * \endspec
   */
  RadarAdaptorSI_OutProxy(RadarAdaptorSI_OutProxy const&) noexcept = default;
   ...
   * \endspec
   */
  RadarAdaptorSI_OutProxy(RadarAdaptorSI_OutProxy&&) noexcept = default;
   ...
   * \endspec
   */
  RadarAdaptorSI_OutProxy& operator=(RadarAdaptorSI_OutProxy const&) & noexcept = default;
   ...
   * \endspec
   */
  RadarAdaptorSI_OutProxy& operator=(RadarAdaptorSI_OutProxy&&) & noexcept = default;
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::ThreadDrivenProxy<radaradaptorsi_out::RadarAdaptorSI_Out, ProxyBackendInterface, radaradaptorsi_out::internal::RadarAdaptorSI_OutHandleType>;
 ...
 public:
  ...
  /*!
   * \brief Event 'FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp' which can be used by application developer.
   * \details
