 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/amsr/someip_protocol/internal/datatype_serialization/RoadEdge1VccRiIDT/serializer_RoadEdge1VccRiIDT.h
 *        \brief  SOME/IP protocol serializer implementation for datatype 'RoadEdge1VccRiIDT'
 *
 *      \details  /CppImplementationDataTypes/RoadEdge1VccRiIDT
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_ROADEDGE1VCCRIIDT_SERIALIZER_ROADEDGE1VCCRIIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_ROADEDGE1VCCRIIDT_SERIALIZER_ROADEDGE1VCCRIIDT_H_
...
/*!
 * \brief Serializer for datatype /CppImplementationDataTypes/RoadEdge1VccRiIDT.
 ...
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/RoadEdge1VccRiIDT to be serialized.
...
void SomeIpProtocolSerialize(amsr::someip_protocol::internal::serialization::Writer& writer, ::RoadEdge1VccRiIDT::RoadEdge1VccRiIDT const &data) noexcept {
...
/*!
 * \brief Calculates the required buffer size for datatype /CppImplementationDataTypes/RoadEdge1VccRiIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/RoadEdge1VccRiIDT.
 ...
 */
template <typename TpPack>
constexpr std::size_t GetRequiredBufferSize(::RoadEdge1VccRiIDT::RoadEdge1VccRiIDT const &data) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/RoadEdge1VccRiIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 ...
 * \endspec
 */
template <typename T, typename TpPack, std::enable_if_t<std::is_same<T, ::RoadEdge1VccRiIDT::RoadEdge1VccRiIDT>::value, bool> = true>
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/RoadEdge1VccRiIDT. For ADL.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr amsr::someip_protocol::internal::serialization::InfSizeT GetMaximumBufferSize(::RoadEdge1VccRiIDT::RoadEdge1VccRiIDT const&) noexcept {
  return GetMaximumBufferSize<::RoadEdge1VccRiIDT::RoadEdge1VccRiIDT, TpPack>();
}

/*!
 * \brief Checks if datatype /CppImplementationDataTypes/RoadEdge1VccRiIDT is of static size.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr bool IsStaticSize(amsr::someip_protocol::internal::serialization::SizeToken<::RoadEdge1VccRiIDT::RoadEdge1VccRiIDT>) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_ROADEDGE1VCCRIIDT_SERIALIZER_ROADEDGE1VCCRIIDT_H_
