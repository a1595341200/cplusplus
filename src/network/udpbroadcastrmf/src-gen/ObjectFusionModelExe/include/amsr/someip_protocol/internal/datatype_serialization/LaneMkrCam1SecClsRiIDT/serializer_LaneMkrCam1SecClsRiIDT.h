 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/amsr/someip_protocol/internal/datatype_serialization/LaneMkrCam1SecClsRiIDT/serializer_LaneMkrCam1SecClsRiIDT.h
 *        \brief  SOME/IP protocol serializer implementation for datatype 'LaneMkrCam1SecClsRiIDT'
 *
 *      \details  /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1SECCLSRIIDT_SERIALIZER_LANEMKRCAM1SECCLSRIIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1SECCLSRIIDT_SERIALIZER_LANEMKRCAM1SECCLSRIIDT_H_
...
namespace LaneMkrCam1SecClsRiIDT {

/*!
 * \brief Serializer for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT.
 ...
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT to be serialized.
...
void SomeIpProtocolSerialize(amsr::someip_protocol::internal::serialization::Writer& writer, ::LaneMkrCam1SecClsRiIDT::LaneMkrCam1SecClsRiIDT const &data) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
  // Serialize non-TLV struct
    // Serialize struct member 'C0Minus' of type /CppImplementationDataTypes/float
    ...
    serialization::SomeIpProtocolSerialize<
                        ...
                        >(writer, data.C0Minus);
    // Serialize struct member 'C0MinusVariance' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                        ...
                        >(writer, data.C0MinusVariance);
    // Serialize struct member 'C1Minus' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                        ...
                        >(writer, data.C1Minus);
    // Serialize struct member 'C1MinusVariance' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                        ...
                        >(writer, data.C1MinusVariance);
    // Serialize struct member 'C2Minus' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                        ...
                        >(writer, data.C2Minus);
    // Serialize struct member 'C2MinusVariance' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                        ...
                        >(writer, data.C2MinusVariance);
    // Serialize struct member 'C3Minus' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                        ...
                        >(writer, data.C3Minus);
    // Serialize struct member 'C3MinusVariance' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                        ...
                        >(writer, data.C3MinusVariance);
    // Serialize struct member 'MinusStartPoint' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                        ...
                        >(writer, data.MinusStartPoint);
    // Serialize struct member 'MinusEndPoint' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
    ...
    // Serialize struct member 'PriStartPoint' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                        ...
                        >(writer, data.PriStartPoint);
    // Serialize struct member 'PriEndPoint' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
    ...
    // Serialize struct member 'IsFirstValid' of type /CppImplementationDataTypes/Bool1VccIDT
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/Bool1VccIDT)
                        ...
                        >(writer, data.IsFirstValid);
    // Serialize struct member 'ColorLane' of type /CppImplementationDataTypes/LineColor1VccIDT
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        ...
                        >(writer, data.ColorLane);
    // Serialize struct member 'TypeLane' of type /CppImplementationDataTypes/CamLineTypeIDT
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        ...
                        >(writer, data.TypeLane);
    // Serialize struct member 'TrackStsLane' of type /CppImplementationDataTypes/LaneTrackStsIDT
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
    ...
    // Serialize struct member 'MrkWidth' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
    ...
    serialization::SomeIpProtocolSerialize<
                        ...
                        >(writer, data.CamCntr);
    // Serialize struct member 'IsVerified' of type /CppImplementationDataTypes/Bool1VccIDT
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/Bool1VccIDT)
    ...
    // Serialize struct member 'TypChgPoint' of type /CppImplementationDataTypes/float
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                        ...
                        >(writer, data.TypChgPoint);
    // Serialize struct member 'TypAftChgPoint' of type /CppImplementationDataTypes/CamLineTypeIDT
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/CamLineTypeIDT)
                        ...
                        >(writer, data.TypAftChgPoint);
    // Serialize struct member 'TypRoad' of type /CppImplementationDataTypes/TypRoadIDT
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
    ...
    // Serialize struct member 'LaneMkrAge' of type /CppImplementationDataTypes/uint32_t
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/uint32_t)
                        ...
                        >(writer, data.LaneMkrAge);
}

/*!
 * \brief Calculates the required buffer size for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT.
 ...
 */
template <typename TpPack>
constexpr std::size_t GetRequiredBufferSize(::LaneMkrCam1SecClsRiIDT::LaneMkrCam1SecClsRiIDT const &data) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 ...
 * \endspec
 */
template <typename T, typename TpPack, std::enable_if_t<std::is_same<T, ::LaneMkrCam1SecClsRiIDT::LaneMkrCam1SecClsRiIDT>::value, bool> = true>
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT. For ADL.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr amsr::someip_protocol::internal::serialization::InfSizeT GetMaximumBufferSize(::LaneMkrCam1SecClsRiIDT::LaneMkrCam1SecClsRiIDT const&) noexcept {
  return GetMaximumBufferSize<::LaneMkrCam1SecClsRiIDT::LaneMkrCam1SecClsRiIDT, TpPack>();
}

/*!
 * \brief Checks if datatype /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT is of static size.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr bool IsStaticSize(amsr::someip_protocol::internal::serialization::SizeToken<::LaneMkrCam1SecClsRiIDT::LaneMkrCam1SecClsRiIDT>) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;

  constexpr bool is_static_size{
  // Check static size status of struct member 'C0Minus' of type /CppImplementationDataTypes/float
  ...
  // Check static size status of struct member 'C0MinusVariance' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'C1Minus' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'C1MinusVariance' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'C2Minus' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'C2MinusVariance' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'C3Minus' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'C3MinusVariance' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'MinusStartPoint' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'MinusEndPoint' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'PriStartPoint' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'PriEndPoint' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'IsFirstValid' of type /CppImplementationDataTypes/Bool1VccIDT
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/Bool1VccIDT)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'ColorLane' of type /CppImplementationDataTypes/LineColor1VccIDT
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/LineColor1VccIDT)
                      typename serialization::Tp<TpPack>::ByteOrder

                      >(serialization::SizeToken<::LineColor1VccIDT::LineColor1VccIDT>{})  && 
  
  // Check static size status of struct member 'TypeLane' of type /CppImplementationDataTypes/CamLineTypeIDT
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/CamLineTypeIDT)
                      typename serialization::Tp<TpPack>::ByteOrder

                      >(serialization::SizeToken<::CamLineTypeIDT::CamLineTypeIDT>{})  && 
  
  // Check static size status of struct member 'TrackStsLane' of type /CppImplementationDataTypes/LaneTrackStsIDT
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/LaneTrackStsIDT)
                      typename serialization::Tp<TpPack>::ByteOrder

                      >(serialization::SizeToken<::LaneTrackStsIDT::LaneTrackStsIDT>{})  && 
  ...
  // Check static size status of struct member 'MrkWidth' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'IsVerified' of type /CppImplementationDataTypes/Bool1VccIDT
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/Bool1VccIDT)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'TypChgPoint' of type /CppImplementationDataTypes/float
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/float)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'TypAftChgPoint' of type /CppImplementationDataTypes/CamLineTypeIDT
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/CamLineTypeIDT)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'TypRoad' of type /CppImplementationDataTypes/TypRoadIDT
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/TypRoadIDT)
                      typename serialization::Tp<TpPack>::ByteOrder

                      >(serialization::SizeToken<::TypRoadIDT::TypRoadIDT>{})  && 
  ...
  // Check static size status of struct member 'LaneMkrAge' of type /CppImplementationDataTypes/uint32_t
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/uint32_t)
                      typename serialization::Tp<TpPack>::ByteOrder
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1SECCLSRIIDT_SERIALIZER_LANEMKRCAM1SECCLSRIIDT_H_
