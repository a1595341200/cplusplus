 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/ObjGroup2VccIDT/impl_type_objgroup2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_OBJGROUP2VCCIDT_IMPL_TYPE_OBJGROUP2VCCIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_OBJGROUP2VCCIDT_IMPL_TYPE_OBJGROUP2VCCIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_OBJGROUP2VCCIDT_IMPL_TYPE_OBJGROUP2VCCIDT_H_
