 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/PerceptionRearLaneInfoIDT/impl_type_perceptionrearlaneinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
