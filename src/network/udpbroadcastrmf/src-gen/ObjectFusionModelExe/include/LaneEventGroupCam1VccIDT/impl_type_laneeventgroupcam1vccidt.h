 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/LaneEventGroupCam1VccIDT/impl_type_laneeventgroupcam1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
