 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/CameraStatusIDT/impl_type_camerastatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
