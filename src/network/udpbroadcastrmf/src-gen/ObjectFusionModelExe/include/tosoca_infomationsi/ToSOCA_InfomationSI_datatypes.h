 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_datatypes.h
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
