...
RadarAdaptorSI_OutProxyXf::RadarAdaptorSI_OutProxyXf(
  ...
  ::amsr::ipc_binding_core::internal::runtime_configuration::ServiceConfig const& service_config)
    : provided_service_instance_id_{service_config.GetId(), service_instance_id,
      ...
      event_backend_FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp_{
...
RadarAdaptorSI_OutProxyXf::~RadarAdaptorSI_OutProxyXf() noexcept { // VCA_IPCB_MOLE_1298
  // VCA_IPCB_SERVICE_INTERFACE_PROXY_XF_SAFE_UNDEFINED_FUNCTION
...
void RadarAdaptorSI_OutProxyXf::EmplaceEventBackends() {
  ...
  static_cast<void>(event_backend_table_.emplace(event_backend_FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp_.GetEventId().value, &event_backend_FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp_ ));
...
::amsr::ipc_binding_core::internal::ForwardOutput RadarAdaptorSI_OutProxyXf::OnResponseReceived(
        ::amsr::ipc_binding_core::internal::ipc_protocol::ResponseMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::ipc_binding_core::internal::ForwardOutput RadarAdaptorSI_OutProxyXf::OnNotificationReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput RadarAdaptorSI_OutProxyXf::OnSubscribeAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput RadarAdaptorSI_OutProxyXf::OnSubscribeNAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput RadarAdaptorSI_OutProxyXf::OnApplicationErrorReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ApplicationErrorMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

// VECTOR NC AutosarC++17_10-M0.1.8: MD_IPCBINDING_AutosarC++17_10_M0.1.8_config_variant
void RadarAdaptorSI_OutProxyXf::OnErrorResponseReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ErrorResponseMessage&&) {
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::socal::SkeletonConnectionState RadarAdaptorSI_OutProxyXf::ReadSkeletonConnectionState() noexcept {
...
// ---- Events ---------------------------------------------------------------------------------------------------
RadarAdaptorSI_OutProxyXfEventBackendFourDRadarObjStsGAPGrp_FourDRadarObjStsGrp& RadarAdaptorSI_OutProxyXf::GetEventBackendFourDRadarObjStsGAPGrp_FourDRadarObjStsGrp() noexcept {
  return event_backend_FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp_;
}
// ---- Events ---------------------------------------------------------------------------------------------------
