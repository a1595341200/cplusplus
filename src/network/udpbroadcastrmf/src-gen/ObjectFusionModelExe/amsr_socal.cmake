...
target_sources(${target} PRIVATE
  ...
  "${CMAKE_CURRENT_LIST_DIR}/src/objectfusionmodelsi_out/objectfusionmodelsi_out_skeleton.cpp"
  ...
  "${CMAKE_CURRENT_LIST_DIR}/src/perceptionsi_visnobjout/perceptionsi_visnobjout_proxy.cpp"
  ...
  "${CMAKE_CURRENT_LIST_DIR}/src/radaradaptorsi_out/radaradaptorsi_out_proxy.cpp"
  ...
  "${CMAKE_CURRENT_LIST_DIR}/src/tosoca_siderdrfusedtargetssi/tosoca_siderdrfusedtargetssi.cpp"
  "${CMAKE_CURRENT_LIST_DIR}/src/tosoca_siderdrfusedtargetssi/tosoca_siderdrfusedtargetssi_proxy.cpp"
)
...
target_sources(${target} PRIVATE
  ...
  "${CMAKE_CURRENT_LIST_DIR}/include/objectfusionmodelsi_out/ObjectFusionModelSI_Out_skeleton_backend_interface.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/objectfusionmodelsi_out/ObjectFusionModelSI_Out_skeleton_impl_interface.h"
  ...
  "${CMAKE_CURRENT_LIST_DIR}/include/objectfusionmodelsi_out/objectfusionmodelsi_out_skeleton.h"
  ...
  "${CMAKE_CURRENT_LIST_DIR}/include/perceptionsi_visnobjout/PerceptionSI_VisnObjOut_datatypes.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/perceptionsi_visnobjout/PerceptionSI_VisnObjOut_proxy_backend_interface.h"
  ...
  "${CMAKE_CURRENT_LIST_DIR}/include/perceptionsi_visnobjout/perceptionsi_visnobjout_proxy.h"
  ...
  "${CMAKE_CURRENT_LIST_DIR}/include/radaradaptorsi_out/RadarAdaptorSI_Out_datatypes.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/radaradaptorsi_out/RadarAdaptorSI_Out_proxy_backend_interface.h"
  ...
  "${CMAKE_CURRENT_LIST_DIR}/include/radaradaptorsi_out/radaradaptorsi_out_proxy.h"
  ...
  "${CMAKE_CURRENT_LIST_DIR}/include/tosoca_siderdrfusedtargetssi/TOSOCA_SideRdrFusedTargetsSI.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/tosoca_siderdrfusedtargetssi/TOSOCA_SideRdrFusedTargetsSI_datatypes.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/tosoca_siderdrfusedtargetssi/TOSOCA_SideRdrFusedTargetsSI_proxy_backend_interface.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/tosoca_siderdrfusedtargetssi/TOSOCA_SideRdrFusedTargetsSI_types.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/tosoca_siderdrfusedtargetssi/tosoca_siderdrfusedtargetssi_common.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/tosoca_siderdrfusedtargetssi/tosoca_siderdrfusedtargetssi_proxy.h"
)
