 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/roadmodelfusionsi_out/RoadModelFusionSI_Out_datatypes.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_DATATYPES_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_DATATYPES_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_DATATYPES_H_
