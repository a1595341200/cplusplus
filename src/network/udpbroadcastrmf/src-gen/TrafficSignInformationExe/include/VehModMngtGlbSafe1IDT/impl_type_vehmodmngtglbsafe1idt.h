 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/VehModMngtGlbSafe1IDT/impl_type_vehmodmngtglbsafe1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
