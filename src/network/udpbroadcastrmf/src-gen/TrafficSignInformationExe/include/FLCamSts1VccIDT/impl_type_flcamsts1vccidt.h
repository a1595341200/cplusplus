 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/FLCamSts1VccIDT/impl_type_flcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_FLCAMSTS1VCCIDT_IMPL_TYPE_FLCAMSTS1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_FLCAMSTS1VCCIDT_IMPL_TYPE_FLCAMSTS1VCCIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_FLCAMSTS1VCCIDT_IMPL_TYPE_FLCAMSTS1VCCIDT_H_
