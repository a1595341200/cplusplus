 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/CamObjTyp1IDT/impl_type_camobjtyp1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
