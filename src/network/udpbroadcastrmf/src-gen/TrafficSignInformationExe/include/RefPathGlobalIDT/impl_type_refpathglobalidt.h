 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/RefPathGlobalIDT/impl_type_refpathglobalidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_REFPATHGLOBALIDT_IMPL_TYPE_REFPATHGLOBALIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_REFPATHGLOBALIDT_IMPL_TYPE_REFPATHGLOBALIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_REFPATHGLOBALIDT_IMPL_TYPE_REFPATHGLOBALIDT_H_
