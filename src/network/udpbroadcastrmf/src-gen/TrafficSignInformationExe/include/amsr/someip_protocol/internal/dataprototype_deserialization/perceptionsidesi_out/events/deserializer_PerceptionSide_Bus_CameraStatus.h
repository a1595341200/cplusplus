 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsidesi_out/events/deserializer_PerceptionSide_Bus_CameraStatus.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_DESERIALIZATION_PERCEPTIONSIDESI_OUT_EVENTS_deserializer_PerceptionSide_Bus_CameraStatus_h_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_DESERIALIZATION_PERCEPTIONSIDESI_OUT_EVENTS_deserializer_PerceptionSide_Bus_CameraStatus_h_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_DESERIALIZATION_PERCEPTIONSIDESI_OUT_EVENTS_deserializer_PerceptionSide_Bus_CameraStatus_h_
