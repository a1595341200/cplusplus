 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/someip_protocol/internal/datatype_deserialization/FLCamSts1VccIDT/deserializer_FLCamSts1VccIDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'FLCamSts1VccIDT'
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_FLCAMSTS1VCCIDT_DESERIALIZER_FLCAMSTS1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_FLCAMSTS1VCCIDT_DESERIALIZER_FLCAMSTS1VCCIDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/FLCamSts1VccIDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/FLCamSts1VccIDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::FLCamSts1VccIDT::FLCamSts1VccIDT &data) noexcept {
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/FLCamSts1VccIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::FLCamSts1VccIDT::FLCamSts1VccIDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_FLCAMSTS1VCCIDT_DESERIALIZER_FLCAMSTS1VCCIDT_H_
