 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/ipc_binding_transformation_layer/internal/perceptionsidesi_out/PerceptionSideSI_Out_proxy_xf_ipc_binding.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_XF_IPC_BINDING_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_XF_IPC_BINDING_H_
...
#include <map>
#include <utility>
#include "amsr/ipc_binding_transformation_layer/internal/perceptionsidesi_out/PerceptionSideSI_Out_proxy_xf_ipc_events.h"
...
class PerceptionSideSI_OutProxyXf final
    : public ::perceptionsidesi_out::internal::PerceptionSideSI_OutProxyBackendInterface,
 ...
 public:
   ...
   *                                                PerceptionSideSI_OutProxyXf's entire life time.
   ...
   * \synchronous TRUE
   */
  ~PerceptionSideSI_OutProxyXf() noexcept final;

  PerceptionSideSI_OutProxyXf(PerceptionSideSI_OutProxyXf const &) = delete;
  PerceptionSideSI_OutProxyXf &operator=(PerceptionSideSI_OutProxyXf const &) = delete;
  PerceptionSideSI_OutProxyXf(PerceptionSideSI_OutProxyXf &&) = delete;
  PerceptionSideSI_OutProxyXf &operator=(PerceptionSideSI_OutProxyXf &&) = delete;
 ...
 // ---- Events ---------------------------------------------------------------------------------------------------
  ...
  /*!
   * \brief       Getter function for the event 'PerceptionSide_Bus_CameraStatus'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSideSI_OutProxyXfEventBackendPerceptionSide_Bus_CameraStatus& GetEventBackendPerceptionSide_Bus_CameraStatus() noexcept final;
 ...
 private:
  ...
  /*!
   * \brief Event backend for proxy event 'PerceptionSide_Bus_CameraStatus'.
   */
  PerceptionSideSI_OutProxyXfEventBackendPerceptionSide_Bus_CameraStatus event_backend_PerceptionSide_Bus_CameraStatus_;
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_XF_IPC_BINDING_H_
