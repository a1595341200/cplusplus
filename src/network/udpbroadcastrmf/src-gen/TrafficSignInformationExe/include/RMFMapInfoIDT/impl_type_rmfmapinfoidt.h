 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/RMFMapInfoIDT/impl_type_rmfmapinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_RMFMAPINFOIDT_IMPL_TYPE_RMFMAPINFOIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_RMFMAPINFOIDT_IMPL_TYPE_RMFMAPINFOIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_RMFMAPINFOIDT_IMPL_TYPE_RMFMAPINFOIDT_H_
