 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/Lane_typeIDT/impl_type_lane_typeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANE_TYPEIDT_IMPL_TYPE_LANE_TYPEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANE_TYPEIDT_IMPL_TYPE_LANE_TYPEIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANE_TYPEIDT_IMPL_TYPE_LANE_TYPEIDT_H_
