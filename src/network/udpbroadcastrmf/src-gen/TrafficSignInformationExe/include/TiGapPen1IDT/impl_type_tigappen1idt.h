 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/TiGapPen1IDT/impl_type_tigappen1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_TIGAPPEN1IDT_IMPL_TYPE_TIGAPPEN1IDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_TIGAPPEN1IDT_IMPL_TYPE_TIGAPPEN1IDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_TIGAPPEN1IDT_IMPL_TYPE_TIGAPPEN1IDT_H_
