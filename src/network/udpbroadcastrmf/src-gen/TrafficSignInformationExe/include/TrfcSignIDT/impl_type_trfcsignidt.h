 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/TrfcSignIDT/impl_type_trfcsignidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
