 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/VehSpdLgtSafe1ChkdIDT/impl_type_vehspdlgtsafe1chkdidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
