 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/RoadSignIDT/impl_type_roadsignidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
