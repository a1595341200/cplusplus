 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/roadmodelfusionsi_out/events/deserializer_RMF_Bus_VectorMapInfo.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/VectorMapInfoIDT/deserializer_VectorMapInfoIDT.h"
...
deserialization::Result DeserializerRMF_Bus_VectorMapInfo::Deserialize(deserialization::Reader &reader, ::VectorMapInfoIDT::VectorMapInfoIDT &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/RoadModelFusionSI_Out/RMF_Bus_VectorMapInfo
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::VectorMapInfoIDT::VectorMapInfoIDT>{})};
