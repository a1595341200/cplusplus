 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionrearsi_out/events/deserializer_PerceptionRear_Bus_CameraStatus.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/RearCamSts1VccIDT/deserializer_RearCamSts1VccIDT.h"
...
deserialization::Result DeserializerPerceptionRear_Bus_CameraStatus::Deserialize(deserialization::Reader &reader, ::RearCamSts1VccIDT::RearCamSts1VccIDT &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionRearSI_Out/PerceptionRear_Bus_CameraStatus
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::RearCamSts1VccIDT::RearCamSts1VccIDT>{})};
