 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/VehBattU1VccIDT/impl_type_vehbattu1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
