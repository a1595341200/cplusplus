 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/BrkPedlrRatIDT/impl_type_brkpedlrratidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_BRKPEDLRRATIDT_IMPL_TYPE_BRKPEDLRRATIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_BRKPEDLRRATIDT_IMPL_TYPE_BRKPEDLRRATIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_BRKPEDLRRATIDT_IMPL_TYPE_BRKPEDLRRATIDT_H_
