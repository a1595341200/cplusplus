 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/PerceptionRearLaneInfoIDT/impl_type_perceptionrearlaneinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
