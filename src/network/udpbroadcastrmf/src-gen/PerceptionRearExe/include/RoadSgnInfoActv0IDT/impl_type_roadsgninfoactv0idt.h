 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/RoadSgnInfoActv0IDT/impl_type_roadsgninfoactv0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
#define PERCEPTIONREAREXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
