 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/LaneMkrCam1RiIDT/impl_type_lanemkrcam1riidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
