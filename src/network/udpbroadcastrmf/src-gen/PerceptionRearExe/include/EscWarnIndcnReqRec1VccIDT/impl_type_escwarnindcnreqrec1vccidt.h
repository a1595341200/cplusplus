 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/EscWarnIndcnReqRec1VccIDT/impl_type_escwarnindcnreqrec1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
