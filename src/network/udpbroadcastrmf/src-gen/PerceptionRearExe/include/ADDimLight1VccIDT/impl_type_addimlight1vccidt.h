 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/ADDimLight1VccIDT/impl_type_addimlight1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
