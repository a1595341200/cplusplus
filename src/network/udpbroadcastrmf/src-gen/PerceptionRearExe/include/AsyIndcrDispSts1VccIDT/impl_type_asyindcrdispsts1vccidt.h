 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/AsyIndcrDispSts1VccIDT/impl_type_asyindcrdispsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
