 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/amsr/socal/internal/lifecycle_manager.h
...
#ifndef PERCEPTIONREAREXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
#define PERCEPTIONREAREXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
...
class LifecycleManager final {
 public:
  ...
  static void Initialize() noexcept {
    ...
    perceptionrearsi_out::skeleton::PerceptionRearSI_OutSkeleton::CreateSingletons();
  ...
  static void Deinitialize() noexcept {
    ...
    perceptionrearsi_out::skeleton::PerceptionRearSI_OutSkeleton::DestroySingletons();
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    perceptionrearsi_out::skeleton::PerceptionRearSI_OutSkeleton::RegisterServiceDiscovery(&perceptionrearsi_out_skeleton_sd_0_);
  }
  ...
  void DeInitializeServiceDiscovery() noexcept {
    ...
    perceptionrearsi_out::skeleton::PerceptionRearSI_OutSkeleton::DeRegisterServiceDiscovery();
  }
   ...
   */
  perceptionrearsi_out::skeleton::PerceptionRearSI_OutSkeleton::ServiceDiscovery perceptionrearsi_out_skeleton_sd_0_{perceptionrearsi_out::PerceptionRearSI_Out::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr

#endif  // PERCEPTIONREAREXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
