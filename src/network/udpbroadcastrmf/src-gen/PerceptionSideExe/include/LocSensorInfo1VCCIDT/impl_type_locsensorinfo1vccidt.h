 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/LocSensorInfo1VCCIDT/impl_type_locsensorinfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_LOCSENSORINFO1VCCIDT_IMPL_TYPE_LOCSENSORINFO1VCCIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_LOCSENSORINFO1VCCIDT_IMPL_TYPE_LOCSENSORINFO1VCCIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_LOCSENSORINFO1VCCIDT_IMPL_TYPE_LOCSENSORINFO1VCCIDT_H_
