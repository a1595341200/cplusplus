 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/amsr/someip_protocol/internal/dataprototype_serialization/perceptionsidesi_out/events/serializer_RLCam_Bus_VisnObj.h
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSIDESI_OUT_EVENTS_serializer_RLCam_Bus_VisnObj_h_
#define PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSIDESI_OUT_EVENTS_serializer_RLCam_Bus_VisnObj_h_
...
class SerializerRLCam_Bus_VisnObj {
 public:
  ...
  /*!
   * \brief Returns the maximum buffer size for the data prototype service event /JICA/Service/Interface/PerceptionSideSI_Out/RLCam_Bus_VisnObj.
   *
   * \return      Calculated buffer size for serialization.
   * \pre         -
   * \context     App
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSIDESI_OUT_EVENTS_serializer_RLCam_Bus_VisnObj_h_
