 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/amsr/ipc_binding_transformation_layer/internal/perceptionsidesi_out/PerceptionSideSI_Out_skeleton_ipc_binding.h
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_SKELETON_IPC_BINDING_H_
#define PERCEPTIONSIDEEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_SKELETON_IPC_BINDING_H_
...
#include <utility>
#include "amsr/ipc_binding_transformation_layer/internal/perceptionsidesi_out/PerceptionSideSI_Out_skeleton_ipc_event_manager.h"
#include "amsr/ipc_binding_transformation_layer/internal/perceptionsidesi_out/PerceptionSideSI_Out_skeleton_ipc_method_manager.h"
...
#include "perceptionsidesi_out/PerceptionSideSI_Out_skeleton_impl_interface.h"
...
class PerceptionSideSI_OutProvidedIpcServiceInstance final
 ...
 /*!
   ...
   * \param[in,out] skeleton                Reference to the skeleton. The reference must be valid for PerceptionSideSI_OutProvidedIpcServiceInstance entire life time.
   * \param[in,out] server_binding_manager  Server binding manager. The reference must be valid for PerceptionSideSI_OutProvidedIpcServiceInstance entire life time.
   ...
   * \synchronous   TRUE
   */
  PerceptionSideSI_OutProvidedIpcServiceInstance(::perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonBackendInterface& skeleton,
      ...
      : ::amsr::ipc_binding_core::internal::LocalServerSink{},
        ...
        logger_{::amsr::ipc_binding_core::internal::logging::kIpcLoggerContextId,
                ...
                ::amsr::core::StringView{"PerceptionSideSI_OutProvidedIpcServiceInstance"}},
        event_FRCam_Bus_VisnObj_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"FRCam_Bus_VisnObj"}).GetId().value},
            instance_id,
            false},
        event_FLCam_Bus_VisnObj_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"FLCam_Bus_VisnObj"}).GetId().value},
            instance_id,
            false},
        event_RLCam_Bus_VisnObj_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"RLCam_Bus_VisnObj"}).GetId().value},
            instance_id,
            false},
        event_RRCam_Bus_VisnObj_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"RRCam_Bus_VisnObj"}).GetId().value},
            instance_id,
            false},
        event_PerceptionSide_Bus_CameraStatus_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"PerceptionSide_Bus_CameraStatus"}).GetId().value},
            instance_id,
            false},
  ...
  PerceptionSideSI_OutProvidedIpcServiceInstance(PerceptionSideSI_OutProvidedIpcServiceInstance const& ) noexcept = delete;
  PerceptionSideSI_OutProvidedIpcServiceInstance(PerceptionSideSI_OutProvidedIpcServiceInstance&& ) noexcept = delete;
  PerceptionSideSI_OutProvidedIpcServiceInstance& operator=(PerceptionSideSI_OutProvidedIpcServiceInstance const& ) noexcept = delete;
  PerceptionSideSI_OutProvidedIpcServiceInstance& operator=(PerceptionSideSI_OutProvidedIpcServiceInstance&& ) noexcept = delete;
  ...
  ~PerceptionSideSI_OutProvidedIpcServiceInstance() noexcept final {
  ...
  /*!
   * \brief   Get the event manager object for the IPC binding service event 'PerceptionSide_Bus_CameraStatus'.
   *
   ...
   * \context App
   */
  PerceptionSideSI_OutSkeletonIpcEventManagerPerceptionSide_Bus_CameraStatus* GetEventManagerPerceptionSide_Bus_CameraStatus() noexcept final;
  // ---- Events --------------------------------------------------------------------------------------------------
 ...
 private:
  ...
  /*!
   * \brief Event manager for skeleton event 'PerceptionSide_Bus_CameraStatus'
   */
  PerceptionSideSI_OutSkeletonIpcEventManagerPerceptionSide_Bus_CameraStatus event_PerceptionSide_Bus_CameraStatus_;
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_SKELETON_IPC_BINDING_H_
