 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/TurnIndcrMonostable1VccIDT/impl_type_turnindcrmonostable1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_TURNINDCRMONOSTABLE1VCCIDT_IMPL_TYPE_TURNINDCRMONOSTABLE1VCCIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_TURNINDCRMONOSTABLE1VCCIDT_IMPL_TYPE_TURNINDCRMONOSTABLE1VCCIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_TURNINDCRMONOSTABLE1VCCIDT_IMPL_TYPE_TURNINDCRMONOSTABLE1VCCIDT_H_
