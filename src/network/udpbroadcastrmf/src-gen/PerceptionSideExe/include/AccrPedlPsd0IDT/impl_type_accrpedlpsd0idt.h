 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/AccrPedlPsd0IDT/impl_type_accrpedlpsd0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
