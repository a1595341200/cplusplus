 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/WipgSpdInfo1VccIDT/impl_type_wipgspdinfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
#define ENDOFLINEEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
