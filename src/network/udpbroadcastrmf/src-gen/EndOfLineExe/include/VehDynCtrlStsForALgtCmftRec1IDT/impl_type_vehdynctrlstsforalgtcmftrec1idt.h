 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/VehDynCtrlStsForALgtCmftRec1IDT/impl_type_vehdynctrlstsforalgtcmftrec1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_IMPL_TYPE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_H_
#define ENDOFLINEEXE_INCLUDE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_IMPL_TYPE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_IMPL_TYPE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_H_
