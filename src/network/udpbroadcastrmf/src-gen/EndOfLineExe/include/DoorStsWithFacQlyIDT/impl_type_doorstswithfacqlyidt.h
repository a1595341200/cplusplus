 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/DoorStsWithFacQlyIDT/impl_type_doorstswithfacqlyidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_DOORSTSWITHFACQLYIDT_IMPL_TYPE_DOORSTSWITHFACQLYIDT_H_
#define ENDOFLINEEXE_INCLUDE_DOORSTSWITHFACQLYIDT_IMPL_TYPE_DOORSTSWITHFACQLYIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_DOORSTSWITHFACQLYIDT_IMPL_TYPE_DOORSTSWITHFACQLYIDT_H_
