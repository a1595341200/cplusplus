 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/VehSpdLgtSafe1ChkdIDT/impl_type_vehspdlgtsafe1chkdidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
#define ENDOFLINEEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
