 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/WipgSpdInfo1VccIDT/impl_type_wipgspdinfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
