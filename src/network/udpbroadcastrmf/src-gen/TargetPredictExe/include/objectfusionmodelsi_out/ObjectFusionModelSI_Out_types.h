 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/objectfusionmodelsi_out/ObjectFusionModelSI_Out_types.h
...
#ifndef TARGETPREDICTEXE_INCLUDE_OBJECTFUSIONMODELSI_OUT_OBJECTFUSIONMODELSI_OUT_TYPES_H_
#define TARGETPREDICTEXE_INCLUDE_OBJECTFUSIONMODELSI_OUT_OBJECTFUSIONMODELSI_OUT_TYPES_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_OBJECTFUSIONMODELSI_OUT_OBJECTFUSIONMODELSI_OUT_TYPES_H_
