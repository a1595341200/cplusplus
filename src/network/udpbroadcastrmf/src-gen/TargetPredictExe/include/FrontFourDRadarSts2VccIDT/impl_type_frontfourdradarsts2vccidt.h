 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/FrontFourDRadarSts2VccIDT/impl_type_frontfourdradarsts2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_FRONTFOURDRADARSTS2VCCIDT_IMPL_TYPE_FRONTFOURDRADARSTS2VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_FRONTFOURDRADARSTS2VCCIDT_IMPL_TYPE_FRONTFOURDRADARSTS2VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_FRONTFOURDRADARSTS2VCCIDT_IMPL_TYPE_FRONTFOURDRADARSTS2VCCIDT_H_
