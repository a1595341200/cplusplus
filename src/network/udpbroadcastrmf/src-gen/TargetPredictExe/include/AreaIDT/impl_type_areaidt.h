 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/AreaIDT/impl_type_areaidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_AREAIDT_IMPL_TYPE_AREAIDT_H_
#define TARGETPREDICTEXE_INCLUDE_AREAIDT_IMPL_TYPE_AREAIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_AREAIDT_IMPL_TYPE_AREAIDT_H_
