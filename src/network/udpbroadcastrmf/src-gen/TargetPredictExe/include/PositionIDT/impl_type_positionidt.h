 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/PositionIDT/impl_type_positionidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_POSITIONIDT_IMPL_TYPE_POSITIONIDT_H_
#define TARGETPREDICTEXE_INCLUDE_POSITIONIDT_IMPL_TYPE_POSITIONIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_POSITIONIDT_IMPL_TYPE_POSITIONIDT_H_
