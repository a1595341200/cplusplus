 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_datatypes.h
...
#ifndef TARGETPREDICTEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
#define TARGETPREDICTEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
