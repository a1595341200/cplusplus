 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/RefLineSpeedInfIDT/impl_type_reflinespeedinfidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_REFLINESPEEDINFIDT_IMPL_TYPE_REFLINESPEEDINFIDT_H_
#define TARGETPREDICTEXE_INCLUDE_REFLINESPEEDINFIDT_IMPL_TYPE_REFLINESPEEDINFIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_REFLINESPEEDINFIDT_IMPL_TYPE_REFLINESPEEDINFIDT_H_
