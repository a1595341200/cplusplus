 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/TrfcInfoMiscFirst1IDT/impl_type_trfcinfomiscfirst1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
#define TARGETPREDICTEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
