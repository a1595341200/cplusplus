 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/PtDrvrSetg1VccIDT/impl_type_ptdrvrsetg1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_PTDRVRSETG1VCCIDT_IMPL_TYPE_PTDRVRSETG1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_PTDRVRSETG1VCCIDT_IMPL_TYPE_PTDRVRSETG1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_PTDRVRSETG1VCCIDT_IMPL_TYPE_PTDRVRSETG1VCCIDT_H_
