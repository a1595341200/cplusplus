 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/FourDRadarStatusIDT/impl_type_fourdradarstatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_FOURDRADARSTATUSIDT_IMPL_TYPE_FOURDRADARSTATUSIDT_H_
#define TARGETPREDICTEXE_INCLUDE_FOURDRADARSTATUSIDT_IMPL_TYPE_FOURDRADARSTATUSIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_FOURDRADARSTATUSIDT_IMPL_TYPE_FOURDRADARSTATUSIDT_H_
