 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/ObjLaneAssignment1IDT/impl_type_objlaneassignment1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_OBJLANEASSIGNMENT1IDT_IMPL_TYPE_OBJLANEASSIGNMENT1IDT_H_
#define TARGETPREDICTEXE_INCLUDE_OBJLANEASSIGNMENT1IDT_IMPL_TYPE_OBJLANEASSIGNMENT1IDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_OBJLANEASSIGNMENT1IDT_IMPL_TYPE_OBJLANEASSIGNMENT1IDT_H_
