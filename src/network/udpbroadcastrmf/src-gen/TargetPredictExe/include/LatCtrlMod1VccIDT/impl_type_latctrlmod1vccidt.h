 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/LatCtrlMod1VccIDT/impl_type_latctrlmod1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_LATCTRLMOD1VCCIDT_IMPL_TYPE_LATCTRLMOD1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_LATCTRLMOD1VCCIDT_IMPL_TYPE_LATCTRLMOD1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_LATCTRLMOD1VCCIDT_IMPL_TYPE_LATCTRLMOD1VCCIDT_H_
