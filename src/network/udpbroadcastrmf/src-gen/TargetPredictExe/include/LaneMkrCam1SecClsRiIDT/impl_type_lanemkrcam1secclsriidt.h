 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/LaneMkrCam1SecClsRiIDT/impl_type_lanemkrcam1secclsriidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
#define TARGETPREDICTEXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
