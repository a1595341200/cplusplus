 ...
 * \details Top-Level data type: /CppImplementationDataTypes/Array_PairConnectivityIDT_Vector
...
class SerializerEHR_Bus_LaneConnectivitys {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/Array_PairConnectivityIDT_Vector.
   *
   ...
   * \endspec
   */
  constexpr static std::size_t GetRequiredBufferSize(::Array_PairConnectivityIDT_Vector::Array_PairConnectivityIDT_Vector const &data) noexcept {
  ...
  /*!
   * \brief Returns the maximum buffer size for the data prototype service event /JICA/Service/Interface/EHRSI_Out/EHR_Bus_LaneConnectivitys.
   *
   * \return      Calculated buffer size for serialization.
   * \pre         -
   * \context     App
  ...
  static void Serialize(serialization::Writer &writer, ::Array_PairConnectivityIDT_Vector::Array_PairConnectivityIDT_Vector const &data) noexcept;
