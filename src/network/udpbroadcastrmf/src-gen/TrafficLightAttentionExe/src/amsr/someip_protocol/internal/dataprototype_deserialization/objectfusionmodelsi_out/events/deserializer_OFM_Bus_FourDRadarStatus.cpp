 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/objectfusionmodelsi_out/events/deserializer_OFM_Bus_FourDRadarStatus.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/FourDRadarStatusIDT/deserializer_FourDRadarStatusIDT.h"
...
deserialization::Result DeserializerOFM_Bus_FourDRadarStatus::Deserialize(deserialization::Reader &reader, ::FourDRadarStatusIDT::FourDRadarStatusIDT &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/ObjectFusionModelSI_Out/OFM_Bus_FourDRadarStatus
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::FourDRadarStatusIDT::FourDRadarStatusIDT>{})};
