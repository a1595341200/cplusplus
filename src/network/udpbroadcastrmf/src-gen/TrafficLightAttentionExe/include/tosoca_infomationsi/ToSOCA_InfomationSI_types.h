 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_types.h
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_TYPES_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_TYPES_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_TYPES_H_
