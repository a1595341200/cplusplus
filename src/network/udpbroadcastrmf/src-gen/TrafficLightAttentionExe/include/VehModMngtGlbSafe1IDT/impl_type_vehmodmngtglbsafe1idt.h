 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/VehModMngtGlbSafe1IDT/impl_type_vehmodmngtglbsafe1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
