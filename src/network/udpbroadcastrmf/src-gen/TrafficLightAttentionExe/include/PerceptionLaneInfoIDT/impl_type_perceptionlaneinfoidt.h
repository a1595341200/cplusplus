 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/PerceptionLaneInfoIDT/impl_type_perceptionlaneinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
