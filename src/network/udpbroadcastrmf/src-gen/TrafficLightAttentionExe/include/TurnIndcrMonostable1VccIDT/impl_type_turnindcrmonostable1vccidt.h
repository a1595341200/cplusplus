 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/TurnIndcrMonostable1VccIDT/impl_type_turnindcrmonostable1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_TURNINDCRMONOSTABLE1VCCIDT_IMPL_TYPE_TURNINDCRMONOSTABLE1VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_TURNINDCRMONOSTABLE1VCCIDT_IMPL_TYPE_TURNINDCRMONOSTABLE1VCCIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_TURNINDCRMONOSTABLE1VCCIDT_IMPL_TYPE_TURNINDCRMONOSTABLE1VCCIDT_H_
