 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/FrntCamSts1VccIDT/impl_type_frntcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
