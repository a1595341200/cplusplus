 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/DrvModReqType2VccIDT/impl_type_drvmodreqtype2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
