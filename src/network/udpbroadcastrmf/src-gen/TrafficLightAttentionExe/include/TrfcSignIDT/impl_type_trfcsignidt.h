 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/TrfcSignIDT/impl_type_trfcsignidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
