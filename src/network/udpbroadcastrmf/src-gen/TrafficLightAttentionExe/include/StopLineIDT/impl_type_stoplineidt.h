 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/StopLineIDT/impl_type_stoplineidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
