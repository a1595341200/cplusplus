 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/VehSpdIndcd1IDT/impl_type_vehspdindcd1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
