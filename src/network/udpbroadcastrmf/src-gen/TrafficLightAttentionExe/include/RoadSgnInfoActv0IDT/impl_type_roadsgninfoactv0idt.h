 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/RoadSgnInfoActv0IDT/impl_type_roadsgninfoactv0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
