 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/VisObjIDT/impl_type_visobjidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
