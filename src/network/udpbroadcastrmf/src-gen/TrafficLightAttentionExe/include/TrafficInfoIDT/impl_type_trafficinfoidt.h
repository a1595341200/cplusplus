 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/TrafficInfoIDT/impl_type_trafficinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
