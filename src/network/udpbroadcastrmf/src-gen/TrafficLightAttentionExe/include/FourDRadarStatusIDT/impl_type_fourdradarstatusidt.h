 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/FourDRadarStatusIDT/impl_type_fourdradarstatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_FOURDRADARSTATUSIDT_IMPL_TYPE_FOURDRADARSTATUSIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_FOURDRADARSTATUSIDT_IMPL_TYPE_FOURDRADARSTATUSIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_FOURDRADARSTATUSIDT_IMPL_TYPE_FOURDRADARSTATUSIDT_H_
