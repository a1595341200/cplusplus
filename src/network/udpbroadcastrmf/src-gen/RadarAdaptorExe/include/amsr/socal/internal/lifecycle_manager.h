...
class LifecycleManager final {
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    radaradaptorsi_out::skeleton::RadarAdaptorSI_OutSkeleton::RegisterServiceDiscovery(&radaradaptorsi_out_skeleton_sd_0_);
  }
   ...
   */
  radaradaptorsi_out::skeleton::RadarAdaptorSI_OutSkeleton::ServiceDiscovery radaradaptorsi_out_skeleton_sd_0_{radaradaptorsi_out::RadarAdaptorSI_Out::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr
