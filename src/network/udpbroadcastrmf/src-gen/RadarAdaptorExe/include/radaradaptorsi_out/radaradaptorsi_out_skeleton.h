...
/*!
 * \brief Type alias for service event 'FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp = ::amsr::socal::events::SkeletonEvent<
    ...
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::FourDRadarObjStsGrp01_42IDT::FourDRadarObjStsGrp01_42IDT>,
    &radaradaptorsi_out::internal::RadarAdaptorSI_OutSkeletonImplInterface::GetEventManagerFourDRadarObjStsGAPGrp_FourDRadarObjStsGrp>;
...
class RadarAdaptorSI_OutSkeleton
    : public ::amsr::socal::Skeleton<radaradaptorsi_out::RadarAdaptorSI_Out,
      ...
      public       radaradaptorsi_out::internal::RadarAdaptorSI_OutSkeletonBackendInterface {
 public:
...
explicit RadarAdaptorSI_OutSkeleton(ConstructionToken&& token) noexcept;
  ...
  /*!
   * \brief The skeleton event 'FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp' which can be used by application developer.
   * \details 
   * Data of type ::FourDRadarObjStsGrp01_42IDT::FourDRadarObjStsGrp01_42IDT
   * \vpublic
   */
  events::FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp;
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<radaradaptorsi_out::RadarAdaptorSI_Out, radaradaptorsi_out::internal::RadarAdaptorSI_OutSkeletonImplInterface, ::amsr::socal::kRuntimeProcessingMode>;
