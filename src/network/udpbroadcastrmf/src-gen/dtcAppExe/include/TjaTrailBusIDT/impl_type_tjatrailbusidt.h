 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/TjaTrailBusIDT/impl_type_tjatrailbusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
#define DTCAPPEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
