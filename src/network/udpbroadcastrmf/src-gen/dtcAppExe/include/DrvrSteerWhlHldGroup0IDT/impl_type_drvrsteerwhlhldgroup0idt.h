 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/DrvrSteerWhlHldGroup0IDT/impl_type_drvrsteerwhlhldgroup0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_DRVRSTEERWHLHLDGROUP0IDT_IMPL_TYPE_DRVRSTEERWHLHLDGROUP0IDT_H_
#define DTCAPPEXE_INCLUDE_DRVRSTEERWHLHLDGROUP0IDT_IMPL_TYPE_DRVRSTEERWHLHLDGROUP0IDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_DRVRSTEERWHLHLDGROUP0IDT_IMPL_TYPE_DRVRSTEERWHLHLDGROUP0IDT_H_
