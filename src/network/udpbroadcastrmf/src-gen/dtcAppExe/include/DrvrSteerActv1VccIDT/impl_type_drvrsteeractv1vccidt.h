 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/DrvrSteerActv1VccIDT/impl_type_drvrsteeractv1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_DRVRSTEERACTV1VCCIDT_IMPL_TYPE_DRVRSTEERACTV1VCCIDT_H_
#define DTCAPPEXE_INCLUDE_DRVRSTEERACTV1VCCIDT_IMPL_TYPE_DRVRSTEERACTV1VCCIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_DRVRSTEERACTV1VCCIDT_IMPL_TYPE_DRVRSTEERACTV1VCCIDT_H_
