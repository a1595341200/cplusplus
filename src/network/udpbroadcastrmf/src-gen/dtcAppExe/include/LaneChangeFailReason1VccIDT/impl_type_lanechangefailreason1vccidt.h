 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/LaneChangeFailReason1VccIDT/impl_type_lanechangefailreason1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
#define DTCAPPEXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
