 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/LaneChgAutInfoForAsyHiWay1VccIDT/impl_type_lanechgautinfoforasyhiway1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_IMPL_TYPE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_H_
#define DTCAPPEXE_INCLUDE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_IMPL_TYPE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_IMPL_TYPE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_H_
