 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/CurrentRoadLvl1VccIDT/impl_type_currentroadlvl1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_CURRENTROADLVL1VCCIDT_IMPL_TYPE_CURRENTROADLVL1VCCIDT_H_
#define DTCAPPEXE_INCLUDE_CURRENTROADLVL1VCCIDT_IMPL_TYPE_CURRENTROADLVL1VCCIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_CURRENTROADLVL1VCCIDT_IMPL_TYPE_CURRENTROADLVL1VCCIDT_H_
