 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/ALgtStdFromWhlSpdSafe1ChkdIDT/impl_type_algtstdfromwhlspdsafe1chkdidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_IMPL_TYPE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_H_
#define DTCAPPEXE_INCLUDE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_IMPL_TYPE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_IMPL_TYPE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_H_
