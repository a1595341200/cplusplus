 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/VehDynCtrlStsForALgtCmftRec1IDT/impl_type_vehdynctrlstsforalgtcmftrec1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_IMPL_TYPE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_H_
#define DTCAPPEXE_INCLUDE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_IMPL_TYPE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_IMPL_TYPE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_H_
