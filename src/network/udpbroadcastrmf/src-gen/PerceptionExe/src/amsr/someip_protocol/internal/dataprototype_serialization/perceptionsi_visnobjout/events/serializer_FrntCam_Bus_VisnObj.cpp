 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/src/amsr/someip_protocol/internal/dataprototype_serialization/perceptionsi_visnobjout/events/serializer_FrntCam_Bus_VisnObj.cpp
...
void SerializerFrntCam_Bus_VisnObj::Serialize(serialization::Writer
&writer, ::Array_FrntCamVisObjIDT_25::Array_FrntCamVisObjIDT_25 const &data) noexcept {
