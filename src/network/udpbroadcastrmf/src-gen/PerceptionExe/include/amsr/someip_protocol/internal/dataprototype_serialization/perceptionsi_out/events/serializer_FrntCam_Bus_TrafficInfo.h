 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_protocol/internal/dataprototype_serialization/perceptionsi_out/events/serializer_FrntCam_Bus_TrafficInfo.h
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_OUT_EVENTS_serializer_FrntCam_Bus_TrafficInfo_h_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_OUT_EVENTS_serializer_FrntCam_Bus_TrafficInfo_h_
...
/*!
 * \brief Serializer for service event /JICA/Service/Interface/PerceptionSI_Out/FrntCam_Bus_TrafficInfo
 *        of service interface /JICA/Service/Interface/PerceptionSI_Out.
 * \details Top-Level data type: /CppImplementationDataTypes/TrafficInfoIDT
 ...
 */
class SerializerFrntCam_Bus_TrafficInfo {
 public:
  /*!
   * \brief Returns the required buffer size for the data prototype service event /JICA/Service/Interface/PerceptionSI_Out/FrntCam_Bus_TrafficInfo.
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/TrafficInfoIDT.
   *
   ...
   * \endspec
   */
  constexpr static std::size_t GetRequiredBufferSize(::TrafficInfoIDT::TrafficInfoIDT const &data) noexcept {
  ...
  /*!
   * \brief Returns the maximum buffer size for the data prototype service event /JICA/Service/Interface/PerceptionSI_Out/FrntCam_Bus_TrafficInfo.
   *
   * \return      Calculated buffer size for serialization.
   * \pre         -
   * \context     App
  ...
  /*!
   * \brief Serialize the data prototype service event /JICA/Service/Interface/PerceptionSI_Out/FrntCam_Bus_TrafficInfo.
   *
  ...
  static void Serialize(serialization::Writer &writer, ::TrafficInfoIDT::TrafficInfoIDT const &data) noexcept;
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_OUT_EVENTS_serializer_FrntCam_Bus_TrafficInfo_h_
