...
#include "amsr/someip_protocol/internal/datatype_serialization/TrfcLi1VccIDT/serializer_TrfcLi1VccIDT.h"
...
class SerializerFrntCam_Bus_TrfcLi {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/Array_TrfcLi1VccIDT_8.
   *
   ...
   * \endspec
   */
  constexpr static std::size_t GetRequiredBufferSize(::Array_TrfcLi1VccIDT_8::Array_TrfcLi1VccIDT_8 const &data) noexcept {
  ...
  /*!
   * \brief Returns the maximum buffer size for the data prototype service event /JICA/Service/Interface/PerceptionSI_Out/FrntCam_Bus_TrfcLi.
   *
   * \return      Calculated buffer size for serialization.
   * \pre         -
   * \context     App
  ...
  static void Serialize(serialization::Writer &writer, ::Array_TrfcLi1VccIDT_8::Array_TrfcLi1VccIDT_8 const &data) noexcept;
