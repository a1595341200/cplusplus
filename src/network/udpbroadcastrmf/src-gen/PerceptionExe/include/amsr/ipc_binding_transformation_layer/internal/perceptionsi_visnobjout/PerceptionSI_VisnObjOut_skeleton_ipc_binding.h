...
class PerceptionSI_VisnObjOutProvidedIpcServiceInstance final
 ...
 /*!
   ...
   * \param[in,out] skeleton                Reference to the skeleton. The reference must be valid for PerceptionSI_VisnObjOutProvidedIpcServiceInstance entire life time.
   * \param[in,out] server_binding_manager  Server binding manager. The reference must be valid for PerceptionSI_VisnObjOutProvidedIpcServiceInstance entire life time.
   ...
   * \synchronous   TRUE
   */
  PerceptionSI_VisnObjOutProvidedIpcServiceInstance(::perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonBackendInterface& skeleton,
      ...
      : ::amsr::ipc_binding_core::internal::LocalServerSink{},
        ...
        logger_{::amsr::ipc_binding_core::internal::logging::kIpcLoggerContextId,
                ...
                ::amsr::core::StringView{"PerceptionSI_VisnObjOutProvidedIpcServiceInstance"}},
        event_FrntCam_Bus_VisnObj_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"FrntCam_Bus_VisnObj"}).GetId().value},
            instance_id,
            false},
        event_FrntCam_Bus_UnfilteredObj_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"FrntCam_Bus_UnfilteredObj"}).GetId().value},
            instance_id,
            false},
  ...
  PerceptionSI_VisnObjOutProvidedIpcServiceInstance(PerceptionSI_VisnObjOutProvidedIpcServiceInstance const& ) noexcept = delete;
  PerceptionSI_VisnObjOutProvidedIpcServiceInstance(PerceptionSI_VisnObjOutProvidedIpcServiceInstance&& ) noexcept = delete;
  PerceptionSI_VisnObjOutProvidedIpcServiceInstance& operator=(PerceptionSI_VisnObjOutProvidedIpcServiceInstance const& ) noexcept = delete;
  PerceptionSI_VisnObjOutProvidedIpcServiceInstance& operator=(PerceptionSI_VisnObjOutProvidedIpcServiceInstance&& ) noexcept = delete;
  ...
  ~PerceptionSI_VisnObjOutProvidedIpcServiceInstance() noexcept final {
  ...
  /*!
   * \brief   Get the event manager object for the IPC binding service event 'FrntCam_Bus_UnfilteredObj'.
   *
   ...
   * \context App
   */
  PerceptionSI_VisnObjOutSkeletonIpcEventManagerFrntCam_Bus_UnfilteredObj* GetEventManagerFrntCam_Bus_UnfilteredObj() noexcept final;
  // ---- Events --------------------------------------------------------------------------------------------------
 ...
 private:
  ...
  /*!
   * \brief Event manager for skeleton event 'FrntCam_Bus_UnfilteredObj'
   */
  PerceptionSI_VisnObjOutSkeletonIpcEventManagerFrntCam_Bus_UnfilteredObj event_FrntCam_Bus_UnfilteredObj_;
