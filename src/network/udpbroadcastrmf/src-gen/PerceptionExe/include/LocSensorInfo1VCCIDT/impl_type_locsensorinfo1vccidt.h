 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LocSensorInfo1VCCIDT/impl_type_locsensorinfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LOCSENSORINFO1VCCIDT_IMPL_TYPE_LOCSENSORINFO1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_LOCSENSORINFO1VCCIDT_IMPL_TYPE_LOCSENSORINFO1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LOCSENSORINFO1VCCIDT_IMPL_TYPE_LOCSENSORINFO1VCCIDT_H_
