 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LaneEventGroupCam1VccIDT/impl_type_laneeventgroupcam1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
