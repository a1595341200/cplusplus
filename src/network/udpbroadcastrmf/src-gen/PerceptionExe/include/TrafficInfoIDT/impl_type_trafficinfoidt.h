 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/TrafficInfoIDT/impl_type_trafficinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
#define PERCEPTIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
