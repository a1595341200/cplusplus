 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LineSignGroupIDT/impl_type_linesigngroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
#define PERCEPTIONEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
