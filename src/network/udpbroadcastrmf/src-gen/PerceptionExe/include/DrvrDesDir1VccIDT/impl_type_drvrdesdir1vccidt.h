 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/DrvrDesDir1VccIDT/impl_type_drvrdesdir1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
