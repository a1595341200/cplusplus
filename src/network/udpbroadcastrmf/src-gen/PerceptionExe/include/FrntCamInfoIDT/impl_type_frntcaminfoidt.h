 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/FrntCamInfoIDT/impl_type_frntcaminfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
#define PERCEPTIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
