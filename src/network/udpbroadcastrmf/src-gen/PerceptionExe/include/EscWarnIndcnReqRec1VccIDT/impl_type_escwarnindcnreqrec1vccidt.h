 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/EscWarnIndcnReqRec1VccIDT/impl_type_escwarnindcnreqrec1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
