 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/ExtInfoIDT/impl_type_extinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
#define PERCEPTIONEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
