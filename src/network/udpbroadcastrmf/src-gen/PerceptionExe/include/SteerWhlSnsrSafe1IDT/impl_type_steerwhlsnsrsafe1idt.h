 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/SteerWhlSnsrSafe1IDT/impl_type_steerwhlsnsrsafe1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
#define PERCEPTIONEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
