 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LatCtrlMod1VccIDT/impl_type_latctrlmod1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LATCTRLMOD1VCCIDT_IMPL_TYPE_LATCTRLMOD1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_LATCTRLMOD1VCCIDT_IMPL_TYPE_LATCTRLMOD1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LATCTRLMOD1VCCIDT_IMPL_TYPE_LATCTRLMOD1VCCIDT_H_
