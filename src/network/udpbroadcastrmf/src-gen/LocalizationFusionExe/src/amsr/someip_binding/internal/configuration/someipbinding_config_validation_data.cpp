 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/src/amsr/someip_binding/internal/configuration/someipbinding_config_validation_data.cpp
...
{"/JICA/Service/Interface/LocalizationFusionSI_Out"_sv,
     ConfigValidationDataAccess{
      &::amsr::someip_binding::internal::configuration::gen_localizationfusionsi_out::LocalizationFusionSI_OutConfigValidationData::kValidEventConfigurationEntities[0],
      1,
      nullptr,
      0,
      nullptr,
