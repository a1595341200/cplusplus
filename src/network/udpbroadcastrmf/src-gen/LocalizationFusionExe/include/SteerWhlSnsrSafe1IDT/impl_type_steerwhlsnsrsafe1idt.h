 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/SteerWhlSnsrSafe1IDT/impl_type_steerwhlsnsrsafe1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
