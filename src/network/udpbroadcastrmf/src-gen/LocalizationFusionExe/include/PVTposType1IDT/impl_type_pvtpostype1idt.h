 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/PVTposType1IDT/impl_type_pvtpostype1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_PVTPOSTYPE1IDT_IMPL_TYPE_PVTPOSTYPE1IDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_PVTPOSTYPE1IDT_IMPL_TYPE_PVTPOSTYPE1IDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_PVTPOSTYPE1IDT_IMPL_TYPE_PVTPOSTYPE1IDT_H_
