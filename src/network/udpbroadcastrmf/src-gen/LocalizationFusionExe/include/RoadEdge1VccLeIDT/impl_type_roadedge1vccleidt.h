 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/RoadEdge1VccLeIDT/impl_type_roadedge1vccleidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
