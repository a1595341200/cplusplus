 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/FrntCamSts1VccIDT/impl_type_frntcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
