 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/VehBattU1VccIDT/impl_type_vehbattu1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
