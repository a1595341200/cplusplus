 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/VehSpdIndcd1IDT/impl_type_vehspdindcd1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
