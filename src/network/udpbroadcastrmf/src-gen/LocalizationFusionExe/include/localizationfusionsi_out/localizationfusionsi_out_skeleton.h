...
using LFM_Bus_MapErrorSts = ::amsr::socal::events::SkeletonEvent<
    ...
    ::MapErrorStsIDT::MapErrorStsIDT,
    localizationfusionsi_out::internal::LocalizationFusionSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::MapErrorStsIDT::MapErrorStsIDT>,
...
class LocalizationFusionSI_OutSkeleton
    : public ::amsr::socal::Skeleton<localizationfusionsi_out::LocalizationFusionSI_Out,
      ...
      public       localizationfusionsi_out::internal::LocalizationFusionSI_OutSkeletonBackendInterface {
 public:
...
explicit LocalizationFusionSI_OutSkeleton(ConstructionToken&& token) noexcept;
   ...
   * \details 
   * Data of type ::MapErrorStsIDT::MapErrorStsIDT
   * \vpublic
   */
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<localizationfusionsi_out::LocalizationFusionSI_Out, localizationfusionsi_out::internal::LocalizationFusionSI_OutSkeletonImplInterface, ::amsr::socal::kRuntimeProcessingMode>;
