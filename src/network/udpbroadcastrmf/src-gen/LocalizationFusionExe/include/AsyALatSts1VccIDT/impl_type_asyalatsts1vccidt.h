 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/AsyALatSts1VccIDT/impl_type_asyalatsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
