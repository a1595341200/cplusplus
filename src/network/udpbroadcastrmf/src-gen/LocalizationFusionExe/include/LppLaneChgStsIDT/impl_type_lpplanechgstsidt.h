 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/LppLaneChgStsIDT/impl_type_lpplanechgstsidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
