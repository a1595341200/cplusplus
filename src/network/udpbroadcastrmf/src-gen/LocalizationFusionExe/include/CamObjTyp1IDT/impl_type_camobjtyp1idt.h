 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/CamObjTyp1IDT/impl_type_camobjtyp1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
