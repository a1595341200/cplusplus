 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/PerceptionLaneInfoIDT/impl_type_perceptionlaneinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
