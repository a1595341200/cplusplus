 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/AccTarSeln1RecIDT/impl_type_acctarseln1recidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
