 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/amsr/someip_binding_xf/internal/localizationfusionsi_out/LocalizationFusionSI_Out_skeleton_xf.h
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_LOCALIZATIONFUSIONSI_OUT_LOCALIZATIONFUSIONSI_OUT_SKELETON_XF_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_LOCALIZATIONFUSIONSI_OUT_LOCALIZATIONFUSIONSI_OUT_SKELETON_XF_H_
...
#include "amsr/someip_binding_xf/internal/localizationfusionsi_out/LocalizationFusionSI_Out_skeleton_someip_methods.h"
...
#include "localizationfusionsi_out/LocalizationFusionSI_Out_skeleton_backend_interface.h"
 ...
 * \remark generated
 */
class LocalizationFusionSI_OutSkeletonXf final :
...
/*!
  ...
  /*!
   * \brief Constructor of LocalizationFusionSI_OutSkeletonXf.
   ...
   * \synchronous TRUE
   */
  LocalizationFusionSI_OutSkeletonXf(::amsr::someip_binding_core::internal::ProvidedServiceInstanceId const provided_service_instance_id,
                                              ::amsr::someip_binding_core::internal::ServerInterface& server,
                                              ::localizationfusionsi_out::internal::LocalizationFusionSI_OutSkeletonBackendInterface& skeleton,
  ...
  ~LocalizationFusionSI_OutSkeletonXf() noexcept override  = default;  // COV_SOMEIPBINDING_SKELETON_XF

  LocalizationFusionSI_OutSkeletonXf(LocalizationFusionSI_OutSkeletonXf const&) noexcept = delete;
  LocalizationFusionSI_OutSkeletonXf(LocalizationFusionSI_OutSkeletonXf&& other) noexcept = delete;
  LocalizationFusionSI_OutSkeletonXf& operator=(LocalizationFusionSI_OutSkeletonXf const&) & = delete;
  LocalizationFusionSI_OutSkeletonXf& operator=(LocalizationFusionSI_OutSkeletonXf&&) & noexcept = delete;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  events::skeleton::LFM_Bus_MapErrorSts::LocalizationFusionSI_OutSkeletonSomeIpEventManagerLFM_Bus_MapErrorSts* GetEventManagerLFM_Bus_MapErrorSts() noexcept override;
 ...
 private:
   ...
   */
  ::localizationfusionsi_out::internal::LocalizationFusionSI_OutSkeletonBackendInterface& skeleton_;
...
// ---- Event manager --------------------------------------------------------------------------------------------
  ...
  ::amsr::someip_binding::internal::configuration::EventConfig const&
      ...
      events_LocalizationFusionSI_OutSkeletonSomeIpEventConfigurationLFM_Bus_MapErrorSts_event_config_{
          ...
          config_wrapper_.GetEventConfig(
              ...
              ::amsr::someip_binding::internal::configuration::Shortname{events::skeleton::LFM_Bus_MapErrorSts::EventDesignInfo::kEventName.c_str()})};

  // Event Xf for skeleton protected event 'LFM_Bus_MapErrorSts'
  // VCA_SOMEIPBINDING_TRIVIAL_VALID_REFERENCE
  std::unique_ptr<ser_deser::SerializerInterface<events::skeleton::LFM_Bus_MapErrorSts::EventDesignInfo::SampleType>> event_xf_serializer_ptr_LFM_Bus_MapErrorSts_{
    events::skeleton::LFM_Bus_MapErrorSts::SerializerFactory::Create()
  };
  ...
  events::skeleton::LFM_Bus_MapErrorSts::LocalizationFusionSI_OutSkeletonSomeIpEventManagerLFM_Bus_MapErrorSts event_manager_LFM_Bus_MapErrorSts_{
      ::amsr::someip_binding_core::internal::SomeIpEventIdentity{
          ...
          events_LocalizationFusionSI_OutSkeletonSomeIpEventConfigurationLFM_Bus_MapErrorSts_event_config_
              ...
              .GetEventId()},
      server_,
      *(event_xf_serializer_ptr_LFM_Bus_MapErrorSts_.get()),
      // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
      // VECTOR NC VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
     ...
     // VCA_SPC_15_SOMEIPBINDING_OTHER_COMPONENT_TYPE_FUNCTION
     // VCA_SOMEIPBINDING_POSSIBLY_CALLING_NULLPTR_METHOD_CALL_ON_REF
     events_LocalizationFusionSI_OutSkeletonSomeIpEventConfigurationLFM_Bus_MapErrorSts_event_config_.GetDisableSessionHandling().value_or(false),
     events_LocalizationFusionSI_OutSkeletonSomeIpEventConfigurationLFM_Bus_MapErrorSts_event_config_
         // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_LOCALIZATIONFUSIONSI_OUT_LOCALIZATIONFUSIONSI_OUT_SKELETON_XF_H_
