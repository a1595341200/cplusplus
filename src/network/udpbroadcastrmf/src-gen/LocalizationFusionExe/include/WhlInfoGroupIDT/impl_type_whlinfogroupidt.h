 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/WhlInfoGroupIDT/impl_type_whlinfogroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
