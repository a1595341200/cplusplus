 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/EgoMotionIDT/impl_type_egomotionidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
