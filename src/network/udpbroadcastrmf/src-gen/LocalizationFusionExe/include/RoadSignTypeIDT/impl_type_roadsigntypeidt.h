 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/RoadSignTypeIDT/impl_type_roadsigntypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
