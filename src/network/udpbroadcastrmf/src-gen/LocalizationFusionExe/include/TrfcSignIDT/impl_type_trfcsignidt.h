 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/TrfcSignIDT/impl_type_trfcsignidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
