 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/PerceptionRearLaneInfoIDT/impl_type_perceptionrearlaneinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
