 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/mcu_data_info/events/deserializer_Mcu_Reset_Info4.cpp
...
deserialization::Result DeserializerMcu_Reset_Info4::Deserialize(deserialization::Reader &reader, ::SOMEIP::ValidationKey::Mcu_Reset_Data &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/MCU_Data_Info/Mcu_Reset_Info4
