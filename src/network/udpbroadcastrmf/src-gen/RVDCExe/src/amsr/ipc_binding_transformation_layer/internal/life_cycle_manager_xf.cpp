 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/src/amsr/ipc_binding_transformation_layer/internal/life_cycle_manager_xf.cpp
...
LifeCycleManagerXf::DeployedServicesVector const LifeCycleManagerXf::deployed_service_interfaces_{
    {ShortnamePath{"/JICA/Service/Interface/EDRSI_Out"}} // VCA_IPCB_BASICSTRING_CONSTRUCTOR
};
...
void LifeCycleManagerXf::InitializeServiceDiscoveryProxyXfs(BindingCoreType& binding_core,
  ...
  // -- Service Config for Service Interface 'EDRSI_Out' --
  {
    ...
    ServiceConfig const& service_config{runtime_config_.GetServiceOf({"/JICA/Service/Interface/EDRSI_Out"})};

    logger_.LogDebug(
        [](::ara::log::LogStream& s) {
          // VCA_IPCB_LOGSTREAM_CONCATENATION_IS_SILENT
          s << "Initializing service proxy '/JICA/Service/Interface/EDRSI_Out'.";
        },
        Logger::LogLocation{__func__, __LINE__});
    ::amsr::generic::Singleton<::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
        ::edrsi_out::internal::EDRSI_OutProxyBackendInterface>*>& service_discovery{
            ::edrsi_out::proxy::EDRSI_OutProxy::GetServiceDiscovery()};

    // VCA_IPCB_VALID_REMOTE_SERVER_MANAGER_POINTER_OR_REF
    ServiceDiscoveryProxyXfInitializer::InitializeSdProxyXfs<
        ::edrsi_out::internal::EDRSI_OutProxyBackendInterface,
        ::amsr::ipc_binding_transformation_layer::internal::edrsi_out::EDRSI_OutProxyXf,
        BindingCoreType>(
...
void LifeCycleManagerXf::DeInitializeServiceDiscoveryProxyXfs() noexcept {
  {
    // Service Config for Service Interface '/JICA/Service/Interface/EDRSI_Out'
    // VCA_IPCB_VALID_RUNTIME_CONFIGURATION_OBJECT, VCA_IPCB_LIFECYCLE_MANAGER_XF_UNDEFINED_FUNCTION, VCA_IPCB_STD_FUNCTION_CALLED
    ServiceConfig const& service_config{runtime_config_.GetServiceOf({"/JICA/Service/Interface/EDRSI_Out"})};
    ...
    logger_.LogDebug(
        [](::ara::log::LogStream& s) {
          // VCA_IPCB_LOGSTREAM_CONCATENATION_IS_SILENT
          s << "Deinitializing service '/JICA/Service/Interface/EDRSI_Out'.";
        },
        Logger::LogLocation{__func__, __LINE__});
