 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/VehSpdLgtSafe1ChkdIDT/impl_type_vehspdlgtsafe1chkdidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
#define RVDCEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
...
#endif  // RVDCEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
