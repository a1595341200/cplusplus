 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/VehMtnStSafeGroup1IDT/impl_type_vehmtnstsafegroup1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_VEHMTNSTSAFEGROUP1IDT_IMPL_TYPE_VEHMTNSTSAFEGROUP1IDT_H_
#define RVDCEXE_INCLUDE_VEHMTNSTSAFEGROUP1IDT_IMPL_TYPE_VEHMTNSTSAFEGROUP1IDT_H_
...
#endif  // RVDCEXE_INCLUDE_VEHMTNSTSAFEGROUP1IDT_IMPL_TYPE_VEHMTNSTSAFEGROUP1IDT_H_
