 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/WhlInfoGroupIDT/impl_type_whlinfogroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
#define RVDCEXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
...
#endif  // RVDCEXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
