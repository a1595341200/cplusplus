 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/EscWarnIndcnReqRec1VccIDT/impl_type_escwarnindcnreqrec1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
#define RVDCEXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
...
#endif  // RVDCEXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
