 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/AsyAutDrvgAvl1VccIDT/impl_type_asyautdrvgavl1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_ASYAUTDRVGAVL1VCCIDT_IMPL_TYPE_ASYAUTDRVGAVL1VCCIDT_H_
#define RVDCEXE_INCLUDE_ASYAUTDRVGAVL1VCCIDT_IMPL_TYPE_ASYAUTDRVGAVL1VCCIDT_H_
...
#endif  // RVDCEXE_INCLUDE_ASYAUTDRVGAVL1VCCIDT_IMPL_TYPE_ASYAUTDRVGAVL1VCCIDT_H_
