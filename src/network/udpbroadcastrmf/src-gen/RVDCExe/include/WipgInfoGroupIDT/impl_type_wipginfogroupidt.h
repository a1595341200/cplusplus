 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/WipgInfoGroupIDT/impl_type_wipginfogroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
#define RVDCEXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
...
#endif  // RVDCEXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
