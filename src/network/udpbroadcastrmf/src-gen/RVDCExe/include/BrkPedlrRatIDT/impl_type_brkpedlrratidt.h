 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/BrkPedlrRatIDT/impl_type_brkpedlrratidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_BRKPEDLRRATIDT_IMPL_TYPE_BRKPEDLRRATIDT_H_
#define RVDCEXE_INCLUDE_BRKPEDLRRATIDT_IMPL_TYPE_BRKPEDLRRATIDT_H_
...
#endif  // RVDCEXE_INCLUDE_BRKPEDLRRATIDT_IMPL_TYPE_BRKPEDLRRATIDT_H_
