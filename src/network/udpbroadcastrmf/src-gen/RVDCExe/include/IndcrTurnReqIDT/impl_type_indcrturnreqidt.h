 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/IndcrTurnReqIDT/impl_type_indcrturnreqidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_INDCRTURNREQIDT_IMPL_TYPE_INDCRTURNREQIDT_H_
#define RVDCEXE_INCLUDE_INDCRTURNREQIDT_IMPL_TYPE_INDCRTURNREQIDT_H_
...
#endif  // RVDCEXE_INCLUDE_INDCRTURNREQIDT_IMPL_TYPE_INDCRTURNREQIDT_H_
