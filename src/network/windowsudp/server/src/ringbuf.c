...
static void ringbuf_copy_in(struct ringbuf_t *self, const void *src, unsigned int len,
                            unsigned int off) {
...
static void ringbuf_copy_out(struct ringbuf_t *self, void *dst, unsigned int len,
                             unsigned int off) {
  unsigned int size = self->mask + 1;
  unsigned int esize = self->esize;
  unsigned int l;
