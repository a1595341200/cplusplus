 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LaneChangeFailReason1VccIDT/impl_type_lanechangefailreason1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
