 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/DrvrSteerActv1VccIDT/impl_type_drvrsteeractv1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_DRVRSTEERACTV1VCCIDT_IMPL_TYPE_DRVRSTEERACTV1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_DRVRSTEERACTV1VCCIDT_IMPL_TYPE_DRVRSTEERACTV1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_DRVRSTEERACTV1VCCIDT_IMPL_TYPE_DRVRSTEERACTV1VCCIDT_H_
