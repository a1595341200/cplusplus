 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/perceptionsi_visnobjout/PerceptionSI_VisnObjOut_datatypes.h
...
#ifndef PERCEPTIONEXE_INCLUDE_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_DATATYPES_H_
#define PERCEPTIONEXE_INCLUDE_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_DATATYPES_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_DATATYPES_H_
