 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/perceptionsi_visnobjout/perceptionsi_visnobjout_skeleton.h
...
#ifndef PERCEPTIONEXE_INCLUDE_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_SKELETON_H_
#define PERCEPTIONEXE_INCLUDE_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_SKELETON_H_
...
#include "perceptionsi_visnobjout/PerceptionSI_VisnObjOut_skeleton_backend_interface.h"
 ...
 */
class PerceptionSI_VisnObjOutSkeleton;
...
/*!
 * \brief Type alias for service event 'FrntCam_Bus_VisnObj', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using FrntCam_Bus_VisnObj = ::amsr::socal::events::SkeletonEvent<
    perceptionsi_visnobjout::skeleton::PerceptionSI_VisnObjOutSkeleton,
    ::Array_FrntCamVisObjIDT_25::Array_FrntCamVisObjIDT_25,
    perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_FrntCamVisObjIDT_25::Array_FrntCamVisObjIDT_25>,
    &perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonImplInterface::GetEventManagerFrntCam_Bus_VisnObj>;

/*!
 * \brief Type alias for service event 'FrntCam_Bus_UnfilteredObj', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using FrntCam_Bus_UnfilteredObj = ::amsr::socal::events::SkeletonEvent<
    perceptionsi_visnobjout::skeleton::PerceptionSI_VisnObjOutSkeleton,
    ::Array_UnfilteredObjIDT_30::Array_UnfilteredObjIDT_30,
    perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_UnfilteredObjIDT_30::Array_UnfilteredObjIDT_30>,
    &perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonImplInterface::GetEventManagerFrntCam_Bus_UnfilteredObj>;
...
/*!
 * \brief Skeleton interface class for the service 'PerceptionSI_VisnObjOut'.
 *
 * \vpublic
 * \trace SPEC-4980341
...
class PerceptionSI_VisnObjOutSkeleton
    : public ::amsr::socal::Skeleton<perceptionsi_visnobjout::PerceptionSI_VisnObjOut,
                                          perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonImplInterface,
                                          ::amsr::socal::kRuntimeProcessingMode>,
      public       perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonBackendInterface {
 public:
// ---- Constructors / Destructors -----------------------------------------------------------------------------------
/*!
 * \brief Exception-less pre-construction of PerceptionSI_VisnObjOut.
 *
...
/*!
 * \brief Exception-less pre-construction of PerceptionSI_VisnObjOutSkeleton.
 *
...
/*!
 * \brief Exception-less constructor of PerceptionSI_VisnObjOutSkeleton.
 ...
 * \trace SPEC-8053555
 */
explicit PerceptionSI_VisnObjOutSkeleton(ConstructionToken&& token) noexcept;

  /*!
   * \brief Delete default constructor.
   */
  PerceptionSI_VisnObjOutSkeleton() = delete;
  /*!
   * \brief Delete copy constructor.
   */
  PerceptionSI_VisnObjOutSkeleton(PerceptionSI_VisnObjOutSkeleton const &) = delete;
  /*!
   * \brief Delete move constructor.
   */
  PerceptionSI_VisnObjOutSkeleton(PerceptionSI_VisnObjOutSkeleton &&) = delete;
  /*!
   * \brief Delete copy assignment.
   */
  PerceptionSI_VisnObjOutSkeleton &operator=(PerceptionSI_VisnObjOutSkeleton const &) & = delete;
  /*!
   * \brief Delete move assignment.
   */
  PerceptionSI_VisnObjOutSkeleton &operator=(PerceptionSI_VisnObjOutSkeleton &&) & = delete;

  /*!
   * \brief Constructor of PerceptionSI_VisnObjOutSkeleton.
   *
   ...
   * \trace SPEC-4980356
   */
   explicit PerceptionSI_VisnObjOutSkeleton(
   ...
   * \endspec
   */
  ~PerceptionSI_VisnObjOutSkeleton() noexcept override;

  /*!
   * \brief Type alias for ServiceDiscovery.
   */
  using ServiceDiscovery = ::amsr::socal::internal::service_discovery::ServiceDiscovery<PerceptionSI_VisnObjOutSkeleton>;
  ...
  /*!
   * \brief The skeleton event 'FrntCam_Bus_VisnObj' which can be used by application developer.
   * \details 
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'FrntCam_Bus_UnfilteredObj' which can be used by application developer.
   * \details 
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<perceptionsi_visnobjout::PerceptionSI_VisnObjOut, perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonImplInterface, ::amsr::socal::kRuntimeProcessingMode>;
...
#endif  // PERCEPTIONEXE_INCLUDE_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_SKELETON_H_
