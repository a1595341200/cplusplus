 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/TrfcSignIDT/impl_type_trfcsignidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
#define PERCEPTIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_TRFCSIGNIDT_IMPL_TYPE_TRFCSIGNIDT_H_
