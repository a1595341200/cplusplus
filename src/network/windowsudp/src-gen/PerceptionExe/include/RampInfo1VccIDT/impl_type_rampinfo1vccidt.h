 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/RampInfo1VccIDT/impl_type_rampinfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_RAMPINFO1VCCIDT_IMPL_TYPE_RAMPINFO1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_RAMPINFO1VCCIDT_IMPL_TYPE_RAMPINFO1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_RAMPINFO1VCCIDT_IMPL_TYPE_RAMPINFO1VCCIDT_H_
