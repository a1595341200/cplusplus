 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/AccrPedlPsd0IDT/impl_type_accrpedlpsd0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
#define PERCEPTIONEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
