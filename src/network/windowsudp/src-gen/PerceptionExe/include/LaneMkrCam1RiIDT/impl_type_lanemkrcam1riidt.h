 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LaneMkrCam1RiIDT/impl_type_lanemkrcam1riidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
#define PERCEPTIONEXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
