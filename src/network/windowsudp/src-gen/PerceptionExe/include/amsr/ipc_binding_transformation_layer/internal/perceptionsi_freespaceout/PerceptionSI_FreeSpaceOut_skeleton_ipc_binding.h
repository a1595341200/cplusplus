...
class PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance final
 ...
 /*!
   ...
   * \param[in,out] skeleton                Reference to the skeleton. The reference must be valid for PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance entire life time.
   * \param[in,out] server_binding_manager  Server binding manager. The reference must be valid for PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance entire life time.
   ...
   * \synchronous   TRUE
   */
  PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance(::perceptionsi_freespaceout::internal::PerceptionSI_FreeSpaceOutSkeletonBackendInterface& skeleton,
      ...
      : ::amsr::ipc_binding_core::internal::LocalServerSink{},
        ...
        logger_{::amsr::ipc_binding_core::internal::logging::kIpcLoggerContextId,
                ...
                ::amsr::core::StringView{"PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance"}},
        event_FusedCam_Bus_FreeSpace_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"FusedCam_Bus_FreeSpace"}).GetId().value},
            instance_id,
            false},
        event_id_set_{  // VCA_IPCB_STD_CONSTRUCTOR_CALLED
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            service_config.GetEventOf({"FusedCam_Bus_FreeSpace"}).GetId()}  {
  ...
  PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance(PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance const& ) noexcept = delete;
  PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance(PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance&& ) noexcept = delete;
  PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance& operator=(PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance const& ) noexcept = delete;
  PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance& operator=(PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance&& ) noexcept = delete;
  ...
  ~PerceptionSI_FreeSpaceOutProvidedIpcServiceInstance() noexcept final {
