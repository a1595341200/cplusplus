...
class LifecycleManager final {
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    tosoca_locsensorinfosi::proxy::ToSOCA_LocSensorInfoSIProxy::RegisterServiceDiscovery(&tosoca_locsensorinfosi_proxy_sd_1_);

    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    perceptionsi_freespaceout::skeleton::PerceptionSI_FreeSpaceOutSkeleton::RegisterServiceDiscovery(&perceptionsi_freespaceout_skeleton_sd_0_);
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    perceptionsi_out::skeleton::PerceptionSI_OutSkeleton::RegisterServiceDiscovery(&perceptionsi_out_skeleton_sd_1_);
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    perceptionsi_visnobjout::skeleton::PerceptionSI_VisnObjOutSkeleton::RegisterServiceDiscovery(&perceptionsi_visnobjout_skeleton_sd_2_);
  }
   ...
   */
  ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      tosoca_locsensorinfosi::internal::ToSOCA_LocSensorInfoSIProxyBackendInterface> tosoca_locsensorinfosi_proxy_sd_1_{tosoca_locsensorinfosi::ToSOCA_LocSensorInfoSI::kServiceShortNamePath};
   ...
   *        for the service interface perceptionsi_freespaceout::PerceptionSI_FreeSpaceOut.
   */
  perceptionsi_freespaceout::skeleton::PerceptionSI_FreeSpaceOutSkeleton::ServiceDiscovery perceptionsi_freespaceout_skeleton_sd_0_{perceptionsi_freespaceout::PerceptionSI_FreeSpaceOut::kServiceShortNamePath};
  /*!
   * \brief Service discovery instance used on skeleton side
   *        for the service interface perceptionsi_out::PerceptionSI_Out.
   */
  perceptionsi_out::skeleton::PerceptionSI_OutSkeleton::ServiceDiscovery perceptionsi_out_skeleton_sd_1_{perceptionsi_out::PerceptionSI_Out::kServiceShortNamePath};
  /*!
   * \brief Service discovery instance used on skeleton side
   *        for the service interface perceptionsi_visnobjout::PerceptionSI_VisnObjOut.
   */
  perceptionsi_visnobjout::skeleton::PerceptionSI_VisnObjOutSkeleton::ServiceDiscovery perceptionsi_visnobjout_skeleton_sd_2_{perceptionsi_visnobjout::PerceptionSI_VisnObjOut::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr
