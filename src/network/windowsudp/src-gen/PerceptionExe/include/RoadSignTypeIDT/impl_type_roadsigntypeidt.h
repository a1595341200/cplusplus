 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/RoadSignTypeIDT/impl_type_roadsigntypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
#define PERCEPTIONEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
