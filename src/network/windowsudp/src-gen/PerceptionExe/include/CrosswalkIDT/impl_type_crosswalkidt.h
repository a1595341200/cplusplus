 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/CrosswalkIDT/impl_type_crosswalkidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
#define PERCEPTIONEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
