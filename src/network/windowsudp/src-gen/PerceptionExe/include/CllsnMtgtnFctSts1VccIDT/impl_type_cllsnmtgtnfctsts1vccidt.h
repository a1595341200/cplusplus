 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/CllsnMtgtnFctSts1VccIDT/impl_type_cllsnmtgtnfctsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_CLLSNMTGTNFCTSTS1VCCIDT_IMPL_TYPE_CLLSNMTGTNFCTSTS1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_CLLSNMTGTNFCTSTS1VCCIDT_IMPL_TYPE_CLLSNMTGTNFCTSTS1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_CLLSNMTGTNFCTSTS1VCCIDT_IMPL_TYPE_CLLSNMTGTNFCTSTS1VCCIDT_H_
