 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/ObjLaneAssignment1IDT/impl_type_objlaneassignment1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_OBJLANEASSIGNMENT1IDT_IMPL_TYPE_OBJLANEASSIGNMENT1IDT_H_
#define PERCEPTIONEXE_INCLUDE_OBJLANEASSIGNMENT1IDT_IMPL_TYPE_OBJLANEASSIGNMENT1IDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_OBJLANEASSIGNMENT1IDT_IMPL_TYPE_OBJLANEASSIGNMENT1IDT_H_
