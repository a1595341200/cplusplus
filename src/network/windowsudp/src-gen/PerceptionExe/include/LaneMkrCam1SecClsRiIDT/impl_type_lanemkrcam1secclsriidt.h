 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LaneMkrCam1SecClsRiIDT/impl_type_lanemkrcam1secclsriidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
#define PERCEPTIONEXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
