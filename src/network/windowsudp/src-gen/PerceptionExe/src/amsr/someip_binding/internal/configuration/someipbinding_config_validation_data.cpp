 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/src/amsr/someip_binding/internal/configuration/someipbinding_config_validation_data.cpp
...
{"/JICA/Service/Interface/PerceptionSI_Out"_sv,
     ConfigValidationDataAccess{
      &::amsr::someip_binding::internal::configuration::gen_perceptionsi_out::PerceptionSI_OutConfigValidationData::kValidEventConfigurationEntities[0],
      6,
      nullptr,
      0,
      nullptr,
