 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/src/amsr/ipc_binding_transformation_layer/internal/perceptionsi_visnobjout/PerceptionSI_VisnObjOut_skeleton_ipc_binding.cpp
 *        \brief  IpcBinding skeleton binding of service 'PerceptionSI_VisnObjOut'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
void PerceptionSI_VisnObjOutProvidedIpcServiceInstance::OnRequestReceived(
...
// VECTOR NC AutosarC++17_10-M0.1.8: MD_IPCBINDING_AutosarC++17_10_M0.1.8_config_variant
// VECTOR NC AutosarC++17_10-M7.1.2: MD_IPCBINDING_AutosarC++17_10-M7.1.2_config_variant
void PerceptionSI_VisnObjOutProvidedIpcServiceInstance::OnRequestNoReturnReceived(
...
::amsr::ipc_binding_core::internal::ForwardNotificationMessage PerceptionSI_VisnObjOutProvidedIpcServiceInstance::OnSubscribeEventReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProvidedIpcServiceInstance::OnUnsubscribeEventReceived(
...
PerceptionSI_VisnObjOutSkeletonIpcEventManagerFrntCam_Bus_VisnObj* PerceptionSI_VisnObjOutProvidedIpcServiceInstance::GetEventManagerFrntCam_Bus_VisnObj() noexcept {
  return &event_FrntCam_Bus_VisnObj_;
}
// Event 'FrntCam_Bus_UnfilteredObj'
PerceptionSI_VisnObjOutSkeletonIpcEventManagerFrntCam_Bus_UnfilteredObj* PerceptionSI_VisnObjOutProvidedIpcServiceInstance::GetEventManagerFrntCam_Bus_UnfilteredObj() noexcept {
  return &event_FrntCam_Bus_UnfilteredObj_;
}
