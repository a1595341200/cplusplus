 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/LineSignGroupIDT/impl_type_linesigngroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
