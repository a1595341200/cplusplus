 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/TrfcLi1VccIDT/impl_type_trfcli1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_TRFCLI1VCCIDT_IMPL_TYPE_TRFCLI1VCCIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_TRFCLI1VCCIDT_IMPL_TYPE_TRFCLI1VCCIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_TRFCLI1VCCIDT_IMPL_TYPE_TRFCLI1VCCIDT_H_
