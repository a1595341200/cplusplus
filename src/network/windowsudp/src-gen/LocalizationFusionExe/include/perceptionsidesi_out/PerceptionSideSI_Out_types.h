 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/perceptionsidesi_out/PerceptionSideSI_Out_types.h
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_TYPES_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_TYPES_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_TYPES_H_
