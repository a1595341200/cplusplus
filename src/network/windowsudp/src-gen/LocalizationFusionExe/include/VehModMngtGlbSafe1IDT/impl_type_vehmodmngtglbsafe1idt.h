 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/VehModMngtGlbSafe1IDT/impl_type_vehmodmngtglbsafe1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
