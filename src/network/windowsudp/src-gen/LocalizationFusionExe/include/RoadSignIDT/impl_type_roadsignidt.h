 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/RoadSignIDT/impl_type_roadsignidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
