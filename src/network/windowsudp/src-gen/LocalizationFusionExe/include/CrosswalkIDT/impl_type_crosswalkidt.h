 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/CrosswalkIDT/impl_type_crosswalkidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
