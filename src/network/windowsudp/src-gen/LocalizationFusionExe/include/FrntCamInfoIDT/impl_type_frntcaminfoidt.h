 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/FrntCamInfoIDT/impl_type_frntcaminfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
