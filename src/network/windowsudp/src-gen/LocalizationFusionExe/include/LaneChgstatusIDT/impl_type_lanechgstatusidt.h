 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/LaneChgstatusIDT/impl_type_lanechgstatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
