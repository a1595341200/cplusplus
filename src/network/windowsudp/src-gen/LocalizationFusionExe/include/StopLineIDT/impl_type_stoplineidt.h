 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/StopLineIDT/impl_type_stoplineidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
