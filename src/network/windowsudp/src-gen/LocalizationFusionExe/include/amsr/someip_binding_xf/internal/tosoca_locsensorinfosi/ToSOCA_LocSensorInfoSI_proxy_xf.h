 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/amsr/someip_binding_xf/internal/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_proxy_xf.h
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_XF_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_XF_H_
...
#include "amsr/someip_binding_xf/internal/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_proxy_methods.h"
...
class ToSOCA_LocSensorInfoSIProxyXf final :
 ...
 public:
  ...
  ~ToSOCA_LocSensorInfoSIProxyXf() noexcept override;

  ToSOCA_LocSensorInfoSIProxyXf(ToSOCA_LocSensorInfoSIProxyXf const&) noexcept = delete;
  ToSOCA_LocSensorInfoSIProxyXf(ToSOCA_LocSensorInfoSIProxyXf&& other) noexcept = delete;
  ToSOCA_LocSensorInfoSIProxyXf& operator=(ToSOCA_LocSensorInfoSIProxyXf const&) & = delete;
  ToSOCA_LocSensorInfoSIProxyXf& operator=(ToSOCA_LocSensorInfoSIProxyXf&&) & noexcept = delete;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  ::amsr::socal::internal::events::ProxyEventBackendInterface<::LocSensorInfo1VCCIDT::LocSensorInfo1VCCIDT>& GetEventBackendOSM2_Bus_LocSensorInfo() noexcept override {
 ...
 private:
  ...
  ::amsr::someip_binding::internal::configuration::EventConfig const&
      ...
      events_ToSOCA_LocSensorInfoSIProxySomeIpEventConfigurationOSM2_Bus_LocSensorInfo_event_config_{
          ...
          config_wrapper_.GetEventConfig(
              ...
              ::amsr::someip_binding::internal::configuration::Shortname{events::proxy::OSM2_Bus_LocSensorInfo::EventDesignInfo::kEventName.c_str()})};

  // Event Xf for proxy event 'OSM2_Bus_LocSensorInfo'
  // VCA_SOMEIPBINDING_ACCESSING_MEMBERS_OF_REFERENCE_CLASS_ATTRIBUTES
  // VCA_SOMEIPBINDING_MISS_OF_INFORMATION_OF_POINTER
  std::unique_ptr<ser_deser::DeserializerInterface<events::proxy::OSM2_Bus_LocSensorInfo::EventDesignInfo::SampleType>> deserializer_ptr_OSM2_Bus_LocSensorInfo_{
    events::proxy::OSM2_Bus_LocSensorInfo::DeserializerFactory::Create()
  };
  ...
  // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
  events::proxy::OSM2_Bus_LocSensorInfo::ToSOCA_LocSensorInfoSIProxySomeIpEventBackendOSM2_Bus_LocSensorInfo event_xf_OSM2_Bus_LocSensorInfo_{
      // VCA_SOMEIPBINDING_ACCESSING_MEMBERS_OF_REFERENCE_CLASS_ATTRIBUTES
      someip_binding_core::internal::SomeIpEventIdentity{
          ...
          events_ToSOCA_LocSensorInfoSIProxySomeIpEventConfigurationOSM2_Bus_LocSensorInfo_event_config_
              ...
              .GetEventId()},
      someip_client_,
      *(deserializer_ptr_OSM2_Bus_LocSensorInfo_.get()),
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_XF_H_
