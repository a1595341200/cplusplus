...
#include "localizationfusionsi_out/LocalizationFusionSI_Out.h"
...
class LifecycleManager final {
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    tosoca_locsensorinfosi::proxy::ToSOCA_LocSensorInfoSIProxy::RegisterServiceDiscovery(&tosoca_locsensorinfosi_proxy_sd_4_);

    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    localizationfusionsi_out::skeleton::LocalizationFusionSI_OutSkeleton::RegisterServiceDiscovery(&localizationfusionsi_out_skeleton_sd_0_);
  }
   ...
   */
  ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      tosoca_locsensorinfosi::internal::ToSOCA_LocSensorInfoSIProxyBackendInterface> tosoca_locsensorinfosi_proxy_sd_4_{tosoca_locsensorinfosi::ToSOCA_LocSensorInfoSI::kServiceShortNamePath};
   ...
   *        for the service interface localizationfusionsi_out::LocalizationFusionSI_Out.
   */
  localizationfusionsi_out::skeleton::LocalizationFusionSI_OutSkeleton::ServiceDiscovery localizationfusionsi_out_skeleton_sd_0_{localizationfusionsi_out::LocalizationFusionSI_Out::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr
