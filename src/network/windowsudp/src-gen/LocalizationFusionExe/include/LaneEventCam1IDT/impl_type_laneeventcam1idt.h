 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/LaneEventCam1IDT/impl_type_laneeventcam1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_LANEEVENTCAM1IDT_IMPL_TYPE_LANEEVENTCAM1IDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_LANEEVENTCAM1IDT_IMPL_TYPE_LANEEVENTCAM1IDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_LANEEVENTCAM1IDT_IMPL_TYPE_LANEEVENTCAM1IDT_H_
