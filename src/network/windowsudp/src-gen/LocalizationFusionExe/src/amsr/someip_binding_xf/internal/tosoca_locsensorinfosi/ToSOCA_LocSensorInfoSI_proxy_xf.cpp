 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/src/amsr/someip_binding_xf/internal/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_proxy_xf.cpp
...
ToSOCA_LocSensorInfoSIProxyXf::~ToSOCA_LocSensorInfoSIProxyXf() noexcept {
// VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
}  // COV_SOMEIPBINDING_PROXY_XF 
