 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/src/amsr/someip_binding/internal/binding_xf_initializer.cpp
...
#include "amsr/someip_binding_xf/internal/localizationfusionsi_out/LocalizationFusionSI_Out_skeleton_xf.h"
...
#include "amsr/someip_binding_xf/internal/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_proxy_xf.h"
...
void BindingXfInitializer::InitializeServiceDiscoveryProxyXfs(
  ...
  { // Instantiate ServiceDiscoveryProxyXfs for Service ToSOCA_LocSensorInfoSI
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/ToSOCA_LocSensorInfoSI"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive

    // Create & initialize SD Proxy XF
    // VCA_SOMEIPBINDING_CONFIG_WRAPPER_OBJECT_LIFECYCLE
    SomeIpBindingProxyXfInitializer::InitializeSdProxyXfs<
        ::tosoca_locsensorinfosi::proxy::ToSOCA_LocSensorInfoSIProxy,
        ::tosoca_locsensorinfosi::internal::ToSOCA_LocSensorInfoSIProxyBackendInterface,
        ::amsr::someip_binding_xf::internal::gen_tosoca_locsensorinfosi::ToSOCA_LocSensorInfoSIProxyXf>(
        // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
        e2e_profiles, life_cycle_manager, client_manager, service_discovery_handler, shortname_path, client_transport_to_daemon);
  } // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT, VCA_SPC_15_SOMEIPBINDING_STL_TYPE_FUNCTION
}
...
void BindingXfInitializer::DeInitializeServiceDiscoveryProxyXfs(
  ...
  {  // Deinitialize ServiceDiscoveryProxyXf for Service ToSOCA_LocSensorInfoSI
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/ToSOCA_LocSensorInfoSI"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
...
::amsr::someip_binding_core::internal::ServerTransportToDaemonInterface& server_transport_to_daemon, std::function<void()> process_polling) noexcept {
  {  // Instantiate ServiceDiscoverySkeletonXfs for Service LocalizationFusionSI_Out
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/LocalizationFusionSI_Out"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
    // Create & initialize SD Skeleton XF
    // VCA_SOMEIPBINDING_CONFIG_WRAPPER_OBJECT_LIFECYCLE
    SomeIpBindingSkeletonXfInitializer::InitializeSdSkeletonXfs<
        ::amsr::someip_binding_xf::internal::gen_localizationfusionsi_out::LocalizationFusionSI_OutSkeletonXf,
        // VECTOR NL AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
        ::localizationfusionsi_out::skeleton::LocalizationFusionSI_OutSkeleton>( // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
        // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
