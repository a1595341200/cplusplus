 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/AsyLineLePahIDT/impl_type_asylinelepahidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_ASYLINELEPAHIDT_IMPL_TYPE_ASYLINELEPAHIDT_H_
#define EDREXE_INCLUDE_ASYLINELEPAHIDT_IMPL_TYPE_ASYLINELEPAHIDT_H_
...
/*!
 * \brief Type AsyLineLePahIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/AsyLineLePahIDT
 */
struct AsyLineLePahIDT {
...
/*!
 * \brief   Compare for equality with another AsyLineLePahIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(AsyLineLePahIDT const& l,
                       AsyLineLePahIDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another AsyLineLePahIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // EDREXE_INCLUDE_ASYLINELEPAHIDT_IMPL_TYPE_ASYLINELEPAHIDT_H_
