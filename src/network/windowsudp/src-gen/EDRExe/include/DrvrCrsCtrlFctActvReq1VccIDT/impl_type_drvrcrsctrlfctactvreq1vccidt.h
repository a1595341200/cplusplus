 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/DrvrCrsCtrlFctActvReq1VccIDT/impl_type_drvrcrsctrlfctactvreq1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_DRVRCRSCTRLFCTACTVREQ1VCCIDT_IMPL_TYPE_DRVRCRSCTRLFCTACTVREQ1VCCIDT_H_
#define EDREXE_INCLUDE_DRVRCRSCTRLFCTACTVREQ1VCCIDT_IMPL_TYPE_DRVRCRSCTRLFCTACTVREQ1VCCIDT_H_
...
#endif  // EDREXE_INCLUDE_DRVRCRSCTRLFCTACTVREQ1VCCIDT_IMPL_TYPE_DRVRCRSCTRLFCTACTVREQ1VCCIDT_H_
