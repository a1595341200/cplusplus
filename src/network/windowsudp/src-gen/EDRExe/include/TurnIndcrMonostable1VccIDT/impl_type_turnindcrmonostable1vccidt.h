 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/TurnIndcrMonostable1VccIDT/impl_type_turnindcrmonostable1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_TURNINDCRMONOSTABLE1VCCIDT_IMPL_TYPE_TURNINDCRMONOSTABLE1VCCIDT_H_
#define EDREXE_INCLUDE_TURNINDCRMONOSTABLE1VCCIDT_IMPL_TYPE_TURNINDCRMONOSTABLE1VCCIDT_H_
...
#endif  // EDREXE_INCLUDE_TURNINDCRMONOSTABLE1VCCIDT_IMPL_TYPE_TURNINDCRMONOSTABLE1VCCIDT_H_
