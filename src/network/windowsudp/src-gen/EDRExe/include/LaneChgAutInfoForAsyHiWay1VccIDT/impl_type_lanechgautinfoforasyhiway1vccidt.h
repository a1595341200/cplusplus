 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/LaneChgAutInfoForAsyHiWay1VccIDT/impl_type_lanechgautinfoforasyhiway1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_IMPL_TYPE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_H_
#define EDREXE_INCLUDE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_IMPL_TYPE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_H_
...
#endif  // EDREXE_INCLUDE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_IMPL_TYPE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_H_
