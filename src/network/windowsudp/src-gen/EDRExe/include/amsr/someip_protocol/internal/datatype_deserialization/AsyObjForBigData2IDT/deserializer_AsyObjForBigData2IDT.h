 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/amsr/someip_protocol/internal/datatype_deserialization/AsyObjForBigData2IDT/deserializer_AsyObjForBigData2IDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'AsyObjForBigData2IDT'
 *
 *      \details  /CppImplementationDataTypes/AsyObjForBigData2IDT
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef EDREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ASYOBJFORBIGDATA2IDT_DESERIALIZER_ASYOBJFORBIGDATA2IDT_H_
#define EDREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ASYOBJFORBIGDATA2IDT_DESERIALIZER_ASYOBJFORBIGDATA2IDT_H_
...
namespace AsyObjForBigData2IDT {

// VECTOR NC Metric-HIS.PATH: MD_SOMEIPPROTOCOL_Metric-HIS.PATH
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/AsyObjForBigData2IDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/AsyObjForBigData2IDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::AsyObjForBigData2IDT::AsyObjForBigData2IDT &data) noexcept {
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/AsyObjForBigData2IDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::AsyObjForBigData2IDT::AsyObjForBigData2IDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
...
#endif  // EDREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ASYOBJFORBIGDATA2IDT_DESERIALIZER_ASYOBJFORBIGDATA2IDT_H_
