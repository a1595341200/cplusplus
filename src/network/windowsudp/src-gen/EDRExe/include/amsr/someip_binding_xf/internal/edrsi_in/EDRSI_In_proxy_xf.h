 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/amsr/someip_binding_xf/internal/edrsi_in/EDRSI_In_proxy_xf.h
 *        \brief  SOME/IP binding of service proxy for service 'EDRSI_In'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef EDREXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_EDRSI_IN_EDRSI_IN_PROXY_XF_H_
#define EDREXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_EDRSI_IN_EDRSI_IN_PROXY_XF_H_
...
#include "amsr/someip_binding_xf/internal/edrsi_in/EDRSI_In_proxy_methods.h"
 ...
 */
class EDRSI_InProxyXf final :
  public ::edrsi_in::internal::EDRSI_InProxyBackendInterface {
 public:
  /*!
   ...
   * \synchronous TRUE
   */
  EDRSI_InProxyXf(::amsr::someip_protocol::internal::ServiceId const service_id,
  ...
  ~EDRSI_InProxyXf() noexcept override;

  EDRSI_InProxyXf(EDRSI_InProxyXf const&) noexcept = delete;
  EDRSI_InProxyXf(EDRSI_InProxyXf&& other) noexcept = delete;
  EDRSI_InProxyXf& operator=(EDRSI_InProxyXf const&) & = delete;
  EDRSI_InProxyXf& operator=(EDRSI_InProxyXf&&) & noexcept = delete;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  ::amsr::socal::internal::events::ProxyEventBackendInterface<::EDRDataGroupIDT::EDRDataGroupIDT>& GetEventBackendOSM2_Bus_EDR_Data() noexcept override {
    return event_xf_OSM2_Bus_EDR_Data_;
 ...
 private:
  ...
  ::amsr::someip_binding::internal::configuration::EventConfig const&
      ...
      events_EDRSI_InProxySomeIpEventConfigurationOSM2_Bus_EDR_Data_event_config_{
          ...
          config_wrapper_.GetEventConfig(
              ...
              ::amsr::someip_binding::internal::configuration::Shortname{events::proxy::OSM2_Bus_EDR_Data::EventDesignInfo::kEventName.c_str()})};

  // Event Xf for proxy event 'OSM2_Bus_EDR_Data'
  // VCA_SOMEIPBINDING_ACCESSING_MEMBERS_OF_REFERENCE_CLASS_ATTRIBUTES
  // VCA_SOMEIPBINDING_MISS_OF_INFORMATION_OF_POINTER
  std::unique_ptr<ser_deser::DeserializerInterface<events::proxy::OSM2_Bus_EDR_Data::EventDesignInfo::SampleType>> deserializer_ptr_OSM2_Bus_EDR_Data_{
    events::proxy::OSM2_Bus_EDR_Data::DeserializerFactory::Create()
  };
  ...
  // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
  events::proxy::OSM2_Bus_EDR_Data::EDRSI_InProxySomeIpEventBackendOSM2_Bus_EDR_Data event_xf_OSM2_Bus_EDR_Data_{
      // VCA_SOMEIPBINDING_ACCESSING_MEMBERS_OF_REFERENCE_CLASS_ATTRIBUTES
      someip_binding_core::internal::SomeIpEventIdentity{
          ...
          events_EDRSI_InProxySomeIpEventConfigurationOSM2_Bus_EDR_Data_event_config_
              ...
              .GetEventId()},
      someip_client_,
      *(deserializer_ptr_OSM2_Bus_EDR_Data_.get()),
...
#endif  // EDREXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_EDRSI_IN_EDRSI_IN_PROXY_XF_H_
