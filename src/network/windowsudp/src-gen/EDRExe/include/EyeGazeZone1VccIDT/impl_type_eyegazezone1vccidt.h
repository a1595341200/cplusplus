 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/EyeGazeZone1VccIDT/impl_type_eyegazezone1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_EYEGAZEZONE1VCCIDT_IMPL_TYPE_EYEGAZEZONE1VCCIDT_H_
#define EDREXE_INCLUDE_EYEGAZEZONE1VCCIDT_IMPL_TYPE_EYEGAZEZONE1VCCIDT_H_
...
#endif  // EDREXE_INCLUDE_EYEGAZEZONE1VCCIDT_IMPL_TYPE_EYEGAZEZONE1VCCIDT_H_
