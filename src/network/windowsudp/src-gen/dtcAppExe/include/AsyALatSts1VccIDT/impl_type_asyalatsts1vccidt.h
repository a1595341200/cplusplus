 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/AsyALatSts1VccIDT/impl_type_asyalatsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
#define DTCAPPEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
