 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/TrfcLiActvStsIDT/impl_type_trfcliactvstsidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
#define DTCAPPEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
