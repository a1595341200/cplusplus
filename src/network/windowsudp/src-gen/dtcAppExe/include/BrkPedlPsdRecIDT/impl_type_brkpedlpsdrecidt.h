 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/BrkPedlPsdRecIDT/impl_type_brkpedlpsdrecidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_BRKPEDLPSDRECIDT_IMPL_TYPE_BRKPEDLPSDRECIDT_H_
#define DTCAPPEXE_INCLUDE_BRKPEDLPSDRECIDT_IMPL_TYPE_BRKPEDLPSDRECIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_BRKPEDLPSDRECIDT_IMPL_TYPE_BRKPEDLPSDRECIDT_H_
