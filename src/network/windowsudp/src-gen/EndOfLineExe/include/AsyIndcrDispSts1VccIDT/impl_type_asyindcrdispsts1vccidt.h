 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/AsyIndcrDispSts1VccIDT/impl_type_asyindcrdispsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
#define ENDOFLINEEXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
