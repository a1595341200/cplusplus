 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/AccFusnTrfcReqIDT/impl_type_accfusntrfcreqidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
#define ENDOFLINEEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
