 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/LaneChgstatusIDT/impl_type_lanechgstatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
#define ENDOFLINEEXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
