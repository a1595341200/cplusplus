 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/amsr/socal/internal/lifecycle_manager.h
...
#ifndef ENDOFLINEEXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
#define ENDOFLINEEXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
...
#include "endoflinesi_out/EndOfLineSI_Out.h"
...
class LifecycleManager final {
 public:
  ...
  static void Initialize() noexcept {
    ...
    endoflinesi_out::skeleton::EndOfLineSI_OutSkeleton::CreateSingletons();
  ...
  static void Deinitialize() noexcept {
    ...
    endoflinesi_out::skeleton::EndOfLineSI_OutSkeleton::DestroySingletons();
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    endoflinesi_out::skeleton::EndOfLineSI_OutSkeleton::RegisterServiceDiscovery(&endoflinesi_out_skeleton_sd_0_);
  }
  ...
  void DeInitializeServiceDiscovery() noexcept {
    ...
    endoflinesi_out::skeleton::EndOfLineSI_OutSkeleton::DeRegisterServiceDiscovery();
  }
   ...
   *        for the service interface endoflinesi_out::EndOfLineSI_Out.
   */
  endoflinesi_out::skeleton::EndOfLineSI_OutSkeleton::ServiceDiscovery endoflinesi_out_skeleton_sd_0_{endoflinesi_out::EndOfLineSI_Out::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr

#endif  // ENDOFLINEEXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
