 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/EyeGazeZone1VccIDT/impl_type_eyegazezone1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_EYEGAZEZONE1VCCIDT_IMPL_TYPE_EYEGAZEZONE1VCCIDT_H_
#define ENDOFLINEEXE_INCLUDE_EYEGAZEZONE1VCCIDT_IMPL_TYPE_EYEGAZEZONE1VCCIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_EYEGAZEZONE1VCCIDT_IMPL_TYPE_EYEGAZEZONE1VCCIDT_H_
