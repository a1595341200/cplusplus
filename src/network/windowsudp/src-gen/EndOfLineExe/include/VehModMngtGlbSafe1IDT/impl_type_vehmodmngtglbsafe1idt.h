 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/VehModMngtGlbSafe1IDT/impl_type_vehmodmngtglbsafe1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
#define ENDOFLINEEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_VEHMODMNGTGLBSAFE1IDT_IMPL_TYPE_VEHMODMNGTGLBSAFE1IDT_H_
