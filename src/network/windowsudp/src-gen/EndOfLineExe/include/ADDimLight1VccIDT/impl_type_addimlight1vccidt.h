 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/ADDimLight1VccIDT/impl_type_addimlight1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
#define ENDOFLINEEXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
