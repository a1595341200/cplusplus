 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/RoadSgnInfoActv0IDT/impl_type_roadsgninfoactv0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
#define ENDOFLINEEXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
