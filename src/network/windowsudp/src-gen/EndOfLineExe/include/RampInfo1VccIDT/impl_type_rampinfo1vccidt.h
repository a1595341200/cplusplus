 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/RampInfo1VccIDT/impl_type_rampinfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_RAMPINFO1VCCIDT_IMPL_TYPE_RAMPINFO1VCCIDT_H_
#define ENDOFLINEEXE_INCLUDE_RAMPINFO1VCCIDT_IMPL_TYPE_RAMPINFO1VCCIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_RAMPINFO1VCCIDT_IMPL_TYPE_RAMPINFO1VCCIDT_H_
