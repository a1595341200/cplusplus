 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/src/amsr/someip_binding/internal/configuration/someipbinding_config_validation_data.cpp
...
#include "amsr/someip_binding/internal/configuration/endoflinesi_out/EndOfLineSI_Out_config_validation_data.h"
...
{"/JICA/Service/Interface/EndOfLineSI_Out"_sv,
     ConfigValidationDataAccess{
      &::amsr::someip_binding::internal::configuration::gen_endoflinesi_out::EndOfLineSI_OutConfigValidationData::kValidEventConfigurationEntities[0],
      1,
      nullptr,
      0,
      nullptr,
