 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/src/amsr/someip_binding/internal/binding_xf_initializer.cpp
...
::amsr::someip_binding_core::internal::ServerTransportToDaemonInterface& server_transport_to_daemon, std::function<void()> process_polling) noexcept {
  {  // Instantiate ServiceDiscoverySkeletonXfs for Service EndOfLineSI_Out
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/EndOfLineSI_Out"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
    // Create & initialize SD Skeleton XF
    // VCA_SOMEIPBINDING_CONFIG_WRAPPER_OBJECT_LIFECYCLE
    SomeIpBindingSkeletonXfInitializer::InitializeSdSkeletonXfs<
        ::amsr::someip_binding_xf::internal::gen_endoflinesi_out::EndOfLineSI_OutSkeletonXf,
        // VECTOR NL AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
        ::endoflinesi_out::skeleton::EndOfLineSI_OutSkeleton>( // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
        // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
