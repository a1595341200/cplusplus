 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/ehrsi_out/events/deserializer_EHR_Bus_AllMergePoints.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/LinkMergePointIDT/deserializer_LinkMergePointIDT.h"
...
deserialization::Result DeserializerEHR_Bus_AllMergePoints::Deserialize(deserialization::Reader &reader, ::Array_LinkMergePointIDT_Vector::Array_LinkMergePointIDT_Vector &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/EHRSI_Out/EHR_Bus_AllMergePoints
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      TpPackAlias,
        // Config of vector length field and max. container size (/CppImplementationDataTypes/Array_LinkMergePointIDT_Vector)
      ...
      >(deserialization::SizeToken<::Array_LinkMergePointIDT_Vector::Array_LinkMergePointIDT_Vector>{})};
