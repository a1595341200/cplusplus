...
#include "amsr/someip_protocol/internal/datatype_deserialization/PairConnectivityIDT/deserializer_PairConnectivityIDT.h"
...
deserialization::Result DeserializerEHR_Bus_LaneConnectivitys::Deserialize(deserialization::Reader &reader, ::Array_PairConnectivityIDT_Vector::Array_PairConnectivityIDT_Vector &data) noexcept {
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      TpPackAlias,
        // Config of vector length field and max. container size (/CppImplementationDataTypes/Array_PairConnectivityIDT_Vector)
      ...
      >(deserialization::SizeToken<::Array_PairConnectivityIDT_Vector::Array_PairConnectivityIDT_Vector>{})};
