 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/src/amsr/ipc_binding_transformation_layer/internal/roadmodelfusionsi_out/RoadModelFusionSI_Out_skeleton_ipc_binding.cpp
 *        \brief  IpcBinding skeleton binding of service 'RoadModelFusionSI_Out'
 *
 *      \details
 *
 *********************************************************************************************************************/
 ...
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/ipc_binding_transformation_layer/internal/roadmodelfusionsi_out/RoadModelFusionSI_Out_skeleton_ipc_binding.h"
#include <utility>
...
void RoadModelFusionSI_OutProvidedIpcServiceInstance::OnRequestReceived(
...
// VECTOR NC AutosarC++17_10-M0.1.8: MD_IPCBINDING_AutosarC++17_10_M0.1.8_config_variant
// VECTOR NC AutosarC++17_10-M7.1.2: MD_IPCBINDING_AutosarC++17_10-M7.1.2_config_variant
void RoadModelFusionSI_OutProvidedIpcServiceInstance::OnRequestNoReturnReceived(
...
::amsr::ipc_binding_core::internal::ForwardNotificationMessage RoadModelFusionSI_OutProvidedIpcServiceInstance::OnSubscribeEventReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput RoadModelFusionSI_OutProvidedIpcServiceInstance::OnUnsubscribeEventReceived(
...
RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_RMFInfo* RoadModelFusionSI_OutProvidedIpcServiceInstance::GetEventManagerRMF_Bus_RMFInfo() noexcept {
  return &event_RMF_Bus_RMFInfo_;
}
// Event 'RMF_Bus_MapInfo'
RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_MapInfo* RoadModelFusionSI_OutProvidedIpcServiceInstance::GetEventManagerRMF_Bus_MapInfo() noexcept {
  return &event_RMF_Bus_MapInfo_;
}
// Event 'RMF_Bus_VectorMapInfo'
RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_VectorMapInfo* RoadModelFusionSI_OutProvidedIpcServiceInstance::GetEventManagerRMF_Bus_VectorMapInfo() noexcept {
  return &event_RMF_Bus_VectorMapInfo_;
}
// Event 'RMF_Bus_Position'
RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_Position* RoadModelFusionSI_OutProvidedIpcServiceInstance::GetEventManagerRMF_Bus_Position() noexcept {
  return &event_RMF_Bus_Position_;
}
