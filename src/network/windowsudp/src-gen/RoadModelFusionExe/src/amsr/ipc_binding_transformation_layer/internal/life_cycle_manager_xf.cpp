 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/src/amsr/ipc_binding_transformation_layer/internal/life_cycle_manager_xf.cpp
...
LifeCycleManagerXf::DeployedServicesVector const LifeCycleManagerXf::deployed_service_interfaces_{
    {ShortnamePath{"/JICA/Service/Interface/EHRSI_Out"}}, // VCA_IPCB_BASICSTRING_CONSTRUCTOR
...
void LifeCycleManagerXf::InitializeServiceDiscoveryProxyXfs(BindingCoreType& binding_core,
  ...
  // -- Service Config for Service Interface 'EHRSI_Out' --
  {
    ...
    ServiceConfig const& service_config{runtime_config_.GetServiceOf({"/JICA/Service/Interface/EHRSI_Out"})};

    logger_.LogDebug(
        [](::ara::log::LogStream& s) {
          // VCA_IPCB_LOGSTREAM_CONCATENATION_IS_SILENT
          s << "Initializing service proxy '/JICA/Service/Interface/EHRSI_Out'.";
        },
        Logger::LogLocation{__func__, __LINE__});
    ::amsr::generic::Singleton<::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
        ::ehrsi_out::internal::EHRSI_OutProxyBackendInterface>*>& service_discovery{
...
void LifeCycleManagerXf::InitializeServiceDiscoverySkeletonXfs(BindingCoreType& binding_core) noexcept{
  ...
  // Service Config for Service Interface '/JICA/Service/Interface/RoadModelFusionSI_Out'
  {
    ...
    logger_.LogDebug(
        [](::ara::log::LogStream& s) {
          // VCA_IPCB_LOGSTREAM_CONCATENATION_IS_SILENT
          s << "Initializing service skeleton '/JICA/Service/Interface/RoadModelFusionSI_Out'.";
        },
        Logger::LogLocation{__func__, __LINE__});
    using SdSkeletonXfType = ::amsr::ipc_binding_transformation_layer::internal::ServiceDiscoverySkeletonXf<
        ::amsr::ipc_binding_transformation_layer::internal::roadmodelfusionsi_out::RoadModelFusionSI_OutProvidedIpcServiceInstance,
...
void LifeCycleManagerXf::DeInitializeServiceDiscoveryProxyXfs() noexcept {
  {
    // Service Config for Service Interface '/JICA/Service/Interface/EHRSI_Out'
    // VCA_IPCB_VALID_RUNTIME_CONFIGURATION_OBJECT, VCA_IPCB_LIFECYCLE_MANAGER_XF_UNDEFINED_FUNCTION, VCA_IPCB_STD_FUNCTION_CALLED
    ServiceConfig const& service_config{runtime_config_.GetServiceOf({"/JICA/Service/Interface/EHRSI_Out"})};
    ...
    logger_.LogDebug(
        [](::ara::log::LogStream& s) {
          // VCA_IPCB_LOGSTREAM_CONCATENATION_IS_SILENT
          s << "Deinitializing service '/JICA/Service/Interface/EHRSI_Out'.";
        },
        Logger::LogLocation{__func__, __LINE__});
