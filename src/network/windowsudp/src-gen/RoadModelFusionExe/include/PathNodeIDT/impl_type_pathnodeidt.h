 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/PathNodeIDT/impl_type_pathnodeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_PATHNODEIDT_IMPL_TYPE_PATHNODEIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_PATHNODEIDT_IMPL_TYPE_PATHNODEIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_PATHNODEIDT_IMPL_TYPE_PATHNODEIDT_H_
