...
/*!
 * \brief Type alias for service event 'RMF_Bus_RMFInfo', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using RMF_Bus_RMFInfo = ::amsr::socal::events::SkeletonEvent<
    ...
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::RMFInfoIDT::RMFInfoIDT>,
    &roadmodelfusionsi_out::internal::RoadModelFusionSI_OutSkeletonImplInterface::GetEventManagerRMF_Bus_RMFInfo>;

/*!
 * \brief Type alias for service event 'RMF_Bus_MapInfo', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using RMF_Bus_MapInfo = ::amsr::socal::events::SkeletonEvent<
    roadmodelfusionsi_out::skeleton::RoadModelFusionSI_OutSkeleton,
    ::RMFMapInfoIDT::RMFMapInfoIDT,
    roadmodelfusionsi_out::internal::RoadModelFusionSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::RMFMapInfoIDT::RMFMapInfoIDT>,
    &roadmodelfusionsi_out::internal::RoadModelFusionSI_OutSkeletonImplInterface::GetEventManagerRMF_Bus_MapInfo>;

/*!
 * \brief Type alias for service event 'RMF_Bus_VectorMapInfo', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using RMF_Bus_VectorMapInfo = ::amsr::socal::events::SkeletonEvent<
    roadmodelfusionsi_out::skeleton::RoadModelFusionSI_OutSkeleton,
    ::VectorMapInfoIDT::VectorMapInfoIDT,
    roadmodelfusionsi_out::internal::RoadModelFusionSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::VectorMapInfoIDT::VectorMapInfoIDT>,
    &roadmodelfusionsi_out::internal::RoadModelFusionSI_OutSkeletonImplInterface::GetEventManagerRMF_Bus_VectorMapInfo>;

/*!
 * \brief Type alias for service event 'RMF_Bus_Position', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using RMF_Bus_Position = ::amsr::socal::events::SkeletonEvent<
    roadmodelfusionsi_out::skeleton::RoadModelFusionSI_OutSkeleton,
    ::PositionIDT::PositionIDT,
    roadmodelfusionsi_out::internal::RoadModelFusionSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::PositionIDT::PositionIDT>,
    &roadmodelfusionsi_out::internal::RoadModelFusionSI_OutSkeletonImplInterface::GetEventManagerRMF_Bus_Position>;
...
class RoadModelFusionSI_OutSkeleton
    : public ::amsr::socal::Skeleton<roadmodelfusionsi_out::RoadModelFusionSI_Out,
      ...
      public       roadmodelfusionsi_out::internal::RoadModelFusionSI_OutSkeletonBackendInterface {
 public:
...
explicit RoadModelFusionSI_OutSkeleton(ConstructionToken&& token) noexcept;
  ...
  /*!
   * \brief The skeleton event 'RMF_Bus_RMFInfo' which can be used by application developer.
   * \details 
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'RMF_Bus_MapInfo' which can be used by application developer.
   * \details 
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'RMF_Bus_VectorMapInfo' which can be used by application developer.
   * \details 
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'RMF_Bus_Position' which can be used by application developer.
   * \details 
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<roadmodelfusionsi_out::RoadModelFusionSI_Out, roadmodelfusionsi_out::internal::RoadModelFusionSI_OutSkeletonImplInterface, ::amsr::socal::kRuntimeProcessingMode>;
