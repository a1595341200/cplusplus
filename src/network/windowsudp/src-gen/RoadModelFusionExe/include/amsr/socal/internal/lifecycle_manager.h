...
class LifecycleManager final {
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    ehrsi_out::proxy::EHRSI_OutProxy::RegisterServiceDiscovery(&ehrsi_out_proxy_sd_0_);

    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    roadmodelfusionsi_out::skeleton::RoadModelFusionSI_OutSkeleton::RegisterServiceDiscovery(&roadmodelfusionsi_out_skeleton_sd_0_);
  }
  ...
  ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      ehrsi_out::internal::EHRSI_OutProxyBackendInterface> ehrsi_out_proxy_sd_0_{ehrsi_out::EHRSI_Out::kServiceShortNamePath};
   ...
   */
  roadmodelfusionsi_out::skeleton::RoadModelFusionSI_OutSkeleton::ServiceDiscovery roadmodelfusionsi_out_skeleton_sd_0_{roadmodelfusionsi_out::RoadModelFusionSI_Out::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr
