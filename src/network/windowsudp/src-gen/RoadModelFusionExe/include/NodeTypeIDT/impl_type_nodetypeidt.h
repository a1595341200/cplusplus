 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/NodeTypeIDT/impl_type_nodetypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_NODETYPEIDT_IMPL_TYPE_NODETYPEIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_NODETYPEIDT_IMPL_TYPE_NODETYPEIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_NODETYPEIDT_IMPL_TYPE_NODETYPEIDT_H_
