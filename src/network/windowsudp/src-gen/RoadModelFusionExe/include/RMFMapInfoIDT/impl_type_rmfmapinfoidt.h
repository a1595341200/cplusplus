 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/RMFMapInfoIDT/impl_type_rmfmapinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_RMFMAPINFOIDT_IMPL_TYPE_RMFMAPINFOIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_RMFMAPINFOIDT_IMPL_TYPE_RMFMAPINFOIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_RMFMAPINFOIDT_IMPL_TYPE_RMFMAPINFOIDT_H_
