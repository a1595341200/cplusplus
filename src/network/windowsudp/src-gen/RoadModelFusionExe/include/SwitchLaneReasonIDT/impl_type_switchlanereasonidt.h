 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/SwitchLaneReasonIDT/impl_type_switchlanereasonidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_SWITCHLANEREASONIDT_IMPL_TYPE_SWITCHLANEREASONIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_SWITCHLANEREASONIDT_IMPL_TYPE_SWITCHLANEREASONIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_SWITCHLANEREASONIDT_IMPL_TYPE_SWITCHLANEREASONIDT_H_
