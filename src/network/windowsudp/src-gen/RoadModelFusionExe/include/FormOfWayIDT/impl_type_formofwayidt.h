 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/FormOfWayIDT/impl_type_formofwayidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_FORMOFWAYIDT_IMPL_TYPE_FORMOFWAYIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_FORMOFWAYIDT_IMPL_TYPE_FORMOFWAYIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_FORMOFWAYIDT_IMPL_TYPE_FORMOFWAYIDT_H_
