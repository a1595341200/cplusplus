 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/Left_line_delimiterIDT/impl_type_left_line_delimiteridt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LEFT_LINE_DELIMITERIDT_IMPL_TYPE_LEFT_LINE_DELIMITERIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_LEFT_LINE_DELIMITERIDT_IMPL_TYPE_LEFT_LINE_DELIMITERIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LEFT_LINE_DELIMITERIDT_IMPL_TYPE_LEFT_LINE_DELIMITERIDT_H_
