 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/GeofenceTypeIDT/impl_type_geofencetypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_GEOFENCETYPEIDT_IMPL_TYPE_GEOFENCETYPEIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_GEOFENCETYPEIDT_IMPL_TYPE_GEOFENCETYPEIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_GEOFENCETYPEIDT_IMPL_TYPE_GEOFENCETYPEIDT_H_
