 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LinkSlopeIDT/impl_type_linkslopeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LINKSLOPEIDT_IMPL_TYPE_LINKSLOPEIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_LINKSLOPEIDT_IMPL_TYPE_LINKSLOPEIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LINKSLOPEIDT_IMPL_TYPE_LINKSLOPEIDT_H_
