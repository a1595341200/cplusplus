 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/GeometryPointIDT/impl_type_geometrypointidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_GEOMETRYPOINTIDT_IMPL_TYPE_GEOMETRYPOINTIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_GEOMETRYPOINTIDT_IMPL_TYPE_GEOMETRYPOINTIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_GEOMETRYPOINTIDT_IMPL_TYPE_GEOMETRYPOINTIDT_H_
