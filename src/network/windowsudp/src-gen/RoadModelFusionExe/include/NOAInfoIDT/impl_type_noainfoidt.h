 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/NOAInfoIDT/impl_type_noainfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_NOAINFOIDT_IMPL_TYPE_NOAINFOIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_NOAINFOIDT_IMPL_TYPE_NOAINFOIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_NOAINFOIDT_IMPL_TYPE_NOAINFOIDT_H_
