 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/PositionIDT/impl_type_positionidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_POSITIONIDT_IMPL_TYPE_POSITIONIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_POSITIONIDT_IMPL_TYPE_POSITIONIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_POSITIONIDT_IMPL_TYPE_POSITIONIDT_H_
