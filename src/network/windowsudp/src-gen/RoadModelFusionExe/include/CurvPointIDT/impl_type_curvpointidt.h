 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/CurvPointIDT/impl_type_curvpointidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_CURVPOINTIDT_IMPL_TYPE_CURVPOINTIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_CURVPOINTIDT_IMPL_TYPE_CURVPOINTIDT_H_
...
/*!
 * \brief Type CurvPointIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/CurvPointIDT
 */
struct CurvPointIDT {
  using PathOffset_generated_type = uint32IDT::uint32IDT;
  using CurvPointValue_generated_type = float32IDT::float32IDT;

  PathOffset_generated_type PathOffset;
  CurvPointValue_generated_type CurvPointValue;
};
// VECTOR Enable AutosarC++17_10-A12.6.1
// VECTOR Enable AutosarC++17_10-M8.5.1

/*!
 * \brief   Compare for equality with another CurvPointIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(CurvPointIDT const& l,
                       CurvPointIDT const& r) noexcept {
  ...
  return (&l == &r) || ((l.PathOffset == r.PathOffset)
                         && compare_float(l.CurvPointValue, r.CurvPointValue)
  );
}

/*!
 * \brief   Compare for inequality with another CurvPointIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_CURVPOINTIDT_IMPL_TYPE_CURVPOINTIDT_H_
