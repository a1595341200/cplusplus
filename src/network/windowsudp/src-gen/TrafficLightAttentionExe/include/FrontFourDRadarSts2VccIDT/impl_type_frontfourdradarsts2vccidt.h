 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/FrontFourDRadarSts2VccIDT/impl_type_frontfourdradarsts2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_FRONTFOURDRADARSTS2VCCIDT_IMPL_TYPE_FRONTFOURDRADARSTS2VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_FRONTFOURDRADARSTS2VCCIDT_IMPL_TYPE_FRONTFOURDRADARSTS2VCCIDT_H_
...
/*!
 * \brief Type FrontFourDRadarSts2VccIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/FrontFourDRadarSts2VccIDT
 */
struct FrontFourDRadarSts2VccIDT {
  ...
  using RdrStsTiStampH_generated_type = uint32IDT::uint32IDT;
  using RdrStsTiStampL_generated_type = uint32IDT::uint32IDT;
  ...
  RdrStsTiStampH_generated_type RdrStsTiStampH;
  RdrStsTiStampL_generated_type RdrStsTiStampL;
...
/*!
 * \brief   Compare for equality with another FrontFourDRadarSts2VccIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(FrontFourDRadarSts2VccIDT const& l,
                       FrontFourDRadarSts2VccIDT const& r) noexcept {
  ...
  return (&l == &r) || ((l.RdrStsRdrNrDetn == r.RdrStsRdrNrDetn)
                         ...
                         && (l.RdrStsTiStampH == r.RdrStsTiStampH)
                         && (l.RdrStsTiStampL == r.RdrStsTiStampL)
...
/*!
 * \brief   Compare for inequality with another FrontFourDRadarSts2VccIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_FRONTFOURDRADARSTS2VCCIDT_IMPL_TYPE_FRONTFOURDRADARSTS2VCCIDT_H_
