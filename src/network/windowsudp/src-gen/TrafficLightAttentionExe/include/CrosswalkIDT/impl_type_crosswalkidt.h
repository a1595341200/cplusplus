 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/CrosswalkIDT/impl_type_crosswalkidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
