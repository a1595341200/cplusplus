 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/Vin1VccIDT/impl_type_vin1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_VIN1VCCIDT_IMPL_TYPE_VIN1VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_VIN1VCCIDT_IMPL_TYPE_VIN1VCCIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_VIN1VCCIDT_IMPL_TYPE_VIN1VCCIDT_H_
