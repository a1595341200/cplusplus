 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_datatypes.h
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
