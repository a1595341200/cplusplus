 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/BltLockStFrntIDT/impl_type_bltlockstfrntidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
