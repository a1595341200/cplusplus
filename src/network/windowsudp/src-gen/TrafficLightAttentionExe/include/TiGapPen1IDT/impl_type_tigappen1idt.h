 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/TiGapPen1IDT/impl_type_tigappen1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_TIGAPPEN1IDT_IMPL_TYPE_TIGAPPEN1IDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_TIGAPPEN1IDT_IMPL_TYPE_TIGAPPEN1IDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_TIGAPPEN1IDT_IMPL_TYPE_TIGAPPEN1IDT_H_
