 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/TrfcLi1VccIDT/impl_type_trfcli1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRFCLI1VCCIDT_IMPL_TYPE_TRFCLI1VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRFCLI1VCCIDT_IMPL_TYPE_TRFCLI1VCCIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRFCLI1VCCIDT_IMPL_TYPE_TRFCLI1VCCIDT_H_
