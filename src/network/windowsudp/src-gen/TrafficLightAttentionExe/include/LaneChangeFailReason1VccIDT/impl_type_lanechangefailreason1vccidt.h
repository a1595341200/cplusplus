 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/LaneChangeFailReason1VccIDT/impl_type_lanechangefailreason1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
