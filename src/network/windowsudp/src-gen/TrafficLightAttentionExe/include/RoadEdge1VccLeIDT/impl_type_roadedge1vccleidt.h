 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/RoadEdge1VccLeIDT/impl_type_roadedge1vccleidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
