 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/SignMainTypeIDT/impl_type_signmaintypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
