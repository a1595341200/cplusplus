 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/ExtInfoIDT/impl_type_extinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
