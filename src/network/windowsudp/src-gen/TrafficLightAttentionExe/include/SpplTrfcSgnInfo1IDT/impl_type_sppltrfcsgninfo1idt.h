 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/SpplTrfcSgnInfo1IDT/impl_type_sppltrfcsgninfo1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
