 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/LaneMkrCam1SecClsRiIDT/impl_type_lanemkrcam1secclsriidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
