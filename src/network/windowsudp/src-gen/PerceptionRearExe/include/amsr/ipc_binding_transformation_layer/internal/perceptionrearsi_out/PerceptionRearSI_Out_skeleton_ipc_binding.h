 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/amsr/ipc_binding_transformation_layer/internal/perceptionrearsi_out/PerceptionRearSI_Out_skeleton_ipc_binding.h
 *        \brief  IPC binding of service skeleton for service 'PerceptionRearSI_Out'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef PERCEPTIONREAREXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_SKELETON_IPC_BINDING_H_
#define PERCEPTIONREAREXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_SKELETON_IPC_BINDING_H_
...
#include <utility>
#include "amsr/ipc_binding_transformation_layer/internal/perceptionrearsi_out/PerceptionRearSI_Out_skeleton_ipc_event_manager.h"
#include "amsr/ipc_binding_transformation_layer/internal/perceptionrearsi_out/PerceptionRearSI_Out_skeleton_ipc_method_manager.h"
...
#include "perceptionrearsi_out/PerceptionRearSI_Out_skeleton_impl_interface.h"
...
/*!
 * \brief Provided service interface deployment of service interface 'PerceptionRearSI_Out'.
...
class PerceptionRearSI_OutProvidedIpcServiceInstance final
 ...
 /*!
  ...
  /*!
   * \brief         Constructor of ProvidedIpcServiceInstance for service 'PerceptionRearSI_Out'.
   * \param[in,out] skeleton                Reference to the skeleton. The reference must be valid for PerceptionRearSI_OutProvidedIpcServiceInstance entire life time.
   * \param[in,out] server_binding_manager  Server binding manager. The reference must be valid for PerceptionRearSI_OutProvidedIpcServiceInstance entire life time.
   ...
   * \synchronous   TRUE
   */
  PerceptionRearSI_OutProvidedIpcServiceInstance(::perceptionrearsi_out::internal::PerceptionRearSI_OutSkeletonBackendInterface& skeleton,
      ...
      : ::amsr::ipc_binding_core::internal::LocalServerSink{},
        ...
        logger_{::amsr::ipc_binding_core::internal::logging::kIpcLoggerContextId,
                ...
                ::amsr::core::StringView{"PerceptionRearSI_OutProvidedIpcServiceInstance"}},
        event_PerceptionRear_Bus_LaneInfo_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"PerceptionRear_Bus_LaneInfo"}).GetId().value},
            instance_id,
            false},
        event_PerceptionRear_Bus_CameraStatus_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"PerceptionRear_Bus_CameraStatus"}).GetId().value},
            instance_id,
            false},
        event_PerceptionRear_Bus_VisnObj_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"PerceptionRear_Bus_VisnObj"}).GetId().value},
            instance_id,
            false},
        event_id_set_{  // VCA_IPCB_STD_CONSTRUCTOR_CALLED
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            service_config.GetEventOf({"PerceptionRear_Bus_LaneInfo"}).GetId(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            service_config.GetEventOf({"PerceptionRear_Bus_CameraStatus"}).GetId(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            service_config.GetEventOf({"PerceptionRear_Bus_VisnObj"}).GetId()}  {
  ...
  PerceptionRearSI_OutProvidedIpcServiceInstance(PerceptionRearSI_OutProvidedIpcServiceInstance const& ) noexcept = delete;
  PerceptionRearSI_OutProvidedIpcServiceInstance(PerceptionRearSI_OutProvidedIpcServiceInstance&& ) noexcept = delete;
  PerceptionRearSI_OutProvidedIpcServiceInstance& operator=(PerceptionRearSI_OutProvidedIpcServiceInstance const& ) noexcept = delete;
  PerceptionRearSI_OutProvidedIpcServiceInstance& operator=(PerceptionRearSI_OutProvidedIpcServiceInstance&& ) noexcept = delete;
  ...
  ~PerceptionRearSI_OutProvidedIpcServiceInstance() noexcept final {
  ...
  /*!
   * \brief   Get the event manager object for the IPC binding service event 'PerceptionRear_Bus_LaneInfo'.
   *
   ...
   * \context App
   */
  PerceptionRearSI_OutSkeletonIpcEventManagerPerceptionRear_Bus_LaneInfo* GetEventManagerPerceptionRear_Bus_LaneInfo() noexcept final;

  /*!
   * \brief   Get the event manager object for the IPC binding service event 'PerceptionRear_Bus_CameraStatus'.
   *
   ...
   * \context App
   */
  PerceptionRearSI_OutSkeletonIpcEventManagerPerceptionRear_Bus_CameraStatus* GetEventManagerPerceptionRear_Bus_CameraStatus() noexcept final;

  /*!
   * \brief   Get the event manager object for the IPC binding service event 'PerceptionRear_Bus_VisnObj'.
   *
   ...
   * \context App
   */
  PerceptionRearSI_OutSkeletonIpcEventManagerPerceptionRear_Bus_VisnObj* GetEventManagerPerceptionRear_Bus_VisnObj() noexcept final;
  // ---- Events --------------------------------------------------------------------------------------------------
 ...
 private:
  ...
  // ---- EventManagers --------------------------------------------------------------------------------------------
  /*!
   * \brief Event manager for skeleton event 'PerceptionRear_Bus_LaneInfo'
   */
  PerceptionRearSI_OutSkeletonIpcEventManagerPerceptionRear_Bus_LaneInfo event_PerceptionRear_Bus_LaneInfo_;

  /*!
   * \brief Event manager for skeleton event 'PerceptionRear_Bus_CameraStatus'
   */
  PerceptionRearSI_OutSkeletonIpcEventManagerPerceptionRear_Bus_CameraStatus event_PerceptionRear_Bus_CameraStatus_;

  /*!
   * \brief Event manager for skeleton event 'PerceptionRear_Bus_VisnObj'
   */
  PerceptionRearSI_OutSkeletonIpcEventManagerPerceptionRear_Bus_VisnObj event_PerceptionRear_Bus_VisnObj_;
...
#endif  // PERCEPTIONREAREXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_SKELETON_IPC_BINDING_H_
