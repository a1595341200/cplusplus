 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/CllsnMtgtnFctSts1VccIDT/impl_type_cllsnmtgtnfctsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_CLLSNMTGTNFCTSTS1VCCIDT_IMPL_TYPE_CLLSNMTGTNFCTSTS1VCCIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_CLLSNMTGTNFCTSTS1VCCIDT_IMPL_TYPE_CLLSNMTGTNFCTSTS1VCCIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_CLLSNMTGTNFCTSTS1VCCIDT_IMPL_TYPE_CLLSNMTGTNFCTSTS1VCCIDT_H_
