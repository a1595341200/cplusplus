...
target_sources(${target} PRIVATE
  "${CMAKE_CURRENT_LIST_DIR}/machine_exec_config.json"
  "${CMAKE_CURRENT_LIST_DIR}/machine_exec_config.json.validation"
)

# Add all generated files that may be installed to target property INTERFACE_SOURCES
target_sources(${target} PUBLIC
  "$<BUILD_INTERFACE:${CMAKE_CURRENT_LIST_DIR}/machine_exec_config.json>"
  "$<INSTALL_INTERFACE:machine_exec_config.json>"
  "$<BUILD_INTERFACE:${CMAKE_CURRENT_LIST_DIR}/machine_exec_config.json.validation>"
  "$<INSTALL_INTERFACE:machine_exec_config.json.validation>"
)
