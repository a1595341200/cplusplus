 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/StaticObjIDT/impl_type_staticobjidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_STATICOBJIDT_IMPL_TYPE_STATICOBJIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_STATICOBJIDT_IMPL_TYPE_STATICOBJIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_STATICOBJIDT_IMPL_TYPE_STATICOBJIDT_H_
