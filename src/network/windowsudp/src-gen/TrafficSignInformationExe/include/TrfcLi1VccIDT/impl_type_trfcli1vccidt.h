 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/TrfcLi1VccIDT/impl_type_trfcli1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCLI1VCCIDT_IMPL_TYPE_TRFCLI1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCLI1VCCIDT_IMPL_TYPE_TRFCLI1VCCIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCLI1VCCIDT_IMPL_TYPE_TRFCLI1VCCIDT_H_
