 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/FRCamSts1VccIDT/impl_type_frcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_FRCAMSTS1VCCIDT_IMPL_TYPE_FRCAMSTS1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_FRCAMSTS1VCCIDT_IMPL_TYPE_FRCAMSTS1VCCIDT_H_
...
/*!
 * \brief Type FRCamSts1VccIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/FRCamSts1VccIDT
 */
struct FRCamSts1VccIDT {
...
/*!
 * \brief Compare for equality with another FRCamSts1VccIDT instance.
 */
inline bool operator==(FRCamSts1VccIDT const& l,
                       FRCamSts1VccIDT const& r) noexcept {
...
/*!
 * \brief Compare for inequality with another FRCamSts1VccIDT instance.
 */
inline bool operator!=(FRCamSts1VccIDT const& l,
                       FRCamSts1VccIDT const& r) noexcept {
  return !(l == r);
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_FRCAMSTS1VCCIDT_IMPL_TYPE_FRCAMSTS1VCCIDT_H_
