 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/CameraStatusIDT/impl_type_camerastatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
