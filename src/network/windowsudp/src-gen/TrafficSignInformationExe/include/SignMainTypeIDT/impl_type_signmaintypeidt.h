 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/SignMainTypeIDT/impl_type_signmaintypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
