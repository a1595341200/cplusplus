 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/SuppSignType2IDT/impl_type_suppsigntype2idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
