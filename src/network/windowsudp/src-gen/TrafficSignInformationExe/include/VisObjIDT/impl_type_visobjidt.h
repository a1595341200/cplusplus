 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/VisObjIDT/impl_type_visobjidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
