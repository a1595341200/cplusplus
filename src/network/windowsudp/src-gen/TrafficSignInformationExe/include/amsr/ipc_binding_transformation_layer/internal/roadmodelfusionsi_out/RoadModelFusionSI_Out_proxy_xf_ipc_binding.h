 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/ipc_binding_transformation_layer/internal/roadmodelfusionsi_out/RoadModelFusionSI_Out_proxy_xf_ipc_binding.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_PROXY_XF_IPC_BINDING_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_PROXY_XF_IPC_BINDING_H_
...
#include <map>
#include <utility>
#include "amsr/ipc_binding_transformation_layer/internal/roadmodelfusionsi_out/RoadModelFusionSI_Out_proxy_xf_ipc_events.h"
...
/*!
 * \brief Required service interface deployment of service interface 'RoadModelFusionSI_Out'.
 * \unit  ProxyInstance
 */
class RoadModelFusionSI_OutProxyXf final
    : public ::roadmodelfusionsi_out::internal::RoadModelFusionSI_OutProxyBackendInterface,
 ...
 public:
  ...
  /*!
   * \brief         Constructor of ProxyXf for service 'RoadModelFusionSI_Out'.
   ...
   *                                                RoadModelFusionSI_OutProxyXf's entire life time.
   ...
   * \synchronous TRUE
   */
  ~RoadModelFusionSI_OutProxyXf() noexcept final;

  RoadModelFusionSI_OutProxyXf(RoadModelFusionSI_OutProxyXf const &) = delete;
  RoadModelFusionSI_OutProxyXf &operator=(RoadModelFusionSI_OutProxyXf const &) = delete;
  RoadModelFusionSI_OutProxyXf(RoadModelFusionSI_OutProxyXf &&) = delete;
  RoadModelFusionSI_OutProxyXf &operator=(RoadModelFusionSI_OutProxyXf &&) = delete;
 ...
 // ---- Events ---------------------------------------------------------------------------------------------------
  ...
  /*!
   * \brief       Getter function for the event 'RMF_Bus_RMFInfo'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_RMFInfo& GetEventBackendRMF_Bus_RMFInfo() noexcept final;

  /*!
   * \brief       Getter function for the event 'RMF_Bus_MapInfo'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_MapInfo& GetEventBackendRMF_Bus_MapInfo() noexcept final;

  /*!
   * \brief       Getter function for the event 'RMF_Bus_VectorMapInfo'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_VectorMapInfo& GetEventBackendRMF_Bus_VectorMapInfo() noexcept final;

  /*!
   * \brief       Getter function for the event 'RMF_Bus_Position'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_Position& GetEventBackendRMF_Bus_Position() noexcept final;
 ...
 private:
  ...
  /*!
   * \brief Event backend for proxy event 'RMF_Bus_RMFInfo'.
   */
  RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_RMFInfo event_backend_RMF_Bus_RMFInfo_;

  /*!
   * \brief Event backend for proxy event 'RMF_Bus_MapInfo'.
   */
  RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_MapInfo event_backend_RMF_Bus_MapInfo_;

  /*!
   * \brief Event backend for proxy event 'RMF_Bus_VectorMapInfo'.
   */
  RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_VectorMapInfo event_backend_RMF_Bus_VectorMapInfo_;

  /*!
   * \brief Event backend for proxy event 'RMF_Bus_Position'.
   */
  RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_Position event_backend_RMF_Bus_Position_;
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_PROXY_XF_IPC_BINDING_H_
