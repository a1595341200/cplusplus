 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/someip_protocol/internal/datatype_deserialization/LaneMkrTempCam1VccIDT/deserializer_LaneMkrTempCam1VccIDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'LaneMkrTempCam1VccIDT'
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRTEMPCAM1VCCIDT_DESERIALIZER_LANEMKRTEMPCAM1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRTEMPCAM1VCCIDT_DESERIALIZER_LANEMKRTEMPCAM1VCCIDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/LaneMkrTempCam1VccIDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/LaneMkrTempCam1VccIDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::LaneMkrTempCam1VccIDT::LaneMkrTempCam1VccIDT &data) noexcept {
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/LaneMkrTempCam1VccIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::LaneMkrTempCam1VccIDT::LaneMkrTempCam1VccIDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRTEMPCAM1VCCIDT_DESERIALIZER_LANEMKRTEMPCAM1VCCIDT_H_
