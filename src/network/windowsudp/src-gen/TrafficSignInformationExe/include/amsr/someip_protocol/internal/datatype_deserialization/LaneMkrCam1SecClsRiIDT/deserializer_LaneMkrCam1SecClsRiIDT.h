 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/someip_protocol/internal/datatype_deserialization/LaneMkrCam1SecClsRiIDT/deserializer_LaneMkrCam1SecClsRiIDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'LaneMkrCam1SecClsRiIDT'
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRCAM1SECCLSRIIDT_DESERIALIZER_LANEMKRCAM1SECCLSRIIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRCAM1SECCLSRIIDT_DESERIALIZER_LANEMKRCAM1SECCLSRIIDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::LaneMkrCam1SecClsRiIDT::LaneMkrCam1SecClsRiIDT &data) noexcept {
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::LaneMkrCam1SecClsRiIDT::LaneMkrCam1SecClsRiIDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRCAM1SECCLSRIIDT_DESERIALIZER_LANEMKRCAM1SECCLSRIIDT_H_
