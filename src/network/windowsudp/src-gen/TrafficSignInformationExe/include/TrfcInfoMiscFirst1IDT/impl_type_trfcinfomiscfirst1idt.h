 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/TrfcInfoMiscFirst1IDT/impl_type_trfcinfomiscfirst1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
