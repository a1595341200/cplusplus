 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/WipgSpdInfo1VccIDT/impl_type_wipgspdinfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
