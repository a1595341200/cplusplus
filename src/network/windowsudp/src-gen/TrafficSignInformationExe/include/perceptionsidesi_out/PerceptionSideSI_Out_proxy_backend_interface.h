 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/perceptionsidesi_out/PerceptionSideSI_Out_proxy_backend_interface.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_BACKEND_INTERFACE_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_BACKEND_INTERFACE_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_BACKEND_INTERFACE_H_
