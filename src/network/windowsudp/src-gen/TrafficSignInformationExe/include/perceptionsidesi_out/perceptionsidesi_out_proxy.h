 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/perceptionsidesi_out/perceptionsidesi_out_proxy.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_H_
