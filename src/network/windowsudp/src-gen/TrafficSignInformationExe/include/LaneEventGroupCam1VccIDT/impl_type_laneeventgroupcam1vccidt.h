 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/LaneEventGroupCam1VccIDT/impl_type_laneeventgroupcam1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
