 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/TrafficInfoIDT/impl_type_trafficinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
