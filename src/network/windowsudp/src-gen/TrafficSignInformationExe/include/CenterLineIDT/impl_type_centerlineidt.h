 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/CenterLineIDT/impl_type_centerlineidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_CENTERLINEIDT_IMPL_TYPE_CENTERLINEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_CENTERLINEIDT_IMPL_TYPE_CENTERLINEIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_CENTERLINEIDT_IMPL_TYPE_CENTERLINEIDT_H_
