...
TrafficSignInformationSI_OutSkeleton::TrafficSignInformationSI_OutSkeleton(::ara::com::InstanceIdentifier instance,
     ...
     : TrafficSignInformationSI_OutSkeleton{Preconstruct(instance, mode).Value()} {}  // VCA_SOCAL_COPY_CTOR_WITH_CTOR_ARGUMENT

TrafficSignInformationSI_OutSkeleton::TrafficSignInformationSI_OutSkeleton(::ara::core::InstanceSpecifier instance,
                                               ::ara::com::MethodCallProcessingMode mode) noexcept
     : TrafficSignInformationSI_OutSkeleton{Preconstruct(instance, mode).Value()} {}
...
TrafficSignInformationSI_OutSkeleton::TrafficSignInformationSI_OutSkeleton(::ara::com::InstanceIdentifierContainer instance_identifiers,
     ...
     : TrafficSignInformationSI_OutSkeleton{Preconstruct(instance_identifiers, mode).Value()} {}
...
void TrafficSignInformationSI_OutSkeleton::SendInitialFieldNotifications(SkeletonImplInterfacePtr const concrete_impl_interface) const noexcept {
...
void TrafficSignInformationSI_OutSkeleton::PrepareEventsAndFieldNotifiers(SkeletonImplInterfacePtr const concrete_impl_interface) noexcept {
   TSI_Bus_HMIData.InitializePreallocatedValue(concrete_impl_interface);
