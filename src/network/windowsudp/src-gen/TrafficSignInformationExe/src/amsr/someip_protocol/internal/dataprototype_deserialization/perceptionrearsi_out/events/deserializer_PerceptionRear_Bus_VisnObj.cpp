 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionrearsi_out/events/deserializer_PerceptionRear_Bus_VisnObj.cpp
...
deserialization::Result DeserializerPerceptionRear_Bus_VisnObj::Deserialize(deserialization::Reader &reader, ::Array_VisObjIDT_20::Array_VisObjIDT_20 &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionRearSI_Out/PerceptionRear_Bus_VisnObj
