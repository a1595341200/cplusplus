 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/roadmodelfusionsi_out/events/deserializer_RMF_Bus_MapInfo.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/RMFMapInfoIDT/deserializer_RMFMapInfoIDT.h"
...
deserialization::Result DeserializerRMF_Bus_MapInfo::Deserialize(deserialization::Reader &reader, ::RMFMapInfoIDT::RMFMapInfoIDT &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/RoadModelFusionSI_Out/RMF_Bus_MapInfo
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::RMFMapInfoIDT::RMFMapInfoIDT>{})};
