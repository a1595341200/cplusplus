...
class LifecycleManager final {
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    rtk_r::proxy::Rtk_ReceiveProxy::RegisterServiceDiscovery(&rtk_receive_proxy_sd_0_);

    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    rtk_p::skeleton::Rtk_ProvideSkeleton::RegisterServiceDiscovery(&rtk_provide_skeleton_sd_0_);
  }
  ...
  ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      rtk_r::internal::Rtk_ReceiveProxyBackendInterface> rtk_receive_proxy_sd_0_{rtk_r::Rtk_Receive::kServiceShortNamePath};
   ...
   *        for the service interface rtk_p::Rtk_Provide.
   */
  rtk_p::skeleton::Rtk_ProvideSkeleton::ServiceDiscovery rtk_provide_skeleton_sd_0_{rtk_p::Rtk_Provide::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr
