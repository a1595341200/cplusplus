 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RtkExe/src/amsr/someip_binding_xf/internal/rtk_p/Rtk_Provide_skeleton_xf.cpp
...
Rtk_ProvideSkeletonXf::Rtk_ProvideSkeletonXf(
...
bool Rtk_ProvideSkeletonXf::HandleMethodRequest(
...
events::skeleton::GgaData_provide::Rtk_ProvideSkeletonSomeIpEventManagerGgaData_provide* Rtk_ProvideSkeletonXf::GetEventManagerGgaData_provide() noexcept {
  return &event_manager_GgaData_provide_;
} // COV_SOMEIPBINDING_SKELETON_XF

// Event 'ErrorCode'
events::skeleton::ErrorCode::Rtk_ProvideSkeletonSomeIpEventManagerErrorCode* Rtk_ProvideSkeletonXf::GetEventManagerErrorCode() noexcept {
