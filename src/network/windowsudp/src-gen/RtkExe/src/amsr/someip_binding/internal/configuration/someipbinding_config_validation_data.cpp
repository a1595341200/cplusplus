 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RtkExe/src/amsr/someip_binding/internal/configuration/someipbinding_config_validation_data.cpp
...
{"/JICA/Service/Interface/Rtk_Provide"_sv,
     ConfigValidationDataAccess{
      &::amsr::someip_binding::internal::configuration::gen_rtk_p::Rtk_ProvideConfigValidationData::kValidEventConfigurationEntities[0],
      2,
      nullptr,
      0,
      nullptr,
