 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/SpplTrfcSgnInfo1IDT/impl_type_sppltrfcsgninfo1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
