...
class LifecycleManager final {
 public:
  ...
  static void Initialize() noexcept {
    ...
    perceptionsidesi_out::skeleton::PerceptionSideSI_OutSkeleton::CreateSingletons();
  ...
  static void Deinitialize() noexcept {
    ...
    perceptionsidesi_out::skeleton::PerceptionSideSI_OutSkeleton::DestroySingletons();
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    perceptionsidesi_out::skeleton::PerceptionSideSI_OutSkeleton::RegisterServiceDiscovery(&perceptionsidesi_out_skeleton_sd_0_);
  }
  ...
  void DeInitializeServiceDiscovery() noexcept {
    ...
    perceptionsidesi_out::skeleton::PerceptionSideSI_OutSkeleton::DeRegisterServiceDiscovery();
  }
   ...
   */
  perceptionsidesi_out::skeleton::PerceptionSideSI_OutSkeleton::ServiceDiscovery perceptionsidesi_out_skeleton_sd_0_{perceptionsidesi_out::PerceptionSideSI_Out::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr
