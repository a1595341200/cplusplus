 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/VisObjIDT/impl_type_visobjidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
