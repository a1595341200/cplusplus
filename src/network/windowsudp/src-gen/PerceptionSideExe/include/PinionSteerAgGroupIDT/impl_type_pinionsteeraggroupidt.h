 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/PinionSteerAgGroupIDT/impl_type_pinionsteeraggroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
