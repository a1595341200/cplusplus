 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/src/amsr/someip_binding_xf/internal/perceptionsidesi_out/PerceptionSideSI_Out_skeleton_xf.cpp
...
PerceptionSideSI_OutSkeletonXf::PerceptionSideSI_OutSkeletonXf(
...
bool PerceptionSideSI_OutSkeletonXf::HandleMethodRequest(
...
events::skeleton::FRCam_Bus_VisnObj::PerceptionSideSI_OutSkeletonSomeIpEventManagerFRCam_Bus_VisnObj* PerceptionSideSI_OutSkeletonXf::GetEventManagerFRCam_Bus_VisnObj() noexcept {
  return &event_manager_FRCam_Bus_VisnObj_;
} // COV_SOMEIPBINDING_SKELETON_XF

// Event 'FLCam_Bus_VisnObj'
events::skeleton::FLCam_Bus_VisnObj::PerceptionSideSI_OutSkeletonSomeIpEventManagerFLCam_Bus_VisnObj* PerceptionSideSI_OutSkeletonXf::GetEventManagerFLCam_Bus_VisnObj() noexcept {
  return &event_manager_FLCam_Bus_VisnObj_;
} // COV_SOMEIPBINDING_SKELETON_XF

// Event 'RLCam_Bus_VisnObj'
events::skeleton::RLCam_Bus_VisnObj::PerceptionSideSI_OutSkeletonSomeIpEventManagerRLCam_Bus_VisnObj* PerceptionSideSI_OutSkeletonXf::GetEventManagerRLCam_Bus_VisnObj() noexcept {
  return &event_manager_RLCam_Bus_VisnObj_;
} // COV_SOMEIPBINDING_SKELETON_XF

// Event 'RRCam_Bus_VisnObj'
events::skeleton::RRCam_Bus_VisnObj::PerceptionSideSI_OutSkeletonSomeIpEventManagerRRCam_Bus_VisnObj* PerceptionSideSI_OutSkeletonXf::GetEventManagerRRCam_Bus_VisnObj() noexcept {
  return &event_manager_RRCam_Bus_VisnObj_;
} // COV_SOMEIPBINDING_SKELETON_XF

// Event 'PerceptionSide_Bus_CameraStatus'
events::skeleton::PerceptionSide_Bus_CameraStatus::PerceptionSideSI_OutSkeletonSomeIpEventManagerPerceptionSide_Bus_CameraStatus* PerceptionSideSI_OutSkeletonXf::GetEventManagerPerceptionSide_Bus_CameraStatus() noexcept {
  return &event_manager_PerceptionSide_Bus_CameraStatus_;
} // COV_SOMEIPBINDING_SKELETON_XF
