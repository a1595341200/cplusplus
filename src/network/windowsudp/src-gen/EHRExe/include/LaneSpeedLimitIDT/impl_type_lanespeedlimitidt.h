 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LaneSpeedLimitIDT/impl_type_lanespeedlimitidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LANESPEEDLIMITIDT_IMPL_TYPE_LANESPEEDLIMITIDT_H_
#define EHREXE_INCLUDE_LANESPEEDLIMITIDT_IMPL_TYPE_LANESPEEDLIMITIDT_H_
...
#endif  // EHREXE_INCLUDE_LANESPEEDLIMITIDT_IMPL_TYPE_LANESPEEDLIMITIDT_H_
