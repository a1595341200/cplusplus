 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/NavigationStatusIDT/impl_type_navigationstatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_NAVIGATIONSTATUSIDT_IMPL_TYPE_NAVIGATIONSTATUSIDT_H_
#define EHREXE_INCLUDE_NAVIGATIONSTATUSIDT_IMPL_TYPE_NAVIGATIONSTATUSIDT_H_
...
#endif  // EHREXE_INCLUDE_NAVIGATIONSTATUSIDT_IMPL_TYPE_NAVIGATIONSTATUSIDT_H_
