...
class LifecycleManager final {
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    ehrsi_out::skeleton::EHRSI_OutSkeleton::RegisterServiceDiscovery(&ehrsi_out_skeleton_sd_0_);
  }
   ...
   *        for the service interface ehrsi_out::EHRSI_Out.
   */
  ehrsi_out::skeleton::EHRSI_OutSkeleton::ServiceDiscovery ehrsi_out_skeleton_sd_0_{ehrsi_out::EHRSI_Out::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr
