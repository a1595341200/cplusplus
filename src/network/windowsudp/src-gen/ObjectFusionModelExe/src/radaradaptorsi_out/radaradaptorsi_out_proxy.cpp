...
RadarAdaptorSI_OutProxy::RadarAdaptorSI_OutProxy(ConstructionToken&& token) noexcept
  : Base{std::move(token)},
    ...
    FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp{&(Base::GetProxyBackend().GetEventBackendFourDRadarObjStsGAPGrp_FourDRadarObjStsGrp()), "RadarAdaptorSI_Out", "FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp", Base::GetProvidedInstanceId().GetAraComInstanceIdentifier()}    {}
  // VCA Enable : VCA_SOCAL_GENERATED_PROXY_GET_BACKEND_REF

// ====================== Proxy constructor ======================
RadarAdaptorSI_OutProxy::RadarAdaptorSI_OutProxy(
  RadarAdaptorSI_OutProxy::HandleType const& handle) noexcept
  : RadarAdaptorSI_OutProxy{Preconstruct(handle).Value()} {}

// ============================= Proxy destructor =============================
RadarAdaptorSI_OutProxy::~RadarAdaptorSI_OutProxy() noexcept {  // VCA_SOCAL_DESTRUCTOR_STATIC_MEMORY
  // Start cleanup of proxy by unsubscribing all event and field notifications
  // Events
  FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp.Unsubscribe();
  FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp.UnsetReceiveHandler();
  FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp.UnsetSubscriptionStateHandler();
