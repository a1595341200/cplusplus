 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/tosoca_siderdrfusedtargetssi/events/deserializer_OSM2_TOSOCA_SideRdrFusedTargets1.cpp
...
deserialization::Result DeserializerOSM2_TOSOCA_SideRdrFusedTargets1::Deserialize(deserialization::Reader &reader, ::Array_TOSOCATFMObjGroupIDT_8::Array_TOSOCATFMObjGroupIDT_8 &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/TOSOCA_SideRdrFusedTargetsSI/OSM2_TOSOCA_SideRdrFusedTargets1
