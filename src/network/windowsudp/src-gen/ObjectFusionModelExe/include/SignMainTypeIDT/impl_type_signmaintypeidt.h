 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/SignMainTypeIDT/impl_type_signmaintypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
