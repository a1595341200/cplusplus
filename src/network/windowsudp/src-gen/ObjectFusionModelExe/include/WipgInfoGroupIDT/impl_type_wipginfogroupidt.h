 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/WipgInfoGroupIDT/impl_type_wipginfogroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
