 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/PerceptionLaneInfoIDT/impl_type_perceptionlaneinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
