 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/TjaTrailBusIDT/impl_type_tjatrailbusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
