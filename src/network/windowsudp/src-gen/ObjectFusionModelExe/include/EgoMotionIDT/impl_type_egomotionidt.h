 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/EgoMotionIDT/impl_type_egomotionidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
