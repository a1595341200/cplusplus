 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/RoadEdge1VccLeIDT/impl_type_roadedge1vccleidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
