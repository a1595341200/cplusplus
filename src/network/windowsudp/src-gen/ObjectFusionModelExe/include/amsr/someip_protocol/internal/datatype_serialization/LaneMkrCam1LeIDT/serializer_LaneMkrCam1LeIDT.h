 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/amsr/someip_protocol/internal/datatype_serialization/LaneMkrCam1LeIDT/serializer_LaneMkrCam1LeIDT.h
 *        \brief  SOME/IP protocol serializer implementation for datatype 'LaneMkrCam1LeIDT'
 *
 *      \details  /CppImplementationDataTypes/LaneMkrCam1LeIDT
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1LEIDT_SERIALIZER_LANEMKRCAM1LEIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1LEIDT_SERIALIZER_LANEMKRCAM1LEIDT_H_
...
namespace LaneMkrCam1LeIDT {

/*!
 * \brief Serializer for datatype /CppImplementationDataTypes/LaneMkrCam1LeIDT.
 ...
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1LeIDT to be serialized.
...
void SomeIpProtocolSerialize(amsr::someip_protocol::internal::serialization::Writer& writer, ::LaneMkrCam1LeIDT::LaneMkrCam1LeIDT const &data) noexcept {
...
/*!
 * \brief Calculates the required buffer size for datatype /CppImplementationDataTypes/LaneMkrCam1LeIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1LeIDT.
 ...
 */
template <typename TpPack>
constexpr std::size_t GetRequiredBufferSize(::LaneMkrCam1LeIDT::LaneMkrCam1LeIDT const &data) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/LaneMkrCam1LeIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 ...
 * \endspec
 */
template <typename T, typename TpPack, std::enable_if_t<std::is_same<T, ::LaneMkrCam1LeIDT::LaneMkrCam1LeIDT>::value, bool> = true>
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/LaneMkrCam1LeIDT. For ADL.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr amsr::someip_protocol::internal::serialization::InfSizeT GetMaximumBufferSize(::LaneMkrCam1LeIDT::LaneMkrCam1LeIDT const&) noexcept {
  return GetMaximumBufferSize<::LaneMkrCam1LeIDT::LaneMkrCam1LeIDT, TpPack>();
}

/*!
 * \brief Checks if datatype /CppImplementationDataTypes/LaneMkrCam1LeIDT is of static size.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr bool IsStaticSize(amsr::someip_protocol::internal::serialization::SizeToken<::LaneMkrCam1LeIDT::LaneMkrCam1LeIDT>) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1LEIDT_SERIALIZER_LANEMKRCAM1LEIDT_H_
