 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/amsr/someip_protocol/internal/datatype_deserialization/FrontFourDRadarSts1VccIDT/deserializer_FrontFourDRadarSts1VccIDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'FrontFourDRadarSts1VccIDT'
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_FRONTFOURDRADARSTS1VCCIDT_DESERIALIZER_FRONTFOURDRADARSTS1VCCIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_FRONTFOURDRADARSTS1VCCIDT_DESERIALIZER_FRONTFOURDRADARSTS1VCCIDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/FrontFourDRadarSts1VccIDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/FrontFourDRadarSts1VccIDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::FrontFourDRadarSts1VccIDT::FrontFourDRadarSts1VccIDT &data) noexcept {
  ...
  // Deserialize struct member 'FourDRdrStsTiStampH' of type /CppImplementationDataTypes/float
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
        ...
        >(reader, data.FourDRdrStsTiStampH);
  }

  // Deserialize struct member 'FourDRdrStsTiStampL' of type /CppImplementationDataTypes/float
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
        ...
        >(reader, data.FourDRdrStsTiStampL);
  }
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/FrontFourDRadarSts1VccIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::FrontFourDRadarSts1VccIDT::FrontFourDRadarSts1VccIDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_FRONTFOURDRADARSTS1VCCIDT_DESERIALIZER_FRONTFOURDRADARSTS1VCCIDT_H_
