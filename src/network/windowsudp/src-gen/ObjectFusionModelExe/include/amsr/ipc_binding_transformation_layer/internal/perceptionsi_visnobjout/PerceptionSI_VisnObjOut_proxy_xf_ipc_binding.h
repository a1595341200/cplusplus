 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/amsr/ipc_binding_transformation_layer/internal/perceptionsi_visnobjout/PerceptionSI_VisnObjOut_proxy_xf_ipc_binding.h
 *        \brief  Frame for IPC binding service instance class of service 'PerceptionSI_VisnObjOut'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_PROXY_XF_IPC_BINDING_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_PROXY_XF_IPC_BINDING_H_
...
#include <map>
#include <utility>
#include "amsr/ipc_binding_transformation_layer/internal/perceptionsi_visnobjout/PerceptionSI_VisnObjOut_proxy_xf_ipc_events.h"
...
/*!
 * \brief Required service interface deployment of service interface 'PerceptionSI_VisnObjOut'.
 * \unit  ProxyInstance
 */
class PerceptionSI_VisnObjOutProxyXf final
    : public ::perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutProxyBackendInterface,
 ...
 public:
  ...
  /*!
   * \brief         Constructor of ProxyXf for service 'PerceptionSI_VisnObjOut'.
   ...
   *                                                PerceptionSI_VisnObjOutProxyXf's entire life time.
   ...
   * \context       App
   */
   PerceptionSI_VisnObjOutProxyXf(
   ...
   * \synchronous TRUE
   */
  ~PerceptionSI_VisnObjOutProxyXf() noexcept final;

  PerceptionSI_VisnObjOutProxyXf(PerceptionSI_VisnObjOutProxyXf const &) = delete;
  PerceptionSI_VisnObjOutProxyXf &operator=(PerceptionSI_VisnObjOutProxyXf const &) = delete;
  PerceptionSI_VisnObjOutProxyXf(PerceptionSI_VisnObjOutProxyXf &&) = delete;
  PerceptionSI_VisnObjOutProxyXf &operator=(PerceptionSI_VisnObjOutProxyXf &&) = delete;
 ...
 // ---- Events ---------------------------------------------------------------------------------------------------
  ...
  /*!
   * \brief       Getter function for the event 'FrntCam_Bus_VisnObj'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_VisnObjOutProxyXfEventBackendFrntCam_Bus_VisnObj& GetEventBackendFrntCam_Bus_VisnObj() noexcept final;

  /*!
   * \brief       Getter function for the event 'FrntCam_Bus_UnfilteredObj'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSI_VisnObjOutProxyXfEventBackendFrntCam_Bus_UnfilteredObj& GetEventBackendFrntCam_Bus_UnfilteredObj() noexcept final;
 ...
 private:
  ...
  /*!
   * \brief Event backend for proxy event 'FrntCam_Bus_VisnObj'.
   */
  PerceptionSI_VisnObjOutProxyXfEventBackendFrntCam_Bus_VisnObj event_backend_FrntCam_Bus_VisnObj_;

  /*!
   * \brief Event backend for proxy event 'FrntCam_Bus_UnfilteredObj'.
   */
  PerceptionSI_VisnObjOutProxyXfEventBackendFrntCam_Bus_UnfilteredObj event_backend_FrntCam_Bus_UnfilteredObj_;
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_PROXY_XF_IPC_BINDING_H_
