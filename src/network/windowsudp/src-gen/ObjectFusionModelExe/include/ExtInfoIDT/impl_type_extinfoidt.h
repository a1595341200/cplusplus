 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/ExtInfoIDT/impl_type_extinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
