 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/SwtIndcr1VccIDT/impl_type_swtindcr1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_SWTINDCR1VCCIDT_IMPL_TYPE_SWTINDCR1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_SWTINDCR1VCCIDT_IMPL_TYPE_SWTINDCR1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_SWTINDCR1VCCIDT_IMPL_TYPE_SWTINDCR1VCCIDT_H_
