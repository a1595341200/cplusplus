 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/VectorMapInfoIDT/impl_type_vectormapinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_VECTORMAPINFOIDT_IMPL_TYPE_VECTORMAPINFOIDT_H_
#define TARGETPREDICTEXE_INCLUDE_VECTORMAPINFOIDT_IMPL_TYPE_VECTORMAPINFOIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_VECTORMAPINFOIDT_IMPL_TYPE_VECTORMAPINFOIDT_H_
