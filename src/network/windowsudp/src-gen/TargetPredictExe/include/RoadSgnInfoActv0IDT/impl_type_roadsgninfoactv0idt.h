 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/RoadSgnInfoActv0IDT/impl_type_roadsgninfoactv0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
#define TARGETPREDICTEXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_ROADSGNINFOACTV0IDT_IMPL_TYPE_ROADSGNINFOACTV0IDT_H_
