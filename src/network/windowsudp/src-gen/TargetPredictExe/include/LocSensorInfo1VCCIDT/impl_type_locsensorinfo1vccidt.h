 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/LocSensorInfo1VCCIDT/impl_type_locsensorinfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_LOCSENSORINFO1VCCIDT_IMPL_TYPE_LOCSENSORINFO1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_LOCSENSORINFO1VCCIDT_IMPL_TYPE_LOCSENSORINFO1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_LOCSENSORINFO1VCCIDT_IMPL_TYPE_LOCSENSORINFO1VCCIDT_H_
