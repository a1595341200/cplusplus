 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/DrvrSteerActv1VccIDT/impl_type_drvrsteeractv1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_DRVRSTEERACTV1VCCIDT_IMPL_TYPE_DRVRSTEERACTV1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_DRVRSTEERACTV1VCCIDT_IMPL_TYPE_DRVRSTEERACTV1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_DRVRSTEERACTV1VCCIDT_IMPL_TYPE_DRVRSTEERACTV1VCCIDT_H_
