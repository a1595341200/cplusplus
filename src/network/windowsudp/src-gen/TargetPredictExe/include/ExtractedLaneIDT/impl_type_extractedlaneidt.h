 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/ExtractedLaneIDT/impl_type_extractedlaneidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_EXTRACTEDLANEIDT_IMPL_TYPE_EXTRACTEDLANEIDT_H_
#define TARGETPREDICTEXE_INCLUDE_EXTRACTEDLANEIDT_IMPL_TYPE_EXTRACTEDLANEIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_EXTRACTEDLANEIDT_IMPL_TYPE_EXTRACTEDLANEIDT_H_
