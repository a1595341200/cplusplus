 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/VehSpdLgtSafe1ChkdIDT/impl_type_vehspdlgtsafe1chkdidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
#define TARGETPREDICTEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_VEHSPDLGTSAFE1CHKDIDT_IMPL_TYPE_VEHSPDLGTSAFE1CHKDIDT_H_
