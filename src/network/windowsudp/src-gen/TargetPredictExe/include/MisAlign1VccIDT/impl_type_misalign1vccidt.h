 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/MisAlign1VccIDT/impl_type_misalign1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_MISALIGN1VCCIDT_IMPL_TYPE_MISALIGN1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_MISALIGN1VCCIDT_IMPL_TYPE_MISALIGN1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_MISALIGN1VCCIDT_IMPL_TYPE_MISALIGN1VCCIDT_H_
