 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/LppLaneChgStsIDT/impl_type_lpplanechgstsidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
#define TARGETPREDICTEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
