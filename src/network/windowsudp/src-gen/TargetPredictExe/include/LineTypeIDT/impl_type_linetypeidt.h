 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/LineTypeIDT/impl_type_linetypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_LINETYPEIDT_IMPL_TYPE_LINETYPEIDT_H_
#define TARGETPREDICTEXE_INCLUDE_LINETYPEIDT_IMPL_TYPE_LINETYPEIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_LINETYPEIDT_IMPL_TYPE_LINETYPEIDT_H_
