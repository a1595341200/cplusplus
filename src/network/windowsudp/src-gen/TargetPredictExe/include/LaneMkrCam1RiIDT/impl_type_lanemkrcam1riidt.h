 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/LaneMkrCam1RiIDT/impl_type_lanemkrcam1riidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
#define TARGETPREDICTEXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
