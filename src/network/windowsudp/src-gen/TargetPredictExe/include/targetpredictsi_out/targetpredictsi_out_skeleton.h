 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/targetpredictsi_out/targetpredictsi_out_skeleton.h
...
#ifndef TARGETPREDICTEXE_INCLUDE_TARGETPREDICTSI_OUT_TARGETPREDICTSI_OUT_SKELETON_H_
#define TARGETPREDICTEXE_INCLUDE_TARGETPREDICTSI_OUT_TARGETPREDICTSI_OUT_SKELETON_H_
...
#include "targetpredictsi_out/TargetPredictSI_Out_skeleton_impl_interface.h"
#include "targetpredictsi_out/TargetPredictSI_Out_types.h"
 ...
 */
class TargetPredictSI_OutSkeleton;
...
/*!
 * \brief Type alias for service event 'TP_Bus_PredTargets1Vcc', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using TP_Bus_PredTargets1Vcc = ::amsr::socal::events::SkeletonEvent<
    targetpredictsi_out::skeleton::TargetPredictSI_OutSkeleton,
    ::Array_ObjPredictIDT_8::Array_ObjPredictIDT_8,
    targetpredictsi_out::internal::TargetPredictSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_ObjPredictIDT_8::Array_ObjPredictIDT_8>,
    &targetpredictsi_out::internal::TargetPredictSI_OutSkeletonImplInterface::GetEventManagerTP_Bus_PredTargets1Vcc>;

/*!
 * \brief Type alias for service event 'TP_Bus_PredTargets2Vcc', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using TP_Bus_PredTargets2Vcc = ::amsr::socal::events::SkeletonEvent<
    targetpredictsi_out::skeleton::TargetPredictSI_OutSkeleton,
    ::Array_ObjPredictIDT_8::Array_ObjPredictIDT_8,
    targetpredictsi_out::internal::TargetPredictSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_ObjPredictIDT_8::Array_ObjPredictIDT_8>,
    &targetpredictsi_out::internal::TargetPredictSI_OutSkeletonImplInterface::GetEventManagerTP_Bus_PredTargets2Vcc>;
...
/*!
 * \brief Skeleton interface class for the service 'TargetPredictSI_Out'.
 *
 * \vpublic
 * \trace SPEC-4980341
...
class TargetPredictSI_OutSkeleton
    : public ::amsr::socal::Skeleton<targetpredictsi_out::TargetPredictSI_Out,
                                          targetpredictsi_out::internal::TargetPredictSI_OutSkeletonImplInterface,
                                          ::amsr::socal::kRuntimeProcessingMode>,
      public       targetpredictsi_out::internal::TargetPredictSI_OutSkeletonBackendInterface {
 public:
// ---- Constructors / Destructors -----------------------------------------------------------------------------------
/*!
 * \brief Exception-less pre-construction of TargetPredictSI_Out.
 *
...
/*!
 * \brief Exception-less pre-construction of TargetPredictSI_OutSkeleton.
 *
...
/*!
 * \brief Exception-less constructor of TargetPredictSI_OutSkeleton.
 ...
 * \trace SPEC-8053555
 */
explicit TargetPredictSI_OutSkeleton(ConstructionToken&& token) noexcept;

  /*!
   * \brief Delete default constructor.
   */
  TargetPredictSI_OutSkeleton() = delete;
  /*!
   * \brief Delete copy constructor.
   */
  TargetPredictSI_OutSkeleton(TargetPredictSI_OutSkeleton const &) = delete;
  /*!
   * \brief Delete move constructor.
   */
  TargetPredictSI_OutSkeleton(TargetPredictSI_OutSkeleton &&) = delete;
  /*!
   * \brief Delete copy assignment.
   */
  TargetPredictSI_OutSkeleton &operator=(TargetPredictSI_OutSkeleton const &) & = delete;
  /*!
   * \brief Delete move assignment.
   */
  TargetPredictSI_OutSkeleton &operator=(TargetPredictSI_OutSkeleton &&) & = delete;

  /*!
   * \brief Constructor of TargetPredictSI_OutSkeleton.
   *
   ...
   * \trace SPEC-4980356
   */
   explicit TargetPredictSI_OutSkeleton(
   ...
   * \endspec
   */
  ~TargetPredictSI_OutSkeleton() noexcept override;

  /*!
   * \brief Type alias for ServiceDiscovery.
   */
  using ServiceDiscovery = ::amsr::socal::internal::service_discovery::ServiceDiscovery<TargetPredictSI_OutSkeleton>;
  ...
  /*!
   * \brief The skeleton event 'TP_Bus_PredTargets1Vcc' which can be used by application developer.
   * \details 
   * Data of type ::Array_ObjPredictIDT_8::Array_ObjPredictIDT_8
   * \vpublic
   */
  events::TP_Bus_PredTargets1Vcc TP_Bus_PredTargets1Vcc;

  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'TP_Bus_PredTargets2Vcc' which can be used by application developer.
   * \details 
   * Data of type ::Array_ObjPredictIDT_8::Array_ObjPredictIDT_8
   * \vpublic
   */
  events::TP_Bus_PredTargets2Vcc TP_Bus_PredTargets2Vcc;
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<targetpredictsi_out::TargetPredictSI_Out, targetpredictsi_out::internal::TargetPredictSI_OutSkeletonImplInterface, ::amsr::socal::kRuntimeProcessingMode>;
...
#endif  // TARGETPREDICTEXE_INCLUDE_TARGETPREDICTSI_OUT_TARGETPREDICTSI_OUT_SKELETON_H_
