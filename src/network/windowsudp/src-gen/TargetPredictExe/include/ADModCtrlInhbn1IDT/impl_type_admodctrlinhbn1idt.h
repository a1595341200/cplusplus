 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/ADModCtrlInhbn1IDT/impl_type_admodctrlinhbn1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_ADMODCTRLINHBN1IDT_IMPL_TYPE_ADMODCTRLINHBN1IDT_H_
#define TARGETPREDICTEXE_INCLUDE_ADMODCTRLINHBN1IDT_IMPL_TYPE_ADMODCTRLINHBN1IDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_ADMODCTRLINHBN1IDT_IMPL_TYPE_ADMODCTRLINHBN1IDT_H_
