 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/roadmodelfusionsi_out/RoadModelFusionSI_Out_datatypes.h
...
#ifndef TARGETPREDICTEXE_INCLUDE_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_DATATYPES_H_
#define TARGETPREDICTEXE_INCLUDE_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_DATATYPES_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_DATATYPES_H_
