 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/CenterLineIDT/impl_type_centerlineidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_CENTERLINEIDT_IMPL_TYPE_CENTERLINEIDT_H_
#define TARGETPREDICTEXE_INCLUDE_CENTERLINEIDT_IMPL_TYPE_CENTERLINEIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_CENTERLINEIDT_IMPL_TYPE_CENTERLINEIDT_H_
