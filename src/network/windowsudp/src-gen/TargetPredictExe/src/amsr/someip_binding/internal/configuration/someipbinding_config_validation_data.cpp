 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/src/amsr/someip_binding/internal/configuration/someipbinding_config_validation_data.cpp
...
#include "amsr/someip_binding/internal/configuration/targetpredictsi_out/TargetPredictSI_Out_config_validation_data.h"
...
{"/JICA/Service/Interface/TargetPredictSI_Out"_sv,
     ConfigValidationDataAccess{
      &::amsr::someip_binding::internal::configuration::gen_targetpredictsi_out::TargetPredictSI_OutConfigValidationData::kValidEventConfigurationEntities[0],
      2,
      nullptr,
      0,
      nullptr,
