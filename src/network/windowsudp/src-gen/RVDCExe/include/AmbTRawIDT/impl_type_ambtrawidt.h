 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/AmbTRawIDT/impl_type_ambtrawidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_AMBTRAWIDT_IMPL_TYPE_AMBTRAWIDT_H_
#define RVDCEXE_INCLUDE_AMBTRAWIDT_IMPL_TYPE_AMBTRAWIDT_H_
...
#endif  // RVDCEXE_INCLUDE_AMBTRAWIDT_IMPL_TYPE_AMBTRAWIDT_H_
