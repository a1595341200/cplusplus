 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/ADModCtrlInhbn1IDT/impl_type_admodctrlinhbn1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_ADMODCTRLINHBN1IDT_IMPL_TYPE_ADMODCTRLINHBN1IDT_H_
#define RVDCEXE_INCLUDE_ADMODCTRLINHBN1IDT_IMPL_TYPE_ADMODCTRLINHBN1IDT_H_
...
#endif  // RVDCEXE_INCLUDE_ADMODCTRLINHBN1IDT_IMPL_TYPE_ADMODCTRLINHBN1IDT_H_
