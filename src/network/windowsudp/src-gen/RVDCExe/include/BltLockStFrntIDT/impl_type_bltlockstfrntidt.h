 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/BltLockStFrntIDT/impl_type_bltlockstfrntidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
#define RVDCEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
...
#endif  // RVDCEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
