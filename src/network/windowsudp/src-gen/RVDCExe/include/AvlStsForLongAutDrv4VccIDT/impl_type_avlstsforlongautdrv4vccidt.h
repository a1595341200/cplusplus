 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/AvlStsForLongAutDrv4VccIDT/impl_type_avlstsforlongautdrv4vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_AVLSTSFORLONGAUTDRV4VCCIDT_IMPL_TYPE_AVLSTSFORLONGAUTDRV4VCCIDT_H_
#define RVDCEXE_INCLUDE_AVLSTSFORLONGAUTDRV4VCCIDT_IMPL_TYPE_AVLSTSFORLONGAUTDRV4VCCIDT_H_
...
#endif  // RVDCEXE_INCLUDE_AVLSTSFORLONGAUTDRV4VCCIDT_IMPL_TYPE_AVLSTSFORLONGAUTDRV4VCCIDT_H_
