 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/TrfcLiActvStsIDT/impl_type_trfcliactvstsidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
#define RVDCEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
...
#endif  // RVDCEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
