 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/CurrentRoadLvl1VccIDT/impl_type_currentroadlvl1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_CURRENTROADLVL1VCCIDT_IMPL_TYPE_CURRENTROADLVL1VCCIDT_H_
#define RVDCEXE_INCLUDE_CURRENTROADLVL1VCCIDT_IMPL_TYPE_CURRENTROADLVL1VCCIDT_H_
...
#endif  // RVDCEXE_INCLUDE_CURRENTROADLVL1VCCIDT_IMPL_TYPE_CURRENTROADLVL1VCCIDT_H_
