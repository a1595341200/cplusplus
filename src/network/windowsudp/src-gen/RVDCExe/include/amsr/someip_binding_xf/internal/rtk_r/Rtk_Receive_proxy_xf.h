 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/amsr/someip_binding_xf/internal/rtk_r/Rtk_Receive_proxy_xf.h
...
#ifndef RVDCEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_RTK_R_RTK_RECEIVE_PROXY_XF_H_
#define RVDCEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_RTK_R_RTK_RECEIVE_PROXY_XF_H_
...
#endif  // RVDCEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_RTK_R_RTK_RECEIVE_PROXY_XF_H_
