 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/rtk_r/events/deserializer_GgaData_receive.cpp
...
deserialization::Result DeserializerGgaData_receive::Deserialize(deserialization::Reader &reader, ::SOMEIP::ValidationKey::GgaData &data) noexcept {
