 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/WhlInfoGroup/impl_type_whlinfogroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_WHLINFOGROUP_IMPL_TYPE_WHLINFOGROUP_H_
