 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/SpdAlrmActvForRoadSgnInfo0/impl_type_spdalrmactvforroadsgninfo0.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0_H_
