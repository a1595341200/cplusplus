 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/DynamicProperty/impl_type_dynamicproperty.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_DYNAMICPROPERTY_IMPL_TYPE_DYNAMICPROPERTY_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_DYNAMICPROPERTY_IMPL_TYPE_DYNAMICPROPERTY_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_DYNAMICPROPERTY_IMPL_TYPE_DYNAMICPROPERTY_H_
