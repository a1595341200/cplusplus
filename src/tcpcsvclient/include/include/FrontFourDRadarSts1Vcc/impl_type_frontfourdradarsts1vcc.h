 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/FrontFourDRadarSts1Vcc/impl_type_frontfourdradarsts1vcc.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_FRONTFOURDRADARSTS1VCC_IMPL_TYPE_FRONTFOURDRADARSTS1VCC_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_FRONTFOURDRADARSTS1VCC_IMPL_TYPE_FRONTFOURDRADARSTS1VCC_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_FRONTFOURDRADARSTS1VCC_IMPL_TYPE_FRONTFOURDRADARSTS1VCC_H_
