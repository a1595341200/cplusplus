 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/WipgSpdInfo/impl_type_wipgspdinfo.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
