 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/ToSOCA_FunctionInfo1VCC/impl_type_tosoca_functioninfo1vcc.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_FUNCTIONINFO1VCC_IMPL_TYPE_TOSOCA_FUNCTIONINFO1VCC_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_FUNCTIONINFO1VCC_IMPL_TYPE_TOSOCA_FUNCTIONINFO1VCC_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_FUNCTIONINFO1VCC_IMPL_TYPE_TOSOCA_FUNCTIONINFO1VCC_H_
