 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/EpbSts/impl_type_epbsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
