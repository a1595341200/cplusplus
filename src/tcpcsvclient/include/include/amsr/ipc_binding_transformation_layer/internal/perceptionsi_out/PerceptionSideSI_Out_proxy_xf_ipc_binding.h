 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/amsr/ipc_binding_transformation_layer/internal/perceptionsi_out/PerceptionSideSI_Out_proxy_xf_ipc_binding.h
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_OUT_PERCEPTIONSIDESI_OUT_PROXY_XF_IPC_BINDING_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_OUT_PERCEPTIONSIDESI_OUT_PROXY_XF_IPC_BINDING_H_
...
#include <map>
#include <utility>
#include "amsr/ipc_binding_transformation_layer/internal/perceptionsi_out/PerceptionSideSI_Out_proxy_xf_ipc_events.h"
...
/*!
 * \brief Parameterization of the IPC deployment information for service interface 'PerceptionSideSI_OutProxy'.
 */
using PerceptionSideSI_OutRequiredIpcDeployment =
    ::amsr::ipc_binding_transformation_layer::internal::IpcServiceInterfaceDeploymentElement<// Abstract service interface reference
                                         ::perceptionsi_out::proxy::PerceptionSideSI_OutProxy,
                                         // Service ID
...
/*!
 * \brief Required service interface deployment of service interface 'PerceptionSideSI_Out'.
 */
class PerceptionSideSI_OutProxyXf final
    : public ::perceptionsi_out::internal::PerceptionSideSI_OutProxyBackendInterface,
      public ::amsr::ipc_binding_core::internal::LocalClientSink,
      public std::enable_shared_from_this< PerceptionSideSI_OutProxyXf> {
 public:

  /*!
   * \brief         Constructor of ProxyXf for service 'PerceptionSideSI_Out'.
   ...
   PerceptionSideSI_OutProxyXf(
      ...
      , event_backend_FLCam_Bus_VisnObj_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4493}, timer_manager, runtime_processing_mode}
      , event_backend_FRCam_Bus_VisnObj_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4494}, timer_manager, runtime_processing_mode}
      , event_backend_RLCam_Bus_VisnObj_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4495}, timer_manager, runtime_processing_mode}
      , event_backend_RRCam_Bus_VisnObj_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4496}, timer_manager, runtime_processing_mode}
      , event_backend_FLCam_Bus_CamSts_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4497}, timer_manager, runtime_processing_mode}
      , event_backend_FRCam_Bus_CamSts_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4498}, timer_manager, runtime_processing_mode}
      , event_backend_RLCam_Bus_CamSts_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4499}, timer_manager, runtime_processing_mode}
      , event_backend_RRCam_Bus_CamSts_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4500}, timer_manager, runtime_processing_mode}
 {
  ...
  */
  ...
  /*!
   * \brief       Getter function for the event 'FLCam_Bus_VisnObj'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSideSI_OutProxyXfEventBackendFLCam_Bus_VisnObj& GetEventBackendFLCam_Bus_VisnObj() noexcept final {
    return event_backend_FLCam_Bus_VisnObj_;
  }

  /*!
   * \brief       Getter function for the event 'FRCam_Bus_VisnObj'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSideSI_OutProxyXfEventBackendFRCam_Bus_VisnObj& GetEventBackendFRCam_Bus_VisnObj() noexcept final {
    return event_backend_FRCam_Bus_VisnObj_;
  }

  /*!
   * \brief       Getter function for the event 'RLCam_Bus_VisnObj'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSideSI_OutProxyXfEventBackendRLCam_Bus_VisnObj& GetEventBackendRLCam_Bus_VisnObj() noexcept final {
    return event_backend_RLCam_Bus_VisnObj_;
  }

  /*!
   * \brief       Getter function for the event 'RRCam_Bus_VisnObj'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSideSI_OutProxyXfEventBackendRRCam_Bus_VisnObj& GetEventBackendRRCam_Bus_VisnObj() noexcept final {
    return event_backend_RRCam_Bus_VisnObj_;
  }

  /*!
   * \brief       Getter function for the event 'FLCam_Bus_CamSts'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSideSI_OutProxyXfEventBackendFLCam_Bus_CamSts& GetEventBackendFLCam_Bus_CamSts() noexcept final {
    return event_backend_FLCam_Bus_CamSts_;
  }

  /*!
   * \brief       Getter function for the event 'FRCam_Bus_CamSts'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSideSI_OutProxyXfEventBackendFRCam_Bus_CamSts& GetEventBackendFRCam_Bus_CamSts() noexcept final {
    return event_backend_FRCam_Bus_CamSts_;
  }

  /*!
   * \brief       Getter function for the event 'RLCam_Bus_CamSts'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSideSI_OutProxyXfEventBackendRLCam_Bus_CamSts& GetEventBackendRLCam_Bus_CamSts() noexcept final {
    return event_backend_RLCam_Bus_CamSts_;
  }

  /*!
   * \brief       Getter function for the event 'RRCam_Bus_CamSts'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  PerceptionSideSI_OutProxyXfEventBackendRRCam_Bus_CamSts& GetEventBackendRRCam_Bus_CamSts() noexcept final {
    return event_backend_RRCam_Bus_CamSts_;
  }
 ...
 private:
   ...
   */
  static constexpr IpcServiceInterfaceDeployment kDeployment{PerceptionSideSI_OutRequiredIpcDeployment::kDeployment};
  ...
  /*!
   * \brief Event backend for proxy event 'FLCam_Bus_VisnObj'.
   */
  PerceptionSideSI_OutProxyXfEventBackendFLCam_Bus_VisnObj event_backend_FLCam_Bus_VisnObj_;

  /*!
   * \brief Event backend for proxy event 'FRCam_Bus_VisnObj'.
   */
  PerceptionSideSI_OutProxyXfEventBackendFRCam_Bus_VisnObj event_backend_FRCam_Bus_VisnObj_;

  /*!
   * \brief Event backend for proxy event 'RLCam_Bus_VisnObj'.
   */
  PerceptionSideSI_OutProxyXfEventBackendRLCam_Bus_VisnObj event_backend_RLCam_Bus_VisnObj_;

  /*!
   * \brief Event backend for proxy event 'RRCam_Bus_VisnObj'.
   */
  PerceptionSideSI_OutProxyXfEventBackendRRCam_Bus_VisnObj event_backend_RRCam_Bus_VisnObj_;

  /*!
   * \brief Event backend for proxy event 'FLCam_Bus_CamSts'.
   */
  PerceptionSideSI_OutProxyXfEventBackendFLCam_Bus_CamSts event_backend_FLCam_Bus_CamSts_;

  /*!
   * \brief Event backend for proxy event 'FRCam_Bus_CamSts'.
   */
  PerceptionSideSI_OutProxyXfEventBackendFRCam_Bus_CamSts event_backend_FRCam_Bus_CamSts_;

  /*!
   * \brief Event backend for proxy event 'RLCam_Bus_CamSts'.
   */
  PerceptionSideSI_OutProxyXfEventBackendRLCam_Bus_CamSts event_backend_RLCam_Bus_CamSts_;

  /*!
   * \brief Event backend for proxy event 'RRCam_Bus_CamSts'.
   */
  PerceptionSideSI_OutProxyXfEventBackendRRCam_Bus_CamSts event_backend_RRCam_Bus_CamSts_;
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_OUT_PERCEPTIONSIDESI_OUT_PROXY_XF_IPC_BINDING_H_
