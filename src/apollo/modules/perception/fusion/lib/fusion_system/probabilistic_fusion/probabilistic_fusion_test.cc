...
//  *****************************************************************************/
// #include
// "modules/perception/fusion/lib/fusion_system/probabilistic_fusion/probabilistic_fusion.h"
...
//   // EXPECT_FLOAT_EQ(pf.trackers_[0]->track_->GetFusedObject()->GetBaseObject()->anchor_point[0],
//   //                 10.0);
//   // EXPECT_FLOAT_EQ(pf.trackers_[0]->track_->GetFusedObject()->GetBaseObject()->anchor_point[1],
//   // 0.0);
//   // EXPECT_FLOAT_EQ(pf.trackers_[0]->track_->GetFusedObject()->GetBaseObject()->anchor_point[1],
//   // 0.0); EXPECT_EQ(fused_objects.size(), 2);
...
//   // 0.0);
//   // EXPECT_FLOAT_EQ(pf.trackers_[0]->track_->GetFusedObject()->GetBaseObject()->anchor_point[1],
//   // 0.0); EXPECT_EQ(fused_objects.size(), 3);
...
//     base_track_lidar->polygon[i].y = static_cast<double>(-1 + 2 * ((i + 1) % 2));
...
//     base_track_radar->polygon[i].y = static_cast<double>(-1 + 2 * ((i + 1) % 2));
