...
void CollectFusedObject::Process(double timestamp, std::vector<base::ObjectPtr>* fused_objects) {
  fused_objects->clear();
...
void CollectFusedObject::CollectObjectsByTrack(double timestamp, const TrackPtr& track,
