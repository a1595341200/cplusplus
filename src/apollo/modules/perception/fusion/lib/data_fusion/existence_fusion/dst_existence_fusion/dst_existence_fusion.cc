...
DstExistenceFusion::DstExistenceFusion(TrackPtr track)
    : BaseExistenceFusion(track), fused_toic_(toic_name_), fused_existence_(name_) {}
...
void DstExistenceFusion::UpdateWithMeasurement(const SensorObjectPtr measurement,
                                               double target_timestamp, double match_dist) {
...
void DstExistenceFusion::UpdateWithoutMeasurement(const std::string &sensor_id,
                                                  ...
                                                  double target_timestamp, double min_match_dist) {
...
double DstExistenceFusion::ComputeDistDecay(base::ObjectConstPtr obj, const std::string &sensor_id,
                                            double timestamp) {
