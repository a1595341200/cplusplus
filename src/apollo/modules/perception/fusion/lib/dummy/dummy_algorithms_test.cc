 ...
 * @Date: 2023-09-23 00:20:28
 * @LastEditors: yao.xie 1595341200@qq.com
 * @LastEditTime: 2023-09-23 00:20:29
 * @FilePath: /cplusplus/src/apollo/modules/perception/fusion/lib/dummy/dummy_algorithms_test.cc
...
//   EXPECT_FALSE(system.Fuse(options, frame, nullptr));
//   std::vector<base::ObjectPtr> objects;
//   EXPECT_TRUE(system.Fuse(options, frame, &objects));
// }
