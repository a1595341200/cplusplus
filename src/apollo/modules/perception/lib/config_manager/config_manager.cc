...
//     return true;
//   }
//   for (auto iter = model_config_map_.begin(); iter != model_config_map_.end(); ++iter) {
//     delete iter->second;
//   }
...
//   if (!common::GetFileList(config_module_path, "config_manager.config", &model_config_files)) {
...
//         << " array_integer_param_map's size: " << array_integer_param_map_.size()
