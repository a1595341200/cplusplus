 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/Sts/impl_type_sts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_STS_IMPL_TYPE_STS_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_STS_IMPL_TYPE_STS_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_STS_IMPL_TYPE_STS_H_
