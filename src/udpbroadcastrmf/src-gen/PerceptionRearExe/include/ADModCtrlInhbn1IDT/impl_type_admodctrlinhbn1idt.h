 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/ADModCtrlInhbn1IDT/impl_type_admodctrlinhbn1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_ADMODCTRLINHBN1IDT_IMPL_TYPE_ADMODCTRLINHBN1IDT_H_
#define PERCEPTIONREAREXE_INCLUDE_ADMODCTRLINHBN1IDT_IMPL_TYPE_ADMODCTRLINHBN1IDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_ADMODCTRLINHBN1IDT_IMPL_TYPE_ADMODCTRLINHBN1IDT_H_
