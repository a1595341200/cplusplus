 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/VisObjIDT/impl_type_visobjidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
