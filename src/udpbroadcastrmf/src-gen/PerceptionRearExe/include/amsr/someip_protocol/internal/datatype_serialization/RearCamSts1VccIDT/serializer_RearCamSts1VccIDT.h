 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/amsr/someip_protocol/internal/datatype_serialization/RearCamSts1VccIDT/serializer_RearCamSts1VccIDT.h
 *        \brief  SOME/IP protocol serializer implementation for datatype 'RearCamSts1VccIDT'
 *
 *      \details  /CppImplementationDataTypes/RearCamSts1VccIDT
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef PERCEPTIONREAREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_REARCAMSTS1VCCIDT_SERIALIZER_REARCAMSTS1VCCIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_REARCAMSTS1VCCIDT_SERIALIZER_REARCAMSTS1VCCIDT_H_
...
namespace RearCamSts1VccIDT {

/*!
 * \brief Serializer for datatype /CppImplementationDataTypes/RearCamSts1VccIDT.
 ...
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/RearCamSts1VccIDT to be serialized.
...
void SomeIpProtocolSerialize(amsr::someip_protocol::internal::serialization::Writer& writer, ::RearCamSts1VccIDT::RearCamSts1VccIDT const &data) noexcept {
...
/*!
 * \brief Calculates the required buffer size for datatype /CppImplementationDataTypes/RearCamSts1VccIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/RearCamSts1VccIDT.
 ...
 */
template <typename TpPack>
constexpr std::size_t GetRequiredBufferSize(::RearCamSts1VccIDT::RearCamSts1VccIDT const &data) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/RearCamSts1VccIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 ...
 * \endspec
 */
template <typename T, typename TpPack, std::enable_if_t<std::is_same<T, ::RearCamSts1VccIDT::RearCamSts1VccIDT>::value, bool> = true>
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/RearCamSts1VccIDT. For ADL.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr amsr::someip_protocol::internal::serialization::InfSizeT GetMaximumBufferSize(::RearCamSts1VccIDT::RearCamSts1VccIDT const&) noexcept {
  return GetMaximumBufferSize<::RearCamSts1VccIDT::RearCamSts1VccIDT, TpPack>();
}

/*!
 * \brief Checks if datatype /CppImplementationDataTypes/RearCamSts1VccIDT is of static size.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr bool IsStaticSize(amsr::someip_protocol::internal::serialization::SizeToken<::RearCamSts1VccIDT::RearCamSts1VccIDT>) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
...
#endif  // PERCEPTIONREAREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_REARCAMSTS1VCCIDT_SERIALIZER_REARCAMSTS1VCCIDT_H_
