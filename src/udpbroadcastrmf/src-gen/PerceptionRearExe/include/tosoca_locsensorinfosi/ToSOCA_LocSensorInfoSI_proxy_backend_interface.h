 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_proxy_backend_interface.h
...
#ifndef PERCEPTIONREAREXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_BACKEND_INTERFACE_H_
#define PERCEPTIONREAREXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_BACKEND_INTERFACE_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_BACKEND_INTERFACE_H_
