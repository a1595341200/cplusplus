 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/LaneMkrCam1SecClsLeIDT/impl_type_lanemkrcam1secclsleidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_LANEMKRCAM1SECCLSLEIDT_IMPL_TYPE_LANEMKRCAM1SECCLSLEIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_LANEMKRCAM1SECCLSLEIDT_IMPL_TYPE_LANEMKRCAM1SECCLSLEIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_LANEMKRCAM1SECCLSLEIDT_IMPL_TYPE_LANEMKRCAM1SECCLSLEIDT_H_
