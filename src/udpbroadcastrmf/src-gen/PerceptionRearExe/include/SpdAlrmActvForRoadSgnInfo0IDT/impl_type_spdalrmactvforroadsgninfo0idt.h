 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/SpdAlrmActvForRoadSgnInfo0IDT/impl_type_spdalrmactvforroadsgninfo0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
#define PERCEPTIONREAREXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
