 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/RearCamSts1VccIDT/impl_type_rearcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_REARCAMSTS1VCCIDT_IMPL_TYPE_REARCAMSTS1VCCIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_REARCAMSTS1VCCIDT_IMPL_TYPE_REARCAMSTS1VCCIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_REARCAMSTS1VCCIDT_IMPL_TYPE_REARCAMSTS1VCCIDT_H_
