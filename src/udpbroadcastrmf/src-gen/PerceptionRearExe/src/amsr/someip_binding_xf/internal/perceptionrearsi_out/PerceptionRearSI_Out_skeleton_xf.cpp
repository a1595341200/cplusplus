 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/src/amsr/someip_binding_xf/internal/perceptionrearsi_out/PerceptionRearSI_Out_skeleton_xf.cpp
...
PerceptionRearSI_OutSkeletonXf::PerceptionRearSI_OutSkeletonXf(
...
bool PerceptionRearSI_OutSkeletonXf::HandleMethodRequest(
...
events::skeleton::PerceptionRear_Bus_LaneInfo::PerceptionRearSI_OutSkeletonSomeIpEventManagerPerceptionRear_Bus_LaneInfo* PerceptionRearSI_OutSkeletonXf::GetEventManagerPerceptionRear_Bus_LaneInfo() noexcept {
  return &event_manager_PerceptionRear_Bus_LaneInfo_;
} // COV_SOMEIPBINDING_SKELETON_XF

// Event 'PerceptionRear_Bus_CameraStatus'
events::skeleton::PerceptionRear_Bus_CameraStatus::PerceptionRearSI_OutSkeletonSomeIpEventManagerPerceptionRear_Bus_CameraStatus* PerceptionRearSI_OutSkeletonXf::GetEventManagerPerceptionRear_Bus_CameraStatus() noexcept {
  return &event_manager_PerceptionRear_Bus_CameraStatus_;
} // COV_SOMEIPBINDING_SKELETON_XF

// Event 'PerceptionRear_Bus_VisnObj'
events::skeleton::PerceptionRear_Bus_VisnObj::PerceptionRearSI_OutSkeletonSomeIpEventManagerPerceptionRear_Bus_VisnObj* PerceptionRearSI_OutSkeletonXf::GetEventManagerPerceptionRear_Bus_VisnObj() noexcept {
  return &event_manager_PerceptionRear_Bus_VisnObj_;
} // COV_SOMEIPBINDING_SKELETON_XF
