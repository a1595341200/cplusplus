 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/AvlStsForLongAutDrv4VccIDT/impl_type_avlstsforlongautdrv4vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_AVLSTSFORLONGAUTDRV4VCCIDT_IMPL_TYPE_AVLSTSFORLONGAUTDRV4VCCIDT_H_
#define DTCAPPEXE_INCLUDE_AVLSTSFORLONGAUTDRV4VCCIDT_IMPL_TYPE_AVLSTSFORLONGAUTDRV4VCCIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_AVLSTSFORLONGAUTDRV4VCCIDT_IMPL_TYPE_AVLSTSFORLONGAUTDRV4VCCIDT_H_
