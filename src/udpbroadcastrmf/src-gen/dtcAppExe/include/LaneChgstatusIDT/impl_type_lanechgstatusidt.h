 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/LaneChgstatusIDT/impl_type_lanechgstatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
#define DTCAPPEXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
