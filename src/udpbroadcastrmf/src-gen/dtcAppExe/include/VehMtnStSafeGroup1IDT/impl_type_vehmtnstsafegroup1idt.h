 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/VehMtnStSafeGroup1IDT/impl_type_vehmtnstsafegroup1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_VEHMTNSTSAFEGROUP1IDT_IMPL_TYPE_VEHMTNSTSAFEGROUP1IDT_H_
#define DTCAPPEXE_INCLUDE_VEHMTNSTSAFEGROUP1IDT_IMPL_TYPE_VEHMTNSTSAFEGROUP1IDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_VEHMTNSTSAFEGROUP1IDT_IMPL_TYPE_VEHMTNSTSAFEGROUP1IDT_H_
