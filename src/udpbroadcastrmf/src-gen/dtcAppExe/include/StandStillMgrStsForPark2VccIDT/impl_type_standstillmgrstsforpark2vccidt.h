 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/StandStillMgrStsForPark2VccIDT/impl_type_standstillmgrstsforpark2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_STANDSTILLMGRSTSFORPARK2VCCIDT_IMPL_TYPE_STANDSTILLMGRSTSFORPARK2VCCIDT_H_
#define DTCAPPEXE_INCLUDE_STANDSTILLMGRSTSFORPARK2VCCIDT_IMPL_TYPE_STANDSTILLMGRSTSFORPARK2VCCIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_STANDSTILLMGRSTSFORPARK2VCCIDT_IMPL_TYPE_STANDSTILLMGRSTSFORPARK2VCCIDT_H_
