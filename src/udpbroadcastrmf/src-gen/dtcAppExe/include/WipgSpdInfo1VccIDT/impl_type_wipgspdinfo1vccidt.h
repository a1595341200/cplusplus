 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/WipgSpdInfo1VccIDT/impl_type_wipgspdinfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
#define DTCAPPEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_WIPGSPDINFO1VCCIDT_IMPL_TYPE_WIPGSPDINFO1VCCIDT_H_
