 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_types.h
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_TYPES_H_
#define PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_TYPES_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_TYPES_H_
