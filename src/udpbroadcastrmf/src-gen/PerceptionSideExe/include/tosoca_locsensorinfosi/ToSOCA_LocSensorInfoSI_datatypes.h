 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_datatypes.h
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
#define PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
