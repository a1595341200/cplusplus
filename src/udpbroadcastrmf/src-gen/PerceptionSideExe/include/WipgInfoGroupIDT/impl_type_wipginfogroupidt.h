 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/WipgInfoGroupIDT/impl_type_wipginfogroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_WIPGINFOGROUPIDT_IMPL_TYPE_WIPGINFOGROUPIDT_H_
