 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/SideRdrSts2VccIDT/impl_type_siderdrsts2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
