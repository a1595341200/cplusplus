 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/VehBattU1VccIDT/impl_type_vehbattu1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
