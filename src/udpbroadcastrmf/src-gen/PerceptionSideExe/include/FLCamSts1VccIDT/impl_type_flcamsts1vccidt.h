 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/FLCamSts1VccIDT/impl_type_flcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_FLCAMSTS1VCCIDT_IMPL_TYPE_FLCAMSTS1VCCIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_FLCAMSTS1VCCIDT_IMPL_TYPE_FLCAMSTS1VCCIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_FLCAMSTS1VCCIDT_IMPL_TYPE_FLCAMSTS1VCCIDT_H_
