 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/RLCamSts1VccIDT/impl_type_rlcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_RLCAMSTS1VCCIDT_IMPL_TYPE_RLCAMSTS1VCCIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_RLCAMSTS1VCCIDT_IMPL_TYPE_RLCAMSTS1VCCIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_RLCAMSTS1VCCIDT_IMPL_TYPE_RLCAMSTS1VCCIDT_H_
