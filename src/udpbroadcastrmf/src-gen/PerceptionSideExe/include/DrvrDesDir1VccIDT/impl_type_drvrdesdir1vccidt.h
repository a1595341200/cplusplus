 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/DrvrDesDir1VccIDT/impl_type_drvrdesdir1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
