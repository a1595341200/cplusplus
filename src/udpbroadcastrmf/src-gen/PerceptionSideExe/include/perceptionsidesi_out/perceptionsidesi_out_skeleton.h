 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/perceptionsidesi_out/perceptionsidesi_out_skeleton.h
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_SKELETON_H_
#define PERCEPTIONSIDEEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_SKELETON_H_
...
using FRCam_Bus_VisnObj = ::amsr::socal::events::SkeletonEvent<
    perceptionsidesi_out::skeleton::PerceptionSideSI_OutSkeleton,
    ::Array_VisObjIDT_20::Array_VisObjIDT_20,
    perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_VisObjIDT_20::Array_VisObjIDT_20>,
    &perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface::GetEventManagerFRCam_Bus_VisnObj>;
...
using FLCam_Bus_VisnObj = ::amsr::socal::events::SkeletonEvent<
    ...
    perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_VisObjIDT_20::Array_VisObjIDT_20>,
    &perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface::GetEventManagerFLCam_Bus_VisnObj>;
...
using RLCam_Bus_VisnObj = ::amsr::socal::events::SkeletonEvent<
    ...
    perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_VisObjIDT_20::Array_VisObjIDT_20>,
    &perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface::GetEventManagerRLCam_Bus_VisnObj>;
...
using RRCam_Bus_VisnObj = ::amsr::socal::events::SkeletonEvent<
    ...
    perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_VisObjIDT_20::Array_VisObjIDT_20>,
    &perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface::GetEventManagerRRCam_Bus_VisnObj>;

/*!
 * \brief Type alias for service event 'PerceptionSide_Bus_CameraStatus', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using PerceptionSide_Bus_CameraStatus = ::amsr::socal::events::SkeletonEvent<
    perceptionsidesi_out::skeleton::PerceptionSideSI_OutSkeleton,
    ::CameraStatusIDT::CameraStatusIDT,
    perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::CameraStatusIDT::CameraStatusIDT>,
    &perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface::GetEventManagerPerceptionSide_Bus_CameraStatus>;
...
class PerceptionSideSI_OutSkeleton
    : public ::amsr::socal::Skeleton<perceptionsidesi_out::PerceptionSideSI_Out,
                                          perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface,
                                          ::amsr::socal::kRuntimeProcessingMode>,
      public       perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonBackendInterface {
 public:
...
explicit PerceptionSideSI_OutSkeleton(ConstructionToken&& token) noexcept;
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'PerceptionSide_Bus_CameraStatus' which can be used by application developer.
   * \details 
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<perceptionsidesi_out::PerceptionSideSI_Out, perceptionsidesi_out::internal::PerceptionSideSI_OutSkeletonImplInterface, ::amsr::socal::kRuntimeProcessingMode>;
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_SKELETON_H_
