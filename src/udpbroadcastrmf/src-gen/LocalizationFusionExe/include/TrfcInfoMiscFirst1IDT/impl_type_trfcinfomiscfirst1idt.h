 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/TrfcInfoMiscFirst1IDT/impl_type_trfcinfomiscfirst1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
