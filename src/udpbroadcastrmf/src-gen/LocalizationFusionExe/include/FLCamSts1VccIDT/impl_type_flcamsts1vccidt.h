 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/FLCamSts1VccIDT/impl_type_flcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_FLCAMSTS1VCCIDT_IMPL_TYPE_FLCAMSTS1VCCIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_FLCAMSTS1VCCIDT_IMPL_TYPE_FLCAMSTS1VCCIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_FLCAMSTS1VCCIDT_IMPL_TYPE_FLCAMSTS1VCCIDT_H_
