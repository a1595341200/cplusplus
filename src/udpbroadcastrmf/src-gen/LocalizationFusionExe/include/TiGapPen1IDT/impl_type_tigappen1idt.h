 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/TiGapPen1IDT/impl_type_tigappen1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_TIGAPPEN1IDT_IMPL_TYPE_TIGAPPEN1IDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_TIGAPPEN1IDT_IMPL_TYPE_TIGAPPEN1IDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_TIGAPPEN1IDT_IMPL_TYPE_TIGAPPEN1IDT_H_
