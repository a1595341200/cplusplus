 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/RLCamSts1VccIDT/impl_type_rlcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_RLCAMSTS1VCCIDT_IMPL_TYPE_RLCAMSTS1VCCIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_RLCAMSTS1VCCIDT_IMPL_TYPE_RLCAMSTS1VCCIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_RLCAMSTS1VCCIDT_IMPL_TYPE_RLCAMSTS1VCCIDT_H_
