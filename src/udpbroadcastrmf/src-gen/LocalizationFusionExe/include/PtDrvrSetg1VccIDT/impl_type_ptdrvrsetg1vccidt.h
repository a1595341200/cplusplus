 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/PtDrvrSetg1VccIDT/impl_type_ptdrvrsetg1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_PTDRVRSETG1VCCIDT_IMPL_TYPE_PTDRVRSETG1VCCIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_PTDRVRSETG1VCCIDT_IMPL_TYPE_PTDRVRSETG1VCCIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_PTDRVRSETG1VCCIDT_IMPL_TYPE_PTDRVRSETG1VCCIDT_H_
