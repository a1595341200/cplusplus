 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/CameraStatusIDT/impl_type_camerastatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
