 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/amsr/someip_protocol/internal/dataprototype_deserialization/rtk_r/events/deserializer_GgaData_receive.h
...
#ifndef RVDCEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_DESERIALIZATION_RTK_R_EVENTS_deserializer_GgaData_receive_h_
#define RVDCEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_DESERIALIZATION_RTK_R_EVENTS_deserializer_GgaData_receive_h_
...
class DeserializerGgaData_receive {
 public:
  ...
  static deserialization::Result Deserialize(deserialization::Reader &reader, ::SOMEIP::ValidationKey::GgaData &data) noexcept;
};
...
#endif  // RVDCEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_DESERIALIZATION_RTK_R_EVENTS_deserializer_GgaData_receive_h_
