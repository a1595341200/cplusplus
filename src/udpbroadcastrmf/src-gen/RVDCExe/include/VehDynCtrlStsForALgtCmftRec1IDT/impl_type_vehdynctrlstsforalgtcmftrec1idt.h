 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/VehDynCtrlStsForALgtCmftRec1IDT/impl_type_vehdynctrlstsforalgtcmftrec1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_IMPL_TYPE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_H_
#define RVDCEXE_INCLUDE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_IMPL_TYPE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_H_
...
#endif  // RVDCEXE_INCLUDE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_IMPL_TYPE_VEHDYNCTRLSTSFORALGTCMFTREC1IDT_H_
