 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/SpdAlrmActvForRoadSgnInfo0IDT/impl_type_spdalrmactvforroadsgninfo0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
#define RVDCEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
...
#endif  // RVDCEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
