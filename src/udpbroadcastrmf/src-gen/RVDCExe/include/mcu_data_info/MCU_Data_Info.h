 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/mcu_data_info/MCU_Data_Info.h
 *        \brief  Header for service 'MCU_Data_Info'.
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef RVDCEXE_INCLUDE_MCU_DATA_INFO_MCU_DATA_INFO_H_
#define RVDCEXE_INCLUDE_MCU_DATA_INFO_MCU_DATA_INFO_H_
...
/*!
 * \brief Representation of service 'MCU_Data_Info'
...
*/
 using CStringView = vac::container::CStringView;
   ...
   */
  static constexpr CStringView kServiceIdentifier{"MCU_Data_Info"_sv};
 ...
 public:
   ...
   */
  static constexpr CStringView kServiceShortNamePath{"/JICA/Service/Interface/MCU_Data_Info"_sv};
};

}  // namespace mcu_data_info

#endif  // RVDCEXE_INCLUDE_MCU_DATA_INFO_MCU_DATA_INFO_H_
