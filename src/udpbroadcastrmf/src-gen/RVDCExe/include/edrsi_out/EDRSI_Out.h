 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/edrsi_out/EDRSI_Out.h
 *        \brief  Header for service 'EDRSI_Out'.
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef RVDCEXE_INCLUDE_EDRSI_OUT_EDRSI_OUT_H_
#define RVDCEXE_INCLUDE_EDRSI_OUT_EDRSI_OUT_H_
...
/*!
 * \brief Representation of service 'EDRSI_Out'
...
*/
 using CStringView = vac::container::CStringView;
   ...
   */
  static constexpr CStringView kServiceIdentifier{"EDRSI_Out"_sv};
 ...
 public:
   ...
   */
  static constexpr CStringView kServiceShortNamePath{"/JICA/Service/Interface/EDRSI_Out"_sv};
};

}  // namespace edrsi_out

#endif  // RVDCEXE_INCLUDE_EDRSI_OUT_EDRSI_OUT_H_
