 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/src/amsr/someip_binding/internal/binding_xf_initializer.cpp
...
#include "amsr/someip_binding_xf/internal/mcu_data_info/MCU_Data_Info_proxy_xf.h"
#include "amsr/someip_binding_xf/internal/rtk_r/Rtk_Receive_proxy_xf.h"
...
void BindingXfInitializer::InitializeServiceDiscoveryProxyXfs(
  ...
  { // Instantiate ServiceDiscoveryProxyXfs for Service MCU_Data_Info
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/MCU_Data_Info"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
    ...
    SomeIpBindingProxyXfInitializer::InitializeSdProxyXfs<
        ::mcu_data_info::proxy::MCU_Data_InfoProxy,
        ::mcu_data_info::internal::MCU_Data_InfoProxyBackendInterface,
        ::amsr::someip_binding_xf::internal::gen_mcu_data_info::MCU_Data_InfoProxyXf>(
        // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
  ...
  { // Instantiate ServiceDiscoveryProxyXfs for Service Rtk_Receive
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/Rtk_Receive"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive

    // Create & initialize SD Proxy XF
    // VCA_SOMEIPBINDING_CONFIG_WRAPPER_OBJECT_LIFECYCLE
    SomeIpBindingProxyXfInitializer::InitializeSdProxyXfs<
        ::rtk_r::proxy::Rtk_ReceiveProxy,
        ::rtk_r::internal::Rtk_ReceiveProxyBackendInterface,
        ::amsr::someip_binding_xf::internal::gen_rtk_r::Rtk_ReceiveProxyXf>(
        // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
        e2e_profiles, life_cycle_manager, client_manager, service_discovery_handler, shortname_path, client_transport_to_daemon);
  } // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT, VCA_SPC_15_SOMEIPBINDING_STL_TYPE_FUNCTION
...
void BindingXfInitializer::DeInitializeServiceDiscoveryProxyXfs(
    configuration::ServiceConfigWrapperInterface const& services_config) noexcept {
  {  // Deinitialize ServiceDiscoveryProxyXf for Service MCU_Data_Info
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/MCU_Data_Info"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
  ...
  {  // Deinitialize ServiceDiscoveryProxyXf for Service Rtk_Receive
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/Rtk_Receive"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
