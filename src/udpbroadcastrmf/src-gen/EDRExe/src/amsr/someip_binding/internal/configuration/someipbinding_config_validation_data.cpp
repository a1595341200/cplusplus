 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/src/amsr/someip_binding/internal/configuration/someipbinding_config_validation_data.cpp
...
#include "amsr/someip_binding/internal/configuration/edrsi_in/EDRSI_In_config_validation_data.h"
...
{"/JICA/Service/Interface/EDRSI_In"_sv,
     ConfigValidationDataAccess{
      &::amsr::someip_binding::internal::configuration::gen_edrsi_in::EDRSI_InConfigValidationData::kValidEventConfigurationEntities[0],
      1,
      nullptr,
      0,
      nullptr,
