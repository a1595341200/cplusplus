...
target_sources(${target} PRIVATE
  ...
  "${CMAKE_CURRENT_LIST_DIR}/src/edrsi_in/edrsi_in.cpp"
  "${CMAKE_CURRENT_LIST_DIR}/src/edrsi_in/edrsi_in_proxy.cpp"
  "${CMAKE_CURRENT_LIST_DIR}/src/edrsi_out/edrsi_out.cpp"
  "${CMAKE_CURRENT_LIST_DIR}/src/edrsi_out/edrsi_out_skeleton.cpp"
...
target_sources(${target} PRIVATE
  ...
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_in/EDRSI_In.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_in/EDRSI_In_datatypes.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_in/EDRSI_In_proxy_backend_interface.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_in/EDRSI_In_types.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_in/edrsi_in_common.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_in/edrsi_in_proxy.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_out/EDRSI_Out.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_out/EDRSI_Out_datatypes.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_out/EDRSI_Out_skeleton_backend_interface.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_out/EDRSI_Out_skeleton_impl_interface.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_out/EDRSI_Out_types.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_out/edrsi_out_common.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/edrsi_out/edrsi_out_skeleton.h"
