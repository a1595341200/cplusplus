 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/ALgtStdFromWhlSpdSafe1ChkdIDT/impl_type_algtstdfromwhlspdsafe1chkdidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_IMPL_TYPE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_H_
#define EDREXE_INCLUDE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_IMPL_TYPE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_H_
...
#endif  // EDREXE_INCLUDE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_IMPL_TYPE_ALGTSTDFROMWHLSPDSAFE1CHKDIDT_H_
