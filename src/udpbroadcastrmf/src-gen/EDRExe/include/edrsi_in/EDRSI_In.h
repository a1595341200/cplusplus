 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/edrsi_in/EDRSI_In.h
 *        \brief  Header for service 'EDRSI_In'.
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef EDREXE_INCLUDE_EDRSI_IN_EDRSI_IN_H_
#define EDREXE_INCLUDE_EDRSI_IN_EDRSI_IN_H_
...
/*!
 * \brief Representation of service 'EDRSI_In'
...
*/
 using CStringView = vac::container::CStringView;
   ...
   */
  static constexpr CStringView kServiceIdentifier{"EDRSI_In"_sv};
 ...
 public:
   ...
   */
  static constexpr CStringView kServiceShortNamePath{"/JICA/Service/Interface/EDRSI_In"_sv};
};

}  // namespace edrsi_in

#endif  // EDREXE_INCLUDE_EDRSI_IN_EDRSI_IN_H_
