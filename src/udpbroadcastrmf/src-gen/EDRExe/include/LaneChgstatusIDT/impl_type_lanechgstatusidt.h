 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/LaneChgstatusIDT/impl_type_lanechgstatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
#define EDREXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
...
#endif  // EDREXE_INCLUDE_LANECHGSTATUSIDT_IMPL_TYPE_LANECHGSTATUSIDT_H_
