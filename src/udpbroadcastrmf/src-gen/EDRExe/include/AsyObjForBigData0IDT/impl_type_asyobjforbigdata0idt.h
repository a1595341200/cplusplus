 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/AsyObjForBigData0IDT/impl_type_asyobjforbigdata0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_ASYOBJFORBIGDATA0IDT_IMPL_TYPE_ASYOBJFORBIGDATA0IDT_H_
#define EDREXE_INCLUDE_ASYOBJFORBIGDATA0IDT_IMPL_TYPE_ASYOBJFORBIGDATA0IDT_H_
...
/*!
 * \brief Type AsyObjForBigData0IDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/AsyObjForBigData0IDT
 */
struct AsyObjForBigData0IDT {
...
/*!
 * \brief   Compare for equality with another AsyObjForBigData0IDT instance.
 ...
 *          use your own.
 */
inline bool operator==(AsyObjForBigData0IDT const& l,
                       AsyObjForBigData0IDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another AsyObjForBigData0IDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // EDREXE_INCLUDE_ASYOBJFORBIGDATA0IDT_IMPL_TYPE_ASYOBJFORBIGDATA0IDT_H_
