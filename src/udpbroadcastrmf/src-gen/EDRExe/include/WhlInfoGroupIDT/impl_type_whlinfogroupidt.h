 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/WhlInfoGroupIDT/impl_type_whlinfogroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
#define EDREXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
...
#endif  // EDREXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
