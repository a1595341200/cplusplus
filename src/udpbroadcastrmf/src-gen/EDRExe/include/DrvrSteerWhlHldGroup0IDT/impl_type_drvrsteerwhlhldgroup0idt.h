 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/DrvrSteerWhlHldGroup0IDT/impl_type_drvrsteerwhlhldgroup0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_DRVRSTEERWHLHLDGROUP0IDT_IMPL_TYPE_DRVRSTEERWHLHLDGROUP0IDT_H_
#define EDREXE_INCLUDE_DRVRSTEERWHLHLDGROUP0IDT_IMPL_TYPE_DRVRSTEERWHLHLDGROUP0IDT_H_
...
#endif  // EDREXE_INCLUDE_DRVRSTEERWHLHLDGROUP0IDT_IMPL_TYPE_DRVRSTEERWHLHLDGROUP0IDT_H_
