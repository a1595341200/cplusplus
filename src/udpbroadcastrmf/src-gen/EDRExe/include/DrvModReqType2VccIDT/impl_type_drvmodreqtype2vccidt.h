 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/DrvModReqType2VccIDT/impl_type_drvmodreqtype2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
#define EDREXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
...
#endif  // EDREXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
