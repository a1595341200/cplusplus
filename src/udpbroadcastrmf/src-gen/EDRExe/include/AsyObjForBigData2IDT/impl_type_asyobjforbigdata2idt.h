 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/AsyObjForBigData2IDT/impl_type_asyobjforbigdata2idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_ASYOBJFORBIGDATA2IDT_IMPL_TYPE_ASYOBJFORBIGDATA2IDT_H_
#define EDREXE_INCLUDE_ASYOBJFORBIGDATA2IDT_IMPL_TYPE_ASYOBJFORBIGDATA2IDT_H_
...
/*!
 * \brief Type AsyObjForBigData2IDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/AsyObjForBigData2IDT
 */
struct AsyObjForBigData2IDT {
...
/*!
 * \brief   Compare for equality with another AsyObjForBigData2IDT instance.
 ...
 *          use your own.
 */
inline bool operator==(AsyObjForBigData2IDT const& l,
                       AsyObjForBigData2IDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another AsyObjForBigData2IDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // EDREXE_INCLUDE_ASYOBJFORBIGDATA2IDT_IMPL_TYPE_ASYOBJFORBIGDATA2IDT_H_
