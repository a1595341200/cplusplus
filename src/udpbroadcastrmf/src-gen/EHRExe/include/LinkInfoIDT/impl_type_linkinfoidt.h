 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LinkInfoIDT/impl_type_linkinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LINKINFOIDT_IMPL_TYPE_LINKINFOIDT_H_
#define EHREXE_INCLUDE_LINKINFOIDT_IMPL_TYPE_LINKINFOIDT_H_
...
#endif  // EHREXE_INCLUDE_LINKINFOIDT_IMPL_TYPE_LINKINFOIDT_H_
