 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/PairConnectivityIDT/impl_type_pairconnectivityidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_PAIRCONNECTIVITYIDT_IMPL_TYPE_PAIRCONNECTIVITYIDT_H_
#define EHREXE_INCLUDE_PAIRCONNECTIVITYIDT_IMPL_TYPE_PAIRCONNECTIVITYIDT_H_
...
#endif  // EHREXE_INCLUDE_PAIRCONNECTIVITYIDT_IMPL_TYPE_PAIRCONNECTIVITYIDT_H_
