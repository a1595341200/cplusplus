 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/GeoFenceIDT/impl_type_geofenceidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_GEOFENCEIDT_IMPL_TYPE_GEOFENCEIDT_H_
#define EHREXE_INCLUDE_GEOFENCEIDT_IMPL_TYPE_GEOFENCEIDT_H_
...
#endif  // EHREXE_INCLUDE_GEOFENCEIDT_IMPL_TYPE_GEOFENCEIDT_H_
