 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LaneTypeIDT/impl_type_lanetypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LANETYPEIDT_IMPL_TYPE_LANETYPEIDT_H_
#define EHREXE_INCLUDE_LANETYPEIDT_IMPL_TYPE_LANETYPEIDT_H_
...
#endif  // EHREXE_INCLUDE_LANETYPEIDT_IMPL_TYPE_LANETYPEIDT_H_
