 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/amsr/someip_protocol/internal/dataprototype_serialization/ehrsi_out/events/serializer_EHR_Bus_LinkSlopes.h
...
#ifndef EHREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_EHRSI_OUT_EVENTS_serializer_EHR_Bus_LinkSlopes_h_
#define EHREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_EHRSI_OUT_EVENTS_serializer_EHR_Bus_LinkSlopes_h_
...
/*!
 * \brief Serializer for service event /JICA/Service/Interface/EHRSI_Out/EHR_Bus_LinkSlopes
 *        of service interface /JICA/Service/Interface/EHRSI_Out.
 * \details Top-Level data type: /CppImplementationDataTypes/Array_LinkSlopeIDT_Vector
 ...
 */
class SerializerEHR_Bus_LinkSlopes {
 public:
  /*!
   * \brief Returns the required buffer size for the data prototype service event /JICA/Service/Interface/EHRSI_Out/EHR_Bus_LinkSlopes.
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/Array_LinkSlopeIDT_Vector.
   *
   ...
   * \endspec
   */
  constexpr static std::size_t GetRequiredBufferSize(::Array_LinkSlopeIDT_Vector::Array_LinkSlopeIDT_Vector const &data) noexcept {
  ...
  /*!
   * \brief Returns the maximum buffer size for the data prototype service event /JICA/Service/Interface/EHRSI_Out/EHR_Bus_LinkSlopes.
   *
   * \return      Calculated buffer size for serialization.
   * \pre         -
   * \context     App
  ...
  /*!
   * \brief Serialize the data prototype service event /JICA/Service/Interface/EHRSI_Out/EHR_Bus_LinkSlopes.
   *
  ...
  static void Serialize(serialization::Writer &writer, ::Array_LinkSlopeIDT_Vector::Array_LinkSlopeIDT_Vector const &data) noexcept;
...
#endif  // EHREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_EHRSI_OUT_EVENTS_serializer_EHR_Bus_LinkSlopes_h_
