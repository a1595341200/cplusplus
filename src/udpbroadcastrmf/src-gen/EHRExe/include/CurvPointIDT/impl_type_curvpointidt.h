 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/CurvPointIDT/impl_type_curvpointidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_CURVPOINTIDT_IMPL_TYPE_CURVPOINTIDT_H_
#define EHREXE_INCLUDE_CURVPOINTIDT_IMPL_TYPE_CURVPOINTIDT_H_
...
#endif  // EHREXE_INCLUDE_CURVPOINTIDT_IMPL_TYPE_CURVPOINTIDT_H_
