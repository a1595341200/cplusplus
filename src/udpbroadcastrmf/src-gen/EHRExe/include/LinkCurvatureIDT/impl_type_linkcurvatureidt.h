 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LinkCurvatureIDT/impl_type_linkcurvatureidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LINKCURVATUREIDT_IMPL_TYPE_LINKCURVATUREIDT_H_
#define EHREXE_INCLUDE_LINKCURVATUREIDT_IMPL_TYPE_LINKCURVATUREIDT_H_
...
#endif  // EHREXE_INCLUDE_LINKCURVATUREIDT_IMPL_TYPE_LINKCURVATUREIDT_H_
