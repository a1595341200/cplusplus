...
class RadarAdaptorSI_OutProxyXf final
 ...
 public:
   ...
   *                                                RadarAdaptorSI_OutProxyXf's entire life time.
   ...
   * \synchronous TRUE
   */
  ~RadarAdaptorSI_OutProxyXf() noexcept final;

  RadarAdaptorSI_OutProxyXf(RadarAdaptorSI_OutProxyXf const &) = delete;
  RadarAdaptorSI_OutProxyXf &operator=(RadarAdaptorSI_OutProxyXf const &) = delete;
  RadarAdaptorSI_OutProxyXf(RadarAdaptorSI_OutProxyXf &&) = delete;
  RadarAdaptorSI_OutProxyXf &operator=(RadarAdaptorSI_OutProxyXf &&) = delete;
 ...
 // ---- Events ---------------------------------------------------------------------------------------------------
  ...
  /*!
   * \brief       Getter function for the event 'FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  RadarAdaptorSI_OutProxyXfEventBackendFourDRadarObjStsGAPGrp_FourDRadarObjStsGrp& GetEventBackendFourDRadarObjStsGAPGrp_FourDRadarObjStsGrp() noexcept final;
 ...
 private:
  ...
  /*!
   * \brief Event backend for proxy event 'FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp'.
   */
  RadarAdaptorSI_OutProxyXfEventBackendFourDRadarObjStsGAPGrp_FourDRadarObjStsGrp event_backend_FourDRadarObjStsGAPGrp_FourDRadarObjStsGrp_;
