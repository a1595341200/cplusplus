 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/amsr/someip_protocol/internal/datatype_deserialization/TOSOCAObjPpty1VccGroupIDT/deserializer_TOSOCAObjPpty1VccGroupIDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'TOSOCAObjPpty1VccGroupIDT'
 *
 *      \details  /CppImplementationDataTypes/TOSOCAObjPpty1VccGroupIDT
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_TOSOCAOBJPPTY1VCCGROUPIDT_DESERIALIZER_TOSOCAOBJPPTY1VCCGROUPIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_TOSOCAOBJPPTY1VCCGROUPIDT_DESERIALIZER_TOSOCAOBJPPTY1VCCGROUPIDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/TOSOCAObjPpty1VccGroupIDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/TOSOCAObjPpty1VccGroupIDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::TOSOCAObjPpty1VccGroupIDT::TOSOCAObjPpty1VccGroupIDT &data) noexcept {
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/TOSOCAObjPpty1VccGroupIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::TOSOCAObjPpty1VccGroupIDT::TOSOCAObjPpty1VccGroupIDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_TOSOCAOBJPPTY1VCCGROUPIDT_DESERIALIZER_TOSOCAOBJPPTY1VCCGROUPIDT_H_
