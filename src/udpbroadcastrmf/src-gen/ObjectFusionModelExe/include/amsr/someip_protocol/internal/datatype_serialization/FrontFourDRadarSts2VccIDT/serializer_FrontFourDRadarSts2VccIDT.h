 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/amsr/someip_protocol/internal/datatype_serialization/FrontFourDRadarSts2VccIDT/serializer_FrontFourDRadarSts2VccIDT.h
 *        \brief  SOME/IP protocol serializer implementation for datatype 'FrontFourDRadarSts2VccIDT'
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_FRONTFOURDRADARSTS2VCCIDT_SERIALIZER_FRONTFOURDRADARSTS2VCCIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_FRONTFOURDRADARSTS2VCCIDT_SERIALIZER_FRONTFOURDRADARSTS2VCCIDT_H_
...
/*!
 * \brief Serializer for datatype /CppImplementationDataTypes/FrontFourDRadarSts2VccIDT.
 ...
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/FrontFourDRadarSts2VccIDT to be serialized.
...
void SomeIpProtocolSerialize(amsr::someip_protocol::internal::serialization::Writer& writer, ::FrontFourDRadarSts2VccIDT::FrontFourDRadarSts2VccIDT const &data) noexcept {
  ...
  // Serialize non-TLV struct
    ...
    // Serialize struct member 'RdrStsTiStampH' of type /CppImplementationDataTypes/uint32_t
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        ...
                        >(writer, data.RdrStsTiStampH);
    // Serialize struct member 'RdrStsTiStampL' of type /CppImplementationDataTypes/uint32_t
     // VCA_SOMEIPPROTOCOL_GEN_SERIALIZE
    serialization::SomeIpProtocolSerialize<
                        TpPack,
                        // Byte-order of primitive datatype (/CppImplementationDataTypes/uint32_t)
...
/*!
 * \brief Calculates the required buffer size for datatype /CppImplementationDataTypes/FrontFourDRadarSts2VccIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/FrontFourDRadarSts2VccIDT.
 ...
 */
template <typename TpPack>
constexpr std::size_t GetRequiredBufferSize(::FrontFourDRadarSts2VccIDT::FrontFourDRadarSts2VccIDT const &data) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/FrontFourDRadarSts2VccIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 ...
 * \endspec
 */
template <typename T, typename TpPack, std::enable_if_t<std::is_same<T, ::FrontFourDRadarSts2VccIDT::FrontFourDRadarSts2VccIDT>::value, bool> = true>
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/FrontFourDRadarSts2VccIDT. For ADL.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr amsr::someip_protocol::internal::serialization::InfSizeT GetMaximumBufferSize(::FrontFourDRadarSts2VccIDT::FrontFourDRadarSts2VccIDT const&) noexcept {
  return GetMaximumBufferSize<::FrontFourDRadarSts2VccIDT::FrontFourDRadarSts2VccIDT, TpPack>();
}

/*!
 * \brief Checks if datatype /CppImplementationDataTypes/FrontFourDRadarSts2VccIDT is of static size.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr bool IsStaticSize(amsr::someip_protocol::internal::serialization::SizeToken<::FrontFourDRadarSts2VccIDT::FrontFourDRadarSts2VccIDT>) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
  ...
  // Check static size status of struct member 'RdrStsTiStampH' of type /CppImplementationDataTypes/uint32_t
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/uint32_t)
                      typename serialization::Tp<TpPack>::ByteOrder
  ...
  // Check static size status of struct member 'RdrStsTiStampL' of type /CppImplementationDataTypes/uint32_t
  serialization::IsStaticSize<
                      TpPack,
                      // Byte-order of primitive datatype (/CppImplementationDataTypes/uint32_t)
                      typename serialization::Tp<TpPack>::ByteOrder
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_FRONTFOURDRADARSTS2VCCIDT_SERIALIZER_FRONTFOURDRADARSTS2VCCIDT_H_
