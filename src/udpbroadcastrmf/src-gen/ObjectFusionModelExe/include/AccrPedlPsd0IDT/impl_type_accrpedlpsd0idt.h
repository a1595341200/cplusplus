 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/AccrPedlPsd0IDT/impl_type_accrpedlpsd0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
