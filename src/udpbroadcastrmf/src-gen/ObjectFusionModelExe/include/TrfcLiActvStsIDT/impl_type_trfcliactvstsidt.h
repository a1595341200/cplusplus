 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/TrfcLiActvStsIDT/impl_type_trfcliactvstsidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
