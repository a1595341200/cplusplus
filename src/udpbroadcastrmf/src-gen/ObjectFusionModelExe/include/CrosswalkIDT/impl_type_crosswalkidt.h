 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/CrosswalkIDT/impl_type_crosswalkidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_CROSSWALKIDT_IMPL_TYPE_CROSSWALKIDT_H_
