...
/*!
 * \brief Type alias for service event 'OFM_Bus_FusedTargets01', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using OFM_Bus_FusedTargets01 = ::amsr::socal::events::SkeletonEvent<
    ...
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8>,
    &objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface::GetEventManagerOFM_Bus_FusedTargets01>;

/*!
 * \brief Type alias for service event 'OFM_Bus_FusedTargets02', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using OFM_Bus_FusedTargets02 = ::amsr::socal::events::SkeletonEvent<
    objectfusionmodelsi_out::skeleton::ObjectFusionModelSI_OutSkeleton,
    ::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8,
    objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8>,
    &objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface::GetEventManagerOFM_Bus_FusedTargets02>;

/*!
 * \brief Type alias for service event 'OFM_Bus_FusedTargets03', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using OFM_Bus_FusedTargets03 = ::amsr::socal::events::SkeletonEvent<
    objectfusionmodelsi_out::skeleton::ObjectFusionModelSI_OutSkeleton,
    ::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8,
    objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8>,
    &objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface::GetEventManagerOFM_Bus_FusedTargets03>;

/*!
 * \brief Type alias for service event 'OFM_Bus_FusedTargets04', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using OFM_Bus_FusedTargets04 = ::amsr::socal::events::SkeletonEvent<
    objectfusionmodelsi_out::skeleton::ObjectFusionModelSI_OutSkeleton,
    ::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8,
    objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8>,
    &objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface::GetEventManagerOFM_Bus_FusedTargets04>;
...
using OFM_St_SOCFusedSts = ::amsr::socal::events::SkeletonEvent<
    ...
    ::uint16IDT::uint16IDT,
    objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::uint16IDT::uint16IDT>,
    &objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface::GetEventManagerOFM_St_SOCFusedSts>;

/*!
 * \brief Type alias for service event 'OFM_Bus_FourDRadarStatus', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using OFM_Bus_FourDRadarStatus = ::amsr::socal::events::SkeletonEvent<
    objectfusionmodelsi_out::skeleton::ObjectFusionModelSI_OutSkeleton,
    ::FourDRadarStatusIDT::FourDRadarStatusIDT,
    objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::FourDRadarStatusIDT::FourDRadarStatusIDT>,
    &objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface::GetEventManagerOFM_Bus_FourDRadarStatus>;

/*!
 * \brief Type alias for service event 'OFM_Bus_LaneInfo', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using OFM_Bus_LaneInfo = ::amsr::socal::events::SkeletonEvent<
    objectfusionmodelsi_out::skeleton::ObjectFusionModelSI_OutSkeleton,
    ...
    &objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface::GetEventManagerOFM_Bus_LaneInfo>;
...
class ObjectFusionModelSI_OutSkeleton
    : public ::amsr::socal::Skeleton<objectfusionmodelsi_out::ObjectFusionModelSI_Out,
      ...
      public       objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonBackendInterface {
 public:
...
explicit ObjectFusionModelSI_OutSkeleton(ConstructionToken&& token) noexcept;
  ...
  /*!
   * \brief The skeleton event 'OFM_Bus_FusedTargets01' which can be used by application developer.
   * \details 
   * Data of type ::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8
   * \vpublic
   */
  events::OFM_Bus_FusedTargets01 OFM_Bus_FusedTargets01;

  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'OFM_Bus_FusedTargets02' which can be used by application developer.
   * \details 
   * Data of type ::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8
   * \vpublic
   */
  events::OFM_Bus_FusedTargets02 OFM_Bus_FusedTargets02;

  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'OFM_Bus_FusedTargets03' which can be used by application developer.
   * \details 
   * Data of type ::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8
   * \vpublic
   */
  events::OFM_Bus_FusedTargets03 OFM_Bus_FusedTargets03;

  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'OFM_Bus_FusedTargets04' which can be used by application developer.
   * \details 
   * Data of type ::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8
   * \vpublic
   */
  events::OFM_Bus_FusedTargets04 OFM_Bus_FusedTargets04;

  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'OFM_St_SOCFusedSts' which can be used by application developer.
   * \details 
   * Data of type ::uint16IDT::uint16IDT
   * \vpublic
   */
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'OFM_Bus_FourDRadarStatus' which can be used by application developer.
   * \details 
   * Data of type ::FourDRadarStatusIDT::FourDRadarStatusIDT
   * \vpublic
   */
  events::OFM_Bus_FourDRadarStatus OFM_Bus_FourDRadarStatus;

  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'OFM_Bus_LaneInfo' which can be used by application developer.
   * \details 
   * Data of type ::PerceptionLaneInfoIDT::PerceptionLaneInfoIDT
   * \vpublic
   */
  events::OFM_Bus_LaneInfo OFM_Bus_LaneInfo;
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<objectfusionmodelsi_out::ObjectFusionModelSI_Out, objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutSkeletonImplInterface, ::amsr::socal::kRuntimeProcessingMode>;
