 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/AccFusnTrfcReqIDT/impl_type_accfusntrfcreqidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
