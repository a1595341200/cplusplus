 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/radaradaptorsi_out/RadarAdaptorSI_Out.h
 *        \brief  Header for service 'RadarAdaptorSI_Out'.
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_RADARADAPTORSI_OUT_RADARADAPTORSI_OUT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_RADARADAPTORSI_OUT_RADARADAPTORSI_OUT_H_
...
/*!
 * \brief Representation of service 'RadarAdaptorSI_Out'
 ...
 * \trace SPEC-4980256
 */
class RadarAdaptorSI_Out final {
...
*/
 using CStringView = vac::container::CStringView;
   ...
   */
  static constexpr CStringView kServiceIdentifier{"RadarAdaptorSI_Out"_sv};
 ...
 public:
   ...
   */
  static constexpr CStringView kServiceShortNamePath{"/JICA/Service/Interface/RadarAdaptorSI_Out"_sv};
};

}  // namespace radaradaptorsi_out

#endif  // OBJECTFUSIONMODELEXE_INCLUDE_RADARADAPTORSI_OUT_RADARADAPTORSI_OUT_H_
