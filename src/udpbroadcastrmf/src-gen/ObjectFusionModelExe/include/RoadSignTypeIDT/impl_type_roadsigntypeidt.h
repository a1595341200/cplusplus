 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/RoadSignTypeIDT/impl_type_roadsigntypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
