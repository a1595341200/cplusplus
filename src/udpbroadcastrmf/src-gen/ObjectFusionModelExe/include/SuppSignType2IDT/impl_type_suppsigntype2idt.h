 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/SuppSignType2IDT/impl_type_suppsigntype2idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
