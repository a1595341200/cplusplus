 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/ipc_binding_transformation_layer/internal/perceptionsi_visnobjout/PerceptionSI_VisnObjOut_proxy_xf_ipc_binding.cpp
...
PerceptionSI_VisnObjOutProxyXf::PerceptionSI_VisnObjOutProxyXf(
  ...
  ::amsr::ipc_binding_core::internal::runtime_configuration::ServiceConfig const& service_config)
    : provided_service_instance_id_{service_config.GetId(), service_instance_id,
      ...
      event_backend_FrntCam_Bus_VisnObj_{
          *this, sd_proxy, timer_manager,
          runtime_processing_mode, provided_service_instance_id_,
          // VCA_IPCB_BASICSTRING_CONSTRUCTOR
          service_config.GetEventOf({"FrntCam_Bus_VisnObj"}).GetId(),
          client_id_},
      event_backend_FrntCam_Bus_UnfilteredObj_{
          *this, sd_proxy, timer_manager,
          runtime_processing_mode, provided_service_instance_id_,
          // VCA_IPCB_BASICSTRING_CONSTRUCTOR
          service_config.GetEventOf({"FrntCam_Bus_UnfilteredObj"}).GetId(),
          client_id_} {
...
PerceptionSI_VisnObjOutProxyXf::~PerceptionSI_VisnObjOutProxyXf() noexcept { // VCA_IPCB_MOLE_1298
  // VCA_IPCB_SERVICE_INTERFACE_PROXY_XF_SAFE_UNDEFINED_FUNCTION
...
void PerceptionSI_VisnObjOutProxyXf::EmplaceEventBackends() {
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_FrntCam_Bus_VisnObj_.GetEventId().value, &event_backend_FrntCam_Bus_VisnObj_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_FrntCam_Bus_UnfilteredObj_.GetEventId().value, &event_backend_FrntCam_Bus_UnfilteredObj_ ));

}

::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::RouteSubscribeMessage(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::RouteUnsubscribeMessage(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::OnResponseReceived(
        ::amsr::ipc_binding_core::internal::ipc_protocol::ResponseMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::OnNotificationReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::OnSubscribeAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::OnSubscribeNAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::OnApplicationErrorReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ApplicationErrorMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

// VECTOR NC AutosarC++17_10-M0.1.8: MD_IPCBINDING_AutosarC++17_10_M0.1.8_config_variant
void PerceptionSI_VisnObjOutProxyXf::OnErrorResponseReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ErrorResponseMessage&&) {
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::socal::SkeletonConnectionState PerceptionSI_VisnObjOutProxyXf::ReadSkeletonConnectionState() noexcept {
...
// ---- Events ---------------------------------------------------------------------------------------------------
PerceptionSI_VisnObjOutProxyXfEventBackendFrntCam_Bus_VisnObj& PerceptionSI_VisnObjOutProxyXf::GetEventBackendFrntCam_Bus_VisnObj() noexcept {
  return event_backend_FrntCam_Bus_VisnObj_;
}
PerceptionSI_VisnObjOutProxyXfEventBackendFrntCam_Bus_UnfilteredObj& PerceptionSI_VisnObjOutProxyXf::GetEventBackendFrntCam_Bus_UnfilteredObj() noexcept {
  return event_backend_FrntCam_Bus_UnfilteredObj_;
}
// ---- Events ---------------------------------------------------------------------------------------------------
