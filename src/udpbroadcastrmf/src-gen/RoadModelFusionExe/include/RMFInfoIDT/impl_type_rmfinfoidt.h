 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/RMFInfoIDT/impl_type_rmfinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_RMFINFOIDT_IMPL_TYPE_RMFINFOIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_RMFINFOIDT_IMPL_TYPE_RMFINFOIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_RMFINFOIDT_IMPL_TYPE_RMFINFOIDT_H_
