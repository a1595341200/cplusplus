 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LineTypeIDT/impl_type_linetypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LINETYPEIDT_IMPL_TYPE_LINETYPEIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_LINETYPEIDT_IMPL_TYPE_LINETYPEIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LINETYPEIDT_IMPL_TYPE_LINETYPEIDT_H_
