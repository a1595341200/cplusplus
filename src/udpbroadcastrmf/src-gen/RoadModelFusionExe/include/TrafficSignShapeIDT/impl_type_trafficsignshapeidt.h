 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/TrafficSignShapeIDT/impl_type_trafficsignshapeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_TRAFFICSIGNSHAPEIDT_IMPL_TYPE_TRAFFICSIGNSHAPEIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_TRAFFICSIGNSHAPEIDT_IMPL_TYPE_TRAFFICSIGNSHAPEIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_TRAFFICSIGNSHAPEIDT_IMPL_TYPE_TRAFFICSIGNSHAPEIDT_H_
