 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LinearObjectIDT/impl_type_linearobjectidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTIDT_IMPL_TYPE_LINEAROBJECTIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTIDT_IMPL_TYPE_LINEAROBJECTIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTIDT_IMPL_TYPE_LINEAROBJECTIDT_H_
