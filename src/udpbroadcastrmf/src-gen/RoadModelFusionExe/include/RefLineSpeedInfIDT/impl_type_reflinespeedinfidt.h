 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/RefLineSpeedInfIDT/impl_type_reflinespeedinfidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_REFLINESPEEDINFIDT_IMPL_TYPE_REFLINESPEEDINFIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_REFLINESPEEDINFIDT_IMPL_TYPE_REFLINESPEEDINFIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_REFLINESPEEDINFIDT_IMPL_TYPE_REFLINESPEEDINFIDT_H_
