...
class DeserializerEHR_Bus_LinkInfos {
 public:
   ...
   *                /CppImplementationDataTypes/Array_LinkInfoIDT_Vector
  ...
  static deserialization::Result Deserialize(deserialization::Reader &reader, ::Array_LinkInfoIDT_Vector::Array_LinkInfoIDT_Vector &data) noexcept;
};
