...
class DeserializerEHR_Bus_LinkSlopes {
 public:
   ...
   *                /CppImplementationDataTypes/Array_LinkSlopeIDT_Vector
  ...
  static deserialization::Result Deserialize(deserialization::Reader &reader, ::Array_LinkSlopeIDT_Vector::Array_LinkSlopeIDT_Vector &data) noexcept;
};
