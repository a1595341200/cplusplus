 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/amsr/ipc_binding_transformation_layer/internal/roadmodelfusionsi_out/RoadModelFusionSI_Out_skeleton_ipc_binding.h
 *        \brief  IPC binding of service skeleton for service 'RoadModelFusionSI_Out'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_SKELETON_IPC_BINDING_H_
#define ROADMODELFUSIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_SKELETON_IPC_BINDING_H_
...
#include <utility>
#include "amsr/ipc_binding_transformation_layer/internal/roadmodelfusionsi_out/RoadModelFusionSI_Out_skeleton_ipc_event_manager.h"
#include "amsr/ipc_binding_transformation_layer/internal/roadmodelfusionsi_out/RoadModelFusionSI_Out_skeleton_ipc_method_manager.h"
...
/*!
 * \brief Provided service interface deployment of service interface 'RoadModelFusionSI_Out'.
...
class RoadModelFusionSI_OutProvidedIpcServiceInstance final
 ...
 /*!
  ...
  /*!
   * \brief         Constructor of ProvidedIpcServiceInstance for service 'RoadModelFusionSI_Out'.
   * \param[in,out] skeleton                Reference to the skeleton. The reference must be valid for RoadModelFusionSI_OutProvidedIpcServiceInstance entire life time.
   * \param[in,out] server_binding_manager  Server binding manager. The reference must be valid for RoadModelFusionSI_OutProvidedIpcServiceInstance entire life time.
   ...
   * \synchronous   TRUE
   */
  RoadModelFusionSI_OutProvidedIpcServiceInstance(::roadmodelfusionsi_out::internal::RoadModelFusionSI_OutSkeletonBackendInterface& skeleton,
      ...
      : ::amsr::ipc_binding_core::internal::LocalServerSink{},
        ...
        logger_{::amsr::ipc_binding_core::internal::logging::kIpcLoggerContextId,
                ...
                ::amsr::core::StringView{"RoadModelFusionSI_OutProvidedIpcServiceInstance"}},
        event_RMF_Bus_RMFInfo_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"RMF_Bus_RMFInfo"}).GetId().value},
            instance_id,
            false},
        event_RMF_Bus_MapInfo_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"RMF_Bus_MapInfo"}).GetId().value},
            instance_id,
            false},
        event_RMF_Bus_VectorMapInfo_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"RMF_Bus_VectorMapInfo"}).GetId().value},
            instance_id,
            false},
        event_RMF_Bus_Position_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"RMF_Bus_Position"}).GetId().value},
            instance_id,
            false},
        event_id_set_{  // VCA_IPCB_STD_CONSTRUCTOR_CALLED
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            service_config.GetEventOf({"RMF_Bus_RMFInfo"}).GetId(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            service_config.GetEventOf({"RMF_Bus_MapInfo"}).GetId(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            service_config.GetEventOf({"RMF_Bus_VectorMapInfo"}).GetId(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            service_config.GetEventOf({"RMF_Bus_Position"}).GetId()}  {
  ...
  RoadModelFusionSI_OutProvidedIpcServiceInstance(RoadModelFusionSI_OutProvidedIpcServiceInstance const& ) noexcept = delete;
  RoadModelFusionSI_OutProvidedIpcServiceInstance(RoadModelFusionSI_OutProvidedIpcServiceInstance&& ) noexcept = delete;
  RoadModelFusionSI_OutProvidedIpcServiceInstance& operator=(RoadModelFusionSI_OutProvidedIpcServiceInstance const& ) noexcept = delete;
  RoadModelFusionSI_OutProvidedIpcServiceInstance& operator=(RoadModelFusionSI_OutProvidedIpcServiceInstance&& ) noexcept = delete;
  ...
  ~RoadModelFusionSI_OutProvidedIpcServiceInstance() noexcept final {
  ...
  /*!
   * \brief   Get the event manager object for the IPC binding service event 'RMF_Bus_RMFInfo'.
   *
   ...
   * \context App
   */
  RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_RMFInfo* GetEventManagerRMF_Bus_RMFInfo() noexcept final;

  /*!
   * \brief   Get the event manager object for the IPC binding service event 'RMF_Bus_MapInfo'.
   *
   ...
   * \context App
   */
  RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_MapInfo* GetEventManagerRMF_Bus_MapInfo() noexcept final;

  /*!
   * \brief   Get the event manager object for the IPC binding service event 'RMF_Bus_VectorMapInfo'.
   *
   ...
   * \context App
   */
  RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_VectorMapInfo* GetEventManagerRMF_Bus_VectorMapInfo() noexcept final;

  /*!
   * \brief   Get the event manager object for the IPC binding service event 'RMF_Bus_Position'.
   *
   ...
   * \context App
   */
  RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_Position* GetEventManagerRMF_Bus_Position() noexcept final;
  // ---- Events --------------------------------------------------------------------------------------------------
 ...
 private:
  ...
  // ---- EventManagers --------------------------------------------------------------------------------------------
  /*!
   * \brief Event manager for skeleton event 'RMF_Bus_RMFInfo'
   */
  RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_RMFInfo event_RMF_Bus_RMFInfo_;

  /*!
   * \brief Event manager for skeleton event 'RMF_Bus_MapInfo'
   */
  RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_MapInfo event_RMF_Bus_MapInfo_;

  /*!
   * \brief Event manager for skeleton event 'RMF_Bus_VectorMapInfo'
   */
  RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_VectorMapInfo event_RMF_Bus_VectorMapInfo_;

  /*!
   * \brief Event manager for skeleton event 'RMF_Bus_Position'
   */
  RoadModelFusionSI_OutSkeletonIpcEventManagerRMF_Bus_Position event_RMF_Bus_Position_;
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_SKELETON_IPC_BINDING_H_
