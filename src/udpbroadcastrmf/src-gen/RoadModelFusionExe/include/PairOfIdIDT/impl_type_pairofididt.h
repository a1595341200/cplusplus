 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/PairOfIdIDT/impl_type_pairofididt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_PAIROFIDIDT_IMPL_TYPE_PAIROFIDIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_PAIROFIDIDT_IMPL_TYPE_PAIROFIDIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_PAIROFIDIDT_IMPL_TYPE_PAIROFIDIDT_H_
