 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LaneWidthIDT/impl_type_lanewidthidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LANEWIDTHIDT_IMPL_TYPE_LANEWIDTHIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_LANEWIDTHIDT_IMPL_TYPE_LANEWIDTHIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LANEWIDTHIDT_IMPL_TYPE_LANEWIDTHIDT_H_
