 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/OutODDReasonIDT/impl_type_outoddreasonidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_OUTODDREASONIDT_IMPL_TYPE_OUTODDREASONIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_OUTODDREASONIDT_IMPL_TYPE_OUTODDREASONIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_OUTODDREASONIDT_IMPL_TYPE_OUTODDREASONIDT_H_
