 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/ehrsi_out/EHRSI_Out.h
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_EHRSI_OUT_EHRSI_OUT_H_
#define ROADMODELFUSIONEXE_INCLUDE_EHRSI_OUT_EHRSI_OUT_H_
...
/*!
 * \brief Representation of service 'EHRSI_Out'
...
*/
 using CStringView = vac::container::CStringView;
   ...
   */
  static constexpr CStringView kServiceIdentifier{"EHRSI_Out"_sv};
 ...
 public:
   ...
   */
  static constexpr CStringView kServiceShortNamePath{"/JICA/Service/Interface/EHRSI_Out"_sv};
};

}  // namespace ehrsi_out

#endif  // ROADMODELFUSIONEXE_INCLUDE_EHRSI_OUT_EHRSI_OUT_H_
