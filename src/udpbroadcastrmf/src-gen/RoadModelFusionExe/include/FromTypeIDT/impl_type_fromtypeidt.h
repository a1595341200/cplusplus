 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/FromTypeIDT/impl_type_fromtypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_FROMTYPEIDT_IMPL_TYPE_FROMTYPEIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_FROMTYPEIDT_IMPL_TYPE_FROMTYPEIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_FROMTYPEIDT_IMPL_TYPE_FROMTYPEIDT_H_
