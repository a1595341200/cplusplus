 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/ehrsi_out/events/deserializer_EHR_Bus_LinearObjects.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/LinearObjectIDT/deserializer_LinearObjectIDT.h"
...
deserialization::Result DeserializerEHR_Bus_LinearObjects::Deserialize(deserialization::Reader &reader, ::Array_LinearObjectIDT_Vector::Array_LinearObjectIDT_Vector &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/EHRSI_Out/EHR_Bus_LinearObjects
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      TpPackAlias,
        // Config of vector length field and max. container size (/CppImplementationDataTypes/Array_LinearObjectIDT_Vector)
      ...
      >(deserialization::SizeToken<::Array_LinearObjectIDT_Vector::Array_LinearObjectIDT_Vector>{})};
