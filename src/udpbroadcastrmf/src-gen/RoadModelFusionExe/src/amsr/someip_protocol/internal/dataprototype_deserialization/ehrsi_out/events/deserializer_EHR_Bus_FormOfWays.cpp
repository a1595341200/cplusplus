 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/ehrsi_out/events/deserializer_EHR_Bus_FormOfWays.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/FormOfWayIDT/deserializer_FormOfWayIDT.h"
...
deserialization::Result DeserializerEHR_Bus_FormOfWays::Deserialize(deserialization::Reader &reader, ::Array_FormOfWayIDT_Vector::Array_FormOfWayIDT_Vector &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/EHRSI_Out/EHR_Bus_FormOfWays
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      TpPackAlias,
        // Config of vector length field and max. container size (/CppImplementationDataTypes/Array_FormOfWayIDT_Vector)
      ...
      >(deserialization::SizeToken<::Array_FormOfWayIDT_Vector::Array_FormOfWayIDT_Vector>{})};
