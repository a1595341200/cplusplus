 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/CurrentRoadLvl1VccIDT/impl_type_currentroadlvl1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_CURRENTROADLVL1VCCIDT_IMPL_TYPE_CURRENTROADLVL1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_CURRENTROADLVL1VCCIDT_IMPL_TYPE_CURRENTROADLVL1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_CURRENTROADLVL1VCCIDT_IMPL_TYPE_CURRENTROADLVL1VCCIDT_H_
