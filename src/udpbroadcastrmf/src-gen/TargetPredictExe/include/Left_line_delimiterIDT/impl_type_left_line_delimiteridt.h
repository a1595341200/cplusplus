 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/Left_line_delimiterIDT/impl_type_left_line_delimiteridt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_LEFT_LINE_DELIMITERIDT_IMPL_TYPE_LEFT_LINE_DELIMITERIDT_H_
#define TARGETPREDICTEXE_INCLUDE_LEFT_LINE_DELIMITERIDT_IMPL_TYPE_LEFT_LINE_DELIMITERIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_LEFT_LINE_DELIMITERIDT_IMPL_TYPE_LEFT_LINE_DELIMITERIDT_H_
