 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/amsr/someip_protocol/internal/dataprototype_serialization/targetpredictsi_out/events/serializer_TP_Bus_PredTargets2Vcc.h
 *        \brief  SOME/IP protocol serializer implementation for data prototype '/JICA/Service/Interface/TargetPredictSI_Out/TP_Bus_PredTargets2Vcc
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef TARGETPREDICTEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_TARGETPREDICTSI_OUT_EVENTS_serializer_TP_Bus_PredTargets2Vcc_h_
#define TARGETPREDICTEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_TARGETPREDICTSI_OUT_EVENTS_serializer_TP_Bus_PredTargets2Vcc_h_
...
/*!
 * \brief Serializer for service event /JICA/Service/Interface/TargetPredictSI_Out/TP_Bus_PredTargets2Vcc
 ...
 */
class SerializerTP_Bus_PredTargets2Vcc {
 public:
  /*!
   * \brief Returns the required buffer size for the data prototype service event /JICA/Service/Interface/TargetPredictSI_Out/TP_Bus_PredTargets2Vcc.
   *
  ...
  /*!
   * \brief Returns the maximum buffer size for the data prototype service event /JICA/Service/Interface/TargetPredictSI_Out/TP_Bus_PredTargets2Vcc.
   *
   * \return      Calculated buffer size for serialization.
   * \pre         -
   * \context     App
  ...
  /*!
   * \brief Serialize the data prototype service event /JICA/Service/Interface/TargetPredictSI_Out/TP_Bus_PredTargets2Vcc.
   *
...
#endif  // TARGETPREDICTEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_TARGETPREDICTSI_OUT_EVENTS_serializer_TP_Bus_PredTargets2Vcc_h_
