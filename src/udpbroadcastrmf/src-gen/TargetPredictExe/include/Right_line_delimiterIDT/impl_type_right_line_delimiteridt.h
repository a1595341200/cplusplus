 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/Right_line_delimiterIDT/impl_type_right_line_delimiteridt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_RIGHT_LINE_DELIMITERIDT_IMPL_TYPE_RIGHT_LINE_DELIMITERIDT_H_
#define TARGETPREDICTEXE_INCLUDE_RIGHT_LINE_DELIMITERIDT_IMPL_TYPE_RIGHT_LINE_DELIMITERIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_RIGHT_LINE_DELIMITERIDT_IMPL_TYPE_RIGHT_LINE_DELIMITERIDT_H_
