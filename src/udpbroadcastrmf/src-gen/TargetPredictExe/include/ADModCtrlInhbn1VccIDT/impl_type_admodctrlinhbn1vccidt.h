 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/ADModCtrlInhbn1VccIDT/impl_type_admodctrlinhbn1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_ADMODCTRLINHBN1VCCIDT_IMPL_TYPE_ADMODCTRLINHBN1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_ADMODCTRLINHBN1VCCIDT_IMPL_TYPE_ADMODCTRLINHBN1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_ADMODCTRLINHBN1VCCIDT_IMPL_TYPE_ADMODCTRLINHBN1VCCIDT_H_
