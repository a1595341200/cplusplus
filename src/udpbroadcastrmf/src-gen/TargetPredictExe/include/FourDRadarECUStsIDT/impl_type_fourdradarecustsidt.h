 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/FourDRadarECUStsIDT/impl_type_fourdradarecustsidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_FOURDRADARECUSTSIDT_IMPL_TYPE_FOURDRADARECUSTSIDT_H_
#define TARGETPREDICTEXE_INCLUDE_FOURDRADARECUSTSIDT_IMPL_TYPE_FOURDRADARECUSTSIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_FOURDRADARECUSTSIDT_IMPL_TYPE_FOURDRADARECUSTSIDT_H_
