 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/MapOddIDT/impl_type_mapoddidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_MAPODDIDT_IMPL_TYPE_MAPODDIDT_H_
#define TARGETPREDICTEXE_INCLUDE_MAPODDIDT_IMPL_TYPE_MAPODDIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_MAPODDIDT_IMPL_TYPE_MAPODDIDT_H_
