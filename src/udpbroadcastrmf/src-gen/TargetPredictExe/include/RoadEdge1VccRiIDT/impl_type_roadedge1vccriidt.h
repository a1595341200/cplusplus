 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/RoadEdge1VccRiIDT/impl_type_roadedge1vccriidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_ROADEDGE1VCCRIIDT_IMPL_TYPE_ROADEDGE1VCCRIIDT_H_
#define TARGETPREDICTEXE_INCLUDE_ROADEDGE1VCCRIIDT_IMPL_TYPE_ROADEDGE1VCCRIIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_ROADEDGE1VCCRIIDT_IMPL_TYPE_ROADEDGE1VCCRIIDT_H_
