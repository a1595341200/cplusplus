 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/RoadEdge1VccLeIDT/impl_type_roadedge1vccleidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
#define TARGETPREDICTEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
