 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/ADDimLight1VccIDT/impl_type_addimlight1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
