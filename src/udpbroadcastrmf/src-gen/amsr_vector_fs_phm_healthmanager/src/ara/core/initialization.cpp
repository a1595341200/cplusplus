 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  amsr_vector_fs_phm_healthmanager/src/ara/core/initialization.cpp
...
ara::core::Result<void> ara::core::Deinitialize() noexcept {
  ...
  if (ara::core::details::g_initialization_state == ara::core::details::InitializationState::kInitialized) {
    ...
    res = amsr::log::internal::DeinitializeComponent() // VCA_APPLICATIONBASE_FUNCTION_CALL_VERIFIED
