 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/LineSignGroupIDT/impl_type_linesigngroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_LINESIGNGROUPIDT_IMPL_TYPE_LINESIGNGROUPIDT_H_
