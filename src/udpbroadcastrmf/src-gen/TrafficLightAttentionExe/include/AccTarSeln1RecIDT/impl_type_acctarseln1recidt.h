 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/AccTarSeln1RecIDT/impl_type_acctarseln1recidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
