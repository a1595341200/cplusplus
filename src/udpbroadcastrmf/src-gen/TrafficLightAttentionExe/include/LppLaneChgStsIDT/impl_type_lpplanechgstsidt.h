 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/LppLaneChgStsIDT/impl_type_lpplanechgstsidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
