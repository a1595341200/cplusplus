 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/SuppSignType2IDT/impl_type_suppsigntype2idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
