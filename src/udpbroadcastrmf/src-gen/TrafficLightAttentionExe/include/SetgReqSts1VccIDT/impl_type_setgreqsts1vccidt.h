 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/SetgReqSts1VccIDT/impl_type_setgreqsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_SETGREQSTS1VCCIDT_IMPL_TYPE_SETGREQSTS1VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_SETGREQSTS1VCCIDT_IMPL_TYPE_SETGREQSTS1VCCIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_SETGREQSTS1VCCIDT_IMPL_TYPE_SETGREQSTS1VCCIDT_H_
