 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/AsyALatSts1VccIDT/impl_type_asyalatsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_ASYALATSTS1VCCIDT_IMPL_TYPE_ASYALATSTS1VCCIDT_H_
