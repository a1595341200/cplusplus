 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionrearsi_out/events/deserializer_PerceptionRear_Bus_CameraStatus.h
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_DESERIALIZATION_PERCEPTIONREARSI_OUT_EVENTS_deserializer_PerceptionRear_Bus_CameraStatus_h_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_DESERIALIZATION_PERCEPTIONREARSI_OUT_EVENTS_deserializer_PerceptionRear_Bus_CameraStatus_h_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_DESERIALIZATION_PERCEPTIONREARSI_OUT_EVENTS_deserializer_PerceptionRear_Bus_CameraStatus_h_
