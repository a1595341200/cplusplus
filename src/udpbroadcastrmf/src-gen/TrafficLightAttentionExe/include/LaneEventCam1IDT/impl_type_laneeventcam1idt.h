 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/LaneEventCam1IDT/impl_type_laneeventcam1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_LANEEVENTCAM1IDT_IMPL_TYPE_LANEEVENTCAM1IDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_LANEEVENTCAM1IDT_IMPL_TYPE_LANEEVENTCAM1IDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_LANEEVENTCAM1IDT_IMPL_TYPE_LANEEVENTCAM1IDT_H_
