 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/perceptionsi_out/PerceptionSI_Out_datatypes.h
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_DATATYPES_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_DATATYPES_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_DATATYPES_H_
