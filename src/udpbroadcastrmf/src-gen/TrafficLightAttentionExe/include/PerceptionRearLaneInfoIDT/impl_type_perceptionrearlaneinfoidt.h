 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/PerceptionRearLaneInfoIDT/impl_type_perceptionrearlaneinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONREARLANEINFOIDT_IMPL_TYPE_PERCEPTIONREARLANEINFOIDT_H_
