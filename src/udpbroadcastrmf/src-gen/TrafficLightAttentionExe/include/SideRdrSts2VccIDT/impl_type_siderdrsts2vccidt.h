 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/SideRdrSts2VccIDT/impl_type_siderdrsts2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
