 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/src/amsr/ipc_binding_transformation_layer/internal/objectfusionmodelsi_out/ObjectFusionModelSI_Out_proxy_xf_ipc_binding.cpp
...
ObjectFusionModelSI_OutProxyXf::ObjectFusionModelSI_OutProxyXf(
  ...
  ::amsr::ipc_binding_core::internal::runtime_configuration::ServiceConfig const& service_config)
    : provided_service_instance_id_{service_config.GetId(), service_instance_id,
      ...
      event_backend_OFM_Bus_FusedTargets01_{
          *this, sd_proxy, timer_manager,
          ...
          client_id_},
      event_backend_OFM_Bus_FusedTargets02_{
          *this, sd_proxy, timer_manager,
          runtime_processing_mode, provided_service_instance_id_,
          // VCA_IPCB_BASICSTRING_CONSTRUCTOR
          service_config.GetEventOf({"OFM_Bus_FusedTargets02"}).GetId(),
          client_id_},
      event_backend_OFM_Bus_FusedTargets03_{
          *this, sd_proxy, timer_manager,
          runtime_processing_mode, provided_service_instance_id_,
          // VCA_IPCB_BASICSTRING_CONSTRUCTOR
          service_config.GetEventOf({"OFM_Bus_FusedTargets03"}).GetId(),
          client_id_},
      event_backend_OFM_Bus_FusedTargets04_{
          *this, sd_proxy, timer_manager,
          runtime_processing_mode, provided_service_instance_id_,
          // VCA_IPCB_BASICSTRING_CONSTRUCTOR
      ...
      event_backend_OFM_St_SOCFusedSts_{
          *this, sd_proxy, timer_manager,
          ...
          client_id_},
      event_backend_OFM_Bus_FourDRadarStatus_{
          *this, sd_proxy, timer_manager,
          runtime_processing_mode, provided_service_instance_id_,
          // VCA_IPCB_BASICSTRING_CONSTRUCTOR
          service_config.GetEventOf({"OFM_Bus_FourDRadarStatus"}).GetId(),
          client_id_},
      event_backend_OFM_Bus_LaneInfo_{
          *this, sd_proxy, timer_manager,
          runtime_processing_mode, provided_service_instance_id_,
          // VCA_IPCB_BASICSTRING_CONSTRUCTOR
...
ObjectFusionModelSI_OutProxyXf::~ObjectFusionModelSI_OutProxyXf() noexcept { // VCA_IPCB_MOLE_1298
  // VCA_IPCB_SERVICE_INTERFACE_PROXY_XF_SAFE_UNDEFINED_FUNCTION
...
void ObjectFusionModelSI_OutProxyXf::EmplaceEventBackends() {
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_OFM_Bus_FusedTargets01_.GetEventId().value, &event_backend_OFM_Bus_FusedTargets01_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_OFM_Bus_FusedTargets02_.GetEventId().value, &event_backend_OFM_Bus_FusedTargets02_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_OFM_Bus_FusedTargets03_.GetEventId().value, &event_backend_OFM_Bus_FusedTargets03_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_OFM_Bus_FusedTargets04_.GetEventId().value, &event_backend_OFM_Bus_FusedTargets04_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_OFM_St_SOCFusedSts_.GetEventId().value, &event_backend_OFM_St_SOCFusedSts_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_OFM_Bus_FourDRadarStatus_.GetEventId().value, &event_backend_OFM_Bus_FourDRadarStatus_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_OFM_Bus_LaneInfo_.GetEventId().value, &event_backend_OFM_Bus_LaneInfo_ ));

}

::amsr::ipc_binding_core::internal::ForwardOutput ObjectFusionModelSI_OutProxyXf::RouteSubscribeMessage(
...
::amsr::ipc_binding_core::internal::ForwardOutput ObjectFusionModelSI_OutProxyXf::RouteUnsubscribeMessage(
...
::amsr::ipc_binding_core::internal::ForwardOutput ObjectFusionModelSI_OutProxyXf::OnResponseReceived(
        ::amsr::ipc_binding_core::internal::ipc_protocol::ResponseMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::ipc_binding_core::internal::ForwardOutput ObjectFusionModelSI_OutProxyXf::OnNotificationReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput ObjectFusionModelSI_OutProxyXf::OnSubscribeAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput ObjectFusionModelSI_OutProxyXf::OnSubscribeNAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput ObjectFusionModelSI_OutProxyXf::OnApplicationErrorReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ApplicationErrorMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

// VECTOR NC AutosarC++17_10-M0.1.8: MD_IPCBINDING_AutosarC++17_10_M0.1.8_config_variant
void ObjectFusionModelSI_OutProxyXf::OnErrorResponseReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ErrorResponseMessage&&) {
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::socal::SkeletonConnectionState ObjectFusionModelSI_OutProxyXf::ReadSkeletonConnectionState() noexcept {
...
// ---- Events ---------------------------------------------------------------------------------------------------
ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets01& ObjectFusionModelSI_OutProxyXf::GetEventBackendOFM_Bus_FusedTargets01() noexcept {
  return event_backend_OFM_Bus_FusedTargets01_;
}
ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets02& ObjectFusionModelSI_OutProxyXf::GetEventBackendOFM_Bus_FusedTargets02() noexcept {
  return event_backend_OFM_Bus_FusedTargets02_;
}
ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets03& ObjectFusionModelSI_OutProxyXf::GetEventBackendOFM_Bus_FusedTargets03() noexcept {
  return event_backend_OFM_Bus_FusedTargets03_;
}
ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets04& ObjectFusionModelSI_OutProxyXf::GetEventBackendOFM_Bus_FusedTargets04() noexcept {
  return event_backend_OFM_Bus_FusedTargets04_;
}
ObjectFusionModelSI_OutProxyXfEventBackendOFM_St_SOCFusedSts& ObjectFusionModelSI_OutProxyXf::GetEventBackendOFM_St_SOCFusedSts() noexcept {
  return event_backend_OFM_St_SOCFusedSts_;
}
ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FourDRadarStatus& ObjectFusionModelSI_OutProxyXf::GetEventBackendOFM_Bus_FourDRadarStatus() noexcept {
  return event_backend_OFM_Bus_FourDRadarStatus_;
}
ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_LaneInfo& ObjectFusionModelSI_OutProxyXf::GetEventBackendOFM_Bus_LaneInfo() noexcept {
  return event_backend_OFM_Bus_LaneInfo_;
}
// ---- Events ---------------------------------------------------------------------------------------------------
