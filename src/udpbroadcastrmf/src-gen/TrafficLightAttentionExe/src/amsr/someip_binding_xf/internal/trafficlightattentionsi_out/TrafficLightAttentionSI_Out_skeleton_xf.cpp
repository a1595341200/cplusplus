 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/src/amsr/someip_binding_xf/internal/trafficlightattentionsi_out/TrafficLightAttentionSI_Out_skeleton_xf.cpp
...
TrafficLightAttentionSI_OutSkeletonXf::TrafficLightAttentionSI_OutSkeletonXf(
...
bool TrafficLightAttentionSI_OutSkeletonXf::HandleMethodRequest(
...
events::skeleton::TLA_Bus_HMIDataTrfcLi::TrafficLightAttentionSI_OutSkeletonSomeIpEventManagerTLA_Bus_HMIDataTrfcLi* TrafficLightAttentionSI_OutSkeletonXf::GetEventManagerTLA_Bus_HMIDataTrfcLi() noexcept {
