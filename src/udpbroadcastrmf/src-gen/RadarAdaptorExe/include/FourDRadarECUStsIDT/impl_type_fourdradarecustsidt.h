 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RadarAdaptorExe/include/FourDRadarECUStsIDT/impl_type_fourdradarecustsidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RADARADAPTOREXE_INCLUDE_FOURDRADARECUSTSIDT_IMPL_TYPE_FOURDRADARECUSTSIDT_H_
#define RADARADAPTOREXE_INCLUDE_FOURDRADARECUSTSIDT_IMPL_TYPE_FOURDRADARECUSTSIDT_H_
...
#endif  // RADARADAPTOREXE_INCLUDE_FOURDRADARECUSTSIDT_IMPL_TYPE_FOURDRADARECUSTSIDT_H_
