 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_binding_xf/internal/trafficsigninformationsi_out/TrafficSignInformationSI_Out_skeleton_xf.cpp
 ...
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/someip_binding_xf/internal/trafficsigninformationsi_out/TrafficSignInformationSI_Out_skeleton_xf.h"
#include <utility>
...
TrafficSignInformationSI_OutSkeletonXf::TrafficSignInformationSI_OutSkeletonXf(
...
bool TrafficSignInformationSI_OutSkeletonXf::HandleMethodRequest(
...
events::skeleton::TSI_Bus_HMIData::TrafficSignInformationSI_OutSkeletonSomeIpEventManagerTSI_Bus_HMIData* TrafficSignInformationSI_OutSkeletonXf::GetEventManagerTSI_Bus_HMIData() noexcept {
