 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/ipc_binding_transformation_layer/internal/roadmodelfusionsi_out/RoadModelFusionSI_Out_proxy_xf_ipc_binding.cpp
 *        \brief  Frame for IPC binding service instance class of service 'RoadModelFusionSI_Out'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
RoadModelFusionSI_OutProxyXf::RoadModelFusionSI_OutProxyXf(
  ...
  ::amsr::ipc_binding_core::internal::runtime_configuration::ServiceConfig const& service_config)
    : provided_service_instance_id_{service_config.GetId(), service_instance_id,
      ...
      event_backend_RMF_Bus_RMFInfo_{
...
RoadModelFusionSI_OutProxyXf::~RoadModelFusionSI_OutProxyXf() noexcept { // VCA_IPCB_MOLE_1298
  // VCA_IPCB_SERVICE_INTERFACE_PROXY_XF_SAFE_UNDEFINED_FUNCTION
...
void RoadModelFusionSI_OutProxyXf::EmplaceEventBackends() {
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_RMF_Bus_RMFInfo_.GetEventId().value, &event_backend_RMF_Bus_RMFInfo_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_RMF_Bus_MapInfo_.GetEventId().value, &event_backend_RMF_Bus_MapInfo_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_RMF_Bus_VectorMapInfo_.GetEventId().value, &event_backend_RMF_Bus_VectorMapInfo_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_RMF_Bus_Position_.GetEventId().value, &event_backend_RMF_Bus_Position_ ));

}

::amsr::ipc_binding_core::internal::ForwardOutput RoadModelFusionSI_OutProxyXf::RouteSubscribeMessage(
...
::amsr::ipc_binding_core::internal::ForwardOutput RoadModelFusionSI_OutProxyXf::RouteUnsubscribeMessage(
...
::amsr::ipc_binding_core::internal::ForwardOutput RoadModelFusionSI_OutProxyXf::OnResponseReceived(
        ::amsr::ipc_binding_core::internal::ipc_protocol::ResponseMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::ipc_binding_core::internal::ForwardOutput RoadModelFusionSI_OutProxyXf::OnNotificationReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput RoadModelFusionSI_OutProxyXf::OnSubscribeAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput RoadModelFusionSI_OutProxyXf::OnSubscribeNAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput RoadModelFusionSI_OutProxyXf::OnApplicationErrorReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ApplicationErrorMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

// VECTOR NC AutosarC++17_10-M0.1.8: MD_IPCBINDING_AutosarC++17_10_M0.1.8_config_variant
void RoadModelFusionSI_OutProxyXf::OnErrorResponseReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ErrorResponseMessage&&) {
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::socal::SkeletonConnectionState RoadModelFusionSI_OutProxyXf::ReadSkeletonConnectionState() noexcept {
...
// ---- Events ---------------------------------------------------------------------------------------------------
RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_RMFInfo& RoadModelFusionSI_OutProxyXf::GetEventBackendRMF_Bus_RMFInfo() noexcept {
  return event_backend_RMF_Bus_RMFInfo_;
}
RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_MapInfo& RoadModelFusionSI_OutProxyXf::GetEventBackendRMF_Bus_MapInfo() noexcept {
  return event_backend_RMF_Bus_MapInfo_;
}
RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_VectorMapInfo& RoadModelFusionSI_OutProxyXf::GetEventBackendRMF_Bus_VectorMapInfo() noexcept {
  return event_backend_RMF_Bus_VectorMapInfo_;
}
RoadModelFusionSI_OutProxyXfEventBackendRMF_Bus_Position& RoadModelFusionSI_OutProxyXf::GetEventBackendRMF_Bus_Position() noexcept {
  return event_backend_RMF_Bus_Position_;
}
// ---- Events ---------------------------------------------------------------------------------------------------
