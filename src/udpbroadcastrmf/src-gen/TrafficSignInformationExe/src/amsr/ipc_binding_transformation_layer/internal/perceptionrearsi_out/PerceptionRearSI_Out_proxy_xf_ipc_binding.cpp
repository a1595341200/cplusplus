 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/ipc_binding_transformation_layer/internal/perceptionrearsi_out/PerceptionRearSI_Out_proxy_xf_ipc_binding.cpp
...
PerceptionRearSI_OutProxyXf::PerceptionRearSI_OutProxyXf(
  ...
  ::amsr::ipc_binding_core::internal::runtime_configuration::ServiceConfig const& service_config)
    : provided_service_instance_id_{service_config.GetId(), service_instance_id,
      ...
      event_backend_PerceptionRear_Bus_LaneInfo_{
          *this, sd_proxy, timer_manager,
          ...
          client_id_},
      event_backend_PerceptionRear_Bus_CameraStatus_{
          *this, sd_proxy, timer_manager,
          runtime_processing_mode, provided_service_instance_id_,
          // VCA_IPCB_BASICSTRING_CONSTRUCTOR
          service_config.GetEventOf({"PerceptionRear_Bus_CameraStatus"}).GetId(),
          client_id_},
      event_backend_PerceptionRear_Bus_VisnObj_{
          *this, sd_proxy, timer_manager,
          runtime_processing_mode, provided_service_instance_id_,
          // VCA_IPCB_BASICSTRING_CONSTRUCTOR
...
PerceptionRearSI_OutProxyXf::~PerceptionRearSI_OutProxyXf() noexcept { // VCA_IPCB_MOLE_1298
  // VCA_IPCB_SERVICE_INTERFACE_PROXY_XF_SAFE_UNDEFINED_FUNCTION
...
void PerceptionRearSI_OutProxyXf::EmplaceEventBackends() {
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_PerceptionRear_Bus_LaneInfo_.GetEventId().value, &event_backend_PerceptionRear_Bus_LaneInfo_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_PerceptionRear_Bus_CameraStatus_.GetEventId().value, &event_backend_PerceptionRear_Bus_CameraStatus_ ));
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_PerceptionRear_Bus_VisnObj_.GetEventId().value, &event_backend_PerceptionRear_Bus_VisnObj_ ));

}

::amsr::ipc_binding_core::internal::ForwardOutput PerceptionRearSI_OutProxyXf::RouteSubscribeMessage(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionRearSI_OutProxyXf::RouteUnsubscribeMessage(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionRearSI_OutProxyXf::OnResponseReceived(
        ::amsr::ipc_binding_core::internal::ipc_protocol::ResponseMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::ipc_binding_core::internal::ForwardOutput PerceptionRearSI_OutProxyXf::OnNotificationReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionRearSI_OutProxyXf::OnSubscribeAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionRearSI_OutProxyXf::OnSubscribeNAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionRearSI_OutProxyXf::OnApplicationErrorReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ApplicationErrorMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

// VECTOR NC AutosarC++17_10-M0.1.8: MD_IPCBINDING_AutosarC++17_10_M0.1.8_config_variant
void PerceptionRearSI_OutProxyXf::OnErrorResponseReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ErrorResponseMessage&&) {
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::socal::SkeletonConnectionState PerceptionRearSI_OutProxyXf::ReadSkeletonConnectionState() noexcept {
...
// ---- Events ---------------------------------------------------------------------------------------------------
PerceptionRearSI_OutProxyXfEventBackendPerceptionRear_Bus_LaneInfo& PerceptionRearSI_OutProxyXf::GetEventBackendPerceptionRear_Bus_LaneInfo() noexcept {
  return event_backend_PerceptionRear_Bus_LaneInfo_;
}
PerceptionRearSI_OutProxyXfEventBackendPerceptionRear_Bus_CameraStatus& PerceptionRearSI_OutProxyXf::GetEventBackendPerceptionRear_Bus_CameraStatus() noexcept {
  return event_backend_PerceptionRear_Bus_CameraStatus_;
}
PerceptionRearSI_OutProxyXfEventBackendPerceptionRear_Bus_VisnObj& PerceptionRearSI_OutProxyXf::GetEventBackendPerceptionRear_Bus_VisnObj() noexcept {
  return event_backend_PerceptionRear_Bus_VisnObj_;
}
// ---- Events ---------------------------------------------------------------------------------------------------
