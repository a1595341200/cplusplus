 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_binding/internal/configuration/someipbinding_config_validation_data.cpp
...
#include "amsr/someip_binding/internal/configuration/trafficsigninformationsi_out/TrafficSignInformationSI_Out_config_validation_data.h"
...
{"/JICA/Service/Interface/ToSOCA_InfomationSI"_sv,
     ...
     ConfigValidationDataAccess{
      &::amsr::someip_binding::internal::configuration::gen_trafficsigninformationsi_out::TrafficSignInformationSI_OutConfigValidationData::kValidEventConfigurationEntities[0],
      1,
      nullptr,
      0,
      nullptr,
