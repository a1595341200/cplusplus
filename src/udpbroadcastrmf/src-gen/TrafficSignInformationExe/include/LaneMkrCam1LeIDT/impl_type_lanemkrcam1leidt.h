 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/LaneMkrCam1LeIDT/impl_type_lanemkrcam1leidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEMKRCAM1LEIDT_IMPL_TYPE_LANEMKRCAM1LEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEMKRCAM1LEIDT_IMPL_TYPE_LANEMKRCAM1LEIDT_H_
...
/*!
 * \brief Type LaneMkrCam1LeIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/LaneMkrCam1LeIDT
 */
struct LaneMkrCam1LeIDT {
...
/*!
 * \brief   Compare for equality with another LaneMkrCam1LeIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(LaneMkrCam1LeIDT const& l,
                       LaneMkrCam1LeIDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another LaneMkrCam1LeIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEMKRCAM1LEIDT_IMPL_TYPE_LANEMKRCAM1LEIDT_H_
