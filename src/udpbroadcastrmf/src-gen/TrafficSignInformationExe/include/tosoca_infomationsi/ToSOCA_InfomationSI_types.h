 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_types.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_TYPES_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_TYPES_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_TYPES_H_
