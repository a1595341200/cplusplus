 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_datatypes.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
