 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/FrntCamSts1VccIDT/impl_type_frntcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
