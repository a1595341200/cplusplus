 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/Right_line_delimiterIDT/impl_type_right_line_delimiteridt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_RIGHT_LINE_DELIMITERIDT_IMPL_TYPE_RIGHT_LINE_DELIMITERIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_RIGHT_LINE_DELIMITERIDT_IMPL_TYPE_RIGHT_LINE_DELIMITERIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_RIGHT_LINE_DELIMITERIDT_IMPL_TYPE_RIGHT_LINE_DELIMITERIDT_H_
