...
using TSI_Bus_HMIData = ::amsr::socal::events::SkeletonEvent<
    ...
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::TsiHmiData1VccIDT::TsiHmiData1VccIDT>,
...
class TrafficSignInformationSI_OutSkeleton
    : public ::amsr::socal::Skeleton<trafficsigninformationsi_out::TrafficSignInformationSI_Out,
      ...
      public       trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonBackendInterface {
 public:
...
explicit TrafficSignInformationSI_OutSkeleton(ConstructionToken&& token) noexcept;
   ...
   * \details 
   * Data of type ::TsiHmiData1VccIDT::TsiHmiData1VccIDT
   * \vpublic
   */
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<trafficsigninformationsi_out::TrafficSignInformationSI_Out, trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonImplInterface, ::amsr::socal::kRuntimeProcessingMode>;
