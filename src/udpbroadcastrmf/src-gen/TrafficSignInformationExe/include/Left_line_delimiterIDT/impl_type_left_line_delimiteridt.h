 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/Left_line_delimiterIDT/impl_type_left_line_delimiteridt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_LEFT_LINE_DELIMITERIDT_IMPL_TYPE_LEFT_LINE_DELIMITERIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_LEFT_LINE_DELIMITERIDT_IMPL_TYPE_LEFT_LINE_DELIMITERIDT_H_
...
/*!
 * \brief Type Left_line_delimiterIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/Left_line_delimiterIDT
 */
struct Left_line_delimiterIDT {
...
/*!
 * \brief   Compare for equality with another Left_line_delimiterIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(Left_line_delimiterIDT const& l,
                       Left_line_delimiterIDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another Left_line_delimiterIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_LEFT_LINE_DELIMITERIDT_IMPL_TYPE_LEFT_LINE_DELIMITERIDT_H_
