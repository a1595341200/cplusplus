 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/SetgReqSts1VccIDT/impl_type_setgreqsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_SETGREQSTS1VCCIDT_IMPL_TYPE_SETGREQSTS1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_SETGREQSTS1VCCIDT_IMPL_TYPE_SETGREQSTS1VCCIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_SETGREQSTS1VCCIDT_IMPL_TYPE_SETGREQSTS1VCCIDT_H_
