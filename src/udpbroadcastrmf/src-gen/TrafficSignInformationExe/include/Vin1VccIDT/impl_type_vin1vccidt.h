 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/Vin1VccIDT/impl_type_vin1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_VIN1VCCIDT_IMPL_TYPE_VIN1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_VIN1VCCIDT_IMPL_TYPE_VIN1VCCIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_VIN1VCCIDT_IMPL_TYPE_VIN1VCCIDT_H_
