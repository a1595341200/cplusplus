 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/LppLaneChgStsIDT/impl_type_lpplanechgstsidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_LPPLANECHGSTSIDT_IMPL_TYPE_LPPLANECHGSTSIDT_H_
