 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/StopLineIDT/impl_type_stoplineidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
...
/*!
 * \brief Type StopLineIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/StopLineIDT
 */
struct StopLineIDT {
...
/*!
 * \brief   Compare for equality with another StopLineIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(StopLineIDT const& l,
                       StopLineIDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another StopLineIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
