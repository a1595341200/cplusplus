 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/DrvModReqType2VccIDT/impl_type_drvmodreqtype2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
