 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/BltLockStFrntIDT/impl_type_bltlockstfrntidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
