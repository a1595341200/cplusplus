 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/someip_protocol/internal/datatype_deserialization/LaneMkrCam1LeIDT/deserializer_LaneMkrCam1LeIDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'LaneMkrCam1LeIDT'
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRCAM1LEIDT_DESERIALIZER_LANEMKRCAM1LEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRCAM1LEIDT_DESERIALIZER_LANEMKRCAM1LEIDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/LaneMkrCam1LeIDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1LeIDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::LaneMkrCam1LeIDT::LaneMkrCam1LeIDT &data) noexcept {
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/LaneMkrCam1LeIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::LaneMkrCam1LeIDT::LaneMkrCam1LeIDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRCAM1LEIDT_DESERIALIZER_LANEMKRCAM1LEIDT_H_
