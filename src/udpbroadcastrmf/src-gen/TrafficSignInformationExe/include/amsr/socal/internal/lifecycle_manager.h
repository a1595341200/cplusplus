 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/socal/internal/lifecycle_manager.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
...
#include "trafficsigninformationsi_out/TrafficSignInformationSI_Out.h"
...
class LifecycleManager final {
 public:
  ...
  static void Initialize() noexcept {
    ...
    trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton::CreateSingletons();
  ...
  static void Deinitialize() noexcept {
    ...
    trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton::DestroySingletons();
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    perceptionsidesi_out::proxy::PerceptionSideSI_OutProxy::RegisterServiceDiscovery(&perceptionsidesi_out_proxy_sd_2_);
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    roadmodelfusionsi_out::proxy::RoadModelFusionSI_OutProxy::RegisterServiceDiscovery(&roadmodelfusionsi_out_proxy_sd_3_);
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    tosoca_infomationsi::proxy::ToSOCA_InfomationSIProxy::RegisterServiceDiscovery(&tosoca_infomationsi_proxy_sd_4_);

    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton::RegisterServiceDiscovery(&trafficsigninformationsi_out_skeleton_sd_0_);
  }
  ...
  void DeInitializeServiceDiscovery() noexcept {
    ...
    trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton::DeRegisterServiceDiscovery();
  }
   ...
   */
  ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      perceptionsidesi_out::internal::PerceptionSideSI_OutProxyBackendInterface> perceptionsidesi_out_proxy_sd_2_{perceptionsidesi_out::PerceptionSideSI_Out::kServiceShortNamePath};
   ...
   */
  ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      roadmodelfusionsi_out::internal::RoadModelFusionSI_OutProxyBackendInterface> roadmodelfusionsi_out_proxy_sd_3_{roadmodelfusionsi_out::RoadModelFusionSI_Out::kServiceShortNamePath};
   ...
   *        for the service interface trafficsigninformationsi_out::TrafficSignInformationSI_Out.
   */
  trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton::ServiceDiscovery trafficsigninformationsi_out_skeleton_sd_0_{trafficsigninformationsi_out::TrafficSignInformationSI_Out::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr

#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
