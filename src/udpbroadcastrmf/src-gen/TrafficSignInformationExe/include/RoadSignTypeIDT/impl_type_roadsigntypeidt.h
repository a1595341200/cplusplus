 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/RoadSignTypeIDT/impl_type_roadsigntypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADSIGNTYPEIDT_IMPL_TYPE_ROADSIGNTYPEIDT_H_
