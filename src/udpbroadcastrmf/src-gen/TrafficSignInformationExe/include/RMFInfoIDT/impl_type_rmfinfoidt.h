 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/RMFInfoIDT/impl_type_rmfinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_RMFINFOIDT_IMPL_TYPE_RMFINFOIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_RMFINFOIDT_IMPL_TYPE_RMFINFOIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_RMFINFOIDT_IMPL_TYPE_RMFINFOIDT_H_
