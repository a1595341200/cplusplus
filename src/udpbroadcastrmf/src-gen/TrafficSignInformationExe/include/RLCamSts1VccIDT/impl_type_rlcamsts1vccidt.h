 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/RLCamSts1VccIDT/impl_type_rlcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_RLCAMSTS1VCCIDT_IMPL_TYPE_RLCAMSTS1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_RLCAMSTS1VCCIDT_IMPL_TYPE_RLCAMSTS1VCCIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_RLCAMSTS1VCCIDT_IMPL_TYPE_RLCAMSTS1VCCIDT_H_
