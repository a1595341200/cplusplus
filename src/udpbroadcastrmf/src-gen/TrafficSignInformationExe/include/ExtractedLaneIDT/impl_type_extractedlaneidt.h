 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/ExtractedLaneIDT/impl_type_extractedlaneidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTRACTEDLANEIDT_IMPL_TYPE_EXTRACTEDLANEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTRACTEDLANEIDT_IMPL_TYPE_EXTRACTEDLANEIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTRACTEDLANEIDT_IMPL_TYPE_EXTRACTEDLANEIDT_H_
