 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/RearCamSts1VccIDT/impl_type_rearcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_REARCAMSTS1VCCIDT_IMPL_TYPE_REARCAMSTS1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_REARCAMSTS1VCCIDT_IMPL_TYPE_REARCAMSTS1VCCIDT_H_
...
/*!
 * \brief Type RearCamSts1VccIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/RearCamSts1VccIDT
 */
struct RearCamSts1VccIDT {
...
/*!
 * \brief Compare for equality with another RearCamSts1VccIDT instance.
 */
inline bool operator==(RearCamSts1VccIDT const& l,
                       RearCamSts1VccIDT const& r) noexcept {
...
/*!
 * \brief Compare for inequality with another RearCamSts1VccIDT instance.
 */
inline bool operator!=(RearCamSts1VccIDT const& l,
                       RearCamSts1VccIDT const& r) noexcept {
  return !(l == r);
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_REARCAMSTS1VCCIDT_IMPL_TYPE_REARCAMSTS1VCCIDT_H_
