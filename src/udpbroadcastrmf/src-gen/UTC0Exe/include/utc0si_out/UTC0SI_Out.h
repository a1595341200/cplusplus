 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  UTC0Exe/include/utc0si_out/UTC0SI_Out.h
 *        \brief  Header for service 'UTC0SI_Out'.
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef UTC0EXE_INCLUDE_UTC0SI_OUT_UTC0SI_OUT_H_
#define UTC0EXE_INCLUDE_UTC0SI_OUT_UTC0SI_OUT_H_
...
/*!
 * \brief Representation of service 'UTC0SI_Out'
...
*/
 using CStringView = vac::container::CStringView;
   ...
   */
  static constexpr CStringView kServiceIdentifier{"UTC0SI_Out"_sv};
 ...
 public:
   ...
   */
  static constexpr CStringView kServiceShortNamePath{"/JICA/Service/Interface/UTC0SI_Out"_sv};
};

}  // namespace utc0si_out

#endif  // UTC0EXE_INCLUDE_UTC0SI_OUT_UTC0SI_OUT_H_
