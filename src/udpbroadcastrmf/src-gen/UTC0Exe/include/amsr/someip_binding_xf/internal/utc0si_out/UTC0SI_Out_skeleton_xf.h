 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  UTC0Exe/include/amsr/someip_binding_xf/internal/utc0si_out/UTC0SI_Out_skeleton_xf.h
...
#ifndef UTC0EXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_UTC0SI_OUT_UTC0SI_OUT_SKELETON_XF_H_
#define UTC0EXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_UTC0SI_OUT_UTC0SI_OUT_SKELETON_XF_H_
...
#include "amsr/someip_binding_xf/internal/utc0si_out/UTC0SI_Out_payload_serializer_factory.h"
 ...
 * \remark generated
 */
class UTC0SI_OutSkeletonXf final :
...
/*!
  ...
  /*!
   * \brief Constructor of UTC0SI_OutSkeletonXf.
   ...
   * \synchronous TRUE
   */
  UTC0SI_OutSkeletonXf(::amsr::someip_binding_core::internal::ProvidedServiceInstanceId const provided_service_instance_id,
  ...
  ~UTC0SI_OutSkeletonXf() noexcept override  = default;  // COV_SOMEIPBINDING_SKELETON_XF

  UTC0SI_OutSkeletonXf(UTC0SI_OutSkeletonXf const&) noexcept = delete;
  UTC0SI_OutSkeletonXf(UTC0SI_OutSkeletonXf&& other) noexcept = delete;
  UTC0SI_OutSkeletonXf& operator=(UTC0SI_OutSkeletonXf const&) & = delete;
  UTC0SI_OutSkeletonXf& operator=(UTC0SI_OutSkeletonXf&&) & noexcept = delete;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  events::skeleton::UTC0_Bus_VehTiAndData::UTC0SI_OutSkeletonSomeIpEventManagerUTC0_Bus_VehTiAndData* GetEventManagerUTC0_Bus_VehTiAndData() noexcept override;
 ...
 private:
   ...
   */
  ::utc0si_out::internal::UTC0SI_OutSkeletonBackendInterface& skeleton_;
...
// ---- Event manager --------------------------------------------------------------------------------------------
  ...
  ::amsr::someip_binding::internal::configuration::EventConfig const&
      ...
      events_UTC0SI_OutSkeletonSomeIpEventConfigurationUTC0_Bus_VehTiAndData_event_config_{
          ...
          config_wrapper_.GetEventConfig(
              ...
              ::amsr::someip_binding::internal::configuration::Shortname{events::skeleton::UTC0_Bus_VehTiAndData::EventDesignInfo::kEventName.c_str()})};

  // Event Xf for skeleton protected event 'UTC0_Bus_VehTiAndData'
  // VCA_SOMEIPBINDING_TRIVIAL_VALID_REFERENCE
  std::unique_ptr<ser_deser::SerializerInterface<events::skeleton::UTC0_Bus_VehTiAndData::EventDesignInfo::SampleType>> event_xf_serializer_ptr_UTC0_Bus_VehTiAndData_{
    events::skeleton::UTC0_Bus_VehTiAndData::SerializerFactory::Create()
  };
  ...
  events::skeleton::UTC0_Bus_VehTiAndData::UTC0SI_OutSkeletonSomeIpEventManagerUTC0_Bus_VehTiAndData event_manager_UTC0_Bus_VehTiAndData_{
      ::amsr::someip_binding_core::internal::SomeIpEventIdentity{
          ...
          events_UTC0SI_OutSkeletonSomeIpEventConfigurationUTC0_Bus_VehTiAndData_event_config_
              ...
              .GetEventId()},
      server_,
      *(event_xf_serializer_ptr_UTC0_Bus_VehTiAndData_.get()),
      // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
      // VECTOR NC VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
     ...
     // VCA_SPC_15_SOMEIPBINDING_OTHER_COMPONENT_TYPE_FUNCTION
     // VCA_SOMEIPBINDING_POSSIBLY_CALLING_NULLPTR_METHOD_CALL_ON_REF
     events_UTC0SI_OutSkeletonSomeIpEventConfigurationUTC0_Bus_VehTiAndData_event_config_.GetDisableSessionHandling().value_or(false),
     events_UTC0SI_OutSkeletonSomeIpEventConfigurationUTC0_Bus_VehTiAndData_event_config_
         // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
...
#endif  // UTC0EXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_UTC0SI_OUT_UTC0SI_OUT_SKELETON_XF_H_
