...
#include "utc0si_out/UTC0SI_Out.h"
...
class LifecycleManager final {
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    utc0si_in::proxy::UTC0SI_InProxy::RegisterServiceDiscovery(&utc0si_in_proxy_sd_0_);

    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    utc0si_out::skeleton::UTC0SI_OutSkeleton::RegisterServiceDiscovery(&utc0si_out_skeleton_sd_0_);
  }
  ...
  ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      utc0si_in::internal::UTC0SI_InProxyBackendInterface> utc0si_in_proxy_sd_0_{utc0si_in::UTC0SI_In::kServiceShortNamePath};
   ...
   *        for the service interface utc0si_out::UTC0SI_Out.
   */
  utc0si_out::skeleton::UTC0SI_OutSkeleton::ServiceDiscovery utc0si_out_skeleton_sd_0_{utc0si_out::UTC0SI_Out::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr
