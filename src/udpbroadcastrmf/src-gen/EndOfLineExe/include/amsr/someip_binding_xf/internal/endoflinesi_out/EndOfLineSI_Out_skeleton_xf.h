 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/amsr/someip_binding_xf/internal/endoflinesi_out/EndOfLineSI_Out_skeleton_xf.h
 *        \brief  SOME/IP binding of service skeleton for service 'EndOfLineSI_Out'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef ENDOFLINEEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_ENDOFLINESI_OUT_ENDOFLINESI_OUT_SKELETON_XF_H_
#define ENDOFLINEEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_ENDOFLINESI_OUT_ENDOFLINESI_OUT_SKELETON_XF_H_
 ...
 * \remark generated
 */
class EndOfLineSI_OutSkeletonXf final :
    public ::endoflinesi_out::internal::EndOfLineSI_OutSkeletonImplInterface,
...
/*!
  ...
  /*!
   * \brief Constructor of EndOfLineSI_OutSkeletonXf.
   ...
   * \synchronous TRUE
   */
  EndOfLineSI_OutSkeletonXf(::amsr::someip_binding_core::internal::ProvidedServiceInstanceId const provided_service_instance_id,
  ...
  ~EndOfLineSI_OutSkeletonXf() noexcept override  = default;  // COV_SOMEIPBINDING_SKELETON_XF

  EndOfLineSI_OutSkeletonXf(EndOfLineSI_OutSkeletonXf const&) noexcept = delete;
  EndOfLineSI_OutSkeletonXf(EndOfLineSI_OutSkeletonXf&& other) noexcept = delete;
  EndOfLineSI_OutSkeletonXf& operator=(EndOfLineSI_OutSkeletonXf const&) & = delete;
  EndOfLineSI_OutSkeletonXf& operator=(EndOfLineSI_OutSkeletonXf&&) & noexcept = delete;
  ...
  /*!
   * \brief Get the event manager object for the SOME/IP binding service event 'EOL_Bus_CamCalibStatus'.
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  events::skeleton::EOL_Bus_CamCalibStatus::EndOfLineSI_OutSkeletonSomeIpEventManagerEOL_Bus_CamCalibStatus* GetEventManagerEOL_Bus_CamCalibStatus() noexcept override;
 ...
 private:
   ...
   */
  ::endoflinesi_out::internal::EndOfLineSI_OutSkeletonBackendInterface& skeleton_;
...
// ---- Event manager --------------------------------------------------------------------------------------------
  ...
  ::amsr::someip_binding::internal::configuration::EventConfig const&
      ...
      events_EndOfLineSI_OutSkeletonSomeIpEventConfigurationEOL_Bus_CamCalibStatus_event_config_{
          ...
          config_wrapper_.GetEventConfig(
              ...
              ::amsr::someip_binding::internal::configuration::Shortname{events::skeleton::EOL_Bus_CamCalibStatus::EventDesignInfo::kEventName.c_str()})};

  // Event Xf for skeleton protected event 'EOL_Bus_CamCalibStatus'
  // VCA_SOMEIPBINDING_TRIVIAL_VALID_REFERENCE
  std::unique_ptr<ser_deser::SerializerInterface<events::skeleton::EOL_Bus_CamCalibStatus::EventDesignInfo::SampleType>> event_xf_serializer_ptr_EOL_Bus_CamCalibStatus_{
    events::skeleton::EOL_Bus_CamCalibStatus::SerializerFactory::Create()
  };
  ...
  events::skeleton::EOL_Bus_CamCalibStatus::EndOfLineSI_OutSkeletonSomeIpEventManagerEOL_Bus_CamCalibStatus event_manager_EOL_Bus_CamCalibStatus_{
      ::amsr::someip_binding_core::internal::SomeIpEventIdentity{
          ...
          events_EndOfLineSI_OutSkeletonSomeIpEventConfigurationEOL_Bus_CamCalibStatus_event_config_
              ...
              .GetEventId()},
      server_,
      *(event_xf_serializer_ptr_EOL_Bus_CamCalibStatus_.get()),
      // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
      // VECTOR NC VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
     ...
     // VCA_SPC_15_SOMEIPBINDING_OTHER_COMPONENT_TYPE_FUNCTION
     // VCA_SOMEIPBINDING_POSSIBLY_CALLING_NULLPTR_METHOD_CALL_ON_REF
     events_EndOfLineSI_OutSkeletonSomeIpEventConfigurationEOL_Bus_CamCalibStatus_event_config_.GetDisableSessionHandling().value_or(false),
     events_EndOfLineSI_OutSkeletonSomeIpEventConfigurationEOL_Bus_CamCalibStatus_event_config_
         // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
...
#endif  // ENDOFLINEEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_ENDOFLINESI_OUT_ENDOFLINESI_OUT_SKELETON_XF_H_
