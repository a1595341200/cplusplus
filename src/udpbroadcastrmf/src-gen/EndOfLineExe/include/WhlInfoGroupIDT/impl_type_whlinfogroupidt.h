 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/WhlInfoGroupIDT/impl_type_whlinfogroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
#define ENDOFLINEEXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_WHLINFOGROUPIDT_IMPL_TYPE_WHLINFOGROUPIDT_H_
