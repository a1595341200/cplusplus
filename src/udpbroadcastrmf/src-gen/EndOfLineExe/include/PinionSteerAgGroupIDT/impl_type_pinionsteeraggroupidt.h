 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/PinionSteerAgGroupIDT/impl_type_pinionsteeraggroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
#define ENDOFLINEEXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
