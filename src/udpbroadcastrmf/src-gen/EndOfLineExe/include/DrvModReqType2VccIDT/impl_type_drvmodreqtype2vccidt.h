 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/DrvModReqType2VccIDT/impl_type_drvmodreqtype2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
#define ENDOFLINEEXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_DRVMODREQTYPE2VCCIDT_IMPL_TYPE_DRVMODREQTYPE2VCCIDT_H_
