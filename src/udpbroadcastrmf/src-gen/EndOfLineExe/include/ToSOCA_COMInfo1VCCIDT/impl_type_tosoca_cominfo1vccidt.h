 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/ToSOCA_COMInfo1VCCIDT/impl_type_tosoca_cominfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_TOSOCA_COMINFO1VCCIDT_IMPL_TYPE_TOSOCA_COMINFO1VCCIDT_H_
#define ENDOFLINEEXE_INCLUDE_TOSOCA_COMINFO1VCCIDT_IMPL_TYPE_TOSOCA_COMINFO1VCCIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_TOSOCA_COMINFO1VCCIDT_IMPL_TYPE_TOSOCA_COMINFO1VCCIDT_H_
