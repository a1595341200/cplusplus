 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/SetgReqSts1VccIDT/impl_type_setgreqsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_SETGREQSTS1VCCIDT_IMPL_TYPE_SETGREQSTS1VCCIDT_H_
#define ENDOFLINEEXE_INCLUDE_SETGREQSTS1VCCIDT_IMPL_TYPE_SETGREQSTS1VCCIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_SETGREQSTS1VCCIDT_IMPL_TYPE_SETGREQSTS1VCCIDT_H_
