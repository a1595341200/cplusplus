 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/src/amsr/socal/internal/runtime_gen.cpp
...
void Runtime::InitializeInstanceSpecifierLookupTables() noexcept {
  ...
  // Add R-Port InstanceSpecifier 'EndOfLineExe/EndOfLine/EndOfLine_ToSOCA_InfomationSI_R' to the lookup table.
  // VCA_SOCAL_UNDEFINED_RUNTIME_ADD_INSTANCE_SPECIFIER_FUNCTION
  AddInstanceSpecifier(required_instance_specifier_table_, "EndOfLineExe/EndOfLine/EndOfLine_ToSOCA_InfomationSI_R"_sv);

  // Add P-Port InstanceSpecifier 'EndOfLineExe/EndOfLine/EndOfLine_EndOfLineSI_Out_P' to the lookup table.
  // VCA_SOCAL_UNDEFINED_RUNTIME_ADD_INSTANCE_SPECIFIER_FUNCTION
  AddInstanceSpecifier(provided_instance_specifier_table_, "EndOfLineExe/EndOfLine/EndOfLine_EndOfLineSI_Out_P"_sv);
}
