 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RtkExe/src/amsr/someip_protocol/internal/dataprototype_serialization/rtk_p/events/serializer_ErrorCode.cpp
...
void SerializerErrorCode::Serialize(serialization::Writer
&writer, ::SOMEIP::ValidationKey::RtkErrorCode const &data) noexcept {
