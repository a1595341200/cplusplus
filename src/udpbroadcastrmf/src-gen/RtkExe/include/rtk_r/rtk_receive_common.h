 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RtkExe/include/rtk_r/rtk_receive_common.h
...
#ifndef RTKEXE_INCLUDE_RTK_R_RTK_RECEIVE_COMMON_H_
#define RTKEXE_INCLUDE_RTK_R_RTK_RECEIVE_COMMON_H_
...
#endif  // RTKEXE_INCLUDE_RTK_R_RTK_RECEIVE_COMMON_H_
