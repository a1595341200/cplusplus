 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RtkExe/include/rtk_r/Rtk_Receive_datatypes.h
...
#ifndef RTKEXE_INCLUDE_RTK_R_RTK_RECEIVE_DATATYPES_H_
#define RTKEXE_INCLUDE_RTK_R_RTK_RECEIVE_DATATYPES_H_
...
#endif  // RTKEXE_INCLUDE_RTK_R_RTK_RECEIVE_DATATYPES_H_
