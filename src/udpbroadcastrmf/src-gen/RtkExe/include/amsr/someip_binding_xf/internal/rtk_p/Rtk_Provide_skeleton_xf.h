 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RtkExe/include/amsr/someip_binding_xf/internal/rtk_p/Rtk_Provide_skeleton_xf.h
...
#ifndef RTKEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_RTK_P_RTK_PROVIDE_SKELETON_XF_H_
#define RTKEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_RTK_P_RTK_PROVIDE_SKELETON_XF_H_
...
#include "amsr/someip_binding_xf/internal/rtk_p/Rtk_Provide_payload_serializer_factory.h"
#include "amsr/someip_binding_xf/internal/rtk_p/Rtk_Provide_skeleton_someip_methods.h"
 ...
 * \remark generated
 */
class Rtk_ProvideSkeletonXf final :
...
/*!
  ...
  /*!
   * \brief Constructor of Rtk_ProvideSkeletonXf.
   ...
   * \synchronous TRUE
   */
  Rtk_ProvideSkeletonXf(::amsr::someip_binding_core::internal::ProvidedServiceInstanceId const provided_service_instance_id,
                                              ::amsr::someip_binding_core::internal::ServerInterface& server,
                                              ::rtk_p::internal::Rtk_ProvideSkeletonBackendInterface& skeleton,
  ...
  ~Rtk_ProvideSkeletonXf() noexcept override  = default;  // COV_SOMEIPBINDING_SKELETON_XF

  Rtk_ProvideSkeletonXf(Rtk_ProvideSkeletonXf const&) noexcept = delete;
  Rtk_ProvideSkeletonXf(Rtk_ProvideSkeletonXf&& other) noexcept = delete;
  Rtk_ProvideSkeletonXf& operator=(Rtk_ProvideSkeletonXf const&) & = delete;
  Rtk_ProvideSkeletonXf& operator=(Rtk_ProvideSkeletonXf&&) & noexcept = delete;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  events::skeleton::GgaData_provide::Rtk_ProvideSkeletonSomeIpEventManagerGgaData_provide* GetEventManagerGgaData_provide() noexcept override;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  events::skeleton::ErrorCode::Rtk_ProvideSkeletonSomeIpEventManagerErrorCode* GetEventManagerErrorCode() noexcept override;
 ...
 private:
   ...
   */
  ::rtk_p::internal::Rtk_ProvideSkeletonBackendInterface& skeleton_;
...
// ---- Event manager --------------------------------------------------------------------------------------------
  ...
  ::amsr::someip_binding::internal::configuration::EventConfig const&
      ...
      events_Rtk_ProvideSkeletonSomeIpEventConfigurationGgaData_provide_event_config_{
          ...
          config_wrapper_.GetEventConfig(
              ...
              ::amsr::someip_binding::internal::configuration::Shortname{events::skeleton::GgaData_provide::EventDesignInfo::kEventName.c_str()})};

  // Event Xf for skeleton protected event 'GgaData_provide'
  // VCA_SOMEIPBINDING_TRIVIAL_VALID_REFERENCE
  std::unique_ptr<ser_deser::SerializerInterface<events::skeleton::GgaData_provide::EventDesignInfo::SampleType>> event_xf_serializer_ptr_GgaData_provide_{
    events::skeleton::GgaData_provide::SerializerFactory::Create()
  };
  ...
  events::skeleton::GgaData_provide::Rtk_ProvideSkeletonSomeIpEventManagerGgaData_provide event_manager_GgaData_provide_{
      ::amsr::someip_binding_core::internal::SomeIpEventIdentity{
          ...
          events_Rtk_ProvideSkeletonSomeIpEventConfigurationGgaData_provide_event_config_
              ...
              .GetEventId()},
      server_,
      *(event_xf_serializer_ptr_GgaData_provide_.get()),
      // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
      // VECTOR NC VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
     ...
     // VCA_SPC_15_SOMEIPBINDING_OTHER_COMPONENT_TYPE_FUNCTION
     // VCA_SOMEIPBINDING_POSSIBLY_CALLING_NULLPTR_METHOD_CALL_ON_REF
     events_Rtk_ProvideSkeletonSomeIpEventConfigurationGgaData_provide_event_config_.GetDisableSessionHandling().value_or(false),
     events_Rtk_ProvideSkeletonSomeIpEventConfigurationGgaData_provide_event_config_
         // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
  ...
  ::amsr::someip_binding::internal::configuration::EventConfig const&
      // VCA_SOMEIPBINDING_ACCESSING_MEMBERS_OF_REFERENCE_CLASS_ATTRIBUTES
      // VCA_SOMEIPBINDING_MISS_OF_INFORMATION_OF_POINTER
      events_Rtk_ProvideSkeletonSomeIpEventConfigurationErrorCode_event_config_{
          // VCA_SOMEIPBINDING_POSSIBLY_CALLING_NULLPTR_METHOD_CALL_ON_REF
          config_wrapper_.GetEventConfig(
              // VCA_SPC_15_SOMEIPBINDING_OTHER_COMPONENT_TYPE_FUNCTION
              ::amsr::someip_binding::internal::configuration::Shortname{events::skeleton::ErrorCode::EventDesignInfo::kEventName.c_str()})};

  // Event Xf for skeleton protected event 'ErrorCode'
  // VCA_SOMEIPBINDING_TRIVIAL_VALID_REFERENCE
  std::unique_ptr<ser_deser::SerializerInterface<events::skeleton::ErrorCode::EventDesignInfo::SampleType>> event_xf_serializer_ptr_ErrorCode_{
    events::skeleton::ErrorCode::SerializerFactory::Create()
  };
  // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
  // VECTOR NC VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
  // VCA_SOMEIPBINDING_TRIVIAL_VALID_REFERENCE
  // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
  events::skeleton::ErrorCode::Rtk_ProvideSkeletonSomeIpEventManagerErrorCode event_manager_ErrorCode_{
      ::amsr::someip_binding_core::internal::SomeIpEventIdentity{
          provided_service_instance_id_.GetServiceId(),
          provided_service_instance_id_.GetMajorVersion(),
          provided_service_instance_id_.GetInstanceId(),
          events_Rtk_ProvideSkeletonSomeIpEventConfigurationErrorCode_event_config_
              ...
              .GetEventId()},
      server_,
      *(event_xf_serializer_ptr_ErrorCode_.get()),
      // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
      // VECTOR NC VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
      // VCA_SOMEIPBINDING_PASSING_REFERENCE
      ::amsr::someip_binding::internal::SomeIpBindingSkeletonEventXfInitializer::GetSkeletonEventXfE2EParametrizationData(
     ...
     // VCA_SPC_15_SOMEIPBINDING_OTHER_COMPONENT_TYPE_FUNCTION
     // VCA_SOMEIPBINDING_POSSIBLY_CALLING_NULLPTR_METHOD_CALL_ON_REF
     events_Rtk_ProvideSkeletonSomeIpEventConfigurationErrorCode_event_config_.GetDisableSessionHandling().value_or(false),
     events_Rtk_ProvideSkeletonSomeIpEventConfigurationErrorCode_event_config_
         // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
         .GetSerialization().value_or(
             ::amsr::someip_binding::internal::configuration::EventConfig::Serialization::someip),
...
#endif  // RTKEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_RTK_P_RTK_PROVIDE_SKELETON_XF_H_
