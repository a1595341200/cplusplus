 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/ADDimLight1VccIDT/impl_type_addimlight1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_ADDIMLIGHT1VCCIDT_IMPL_TYPE_ADDIMLIGHT1VCCIDT_H_
