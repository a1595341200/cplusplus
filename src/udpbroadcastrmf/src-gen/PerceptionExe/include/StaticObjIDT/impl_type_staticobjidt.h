 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/StaticObjIDT/impl_type_staticobjidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_STATICOBJIDT_IMPL_TYPE_STATICOBJIDT_H_
#define PERCEPTIONEXE_INCLUDE_STATICOBJIDT_IMPL_TYPE_STATICOBJIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_STATICOBJIDT_IMPL_TYPE_STATICOBJIDT_H_
