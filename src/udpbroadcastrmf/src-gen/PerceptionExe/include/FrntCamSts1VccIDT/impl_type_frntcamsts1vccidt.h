 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/FrntCamSts1VccIDT/impl_type_frntcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_FRNTCAMSTS1VCCIDT_IMPL_TYPE_FRNTCAMSTS1VCCIDT_H_
