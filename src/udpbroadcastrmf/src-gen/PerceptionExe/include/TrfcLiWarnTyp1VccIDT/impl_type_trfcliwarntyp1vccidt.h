 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/TrfcLiWarnTyp1VccIDT/impl_type_trfcliwarntyp1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_TRFCLIWARNTYP1VCCIDT_IMPL_TYPE_TRFCLIWARNTYP1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_TRFCLIWARNTYP1VCCIDT_IMPL_TYPE_TRFCLIWARNTYP1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_TRFCLIWARNTYP1VCCIDT_IMPL_TYPE_TRFCLIWARNTYP1VCCIDT_H_
