 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LaneEventCam1IDT/impl_type_laneeventcam1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LANEEVENTCAM1IDT_IMPL_TYPE_LANEEVENTCAM1IDT_H_
#define PERCEPTIONEXE_INCLUDE_LANEEVENTCAM1IDT_IMPL_TYPE_LANEEVENTCAM1IDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LANEEVENTCAM1IDT_IMPL_TYPE_LANEEVENTCAM1IDT_H_
