 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/PerceptionLaneInfoIDT/impl_type_perceptionlaneinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
#define PERCEPTIONEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_PERCEPTIONLANEINFOIDT_IMPL_TYPE_PERCEPTIONLANEINFOIDT_H_
