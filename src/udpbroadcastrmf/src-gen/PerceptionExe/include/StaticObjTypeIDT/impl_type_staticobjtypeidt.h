 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/StaticObjTypeIDT/impl_type_staticobjtypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_STATICOBJTYPEIDT_IMPL_TYPE_STATICOBJTYPEIDT_H_
#define PERCEPTIONEXE_INCLUDE_STATICOBJTYPEIDT_IMPL_TYPE_STATICOBJTYPEIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_STATICOBJTYPEIDT_IMPL_TYPE_STATICOBJTYPEIDT_H_
