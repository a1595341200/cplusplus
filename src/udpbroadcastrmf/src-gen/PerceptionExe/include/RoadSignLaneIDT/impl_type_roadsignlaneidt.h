 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/RoadSignLaneIDT/impl_type_roadsignlaneidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_ROADSIGNLANEIDT_IMPL_TYPE_ROADSIGNLANEIDT_H_
#define PERCEPTIONEXE_INCLUDE_ROADSIGNLANEIDT_IMPL_TYPE_ROADSIGNLANEIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_ROADSIGNLANEIDT_IMPL_TYPE_ROADSIGNLANEIDT_H_
