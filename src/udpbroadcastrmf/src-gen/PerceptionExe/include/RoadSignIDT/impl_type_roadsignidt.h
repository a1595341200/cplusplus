 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/RoadSignIDT/impl_type_roadsignidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
#define PERCEPTIONEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
