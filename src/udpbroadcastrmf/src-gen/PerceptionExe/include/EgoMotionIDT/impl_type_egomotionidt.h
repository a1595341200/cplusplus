 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/EgoMotionIDT/impl_type_egomotionidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
#define PERCEPTIONEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
