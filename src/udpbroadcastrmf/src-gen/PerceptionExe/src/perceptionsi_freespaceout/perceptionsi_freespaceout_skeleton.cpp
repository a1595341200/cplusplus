...
PerceptionSI_FreeSpaceOutSkeleton::PerceptionSI_FreeSpaceOutSkeleton(::ara::com::InstanceIdentifier instance,
     ...
     : PerceptionSI_FreeSpaceOutSkeleton{Preconstruct(instance, mode).Value()} {}  // VCA_SOCAL_COPY_CTOR_WITH_CTOR_ARGUMENT

PerceptionSI_FreeSpaceOutSkeleton::PerceptionSI_FreeSpaceOutSkeleton(::ara::core::InstanceSpecifier instance,
                                               ::ara::com::MethodCallProcessingMode mode) noexcept
     : PerceptionSI_FreeSpaceOutSkeleton{Preconstruct(instance, mode).Value()} {}
...
PerceptionSI_FreeSpaceOutSkeleton::PerceptionSI_FreeSpaceOutSkeleton(::ara::com::InstanceIdentifierContainer instance_identifiers,
     ...
     : PerceptionSI_FreeSpaceOutSkeleton{Preconstruct(instance_identifiers, mode).Value()} {}
...
void PerceptionSI_FreeSpaceOutSkeleton::SendInitialFieldNotifications(SkeletonImplInterfacePtr const concrete_impl_interface) const noexcept {
...
void PerceptionSI_FreeSpaceOutSkeleton::PrepareEventsAndFieldNotifiers(SkeletonImplInterfacePtr const concrete_impl_interface) noexcept {
   FusedCam_Bus_FreeSpace.InitializePreallocatedValue(concrete_impl_interface);
