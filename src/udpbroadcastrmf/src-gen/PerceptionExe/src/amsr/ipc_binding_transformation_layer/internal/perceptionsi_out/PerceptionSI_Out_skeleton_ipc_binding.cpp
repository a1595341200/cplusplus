...
void PerceptionSI_OutProvidedIpcServiceInstance::OnRequestReceived(
...
// VECTOR NC AutosarC++17_10-M0.1.8: MD_IPCBINDING_AutosarC++17_10_M0.1.8_config_variant
// VECTOR NC AutosarC++17_10-M7.1.2: MD_IPCBINDING_AutosarC++17_10-M7.1.2_config_variant
void PerceptionSI_OutProvidedIpcServiceInstance::OnRequestNoReturnReceived(
...
::amsr::ipc_binding_core::internal::ForwardNotificationMessage PerceptionSI_OutProvidedIpcServiceInstance::OnSubscribeEventReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_OutProvidedIpcServiceInstance::OnUnsubscribeEventReceived(
...
PerceptionSI_OutSkeletonIpcEventManagerPerception_Bus_LaneInfo* PerceptionSI_OutProvidedIpcServiceInstance::GetEventManagerPerception_Bus_LaneInfo() noexcept {
  return &event_Perception_Bus_LaneInfo_;
}
// Event 'Perception_Bus_FrntCamInfo'
PerceptionSI_OutSkeletonIpcEventManagerPerception_Bus_FrntCamInfo* PerceptionSI_OutProvidedIpcServiceInstance::GetEventManagerPerception_Bus_FrntCamInfo() noexcept {
  return &event_Perception_Bus_FrntCamInfo_;
}
// Event 'FrntCam_Bus_TrafficInfo'
PerceptionSI_OutSkeletonIpcEventManagerFrntCam_Bus_TrafficInfo* PerceptionSI_OutProvidedIpcServiceInstance::GetEventManagerFrntCam_Bus_TrafficInfo() noexcept {
  return &event_FrntCam_Bus_TrafficInfo_;
}
...
PerceptionSI_OutSkeletonIpcEventManagerFrntCam_Bus_LineSignGroup* PerceptionSI_OutProvidedIpcServiceInstance::GetEventManagerFrntCam_Bus_LineSignGroup() noexcept {
  return &event_FrntCam_Bus_LineSignGroup_;
}
