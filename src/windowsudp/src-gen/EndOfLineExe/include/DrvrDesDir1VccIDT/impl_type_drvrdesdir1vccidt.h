 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/DrvrDesDir1VccIDT/impl_type_drvrdesdir1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
#define ENDOFLINEEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
