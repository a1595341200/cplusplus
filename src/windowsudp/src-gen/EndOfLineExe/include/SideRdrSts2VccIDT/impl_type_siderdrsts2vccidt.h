 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/SideRdrSts2VccIDT/impl_type_siderdrsts2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
#define ENDOFLINEEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
