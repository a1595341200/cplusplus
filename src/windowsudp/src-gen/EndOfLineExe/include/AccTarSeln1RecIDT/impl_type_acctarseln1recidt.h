 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/AccTarSeln1RecIDT/impl_type_acctarseln1recidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
#define ENDOFLINEEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_ACCTARSELN1RECIDT_IMPL_TYPE_ACCTARSELN1RECIDT_H_
