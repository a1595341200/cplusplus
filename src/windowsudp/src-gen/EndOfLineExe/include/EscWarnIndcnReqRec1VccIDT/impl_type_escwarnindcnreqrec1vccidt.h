 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/EscWarnIndcnReqRec1VccIDT/impl_type_escwarnindcnreqrec1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
#define ENDOFLINEEXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_ESCWARNINDCNREQREC1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQREC1VCCIDT_H_
