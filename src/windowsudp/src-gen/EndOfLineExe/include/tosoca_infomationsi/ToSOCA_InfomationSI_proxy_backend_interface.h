 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_proxy_backend_interface.h
...
#ifndef ENDOFLINEEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_BACKEND_INTERFACE_H_
#define ENDOFLINEEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_BACKEND_INTERFACE_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_BACKEND_INTERFACE_H_
