 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/TjaTrailBusIDT/impl_type_tjatrailbusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
#define ENDOFLINEEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
