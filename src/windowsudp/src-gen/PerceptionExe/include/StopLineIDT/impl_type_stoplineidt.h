 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/StopLineIDT/impl_type_stoplineidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
#define PERCEPTIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_STOPLINEIDT_IMPL_TYPE_STOPLINEIDT_H_
