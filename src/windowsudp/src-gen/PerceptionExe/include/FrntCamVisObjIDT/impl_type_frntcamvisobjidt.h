 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/FrntCamVisObjIDT/impl_type_frntcamvisobjidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_FRNTCAMVISOBJIDT_IMPL_TYPE_FRNTCAMVISOBJIDT_H_
#define PERCEPTIONEXE_INCLUDE_FRNTCAMVISOBJIDT_IMPL_TYPE_FRNTCAMVISOBJIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_FRNTCAMVISOBJIDT_IMPL_TYPE_FRNTCAMVISOBJIDT_H_
