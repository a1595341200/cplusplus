 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/SideRdrSts2VccIDT/impl_type_siderdrsts2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_SIDERDRSTS2VCCIDT_IMPL_TYPE_SIDERDRSTS2VCCIDT_H_
