 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LsrObjIDT/impl_type_lsrobjidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LSROBJIDT_IMPL_TYPE_LSROBJIDT_H_
#define PERCEPTIONEXE_INCLUDE_LSROBJIDT_IMPL_TYPE_LSROBJIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LSROBJIDT_IMPL_TYPE_LSROBJIDT_H_
