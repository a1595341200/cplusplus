 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/CrossInfo1VccIDT/impl_type_crossinfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_CROSSINFO1VCCIDT_IMPL_TYPE_CROSSINFO1VCCIDT_H_
#define PERCEPTIONEXE_INCLUDE_CROSSINFO1VCCIDT_IMPL_TYPE_CROSSINFO1VCCIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_CROSSINFO1VCCIDT_IMPL_TYPE_CROSSINFO1VCCIDT_H_
