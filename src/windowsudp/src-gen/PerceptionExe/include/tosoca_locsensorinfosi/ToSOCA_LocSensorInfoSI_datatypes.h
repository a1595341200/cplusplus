 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_datatypes.h
...
#ifndef PERCEPTIONEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
#define PERCEPTIONEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
