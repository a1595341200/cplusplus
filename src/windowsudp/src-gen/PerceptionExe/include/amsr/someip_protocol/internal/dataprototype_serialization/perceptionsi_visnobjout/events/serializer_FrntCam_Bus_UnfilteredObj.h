 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_protocol/internal/dataprototype_serialization/perceptionsi_visnobjout/events/serializer_FrntCam_Bus_UnfilteredObj.h
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_VISNOBJOUT_EVENTS_serializer_FrntCam_Bus_UnfilteredObj_h_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_VISNOBJOUT_EVENTS_serializer_FrntCam_Bus_UnfilteredObj_h_
...
/*!
 * \brief Serializer for service event /JICA/Service/Interface/PerceptionSI_VisnObjOut/FrntCam_Bus_UnfilteredObj
 *        of service interface /JICA/Service/Interface/PerceptionSI_VisnObjOut.
 * \details Top-Level data type: /CppImplementationDataTypes/Array_UnfilteredObjIDT_30
 ...
 */
class SerializerFrntCam_Bus_UnfilteredObj {
 public:
  /*!
   * \brief Returns the required buffer size for the data prototype service event /JICA/Service/Interface/PerceptionSI_VisnObjOut/FrntCam_Bus_UnfilteredObj.
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/Array_UnfilteredObjIDT_30.
   *
   ...
   * \endspec
   */
  constexpr static std::size_t GetRequiredBufferSize(::Array_UnfilteredObjIDT_30::Array_UnfilteredObjIDT_30 const &data) noexcept {
  ...
  /*!
   * \brief Returns the maximum buffer size for the data prototype service event /JICA/Service/Interface/PerceptionSI_VisnObjOut/FrntCam_Bus_UnfilteredObj.
   *
   * \return      Calculated buffer size for serialization.
   * \pre         -
   * \context     App
  ...
  /*!
   * \brief Serialize the data prototype service event /JICA/Service/Interface/PerceptionSI_VisnObjOut/FrntCam_Bus_UnfilteredObj.
   *
  ...
  static void Serialize(serialization::Writer &writer, ::Array_UnfilteredObjIDT_30::Array_UnfilteredObjIDT_30 const &data) noexcept;
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_VISNOBJOUT_EVENTS_serializer_FrntCam_Bus_UnfilteredObj_h_
