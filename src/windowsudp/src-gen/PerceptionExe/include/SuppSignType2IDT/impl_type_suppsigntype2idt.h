 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/SuppSignType2IDT/impl_type_suppsigntype2idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
#define PERCEPTIONEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_SUPPSIGNTYPE2IDT_IMPL_TYPE_SUPPSIGNTYPE2IDT_H_
