 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/CamLineTypeIDT/impl_type_camlinetypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_CAMLINETYPEIDT_IMPL_TYPE_CAMLINETYPEIDT_H_
#define PERCEPTIONEXE_INCLUDE_CAMLINETYPEIDT_IMPL_TYPE_CAMLINETYPEIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_CAMLINETYPEIDT_IMPL_TYPE_CAMLINETYPEIDT_H_
