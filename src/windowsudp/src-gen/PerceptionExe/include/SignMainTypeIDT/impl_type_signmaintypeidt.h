 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/SignMainTypeIDT/impl_type_signmaintypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
#define PERCEPTIONEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_SIGNMAINTYPEIDT_IMPL_TYPE_SIGNMAINTYPEIDT_H_
