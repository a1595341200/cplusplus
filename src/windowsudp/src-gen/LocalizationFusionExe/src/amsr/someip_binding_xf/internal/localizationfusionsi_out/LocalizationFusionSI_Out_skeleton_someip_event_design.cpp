 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/src/amsr/someip_binding_xf/internal/localizationfusionsi_out/LocalizationFusionSI_Out_skeleton_someip_event_design.cpp
...
/*!
 * \brief Definition of the shortname of the skeleton event configuration for event 'LFM_Bus_MapErrorSts'.
 */
