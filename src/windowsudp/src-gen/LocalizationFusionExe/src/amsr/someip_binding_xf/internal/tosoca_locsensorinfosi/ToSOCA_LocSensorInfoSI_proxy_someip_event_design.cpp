 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/src/amsr/someip_binding_xf/internal/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_proxy_someip_event_design.cpp
...
/*!
 * \brief Definition of the shortname of the proxy event configuration for event 'OSM2_Bus_LocSensorInfo'.
 */
