 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/perceptionsi_out/PerceptionSI_Out_datatypes.h
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_DATATYPES_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_DATATYPES_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_DATATYPES_H_
