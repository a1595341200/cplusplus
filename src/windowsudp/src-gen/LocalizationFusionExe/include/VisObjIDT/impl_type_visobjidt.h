 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/VisObjIDT/impl_type_visobjidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_VISOBJIDT_IMPL_TYPE_VISOBJIDT_H_
