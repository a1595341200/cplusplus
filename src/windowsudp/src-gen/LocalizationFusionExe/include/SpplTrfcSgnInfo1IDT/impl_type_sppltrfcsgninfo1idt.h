 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/SpplTrfcSgnInfo1IDT/impl_type_sppltrfcsgninfo1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
