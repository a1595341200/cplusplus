 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/BltLockStFrntIDT/impl_type_bltlockstfrntidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_BLTLOCKSTFRNTIDT_IMPL_TYPE_BLTLOCKSTFRNTIDT_H_
