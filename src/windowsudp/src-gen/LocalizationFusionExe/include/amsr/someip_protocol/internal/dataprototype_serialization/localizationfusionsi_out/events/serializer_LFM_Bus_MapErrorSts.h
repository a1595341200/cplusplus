 ...
 * \details Top-Level data type: /CppImplementationDataTypes/MapErrorStsIDT
...
class SerializerLFM_Bus_MapErrorSts {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/MapErrorStsIDT.
   *
   ...
   * \endspec
   */
  constexpr static std::size_t GetRequiredBufferSize(::MapErrorStsIDT::MapErrorStsIDT const &data) noexcept {
  ...
  /*!
   * \brief Returns the maximum buffer size for the data prototype service event /JICA/Service/Interface/LocalizationFusionSI_Out/LFM_Bus_MapErrorSts.
   *
   * \return      Calculated buffer size for serialization.
   * \pre         -
   * \context     App
  ...
  static void Serialize(serialization::Writer &writer, ::MapErrorStsIDT::MapErrorStsIDT const &data) noexcept;
