 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/RearCamSts1VccIDT/impl_type_rearcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_REARCAMSTS1VCCIDT_IMPL_TYPE_REARCAMSTS1VCCIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_REARCAMSTS1VCCIDT_IMPL_TYPE_REARCAMSTS1VCCIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_REARCAMSTS1VCCIDT_IMPL_TYPE_REARCAMSTS1VCCIDT_H_
