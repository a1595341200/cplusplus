 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/StaticObjIDT/impl_type_staticobjidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_STATICOBJIDT_IMPL_TYPE_STATICOBJIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_STATICOBJIDT_IMPL_TYPE_STATICOBJIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_STATICOBJIDT_IMPL_TYPE_STATICOBJIDT_H_
