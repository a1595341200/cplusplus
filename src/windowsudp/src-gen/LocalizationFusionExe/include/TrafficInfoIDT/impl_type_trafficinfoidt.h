 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/TrafficInfoIDT/impl_type_trafficinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_TRAFFICINFOIDT_IMPL_TYPE_TRAFFICINFOIDT_H_
