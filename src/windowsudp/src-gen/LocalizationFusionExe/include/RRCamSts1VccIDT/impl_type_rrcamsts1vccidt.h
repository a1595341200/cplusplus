 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/RRCamSts1VccIDT/impl_type_rrcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_RRCAMSTS1VCCIDT_IMPL_TYPE_RRCAMSTS1VCCIDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_RRCAMSTS1VCCIDT_IMPL_TYPE_RRCAMSTS1VCCIDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_RRCAMSTS1VCCIDT_IMPL_TYPE_RRCAMSTS1VCCIDT_H_
