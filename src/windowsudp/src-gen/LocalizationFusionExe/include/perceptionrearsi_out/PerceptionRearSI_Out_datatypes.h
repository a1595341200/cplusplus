 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/perceptionrearsi_out/PerceptionRearSI_Out_datatypes.h
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_DATATYPES_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_DATATYPES_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_DATATYPES_H_
