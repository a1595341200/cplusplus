 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/VehMtnSt2IDT/impl_type_vehmtnst2idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_VEHMTNST2IDT_IMPL_TYPE_VEHMTNST2IDT_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_VEHMTNST2IDT_IMPL_TYPE_VEHMTNST2IDT_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_VEHMTNST2IDT_IMPL_TYPE_VEHMTNST2IDT_H_
