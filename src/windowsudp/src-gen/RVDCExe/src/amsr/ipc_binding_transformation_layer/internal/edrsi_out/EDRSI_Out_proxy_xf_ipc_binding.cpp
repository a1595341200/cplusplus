 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/src/amsr/ipc_binding_transformation_layer/internal/edrsi_out/EDRSI_Out_proxy_xf_ipc_binding.cpp
 *        \brief  Frame for IPC binding service instance class of service 'EDRSI_Out'
 *
 *      \details
 *
 *********************************************************************************************************************/
 ...
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/ipc_binding_transformation_layer/internal/edrsi_out/EDRSI_Out_proxy_xf_ipc_binding.h"
#include <utility>
...
EDRSI_OutProxyXf::EDRSI_OutProxyXf(
  ...
  ::amsr::ipc_binding_core::internal::runtime_configuration::ServiceConfig const& service_config)
    : provided_service_instance_id_{service_config.GetId(), service_instance_id,
      ...
      event_backend_EDR_Bus_EDRInfo_{
...
EDRSI_OutProxyXf::~EDRSI_OutProxyXf() noexcept { // VCA_IPCB_MOLE_1298
  // VCA_IPCB_SERVICE_INTERFACE_PROXY_XF_SAFE_UNDEFINED_FUNCTION
...
void EDRSI_OutProxyXf::EmplaceEventBackends() {
  // VCA_IPCB_STD_FUNCTION_CALLED
  static_cast<void>(event_backend_table_.emplace(event_backend_EDR_Bus_EDRInfo_.GetEventId().value, &event_backend_EDR_Bus_EDRInfo_ ));

}

::amsr::ipc_binding_core::internal::ForwardOutput EDRSI_OutProxyXf::RouteSubscribeMessage(
...
::amsr::ipc_binding_core::internal::ForwardOutput EDRSI_OutProxyXf::RouteUnsubscribeMessage(
...
::amsr::ipc_binding_core::internal::ForwardOutput EDRSI_OutProxyXf::OnResponseReceived(
        ::amsr::ipc_binding_core::internal::ipc_protocol::ResponseMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::ipc_binding_core::internal::ForwardOutput EDRSI_OutProxyXf::OnNotificationReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput EDRSI_OutProxyXf::OnSubscribeAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput EDRSI_OutProxyXf::OnSubscribeNAckReceived(
...
::amsr::ipc_binding_core::internal::ForwardOutput EDRSI_OutProxyXf::OnApplicationErrorReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ApplicationErrorMessage&&) {
  return true;
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

// VECTOR NC AutosarC++17_10-M0.1.8: MD_IPCBINDING_AutosarC++17_10_M0.1.8_config_variant
void EDRSI_OutProxyXf::OnErrorResponseReceived(
    ::amsr::ipc_binding_core::internal::ipc_protocol::ErrorResponseMessage&&) {
}  // COV_IpcBinding_FunctionCallCoverage_unused_functionality

::amsr::socal::SkeletonConnectionState EDRSI_OutProxyXf::ReadSkeletonConnectionState() noexcept {
...
// ---- Events ---------------------------------------------------------------------------------------------------
EDRSI_OutProxyXfEventBackendEDR_Bus_EDRInfo& EDRSI_OutProxyXf::GetEventBackendEDR_Bus_EDRInfo() noexcept {
  return event_backend_EDR_Bus_EDRInfo_;
}
// ---- Events ---------------------------------------------------------------------------------------------------
