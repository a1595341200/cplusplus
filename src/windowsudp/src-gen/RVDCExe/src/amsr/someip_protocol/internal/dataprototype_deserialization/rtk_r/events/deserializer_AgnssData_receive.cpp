 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/rtk_r/events/deserializer_AgnssData_receive.cpp
...
deserialization::Result DeserializerAgnssData_receive::Deserialize(deserialization::Reader &reader, ::SOMEIP::ValidationKey::RtkVIN &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/Rtk_Receive/AgnssData_receive
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      TpPackAlias,
        // Config of array length field (/AUTOSAR/RTK/RtkVIN)
      ...
      >(deserialization::SizeToken<::SOMEIP::ValidationKey::RtkVIN>{})};
