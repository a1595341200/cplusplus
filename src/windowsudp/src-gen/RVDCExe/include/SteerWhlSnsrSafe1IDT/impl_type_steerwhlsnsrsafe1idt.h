 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/SteerWhlSnsrSafe1IDT/impl_type_steerwhlsnsrsafe1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
#define RVDCEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
...
#endif  // RVDCEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
