 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/amsr/ipc_binding_transformation_layer/internal/edrsi_out/EDRSI_Out_proxy_xf_ipc_binding.h
...
#ifndef RVDCEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_EDRSI_OUT_EDRSI_OUT_PROXY_XF_IPC_BINDING_H_
#define RVDCEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_EDRSI_OUT_EDRSI_OUT_PROXY_XF_IPC_BINDING_H_
...
#include <map>
#include <utility>
#include "amsr/ipc_binding_transformation_layer/internal/edrsi_out/EDRSI_Out_proxy_xf_ipc_events.h"
...
/*!
 * \brief Required service interface deployment of service interface 'EDRSI_Out'.
 * \unit  ProxyInstance
 */
class EDRSI_OutProxyXf final
    : public ::edrsi_out::internal::EDRSI_OutProxyBackendInterface,
 ...
 public:
  ...
  /*!
   * \brief         Constructor of ProxyXf for service 'EDRSI_Out'.
   ...
   *                                                EDRSI_OutProxyXf's entire life time.
   ...
   * \synchronous TRUE
   */
  ~EDRSI_OutProxyXf() noexcept final;

  EDRSI_OutProxyXf(EDRSI_OutProxyXf const &) = delete;
  EDRSI_OutProxyXf &operator=(EDRSI_OutProxyXf const &) = delete;
  EDRSI_OutProxyXf(EDRSI_OutProxyXf &&) = delete;
  EDRSI_OutProxyXf &operator=(EDRSI_OutProxyXf &&) = delete;
 ...
 // ---- Events ---------------------------------------------------------------------------------------------------
  ...
  /*!
   * \brief       Getter function for the event 'EDR_Bus_EDRInfo'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  EDRSI_OutProxyXfEventBackendEDR_Bus_EDRInfo& GetEventBackendEDR_Bus_EDRInfo() noexcept final;
 ...
 private:
  ...
  /*!
   * \brief Event backend for proxy event 'EDR_Bus_EDRInfo'.
   */
  EDRSI_OutProxyXfEventBackendEDR_Bus_EDRInfo event_backend_EDR_Bus_EDRInfo_;
...
#endif  // RVDCEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_EDRSI_OUT_EDRSI_OUT_PROXY_XF_IPC_BINDING_H_
