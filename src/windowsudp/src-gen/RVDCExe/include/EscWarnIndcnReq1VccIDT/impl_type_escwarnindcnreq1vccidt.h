 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/EscWarnIndcnReq1VccIDT/impl_type_escwarnindcnreq1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_ESCWARNINDCNREQ1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQ1VCCIDT_H_
#define RVDCEXE_INCLUDE_ESCWARNINDCNREQ1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQ1VCCIDT_H_
...
#endif  // RVDCEXE_INCLUDE_ESCWARNINDCNREQ1VCCIDT_IMPL_TYPE_ESCWARNINDCNREQ1VCCIDT_H_
