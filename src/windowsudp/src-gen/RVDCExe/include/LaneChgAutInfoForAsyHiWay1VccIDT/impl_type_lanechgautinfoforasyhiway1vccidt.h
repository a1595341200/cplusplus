 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/LaneChgAutInfoForAsyHiWay1VccIDT/impl_type_lanechgautinfoforasyhiway1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_IMPL_TYPE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_H_
#define RVDCEXE_INCLUDE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_IMPL_TYPE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_H_
...
#endif  // RVDCEXE_INCLUDE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_IMPL_TYPE_LANECHGAUTINFOFORASYHIWAY1VCCIDT_H_
