 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RVDCExe/include/IntvAndWarnModForLaneKeepAidSts1VccIDT/impl_type_intvandwarnmodforlanekeepaidsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RVDCEXE_INCLUDE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_IMPL_TYPE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_H_
#define RVDCEXE_INCLUDE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_IMPL_TYPE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_H_
...
#endif  // RVDCEXE_INCLUDE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_IMPL_TYPE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_H_
