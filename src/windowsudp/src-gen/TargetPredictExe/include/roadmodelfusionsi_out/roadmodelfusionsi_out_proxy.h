 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/roadmodelfusionsi_out/roadmodelfusionsi_out_proxy.h
...
#ifndef TARGETPREDICTEXE_INCLUDE_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_PROXY_H_
#define TARGETPREDICTEXE_INCLUDE_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_PROXY_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_ROADMODELFUSIONSI_OUT_ROADMODELFUSIONSI_OUT_PROXY_H_
