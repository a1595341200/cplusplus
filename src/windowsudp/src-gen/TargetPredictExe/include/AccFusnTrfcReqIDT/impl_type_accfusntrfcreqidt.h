 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/AccFusnTrfcReqIDT/impl_type_accfusntrfcreqidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
#define TARGETPREDICTEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
