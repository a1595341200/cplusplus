 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/RampInfo1VccIDT/impl_type_rampinfo1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_RAMPINFO1VCCIDT_IMPL_TYPE_RAMPINFO1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_RAMPINFO1VCCIDT_IMPL_TYPE_RAMPINFO1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_RAMPINFO1VCCIDT_IMPL_TYPE_RAMPINFO1VCCIDT_H_
