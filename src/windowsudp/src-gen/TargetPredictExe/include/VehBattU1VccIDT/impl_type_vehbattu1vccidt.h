 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/VehBattU1VccIDT/impl_type_vehbattu1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_VEHBATTU1VCCIDT_IMPL_TYPE_VEHBATTU1VCCIDT_H_
