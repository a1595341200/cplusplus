 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/EpbSts1VccIDT/impl_type_epbsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_EPBSTS1VCCIDT_IMPL_TYPE_EPBSTS1VCCIDT_H_
#define TARGETPREDICTEXE_INCLUDE_EPBSTS1VCCIDT_IMPL_TYPE_EPBSTS1VCCIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_EPBSTS1VCCIDT_IMPL_TYPE_EPBSTS1VCCIDT_H_
