 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/AccrPedlPsd0IDT/impl_type_accrpedlpsd0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
#define TARGETPREDICTEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_ACCRPEDLPSD0IDT_IMPL_TYPE_ACCRPEDLPSD0IDT_H_
