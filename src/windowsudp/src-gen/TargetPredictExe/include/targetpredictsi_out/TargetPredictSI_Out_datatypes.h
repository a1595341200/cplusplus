 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/targetpredictsi_out/TargetPredictSI_Out_datatypes.h
...
#ifndef TARGETPREDICTEXE_INCLUDE_TARGETPREDICTSI_OUT_TARGETPREDICTSI_OUT_DATATYPES_H_
#define TARGETPREDICTEXE_INCLUDE_TARGETPREDICTSI_OUT_TARGETPREDICTSI_OUT_DATATYPES_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_TARGETPREDICTSI_OUT_TARGETPREDICTSI_OUT_DATATYPES_H_
