 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/targetpredictsi_out/TargetPredictSI_Out.h
 *        \brief  Header for service 'TargetPredictSI_Out'.
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef TARGETPREDICTEXE_INCLUDE_TARGETPREDICTSI_OUT_TARGETPREDICTSI_OUT_H_
#define TARGETPREDICTEXE_INCLUDE_TARGETPREDICTSI_OUT_TARGETPREDICTSI_OUT_H_
...
/*!
 * \brief Representation of service 'TargetPredictSI_Out'
 ...
 * \trace SPEC-4980256
 */
class TargetPredictSI_Out final {
...
*/
 using CStringView = vac::container::CStringView;
   ...
   */
  static constexpr CStringView kServiceIdentifier{"TargetPredictSI_Out"_sv};
 ...
 public:
   ...
   */
  static constexpr CStringView kServiceShortNamePath{"/JICA/Service/Interface/TargetPredictSI_Out"_sv};
};

}  // namespace targetpredictsi_out

#endif  // TARGETPREDICTEXE_INCLUDE_TARGETPREDICTSI_OUT_TARGETPREDICTSI_OUT_H_
