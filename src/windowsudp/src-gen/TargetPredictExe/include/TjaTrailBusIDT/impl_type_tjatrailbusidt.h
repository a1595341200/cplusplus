 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/TjaTrailBusIDT/impl_type_tjatrailbusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
#define TARGETPREDICTEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_TJATRAILBUSIDT_IMPL_TYPE_TJATRAILBUSIDT_H_
