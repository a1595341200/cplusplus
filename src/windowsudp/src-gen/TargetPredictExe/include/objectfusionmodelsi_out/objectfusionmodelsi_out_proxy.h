 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/objectfusionmodelsi_out/objectfusionmodelsi_out_proxy.h
...
#ifndef TARGETPREDICTEXE_INCLUDE_OBJECTFUSIONMODELSI_OUT_OBJECTFUSIONMODELSI_OUT_PROXY_H_
#define TARGETPREDICTEXE_INCLUDE_OBJECTFUSIONMODELSI_OUT_OBJECTFUSIONMODELSI_OUT_PROXY_H_
...
/*!
 * \brief Type alias for service event 'OFM_Bus_FusedTargets01', that is part of the proxy.
 *
 * \trace SPEC-4980345
 */

using OFM_Bus_FusedTargets01 =
    ::amsr::socal::events::ProxyEvent<::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8, ::amsr::socal::kRuntimeProcessingMode>;

/*!
 * \brief Type alias for service event 'OFM_Bus_FusedTargets02', that is part of the proxy.
 *
 * \trace SPEC-4980345
 */

using OFM_Bus_FusedTargets02 =
    ::amsr::socal::events::ProxyEvent<::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8, ::amsr::socal::kRuntimeProcessingMode>;

/*!
 * \brief Type alias for service event 'OFM_Bus_FusedTargets03', that is part of the proxy.
 *
 * \trace SPEC-4980345
 */

using OFM_Bus_FusedTargets03 =
    ::amsr::socal::events::ProxyEvent<::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8, ::amsr::socal::kRuntimeProcessingMode>;

/*!
 * \brief Type alias for service event 'OFM_Bus_FusedTargets04', that is part of the proxy.
 *
 * \trace SPEC-4980345
 */

using OFM_Bus_FusedTargets04 =
    ::amsr::socal::events::ProxyEvent<::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8, ::amsr::socal::kRuntimeProcessingMode>;
...
using OFM_St_SOCFusedSts =
    ::amsr::socal::events::ProxyEvent<::uint16IDT::uint16IDT, ::amsr::socal::kRuntimeProcessingMode>;

/*!
 * \brief Type alias for service event 'OFM_Bus_FourDRadarStatus', that is part of the proxy.
 *
 * \trace SPEC-4980345
 */

using OFM_Bus_FourDRadarStatus =
    ::amsr::socal::events::ProxyEvent<::FourDRadarStatusIDT::FourDRadarStatusIDT, ::amsr::socal::kRuntimeProcessingMode>;

/*!
 * \brief Type alias for service event 'OFM_Bus_LaneInfo', that is part of the proxy.
 *
 * \trace SPEC-4980345
 */

using OFM_Bus_LaneInfo =
 ...
 */
class ObjectFusionModelSI_OutProxy : public ::amsr::socal::ThreadDrivenProxy<objectfusionmodelsi_out::ObjectFusionModelSI_Out, objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutProxyBackendInterface, objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutHandleType>{
 public:
  ...
  */
   ...
   * \endspec
   */
  ObjectFusionModelSI_OutProxy(ObjectFusionModelSI_OutProxy const&) noexcept = default;
   ...
   * \endspec
   */
  ObjectFusionModelSI_OutProxy(ObjectFusionModelSI_OutProxy&&) noexcept = default;
   ...
   * \endspec
   */
  ObjectFusionModelSI_OutProxy& operator=(ObjectFusionModelSI_OutProxy const&) & noexcept = default;
   ...
   * \endspec
   */
  ObjectFusionModelSI_OutProxy& operator=(ObjectFusionModelSI_OutProxy&&) & noexcept = default;
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::ThreadDrivenProxy<objectfusionmodelsi_out::ObjectFusionModelSI_Out, ProxyBackendInterface, objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutHandleType>;
 ...
 public:
  ...
  /*!
   * \brief Event 'OFM_Bus_FusedTargets01' which can be used by application developer.
   * \details
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief Event 'OFM_Bus_FusedTargets02' which can be used by application developer.
   * \details
   * Data of type ::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8 
   * \vpublic
   * \spec
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief Event 'OFM_Bus_FusedTargets03' which can be used by application developer.
   * \details
   * Data of type ::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8 
   * \vpublic
   * \spec
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief Event 'OFM_Bus_FusedTargets04' which can be used by application developer.
   * \details
   * Data of type ::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8 
   * \vpublic
   * \spec
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief Event 'OFM_Bus_FourDRadarStatus' which can be used by application developer.
   * \details
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief Event 'OFM_Bus_LaneInfo' which can be used by application developer.
   * \details
...
#endif  // TARGETPREDICTEXE_INCLUDE_OBJECTFUSIONMODELSI_OUT_OBJECTFUSIONMODELSI_OUT_PROXY_H_
