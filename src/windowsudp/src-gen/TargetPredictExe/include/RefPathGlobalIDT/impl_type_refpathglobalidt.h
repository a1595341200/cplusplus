 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/RefPathGlobalIDT/impl_type_refpathglobalidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_REFPATHGLOBALIDT_IMPL_TYPE_REFPATHGLOBALIDT_H_
#define TARGETPREDICTEXE_INCLUDE_REFPATHGLOBALIDT_IMPL_TYPE_REFPATHGLOBALIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_REFPATHGLOBALIDT_IMPL_TYPE_REFPATHGLOBALIDT_H_
