 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/VehSpdIndcd1IDT/impl_type_vehspdindcd1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
#define TARGETPREDICTEXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
