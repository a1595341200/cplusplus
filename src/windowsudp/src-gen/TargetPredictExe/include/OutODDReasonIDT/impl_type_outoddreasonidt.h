 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/OutODDReasonIDT/impl_type_outoddreasonidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_OUTODDREASONIDT_IMPL_TYPE_OUTODDREASONIDT_H_
#define TARGETPREDICTEXE_INCLUDE_OUTODDREASONIDT_IMPL_TYPE_OUTODDREASONIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_OUTODDREASONIDT_IMPL_TYPE_OUTODDREASONIDT_H_
