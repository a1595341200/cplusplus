 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_datatypes.h
...
#ifndef TARGETPREDICTEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
#define TARGETPREDICTEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
