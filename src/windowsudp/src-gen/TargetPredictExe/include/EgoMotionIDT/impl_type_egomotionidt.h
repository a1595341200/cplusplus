 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/EgoMotionIDT/impl_type_egomotionidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
#define TARGETPREDICTEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_EGOMOTIONIDT_IMPL_TYPE_EGOMOTIONIDT_H_
