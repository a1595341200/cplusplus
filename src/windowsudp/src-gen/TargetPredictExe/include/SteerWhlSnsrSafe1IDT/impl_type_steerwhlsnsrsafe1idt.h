 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TargetPredictExe/include/SteerWhlSnsrSafe1IDT/impl_type_steerwhlsnsrsafe1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TARGETPREDICTEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
#define TARGETPREDICTEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
...
#endif  // TARGETPREDICTEXE_INCLUDE_STEERWHLSNSRSAFE1IDT_IMPL_TYPE_STEERWHLSNSRSAFE1IDT_H_
