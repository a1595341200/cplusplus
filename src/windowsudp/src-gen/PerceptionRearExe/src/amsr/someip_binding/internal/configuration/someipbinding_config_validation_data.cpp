 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/src/amsr/someip_binding/internal/configuration/someipbinding_config_validation_data.cpp
...
#include "amsr/someip_binding/internal/configuration/perceptionrearsi_out/PerceptionRearSI_Out_config_validation_data.h"
...
{"/JICA/Service/Interface/PerceptionRearSI_Out"_sv,
     ConfigValidationDataAccess{
      &::amsr::someip_binding::internal::configuration::gen_perceptionrearsi_out::PerceptionRearSI_OutConfigValidationData::kValidEventConfigurationEntities[0],
      3,
      nullptr,
      0,
      nullptr,
