 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/perceptionrearsi_out/PerceptionRearSI_Out_datatypes.h
...
#ifndef PERCEPTIONREAREXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_DATATYPES_H_
#define PERCEPTIONREAREXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_DATATYPES_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_DATATYPES_H_
