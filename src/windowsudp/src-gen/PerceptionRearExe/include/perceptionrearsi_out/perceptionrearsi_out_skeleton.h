 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/perceptionrearsi_out/perceptionrearsi_out_skeleton.h
...
#ifndef PERCEPTIONREAREXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_SKELETON_H_
#define PERCEPTIONREAREXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_SKELETON_H_
...
#include "perceptionrearsi_out/PerceptionRearSI_Out_types.h"
 ...
 */
class PerceptionRearSI_OutSkeleton;
...
/*!
 * \brief Type alias for service event 'PerceptionRear_Bus_LaneInfo', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using PerceptionRear_Bus_LaneInfo = ::amsr::socal::events::SkeletonEvent<
    perceptionrearsi_out::skeleton::PerceptionRearSI_OutSkeleton,
    ::PerceptionRearLaneInfoIDT::PerceptionRearLaneInfoIDT,
    perceptionrearsi_out::internal::PerceptionRearSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::PerceptionRearLaneInfoIDT::PerceptionRearLaneInfoIDT>,
    &perceptionrearsi_out::internal::PerceptionRearSI_OutSkeletonImplInterface::GetEventManagerPerceptionRear_Bus_LaneInfo>;

/*!
 * \brief Type alias for service event 'PerceptionRear_Bus_CameraStatus', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using PerceptionRear_Bus_CameraStatus = ::amsr::socal::events::SkeletonEvent<
    perceptionrearsi_out::skeleton::PerceptionRearSI_OutSkeleton,
    ::RearCamSts1VccIDT::RearCamSts1VccIDT,
    perceptionrearsi_out::internal::PerceptionRearSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::RearCamSts1VccIDT::RearCamSts1VccIDT>,
    &perceptionrearsi_out::internal::PerceptionRearSI_OutSkeletonImplInterface::GetEventManagerPerceptionRear_Bus_CameraStatus>;

/*!
 * \brief Type alias for service event 'PerceptionRear_Bus_VisnObj', that is part of the skeleton.
 *
 * \trace SPEC-4980342
 */
using PerceptionRear_Bus_VisnObj = ::amsr::socal::events::SkeletonEvent<
    perceptionrearsi_out::skeleton::PerceptionRearSI_OutSkeleton,
    ::Array_VisObjIDT_20::Array_VisObjIDT_20,
    perceptionrearsi_out::internal::PerceptionRearSI_OutSkeletonImplInterface,
    ::amsr::socal::internal::events::SkeletonEventManagerInterface<::Array_VisObjIDT_20::Array_VisObjIDT_20>,
    &perceptionrearsi_out::internal::PerceptionRearSI_OutSkeletonImplInterface::GetEventManagerPerceptionRear_Bus_VisnObj>;
...
/*!
 * \brief Skeleton interface class for the service 'PerceptionRearSI_Out'.
 *
 * \vpublic
 * \trace SPEC-4980341
...
class PerceptionRearSI_OutSkeleton
    : public ::amsr::socal::Skeleton<perceptionrearsi_out::PerceptionRearSI_Out,
                                          perceptionrearsi_out::internal::PerceptionRearSI_OutSkeletonImplInterface,
                                          ::amsr::socal::kRuntimeProcessingMode>,
      public       perceptionrearsi_out::internal::PerceptionRearSI_OutSkeletonBackendInterface {
 public:
// ---- Constructors / Destructors -----------------------------------------------------------------------------------
/*!
 * \brief Exception-less pre-construction of PerceptionRearSI_Out.
 *
...
/*!
 * \brief Exception-less pre-construction of PerceptionRearSI_OutSkeleton.
 *
...
/*!
 * \brief Exception-less constructor of PerceptionRearSI_OutSkeleton.
 ...
 * \trace SPEC-8053555
 */
explicit PerceptionRearSI_OutSkeleton(ConstructionToken&& token) noexcept;

  /*!
   * \brief Delete default constructor.
   */
  PerceptionRearSI_OutSkeleton() = delete;
  /*!
   * \brief Delete copy constructor.
   */
  PerceptionRearSI_OutSkeleton(PerceptionRearSI_OutSkeleton const &) = delete;
  /*!
   * \brief Delete move constructor.
   */
  PerceptionRearSI_OutSkeleton(PerceptionRearSI_OutSkeleton &&) = delete;
  /*!
   * \brief Delete copy assignment.
   */
  PerceptionRearSI_OutSkeleton &operator=(PerceptionRearSI_OutSkeleton const &) & = delete;
  /*!
   * \brief Delete move assignment.
   */
  PerceptionRearSI_OutSkeleton &operator=(PerceptionRearSI_OutSkeleton &&) & = delete;

  /*!
   * \brief Constructor of PerceptionRearSI_OutSkeleton.
   *
   ...
   * \trace SPEC-4980356
   */
   explicit PerceptionRearSI_OutSkeleton(
   ...
   * \endspec
   */
  ~PerceptionRearSI_OutSkeleton() noexcept override;

  /*!
   * \brief Type alias for ServiceDiscovery.
   */
  using ServiceDiscovery = ::amsr::socal::internal::service_discovery::ServiceDiscovery<PerceptionRearSI_OutSkeleton>;
  ...
  /*!
   * \brief The skeleton event 'PerceptionRear_Bus_LaneInfo' which can be used by application developer.
   * \details 
   * Data of type ::PerceptionRearLaneInfoIDT::PerceptionRearLaneInfoIDT
   * \vpublic
   */
  events::PerceptionRear_Bus_LaneInfo PerceptionRear_Bus_LaneInfo;

  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'PerceptionRear_Bus_CameraStatus' which can be used by application developer.
   * \details 
   * Data of type ::RearCamSts1VccIDT::RearCamSts1VccIDT
   * \vpublic
   */
  events::PerceptionRear_Bus_CameraStatus PerceptionRear_Bus_CameraStatus;

  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief The skeleton event 'PerceptionRear_Bus_VisnObj' which can be used by application developer.
   * \details 
   * Data of type ::Array_VisObjIDT_20::Array_VisObjIDT_20
   * \vpublic
   */
  events::PerceptionRear_Bus_VisnObj PerceptionRear_Bus_VisnObj;
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<perceptionrearsi_out::PerceptionRearSI_Out, perceptionrearsi_out::internal::PerceptionRearSI_OutSkeletonImplInterface, ::amsr::socal::kRuntimeProcessingMode>;
...
#endif  // PERCEPTIONREAREXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_SKELETON_H_
