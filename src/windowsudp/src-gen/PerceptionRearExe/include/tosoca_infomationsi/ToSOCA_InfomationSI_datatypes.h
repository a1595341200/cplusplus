 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_datatypes.h
...
#ifndef PERCEPTIONREAREXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
#define PERCEPTIONREAREXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_DATATYPES_H_
