 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/amsr/someip_protocol/internal/dataprototype_serialization/perceptionrearsi_out/events/serializer_PerceptionRear_Bus_VisnObj.h
 *        \brief  SOME/IP protocol serializer implementation for data prototype '/JICA/Service/Interface/PerceptionRearSI_Out/PerceptionRear_Bus_VisnObj
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef PERCEPTIONREAREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONREARSI_OUT_EVENTS_serializer_PerceptionRear_Bus_VisnObj_h_
#define PERCEPTIONREAREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONREARSI_OUT_EVENTS_serializer_PerceptionRear_Bus_VisnObj_h_
...
/*!
 * \brief Serializer for service event /JICA/Service/Interface/PerceptionRearSI_Out/PerceptionRear_Bus_VisnObj
 ...
 */
class SerializerPerceptionRear_Bus_VisnObj {
 public:
  /*!
   * \brief Returns the required buffer size for the data prototype service event /JICA/Service/Interface/PerceptionRearSI_Out/PerceptionRear_Bus_VisnObj.
   *
  ...
  /*!
   * \brief Returns the maximum buffer size for the data prototype service event /JICA/Service/Interface/PerceptionRearSI_Out/PerceptionRear_Bus_VisnObj.
   *
   * \return      Calculated buffer size for serialization.
   * \pre         -
   * \context     App
  ...
  /*!
   * \brief Serialize the data prototype service event /JICA/Service/Interface/PerceptionRearSI_Out/PerceptionRear_Bus_VisnObj.
   *
...
#endif  // PERCEPTIONREAREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONREARSI_OUT_EVENTS_serializer_PerceptionRear_Bus_VisnObj_h_
