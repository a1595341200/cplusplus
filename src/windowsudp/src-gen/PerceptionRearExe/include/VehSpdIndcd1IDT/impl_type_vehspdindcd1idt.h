 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/VehSpdIndcd1IDT/impl_type_vehspdindcd1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
#define PERCEPTIONREAREXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_VEHSPDINDCD1IDT_IMPL_TYPE_VEHSPDINDCD1IDT_H_
