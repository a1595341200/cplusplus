 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_datatypes.h
...
#ifndef PERCEPTIONREAREXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
#define PERCEPTIONREAREXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_DATATYPES_H_
