 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/LaneChangeFailReason1VccIDT/impl_type_lanechangefailreason1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
#define PERCEPTIONREAREXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_LANECHANGEFAILREASON1VCCIDT_IMPL_TYPE_LANECHANGEFAILREASON1VCCIDT_H_
