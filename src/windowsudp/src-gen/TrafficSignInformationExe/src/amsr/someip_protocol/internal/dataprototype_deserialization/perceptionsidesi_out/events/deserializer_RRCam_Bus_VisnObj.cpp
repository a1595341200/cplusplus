 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsidesi_out/events/deserializer_RRCam_Bus_VisnObj.cpp
...
deserialization::Result DeserializerRRCam_Bus_VisnObj::Deserialize(deserialization::Reader &reader, ::Array_VisObjIDT_20::Array_VisObjIDT_20 &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionSideSI_Out/RRCam_Bus_VisnObj
