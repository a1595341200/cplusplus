 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionrearsi_out/events/deserializer_PerceptionRear_Bus_LaneInfo.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/PerceptionRearLaneInfoIDT/deserializer_PerceptionRearLaneInfoIDT.h"
...
deserialization::Result DeserializerPerceptionRear_Bus_LaneInfo::Deserialize(deserialization::Reader &reader, ::PerceptionRearLaneInfoIDT::PerceptionRearLaneInfoIDT &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionRearSI_Out/PerceptionRear_Bus_LaneInfo
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::PerceptionRearLaneInfoIDT::PerceptionRearLaneInfoIDT>{})};
