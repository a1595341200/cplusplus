...
target_sources(${target} PRIVATE
  ...
  "${CMAKE_CURRENT_LIST_DIR}/src/roadmodelfusionsi_out/roadmodelfusionsi_out.cpp"
  "${CMAKE_CURRENT_LIST_DIR}/src/roadmodelfusionsi_out/roadmodelfusionsi_out_proxy.cpp"
  ...
  "${CMAKE_CURRENT_LIST_DIR}/src/trafficsigninformationsi_out/trafficsigninformationsi_out.cpp"
  "${CMAKE_CURRENT_LIST_DIR}/src/trafficsigninformationsi_out/trafficsigninformationsi_out_skeleton.cpp"
)
...
target_sources(${target} PRIVATE
  ...
  "${CMAKE_CURRENT_LIST_DIR}/include/roadmodelfusionsi_out/RoadModelFusionSI_Out.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/roadmodelfusionsi_out/RoadModelFusionSI_Out_datatypes.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/roadmodelfusionsi_out/RoadModelFusionSI_Out_proxy_backend_interface.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/roadmodelfusionsi_out/RoadModelFusionSI_Out_types.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/roadmodelfusionsi_out/roadmodelfusionsi_out_common.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/roadmodelfusionsi_out/roadmodelfusionsi_out_proxy.h"
  ...
  "${CMAKE_CURRENT_LIST_DIR}/include/trafficsigninformationsi_out/TrafficSignInformationSI_Out.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/trafficsigninformationsi_out/TrafficSignInformationSI_Out_datatypes.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/trafficsigninformationsi_out/TrafficSignInformationSI_Out_skeleton_backend_interface.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/trafficsigninformationsi_out/TrafficSignInformationSI_Out_skeleton_impl_interface.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/trafficsigninformationsi_out/TrafficSignInformationSI_Out_types.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/trafficsigninformationsi_out/trafficsigninformationsi_out_common.h"
  "${CMAKE_CURRENT_LIST_DIR}/include/trafficsigninformationsi_out/trafficsigninformationsi_out_skeleton.h"
)
