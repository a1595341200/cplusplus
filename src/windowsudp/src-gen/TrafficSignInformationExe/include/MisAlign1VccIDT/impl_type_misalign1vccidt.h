 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/MisAlign1VccIDT/impl_type_misalign1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_MISALIGN1VCCIDT_IMPL_TYPE_MISALIGN1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_MISALIGN1VCCIDT_IMPL_TYPE_MISALIGN1VCCIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_MISALIGN1VCCIDT_IMPL_TYPE_MISALIGN1VCCIDT_H_
