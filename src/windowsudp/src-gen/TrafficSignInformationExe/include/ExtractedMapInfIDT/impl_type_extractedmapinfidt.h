 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/ExtractedMapInfIDT/impl_type_extractedmapinfidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTRACTEDMAPINFIDT_IMPL_TYPE_EXTRACTEDMAPINFIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTRACTEDMAPINFIDT_IMPL_TYPE_EXTRACTEDMAPINFIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTRACTEDMAPINFIDT_IMPL_TYPE_EXTRACTEDMAPINFIDT_H_
