 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/someip_protocol/internal/datatype_deserialization/LaneMkrCam1SecClsLeIDT/deserializer_LaneMkrCam1SecClsLeIDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'LaneMkrCam1SecClsLeIDT'
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRCAM1SECCLSLEIDT_DESERIALIZER_LANEMKRCAM1SECCLSLEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRCAM1SECCLSLEIDT_DESERIALIZER_LANEMKRCAM1SECCLSLEIDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsLeIDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1SecClsLeIDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::LaneMkrCam1SecClsLeIDT::LaneMkrCam1SecClsLeIDT &data) noexcept {
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsLeIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::LaneMkrCam1SecClsLeIDT::LaneMkrCam1SecClsLeIDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANEMKRCAM1SECCLSLEIDT_DESERIALIZER_LANEMKRCAM1SECCLSLEIDT_H_
