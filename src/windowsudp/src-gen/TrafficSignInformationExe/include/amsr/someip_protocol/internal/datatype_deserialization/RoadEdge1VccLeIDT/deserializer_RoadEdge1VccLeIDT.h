 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/someip_protocol/internal/datatype_deserialization/RoadEdge1VccLeIDT/deserializer_RoadEdge1VccLeIDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'RoadEdge1VccLeIDT'
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ROADEDGE1VCCLEIDT_DESERIALIZER_ROADEDGE1VCCLEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ROADEDGE1VCCLEIDT_DESERIALIZER_ROADEDGE1VCCLEIDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/RoadEdge1VccLeIDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/RoadEdge1VccLeIDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::RoadEdge1VccLeIDT::RoadEdge1VccLeIDT &data) noexcept {
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/RoadEdge1VccLeIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::RoadEdge1VccLeIDT::RoadEdge1VccLeIDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ROADEDGE1VCCLEIDT_DESERIALIZER_ROADEDGE1VCCLEIDT_H_
