 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/someip_protocol/internal/datatype_deserialization/FrntCamSts1VccIDT/deserializer_FrntCamSts1VccIDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'FrntCamSts1VccIDT'
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_FRNTCAMSTS1VCCIDT_DESERIALIZER_FRNTCAMSTS1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_FRNTCAMSTS1VCCIDT_DESERIALIZER_FRNTCAMSTS1VCCIDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/FrntCamSts1VccIDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/FrntCamSts1VccIDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::FrntCamSts1VccIDT::FrntCamSts1VccIDT &data) noexcept {
  ...
  // Deserialize struct member 'Lowilluminance' of type /CppImplementationDataTypes/LowilluminanceIDT
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/FrntCamSts1VccIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::FrntCamSts1VccIDT::FrntCamSts1VccIDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
 ...
 constexpr std::size_t static_size{
  ...
  // Accumulate the static size of struct member 'Lowilluminance' of type /CppImplementationDataTypes/LowilluminanceIDT
   SomeIpProtocolGetStaticSize<TpPack,
                               ...
                               >(deserialization::SizeToken<::LowilluminanceIDT::LowilluminanceIDT>{}) 
  };
  return static_size;
}
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_FRNTCAMSTS1VCCIDT_DESERIALIZER_FRNTCAMSTS1VCCIDT_H_
