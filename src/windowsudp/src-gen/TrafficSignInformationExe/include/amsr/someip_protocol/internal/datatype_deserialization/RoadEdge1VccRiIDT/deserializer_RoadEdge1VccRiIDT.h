 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/someip_protocol/internal/datatype_deserialization/RoadEdge1VccRiIDT/deserializer_RoadEdge1VccRiIDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'RoadEdge1VccRiIDT'
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ROADEDGE1VCCRIIDT_DESERIALIZER_ROADEDGE1VCCRIIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ROADEDGE1VCCRIIDT_DESERIALIZER_ROADEDGE1VCCRIIDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/RoadEdge1VccRiIDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/RoadEdge1VccRiIDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::RoadEdge1VccRiIDT::RoadEdge1VccRiIDT &data) noexcept {
  ...
  // Deserialize struct member 'LongDistanceToStart' of type /CppImplementationDataTypes/float
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
        ...
        >(reader, data.LongDistanceToStart);
  }

  // Deserialize struct member 'LongDistanceToEnd' of type /CppImplementationDataTypes/float
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
        ...
        >(reader, data.LongDistanceToEnd);
  }

  // Deserialize struct member 'MdlQly' of type /CppImplementationDataTypes/float
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
  ...
  // Deserialize struct member 'MeasQly' of type /CppImplementationDataTypes/float
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
  ...
  // Deserialize struct member 'TrackStsRE' of type /CppImplementationDataTypes/TrackStsREIDT
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
  ...
  // Deserialize struct member 'IsTransverible' of type /CppImplementationDataTypes/IsTransveribleIDT
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/RoadEdge1VccRiIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::RoadEdge1VccRiIDT::RoadEdge1VccRiIDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
 ...
 constexpr std::size_t static_size{
  ...
  // Accumulate the static size of struct member 'TrackStsRE' of type /CppImplementationDataTypes/TrackStsREIDT
   SomeIpProtocolGetStaticSize<TpPack,
                               ...
                               >(deserialization::SizeToken<::TrackStsREIDT::TrackStsREIDT>{})  + 
  ...
  // Accumulate the static size of struct member 'IsTransverible' of type /CppImplementationDataTypes/IsTransveribleIDT
   SomeIpProtocolGetStaticSize<TpPack,
                               ...
                               >(deserialization::SizeToken<::IsTransveribleIDT::IsTransveribleIDT>{}) 
  };
  return static_size;
}
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ROADEDGE1VCCRIIDT_DESERIALIZER_ROADEDGE1VCCRIIDT_H_
