 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/amsr/someip_binding_xf/internal/trafficsigninformationsi_out/TrafficSignInformationSI_Out_skeleton_xf.h
 *        \brief  SOME/IP binding of service skeleton for service 'TrafficSignInformationSI_Out'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_TRAFFICSIGNINFORMATIONSI_OUT_TRAFFICSIGNINFORMATIONSI_OUT_SKELETON_XF_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_TRAFFICSIGNINFORMATIONSI_OUT_TRAFFICSIGNINFORMATIONSI_OUT_SKELETON_XF_H_
...
#include "amsr/someip_binding_xf/internal/trafficsigninformationsi_out/TrafficSignInformationSI_Out_skeleton_someip_methods.h"
#include "someip-protocol/internal/someip_posix_types.h"
#include "trafficsigninformationsi_out/TrafficSignInformationSI_Out_skeleton_backend_interface.h"
...
/*!
 * \brief SOME/IP skeleton binding of Service 'TrafficSignInformationSI_Out'.
 * \details Handles serialization and deserialization of all method calls, events, etc.
 * \remark generated
 */
class TrafficSignInformationSI_OutSkeletonXf final :
    public ::trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonImplInterface,
...
/*!
  ...
  /*!
   * \brief Constructor of TrafficSignInformationSI_OutSkeletonXf.
   ...
   * \synchronous TRUE
   */
  TrafficSignInformationSI_OutSkeletonXf(::amsr::someip_binding_core::internal::ProvidedServiceInstanceId const provided_service_instance_id,
                                              ::amsr::someip_binding_core::internal::ServerInterface& server,
                                              ::trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonBackendInterface& skeleton,
  ...
  ~TrafficSignInformationSI_OutSkeletonXf() noexcept override  = default;  // COV_SOMEIPBINDING_SKELETON_XF

  TrafficSignInformationSI_OutSkeletonXf(TrafficSignInformationSI_OutSkeletonXf const&) noexcept = delete;
  TrafficSignInformationSI_OutSkeletonXf(TrafficSignInformationSI_OutSkeletonXf&& other) noexcept = delete;
  TrafficSignInformationSI_OutSkeletonXf& operator=(TrafficSignInformationSI_OutSkeletonXf const&) & = delete;
  TrafficSignInformationSI_OutSkeletonXf& operator=(TrafficSignInformationSI_OutSkeletonXf&&) & noexcept = delete;
  ...
  /*!
   * \brief Get the event manager object for the SOME/IP binding service event 'TSI_Bus_HMIData'.
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  events::skeleton::TSI_Bus_HMIData::TrafficSignInformationSI_OutSkeletonSomeIpEventManagerTSI_Bus_HMIData* GetEventManagerTSI_Bus_HMIData() noexcept override;
 ...
 private:
   ...
   */
  ::trafficsigninformationsi_out::internal::TrafficSignInformationSI_OutSkeletonBackendInterface& skeleton_;
...
// ---- Event manager --------------------------------------------------------------------------------------------
  ...
  ::amsr::someip_binding::internal::configuration::EventConfig const&
      ...
      events_TrafficSignInformationSI_OutSkeletonSomeIpEventConfigurationTSI_Bus_HMIData_event_config_{
          ...
          config_wrapper_.GetEventConfig(
              ...
              ::amsr::someip_binding::internal::configuration::Shortname{events::skeleton::TSI_Bus_HMIData::EventDesignInfo::kEventName.c_str()})};

  // Event Xf for skeleton protected event 'TSI_Bus_HMIData'
  // VCA_SOMEIPBINDING_TRIVIAL_VALID_REFERENCE
  std::unique_ptr<ser_deser::SerializerInterface<events::skeleton::TSI_Bus_HMIData::EventDesignInfo::SampleType>> event_xf_serializer_ptr_TSI_Bus_HMIData_{
    events::skeleton::TSI_Bus_HMIData::SerializerFactory::Create()
  };
  ...
  events::skeleton::TSI_Bus_HMIData::TrafficSignInformationSI_OutSkeletonSomeIpEventManagerTSI_Bus_HMIData event_manager_TSI_Bus_HMIData_{
      ::amsr::someip_binding_core::internal::SomeIpEventIdentity{
          ...
          events_TrafficSignInformationSI_OutSkeletonSomeIpEventConfigurationTSI_Bus_HMIData_event_config_
              ...
              .GetEventId()},
      server_,
      *(event_xf_serializer_ptr_TSI_Bus_HMIData_.get()),
      // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
      // VECTOR NC VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
     ...
     // VCA_SPC_15_SOMEIPBINDING_OTHER_COMPONENT_TYPE_FUNCTION
     // VCA_SOMEIPBINDING_POSSIBLY_CALLING_NULLPTR_METHOD_CALL_ON_REF
     events_TrafficSignInformationSI_OutSkeletonSomeIpEventConfigurationTSI_Bus_HMIData_event_config_.GetDisableSessionHandling().value_or(false),
     events_TrafficSignInformationSI_OutSkeletonSomeIpEventConfigurationTSI_Bus_HMIData_event_config_
         // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_TRAFFICSIGNINFORMATIONSI_OUT_TRAFFICSIGNINFORMATIONSI_OUT_SKELETON_XF_H_
