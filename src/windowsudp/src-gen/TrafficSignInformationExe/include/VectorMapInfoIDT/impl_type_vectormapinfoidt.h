 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/VectorMapInfoIDT/impl_type_vectormapinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_VECTORMAPINFOIDT_IMPL_TYPE_VECTORMAPINFOIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_VECTORMAPINFOIDT_IMPL_TYPE_VECTORMAPINFOIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_VECTORMAPINFOIDT_IMPL_TYPE_VECTORMAPINFOIDT_H_
