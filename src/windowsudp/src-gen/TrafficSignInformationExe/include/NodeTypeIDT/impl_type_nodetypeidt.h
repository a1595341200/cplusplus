 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/NodeTypeIDT/impl_type_nodetypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_NODETYPEIDT_IMPL_TYPE_NODETYPEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_NODETYPEIDT_IMPL_TYPE_NODETYPEIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_NODETYPEIDT_IMPL_TYPE_NODETYPEIDT_H_
