 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/perceptionsi_out/PerceptionSI_Out_datatypes.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_DATATYPES_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_DATATYPES_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_DATATYPES_H_
