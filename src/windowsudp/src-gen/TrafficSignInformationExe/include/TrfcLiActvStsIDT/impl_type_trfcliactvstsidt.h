 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/TrfcLiActvStsIDT/impl_type_trfcliactvstsidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCLIACTVSTSIDT_IMPL_TYPE_TRFCLIACTVSTSIDT_H_
