 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/LaneMkrCam1RiIDT/impl_type_lanemkrcam1riidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
...
/*!
 * \brief Type LaneMkrCam1RiIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/LaneMkrCam1RiIDT
 */
struct LaneMkrCam1RiIDT {
...
/*!
 * \brief   Compare for equality with another LaneMkrCam1RiIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(LaneMkrCam1RiIDT const& l,
                       LaneMkrCam1RiIDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another LaneMkrCam1RiIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEMKRCAM1RIIDT_IMPL_TYPE_LANEMKRCAM1RIIDT_H_
