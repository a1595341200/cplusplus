 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/LaneMkrCam1SecClsRiIDT/impl_type_lanemkrcam1secclsriidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
...
/*!
 * \brief Type LaneMkrCam1SecClsRiIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/LaneMkrCam1SecClsRiIDT
 */
struct LaneMkrCam1SecClsRiIDT {
...
/*!
 * \brief   Compare for equality with another LaneMkrCam1SecClsRiIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(LaneMkrCam1SecClsRiIDT const& l,
                       LaneMkrCam1SecClsRiIDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another LaneMkrCam1SecClsRiIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_LANEMKRCAM1SECCLSRIIDT_IMPL_TYPE_LANEMKRCAM1SECCLSRIIDT_H_
