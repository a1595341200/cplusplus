 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/RoadEdge1VccLeIDT/impl_type_roadedge1vccleidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
...
/*!
 * \brief Type RoadEdge1VccLeIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/RoadEdge1VccLeIDT
 */
struct RoadEdge1VccLeIDT {
...
/*!
 * \brief   Compare for equality with another RoadEdge1VccLeIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(RoadEdge1VccLeIDT const& l,
                       RoadEdge1VccLeIDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another RoadEdge1VccLeIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_ROADEDGE1VCCLEIDT_IMPL_TYPE_ROADEDGE1VCCLEIDT_H_
