 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/FrntCamInfoIDT/impl_type_frntcaminfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
