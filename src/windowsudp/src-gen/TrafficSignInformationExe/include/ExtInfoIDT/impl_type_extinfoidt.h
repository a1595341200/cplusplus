 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/ExtInfoIDT/impl_type_extinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_EXTINFOIDT_IMPL_TYPE_EXTINFOIDT_H_
