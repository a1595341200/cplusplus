 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/RRCamSts1VccIDT/impl_type_rrcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_RRCAMSTS1VCCIDT_IMPL_TYPE_RRCAMSTS1VCCIDT_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_RRCAMSTS1VCCIDT_IMPL_TYPE_RRCAMSTS1VCCIDT_H_
...
/*!
 * \brief Type RRCamSts1VccIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/RRCamSts1VccIDT
 */
struct RRCamSts1VccIDT {
...
/*!
 * \brief Compare for equality with another RRCamSts1VccIDT instance.
 */
inline bool operator==(RRCamSts1VccIDT const& l,
                       RRCamSts1VccIDT const& r) noexcept {
...
/*!
 * \brief Compare for inequality with another RRCamSts1VccIDT instance.
 */
inline bool operator!=(RRCamSts1VccIDT const& l,
                       RRCamSts1VccIDT const& r) noexcept {
  return !(l == r);
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_RRCAMSTS1VCCIDT_IMPL_TYPE_RRCAMSTS1VCCIDT_H_
