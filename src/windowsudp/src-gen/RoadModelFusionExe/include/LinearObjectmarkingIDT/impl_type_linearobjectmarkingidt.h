 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LinearObjectmarkingIDT/impl_type_linearobjectmarkingidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTMARKINGIDT_IMPL_TYPE_LINEAROBJECTMARKINGIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTMARKINGIDT_IMPL_TYPE_LINEAROBJECTMARKINGIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTMARKINGIDT_IMPL_TYPE_LINEAROBJECTMARKINGIDT_H_
