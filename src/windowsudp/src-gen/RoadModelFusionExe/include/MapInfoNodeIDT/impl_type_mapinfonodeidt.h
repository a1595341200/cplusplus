 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/MapInfoNodeIDT/impl_type_mapinfonodeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_MAPINFONODEIDT_IMPL_TYPE_MAPINFONODEIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_MAPINFONODEIDT_IMPL_TYPE_MAPINFONODEIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_MAPINFONODEIDT_IMPL_TYPE_MAPINFONODEIDT_H_
