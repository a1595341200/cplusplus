 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LinearObjectColourIDT/impl_type_linearobjectcolouridt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTCOLOURIDT_IMPL_TYPE_LINEAROBJECTCOLOURIDT_H_
#define ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTCOLOURIDT_IMPL_TYPE_LINEAROBJECTCOLOURIDT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTCOLOURIDT_IMPL_TYPE_LINEAROBJECTCOLOURIDT_H_
