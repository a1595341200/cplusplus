 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/src/amsr/socal/internal/runtime_gen.cpp
...
void Runtime::InitializeInstanceSpecifierLookupTables() noexcept {
  ...
  // Add R-Port InstanceSpecifier 'RoadModelFusionExe/RoadModelFusion/RoadModelFusion_EHRSI_Out_R' to the lookup table.
  // VCA_SOCAL_UNDEFINED_RUNTIME_ADD_INSTANCE_SPECIFIER_FUNCTION
  AddInstanceSpecifier(required_instance_specifier_table_, "RoadModelFusionExe/RoadModelFusion/RoadModelFusion_EHRSI_Out_R"_sv);

  // Add P-Port InstanceSpecifier 'RoadModelFusionExe/RoadModelFusion/RoadModelFusion_RoadModelFusionSI_Out_P' to the lookup table.
  // VCA_SOCAL_UNDEFINED_RUNTIME_ADD_INSTANCE_SPECIFIER_FUNCTION
  AddInstanceSpecifier(provided_instance_specifier_table_, "RoadModelFusionExe/RoadModelFusion/RoadModelFusion_RoadModelFusionSI_Out_P"_sv);
}
