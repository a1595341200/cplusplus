...
#include "amsr/someip_protocol/internal/datatype_deserialization/NOAInfoIDT/deserializer_NOAInfoIDT.h"
...
deserialization::Result DeserializerEHR_Bus_NOAInfo::Deserialize(deserialization::Reader &reader, ::NOAInfoIDT::NOAInfoIDT &data) noexcept {
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::NOAInfoIDT::NOAInfoIDT>{})};
