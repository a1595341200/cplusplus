...
#include "amsr/someip_protocol/internal/datatype_deserialization/LinkCurvatureIDT/deserializer_LinkCurvatureIDT.h"
...
deserialization::Result DeserializerEHR_Bus_LinkCurvatures::Deserialize(deserialization::Reader &reader, ::Array_LinkCurvatureIDT_Vector::Array_LinkCurvatureIDT_Vector &data) noexcept {
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      TpPackAlias,
        // Config of vector length field and max. container size (/CppImplementationDataTypes/Array_LinkCurvatureIDT_Vector)
      ...
      >(deserialization::SizeToken<::Array_LinkCurvatureIDT_Vector::Array_LinkCurvatureIDT_Vector>{})};
