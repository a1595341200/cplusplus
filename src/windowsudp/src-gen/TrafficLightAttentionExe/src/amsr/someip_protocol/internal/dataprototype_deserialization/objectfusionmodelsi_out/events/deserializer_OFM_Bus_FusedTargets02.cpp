 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/objectfusionmodelsi_out/events/deserializer_OFM_Bus_FusedTargets02.cpp
...
deserialization::Result DeserializerOFM_Bus_FusedTargets02::Deserialize(deserialization::Reader &reader, ::Array_ObjGroup2VccIDT_8::Array_ObjGroup2VccIDT_8 &data) noexcept {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/ObjectFusionModelSI_Out/OFM_Bus_FusedTargets02
