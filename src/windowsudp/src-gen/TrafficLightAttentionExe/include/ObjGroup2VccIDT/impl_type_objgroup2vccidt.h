 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/ObjGroup2VccIDT/impl_type_objgroup2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_OBJGROUP2VCCIDT_IMPL_TYPE_OBJGROUP2VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_OBJGROUP2VCCIDT_IMPL_TYPE_OBJGROUP2VCCIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_OBJGROUP2VCCIDT_IMPL_TYPE_OBJGROUP2VCCIDT_H_
