 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/FrntCamInfoIDT/impl_type_frntcaminfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_FRNTCAMINFOIDT_IMPL_TYPE_FRNTCAMINFOIDT_H_
