 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/CamSts1IDT/impl_type_camsts1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_CAMSTS1IDT_IMPL_TYPE_CAMSTS1IDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_CAMSTS1IDT_IMPL_TYPE_CAMSTS1IDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_CAMSTS1IDT_IMPL_TYPE_CAMSTS1IDT_H_
