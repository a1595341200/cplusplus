 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/perceptionsidesi_out/PerceptionSideSI_Out_proxy_backend_interface.h
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_BACKEND_INTERFACE_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_BACKEND_INTERFACE_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_PROXY_BACKEND_INTERFACE_H_
