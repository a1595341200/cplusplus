 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/TrfcInfoMiscFirst1IDT/impl_type_trfcinfomiscfirst1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_TRFCINFOMISCFIRST1IDT_IMPL_TYPE_TRFCINFOMISCFIRST1IDT_H_
