 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/perceptionrearsi_out/PerceptionRearSI_Out_types.h
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_TYPES_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_TYPES_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_TYPES_H_
