 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/LaneEventGroupCam1VccIDT/impl_type_laneeventgroupcam1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_LANEEVENTGROUPCAM1VCCIDT_IMPL_TYPE_LANEEVENTGROUPCAM1VCCIDT_H_
