 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/CameraStatusIDT/impl_type_camerastatusidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_CAMERASTATUSIDT_IMPL_TYPE_CAMERASTATUSIDT_H_
