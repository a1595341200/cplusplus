 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/SpdAlrmActvForRoadSgnInfo0IDT/impl_type_spdalrmactvforroadsgninfo0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
