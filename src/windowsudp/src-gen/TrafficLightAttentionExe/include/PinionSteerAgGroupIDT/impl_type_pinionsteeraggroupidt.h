 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/PinionSteerAgGroupIDT/impl_type_pinionsteeraggroupidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_PINIONSTEERAGGROUPIDT_IMPL_TYPE_PINIONSTEERAGGROUPIDT_H_
