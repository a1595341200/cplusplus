 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/CamObjTyp1IDT/impl_type_camobjtyp1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_CAMOBJTYP1IDT_IMPL_TYPE_CAMOBJTYP1IDT_H_
