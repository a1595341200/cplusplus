 ...
 * \details Top-Level data type: /CppImplementationDataTypes/HMIDataTrfcLi1VccIDT
...
class SerializerTLA_Bus_HMIDataTrfcLi {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/HMIDataTrfcLi1VccIDT.
   *
   ...
   * \endspec
   */
  constexpr static std::size_t GetRequiredBufferSize(::HMIDataTrfcLi1VccIDT::HMIDataTrfcLi1VccIDT const &data) noexcept {
  ...
  /*!
   * \brief Returns the maximum buffer size for the data prototype service event /JICA/Service/Interface/TrafficLightAttentionSI_Out/TLA_Bus_HMIDataTrfcLi.
   *
   * \return      Calculated buffer size for serialization.
   * \pre         -
   * \context     App
  ...
  static void Serialize(serialization::Writer &writer, ::HMIDataTrfcLi1VccIDT::HMIDataTrfcLi1VccIDT const &data) noexcept;
