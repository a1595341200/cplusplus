...
class ObjectFusionModelSI_OutProxyXf final
 ...
 public:
   ...
   *                                                ObjectFusionModelSI_OutProxyXf's entire life time.
   ...
   * \synchronous TRUE
   */
  ~ObjectFusionModelSI_OutProxyXf() noexcept final;

  ObjectFusionModelSI_OutProxyXf(ObjectFusionModelSI_OutProxyXf const &) = delete;
  ObjectFusionModelSI_OutProxyXf &operator=(ObjectFusionModelSI_OutProxyXf const &) = delete;
  ObjectFusionModelSI_OutProxyXf(ObjectFusionModelSI_OutProxyXf &&) = delete;
  ObjectFusionModelSI_OutProxyXf &operator=(ObjectFusionModelSI_OutProxyXf &&) = delete;
 ...
 // ---- Events ---------------------------------------------------------------------------------------------------
  ...
  /*!
   * \brief       Getter function for the event 'OFM_Bus_FusedTargets01'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets01& GetEventBackendOFM_Bus_FusedTargets01() noexcept final;

  /*!
   * \brief       Getter function for the event 'OFM_Bus_FusedTargets02'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets02& GetEventBackendOFM_Bus_FusedTargets02() noexcept final;

  /*!
   * \brief       Getter function for the event 'OFM_Bus_FusedTargets03'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets03& GetEventBackendOFM_Bus_FusedTargets03() noexcept final;

  /*!
   * \brief       Getter function for the event 'OFM_Bus_FusedTargets04'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets04& GetEventBackendOFM_Bus_FusedTargets04() noexcept final;
  ...
  /*!
   * \brief       Getter function for the event 'OFM_Bus_FourDRadarStatus'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FourDRadarStatus& GetEventBackendOFM_Bus_FourDRadarStatus() noexcept final;

  /*!
   * \brief       Getter function for the event 'OFM_Bus_LaneInfo'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_LaneInfo& GetEventBackendOFM_Bus_LaneInfo() noexcept final;
 ...
 private:
  ...
  /*!
   * \brief Event backend for proxy event 'OFM_Bus_FusedTargets01'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets01 event_backend_OFM_Bus_FusedTargets01_;

  /*!
   * \brief Event backend for proxy event 'OFM_Bus_FusedTargets02'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets02 event_backend_OFM_Bus_FusedTargets02_;

  /*!
   * \brief Event backend for proxy event 'OFM_Bus_FusedTargets03'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets03 event_backend_OFM_Bus_FusedTargets03_;

  /*!
   * \brief Event backend for proxy event 'OFM_Bus_FusedTargets04'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets04 event_backend_OFM_Bus_FusedTargets04_;
  ...
  /*!
   * \brief Event backend for proxy event 'OFM_Bus_FourDRadarStatus'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FourDRadarStatus event_backend_OFM_Bus_FourDRadarStatus_;

  /*!
   * \brief Event backend for proxy event 'OFM_Bus_LaneInfo'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_LaneInfo event_backend_OFM_Bus_LaneInfo_;
