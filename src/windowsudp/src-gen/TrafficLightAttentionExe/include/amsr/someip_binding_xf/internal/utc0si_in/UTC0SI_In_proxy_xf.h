 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/amsr/someip_binding_xf/internal/utc0si_in/UTC0SI_In_proxy_xf.h
 *        \brief  SOME/IP binding of service proxy for service 'UTC0SI_In'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_UTC0SI_IN_UTC0SI_IN_PROXY_XF_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_UTC0SI_IN_UTC0SI_IN_PROXY_XF_H_
...
#include "amsr/someip_binding_xf/internal/utc0si_in/UTC0SI_In_proxy_methods.h"
 ...
 */
class UTC0SI_InProxyXf final :
  public ::utc0si_in::internal::UTC0SI_InProxyBackendInterface {
 public:
  /*!
   ...
   * \synchronous TRUE
   */
  UTC0SI_InProxyXf(::amsr::someip_protocol::internal::ServiceId const service_id,
  ...
  ~UTC0SI_InProxyXf() noexcept override;

  UTC0SI_InProxyXf(UTC0SI_InProxyXf const&) noexcept = delete;
  UTC0SI_InProxyXf(UTC0SI_InProxyXf&& other) noexcept = delete;
  UTC0SI_InProxyXf& operator=(UTC0SI_InProxyXf const&) & = delete;
  UTC0SI_InProxyXf& operator=(UTC0SI_InProxyXf&&) & noexcept = delete;
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  ::amsr::socal::internal::events::ProxyEventBackendInterface<::DateTi30_2IDT::DateTi30_2IDT>& GetEventBackendOSM2_Bus_VehTiAndData() noexcept override {
    return event_xf_OSM2_Bus_VehTiAndData_;
 ...
 private:
  ...
  ::amsr::someip_binding::internal::configuration::EventConfig const&
      ...
      events_UTC0SI_InProxySomeIpEventConfigurationOSM2_Bus_VehTiAndData_event_config_{
          ...
          config_wrapper_.GetEventConfig(
              ...
              ::amsr::someip_binding::internal::configuration::Shortname{events::proxy::OSM2_Bus_VehTiAndData::EventDesignInfo::kEventName.c_str()})};

  // Event Xf for proxy event 'OSM2_Bus_VehTiAndData'
  // VCA_SOMEIPBINDING_ACCESSING_MEMBERS_OF_REFERENCE_CLASS_ATTRIBUTES
  // VCA_SOMEIPBINDING_MISS_OF_INFORMATION_OF_POINTER
  std::unique_ptr<ser_deser::DeserializerInterface<events::proxy::OSM2_Bus_VehTiAndData::EventDesignInfo::SampleType>> deserializer_ptr_OSM2_Bus_VehTiAndData_{
    events::proxy::OSM2_Bus_VehTiAndData::DeserializerFactory::Create()
  };
  ...
  // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
  events::proxy::OSM2_Bus_VehTiAndData::UTC0SI_InProxySomeIpEventBackendOSM2_Bus_VehTiAndData event_xf_OSM2_Bus_VehTiAndData_{
      // VCA_SOMEIPBINDING_ACCESSING_MEMBERS_OF_REFERENCE_CLASS_ATTRIBUTES
      someip_binding_core::internal::SomeIpEventIdentity{
          ...
          events_UTC0SI_InProxySomeIpEventConfigurationOSM2_Bus_VehTiAndData_event_config_
              ...
              .GetEventId()},
      someip_client_,
      *(deserializer_ptr_OSM2_Bus_VehTiAndData_.get()),
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_XF_INTERNAL_UTC0SI_IN_UTC0SI_IN_PROXY_XF_H_
