 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/PathTrafficSignsIDT/impl_type_pathtrafficsignsidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_PATHTRAFFICSIGNSIDT_IMPL_TYPE_PATHTRAFFICSIGNSIDT_H_
#define EHREXE_INCLUDE_PATHTRAFFICSIGNSIDT_IMPL_TYPE_PATHTRAFFICSIGNSIDT_H_
...
#endif  // EHREXE_INCLUDE_PATHTRAFFICSIGNSIDT_IMPL_TYPE_PATHTRAFFICSIGNSIDT_H_
