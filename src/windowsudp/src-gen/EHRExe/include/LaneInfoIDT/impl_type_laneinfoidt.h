 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LaneInfoIDT/impl_type_laneinfoidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LANEINFOIDT_IMPL_TYPE_LANEINFOIDT_H_
#define EHREXE_INCLUDE_LANEINFOIDT_IMPL_TYPE_LANEINFOIDT_H_
...
#endif  // EHREXE_INCLUDE_LANEINFOIDT_IMPL_TYPE_LANEINFOIDT_H_
