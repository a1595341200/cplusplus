 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/ehrsi_out/ehrsi_out_common.h
...
#ifndef EHREXE_INCLUDE_EHRSI_OUT_EHRSI_OUT_COMMON_H_
#define EHREXE_INCLUDE_EHRSI_OUT_EHRSI_OUT_COMMON_H_
...
#endif  // EHREXE_INCLUDE_EHRSI_OUT_EHRSI_OUT_COMMON_H_
