...
#include "amsr/someip_protocol/internal/datatype_serialization/LaneSpeedLimitIDT/serializer_LaneSpeedLimitIDT.h"
...
class SerializerEHR_Bus_LaneSpeedLimits {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/Array_LaneSpeedLimitIDT_Vector.
   *
   ...
   * \endspec
   */
  constexpr static std::size_t GetRequiredBufferSize(::Array_LaneSpeedLimitIDT_Vector::Array_LaneSpeedLimitIDT_Vector const &data) noexcept {
    return serialization::GetRequiredBufferSize<
      TpPackDataPrototype,
      // Config of vector length field and max. container size based on 'arraySize=null' model configuration. (/CppImplementationDataTypes/Array_LaneSpeedLimitIDT_Vector)
  ...
  /*!
   * \brief Returns the maximum buffer size for the data prototype service event /JICA/Service/Interface/EHRSI_Out/EHR_Bus_LaneSpeedLimits.
   *
   * \return      Calculated buffer size for serialization.
   * \pre         -
   * \context     App
  ...
  static void Serialize(serialization::Writer &writer, ::Array_LaneSpeedLimitIDT_Vector::Array_LaneSpeedLimitIDT_Vector const &data) noexcept;
