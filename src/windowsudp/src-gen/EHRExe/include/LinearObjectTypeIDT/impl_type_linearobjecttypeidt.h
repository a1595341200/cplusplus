 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/LinearObjectTypeIDT/impl_type_linearobjecttypeidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_LINEAROBJECTTYPEIDT_IMPL_TYPE_LINEAROBJECTTYPEIDT_H_
#define EHREXE_INCLUDE_LINEAROBJECTTYPEIDT_IMPL_TYPE_LINEAROBJECTTYPEIDT_H_
...
#endif  // EHREXE_INCLUDE_LINEAROBJECTTYPEIDT_IMPL_TYPE_LINEAROBJECTTYPEIDT_H_
