 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/SwtIndcr1VccIDT/impl_type_swtindcr1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_SWTINDCR1VCCIDT_IMPL_TYPE_SWTINDCR1VCCIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_SWTINDCR1VCCIDT_IMPL_TYPE_SWTINDCR1VCCIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_SWTINDCR1VCCIDT_IMPL_TYPE_SWTINDCR1VCCIDT_H_
