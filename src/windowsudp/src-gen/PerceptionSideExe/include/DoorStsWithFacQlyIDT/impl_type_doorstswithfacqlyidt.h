 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/DoorStsWithFacQlyIDT/impl_type_doorstswithfacqlyidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_DOORSTSWITHFACQLYIDT_IMPL_TYPE_DOORSTSWITHFACQLYIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_DOORSTSWITHFACQLYIDT_IMPL_TYPE_DOORSTSWITHFACQLYIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_DOORSTSWITHFACQLYIDT_IMPL_TYPE_DOORSTSWITHFACQLYIDT_H_
