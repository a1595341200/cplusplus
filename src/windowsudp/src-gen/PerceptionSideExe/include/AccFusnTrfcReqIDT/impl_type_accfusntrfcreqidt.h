 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/AccFusnTrfcReqIDT/impl_type_accfusntrfcreqidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_ACCFUSNTRFCREQIDT_IMPL_TYPE_ACCFUSNTRFCREQIDT_H_
