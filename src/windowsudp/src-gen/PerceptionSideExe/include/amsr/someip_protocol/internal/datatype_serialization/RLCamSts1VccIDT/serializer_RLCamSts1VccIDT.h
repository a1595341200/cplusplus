 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/amsr/someip_protocol/internal/datatype_serialization/RLCamSts1VccIDT/serializer_RLCamSts1VccIDT.h
 *        \brief  SOME/IP protocol serializer implementation for datatype 'RLCamSts1VccIDT'
 *
 *      \details  /CppImplementationDataTypes/RLCamSts1VccIDT
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_RLCAMSTS1VCCIDT_SERIALIZER_RLCAMSTS1VCCIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_RLCAMSTS1VCCIDT_SERIALIZER_RLCAMSTS1VCCIDT_H_
...
/*!
 * \brief Serializer for datatype /CppImplementationDataTypes/RLCamSts1VccIDT.
 ...
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/RLCamSts1VccIDT to be serialized.
...
void SomeIpProtocolSerialize(amsr::someip_protocol::internal::serialization::Writer& writer, ::RLCamSts1VccIDT::RLCamSts1VccIDT const &data) noexcept {
...
/*!
 * \brief Calculates the required buffer size for datatype /CppImplementationDataTypes/RLCamSts1VccIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/RLCamSts1VccIDT.
 ...
 */
template <typename TpPack>
constexpr std::size_t GetRequiredBufferSize(::RLCamSts1VccIDT::RLCamSts1VccIDT const &data) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/RLCamSts1VccIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 ...
 * \endspec
 */
template <typename T, typename TpPack, std::enable_if_t<std::is_same<T, ::RLCamSts1VccIDT::RLCamSts1VccIDT>::value, bool> = true>
...
/*!
 * \brief Calculates the maximum buffer size for datatype /CppImplementationDataTypes/RLCamSts1VccIDT. For ADL.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr amsr::someip_protocol::internal::serialization::InfSizeT GetMaximumBufferSize(::RLCamSts1VccIDT::RLCamSts1VccIDT const&) noexcept {
  return GetMaximumBufferSize<::RLCamSts1VccIDT::RLCamSts1VccIDT, TpPack>();
}

/*!
 * \brief Checks if datatype /CppImplementationDataTypes/RLCamSts1VccIDT is of static size.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr bool IsStaticSize(amsr::someip_protocol::internal::serialization::SizeToken<::RLCamSts1VccIDT::RLCamSts1VccIDT>) noexcept {
  // Namespace alias for static serialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace serialization = internal::serialization;
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_RLCAMSTS1VCCIDT_SERIALIZER_RLCAMSTS1VCCIDT_H_
