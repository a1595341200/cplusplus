 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/tosoca_locsensorinfosi/ToSOCA_LocSensorInfoSI_proxy_backend_interface.h
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_BACKEND_INTERFACE_H_
#define PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_BACKEND_INTERFACE_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_TOSOCA_LOCSENSORINFOSI_TOSOCA_LOCSENSORINFOSI_PROXY_BACKEND_INTERFACE_H_
