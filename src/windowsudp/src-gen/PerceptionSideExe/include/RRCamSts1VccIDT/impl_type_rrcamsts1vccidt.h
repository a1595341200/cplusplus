 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/RRCamSts1VccIDT/impl_type_rrcamsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_RRCAMSTS1VCCIDT_IMPL_TYPE_RRCAMSTS1VCCIDT_H_
#define PERCEPTIONSIDEEXE_INCLUDE_RRCAMSTS1VCCIDT_IMPL_TYPE_RRCAMSTS1VCCIDT_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_RRCAMSTS1VCCIDT_IMPL_TYPE_RRCAMSTS1VCCIDT_H_
