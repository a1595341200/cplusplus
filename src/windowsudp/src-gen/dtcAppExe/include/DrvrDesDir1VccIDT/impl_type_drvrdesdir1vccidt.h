 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/DrvrDesDir1VccIDT/impl_type_drvrdesdir1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
#define DTCAPPEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_DRVRDESDIR1VCCIDT_IMPL_TYPE_DRVRDESDIR1VCCIDT_H_
