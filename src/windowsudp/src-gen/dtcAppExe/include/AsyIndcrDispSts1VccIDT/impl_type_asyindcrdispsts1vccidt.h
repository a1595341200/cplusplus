 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/AsyIndcrDispSts1VccIDT/impl_type_asyindcrdispsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef DTCAPPEXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
#define DTCAPPEXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
...
#endif  // DTCAPPEXE_INCLUDE_ASYINDCRDISPSTS1VCCIDT_IMPL_TYPE_ASYINDCRDISPSTS1VCCIDT_H_
