 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  UTC0Exe/src/amsr/socal/internal/runtime_gen.cpp
...
void Runtime::InitializeInstanceSpecifierLookupTables() noexcept {
  ...
  // Add R-Port InstanceSpecifier 'UTC0Exe/UTC0/UTC0_UTC0SI_In_R' to the lookup table.
  // VCA_SOCAL_UNDEFINED_RUNTIME_ADD_INSTANCE_SPECIFIER_FUNCTION
  AddInstanceSpecifier(required_instance_specifier_table_, "UTC0Exe/UTC0/UTC0_UTC0SI_In_R"_sv);

  // Add P-Port InstanceSpecifier 'UTC0Exe/UTC0/UTC0_UTC0SI_Out_P' to the lookup table.
  // VCA_SOCAL_UNDEFINED_RUNTIME_ADD_INSTANCE_SPECIFIER_FUNCTION
  AddInstanceSpecifier(provided_instance_specifier_table_, "UTC0Exe/UTC0/UTC0_UTC0SI_Out_P"_sv);
}
