 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RadarAdaptorExe/src/amsr/socal/internal/runtime_gen.cpp
...
void Runtime::InitializeInstanceSpecifierLookupTables() noexcept {
  ...
  // Add P-Port InstanceSpecifier 'RadarAdaptorExe/RadarAdaptor/RadarAdaptor_RadarAdaptorSI_Out_P' to the lookup table.
  // VCA_SOCAL_UNDEFINED_RUNTIME_ADD_INSTANCE_SPECIFIER_FUNCTION
  AddInstanceSpecifier(provided_instance_specifier_table_, "RadarAdaptorExe/RadarAdaptor/RadarAdaptor_RadarAdaptorSI_Out_P"_sv);
}
