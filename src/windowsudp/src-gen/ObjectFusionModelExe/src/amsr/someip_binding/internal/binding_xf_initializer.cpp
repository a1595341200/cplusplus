 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/someip_binding/internal/binding_xf_initializer.cpp
...
::ara::core::Result<void> BindingXfInitializer::Initialize(
  ...
  ::amsr::someip_binding::internal::configuration::ServiceConfigValidationDataAccess const service_config_validation_data_access{
    &::amsr::someip_binding::internal::configuration::SomeipBindingConfigValidationData::kValidServiceEntities[0], 3
  };
...
void BindingXfInitializer::InitializeServiceDiscoveryProxyXfs(
  ...
  { // Instantiate ServiceDiscoveryProxyXfs for Service TOSOCA_SideRdrFusedTargetsSI
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/TOSOCA_SideRdrFusedTargetsSI"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
    ...
    SomeIpBindingProxyXfInitializer::InitializeSdProxyXfs<
        ::tosoca_siderdrfusedtargetssi::proxy::TOSOCA_SideRdrFusedTargetsSIProxy,
        ::tosoca_siderdrfusedtargetssi::internal::TOSOCA_SideRdrFusedTargetsSIProxyBackendInterface,
        ::amsr::someip_binding_xf::internal::gen_tosoca_siderdrfusedtargetssi::TOSOCA_SideRdrFusedTargetsSIProxyXf>(
        // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
...
void BindingXfInitializer::DeInitializeServiceDiscoveryProxyXfs(
    configuration::ServiceConfigWrapperInterface const& services_config) noexcept {
  {  // Deinitialize ServiceDiscoveryProxyXf for Service TOSOCA_SideRdrFusedTargetsSI
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/TOSOCA_SideRdrFusedTargetsSI"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
...
::amsr::someip_binding_core::internal::ServerTransportToDaemonInterface& server_transport_to_daemon, std::function<void()> process_polling) noexcept {
  {  // Instantiate ServiceDiscoverySkeletonXfs for Service ObjectFusionModelSI_Out
    // Shortname path
    // VECTOR NC AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
    // VCA_SOMEIPBINDING_TRIVIAL_FUNCTION_CONTRACT
    ::amsr::someip_binding::internal::configuration::ShortnamePath const shortname_path{"/JICA/Service/Interface/ObjectFusionModelSI_Out"}; // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
    // Create & initialize SD Skeleton XF
    // VCA_SOMEIPBINDING_CONFIG_WRAPPER_OBJECT_LIFECYCLE
    SomeIpBindingSkeletonXfInitializer::InitializeSdSkeletonXfs<
        ::amsr::someip_binding_xf::internal::gen_objectfusionmodelsi_out::ObjectFusionModelSI_OutSkeletonXf,
        // VECTOR NL AutosarC++17_10-A5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-A5.0.1_independent_unsequenced_calls
        ::objectfusionmodelsi_out::skeleton::ObjectFusionModelSI_OutSkeleton>( // VECTOR SL VectorC++-V5.0.1: MD_SOMEIPBINDING_VectorC++-V5.0.1_unsequenced_call_false_positive
        // VCA_SLC_20_SOMEIPBINDING_FUNCTION_IS_DEFINED
