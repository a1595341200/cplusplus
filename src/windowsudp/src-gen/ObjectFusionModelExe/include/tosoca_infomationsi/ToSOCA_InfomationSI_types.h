 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_types.h
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_TYPES_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_TYPES_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_TYPES_H_
