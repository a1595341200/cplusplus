 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/perceptionsidesi_out/PerceptionSideSI_Out_datatypes.h
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_DATATYPES_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_DATATYPES_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONSIDESI_OUT_PERCEPTIONSIDESI_OUT_DATATYPES_H_
