 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/RoadSignIDT/impl_type_roadsignidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_ROADSIGNIDT_IMPL_TYPE_ROADSIGNIDT_H_
