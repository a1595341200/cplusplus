 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/perceptionrearsi_out/PerceptionRearSI_Out_datatypes.h
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_DATATYPES_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_DATATYPES_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONREARSI_OUT_PERCEPTIONREARSI_OUT_DATATYPES_H_
