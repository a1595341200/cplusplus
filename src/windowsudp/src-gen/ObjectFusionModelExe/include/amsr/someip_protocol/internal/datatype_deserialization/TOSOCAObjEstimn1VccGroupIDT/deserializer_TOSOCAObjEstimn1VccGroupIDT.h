 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/amsr/someip_protocol/internal/datatype_deserialization/TOSOCAObjEstimn1VccGroupIDT/deserializer_TOSOCAObjEstimn1VccGroupIDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'TOSOCAObjEstimn1VccGroupIDT'
 *
 *      \details  /CppImplementationDataTypes/TOSOCAObjEstimn1VccGroupIDT
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_TOSOCAOBJESTIMN1VCCGROUPIDT_DESERIALIZER_TOSOCAOBJESTIMN1VCCGROUPIDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_TOSOCAOBJESTIMN1VCCGROUPIDT_DESERIALIZER_TOSOCAOBJESTIMN1VCCGROUPIDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/TOSOCAObjEstimn1VccGroupIDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/TOSOCAObjEstimn1VccGroupIDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::TOSOCAObjEstimn1VccGroupIDT::TOSOCAObjEstimn1VccGroupIDT &data) noexcept {
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/TOSOCAObjEstimn1VccGroupIDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::TOSOCAObjEstimn1VccGroupIDT::TOSOCAObjEstimn1VccGroupIDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_TOSOCAOBJESTIMN1VCCGROUPIDT_DESERIALIZER_TOSOCAOBJESTIMN1VCCGROUPIDT_H_
