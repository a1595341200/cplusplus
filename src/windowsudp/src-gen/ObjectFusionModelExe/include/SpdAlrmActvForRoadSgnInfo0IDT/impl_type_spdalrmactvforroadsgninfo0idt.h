 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/SpdAlrmActvForRoadSgnInfo0IDT/impl_type_spdalrmactvforroadsgninfo0idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_SPDALRMACTVFORROADSGNINFO0IDT_IMPL_TYPE_SPDALRMACTVFORROADSGNINFO0IDT_H_
