 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/AsyLineRiPah2IDT/impl_type_asylineripah2idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_ASYLINERIPAH2IDT_IMPL_TYPE_ASYLINERIPAH2IDT_H_
#define EDREXE_INCLUDE_ASYLINERIPAH2IDT_IMPL_TYPE_ASYLINERIPAH2IDT_H_
...
/*!
 * \brief Type AsyLineRiPah2IDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/AsyLineRiPah2IDT
 */
struct AsyLineRiPah2IDT {
...
/*!
 * \brief   Compare for equality with another AsyLineRiPah2IDT instance.
 ...
 *          use your own.
 */
inline bool operator==(AsyLineRiPah2IDT const& l,
                       AsyLineRiPah2IDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another AsyLineRiPah2IDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // EDREXE_INCLUDE_ASYLINERIPAH2IDT_IMPL_TYPE_ASYLINERIPAH2IDT_H_
