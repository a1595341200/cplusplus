 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_proxy_backend_interface.h
...
#ifndef EDREXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_BACKEND_INTERFACE_H_
#define EDREXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_BACKEND_INTERFACE_H_
...
#endif  // EDREXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_BACKEND_INTERFACE_H_
