 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/StandStillMgrStsForPark2VccIDT/impl_type_standstillmgrstsforpark2vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_STANDSTILLMGRSTSFORPARK2VCCIDT_IMPL_TYPE_STANDSTILLMGRSTSFORPARK2VCCIDT_H_
#define EDREXE_INCLUDE_STANDSTILLMGRSTSFORPARK2VCCIDT_IMPL_TYPE_STANDSTILLMGRSTSFORPARK2VCCIDT_H_
...
#endif  // EDREXE_INCLUDE_STANDSTILLMGRSTSFORPARK2VCCIDT_IMPL_TYPE_STANDSTILLMGRSTSFORPARK2VCCIDT_H_
