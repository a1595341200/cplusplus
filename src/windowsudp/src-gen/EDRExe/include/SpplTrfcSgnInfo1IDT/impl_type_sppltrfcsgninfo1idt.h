 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/SpplTrfcSgnInfo1IDT/impl_type_sppltrfcsgninfo1idt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
#define EDREXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
...
#endif  // EDREXE_INCLUDE_SPPLTRFCSGNINFO1IDT_IMPL_TYPE_SPPLTRFCSGNINFO1IDT_H_
