 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/IntvAndWarnModForLaneKeepAidSts1VccIDT/impl_type_intvandwarnmodforlanekeepaidsts1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_IMPL_TYPE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_H_
#define EDREXE_INCLUDE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_IMPL_TYPE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_H_
...
#endif  // EDREXE_INCLUDE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_IMPL_TYPE_INTVANDWARNMODFORLANEKEEPAIDSTS1VCCIDT_H_
