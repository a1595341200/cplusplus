 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/amsr/ipc_binding_transformation_layer/internal/edrsi_out/EDRSI_Out_skeleton_ipc_binding.h
 *        \brief  IPC binding of service skeleton for service 'EDRSI_Out'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef EDREXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_EDRSI_OUT_EDRSI_OUT_SKELETON_IPC_BINDING_H_
#define EDREXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_EDRSI_OUT_EDRSI_OUT_SKELETON_IPC_BINDING_H_
...
#include <utility>
#include "amsr/ipc_binding_transformation_layer/internal/edrsi_out/EDRSI_Out_skeleton_ipc_event_manager.h"
#include "amsr/ipc_binding_transformation_layer/internal/edrsi_out/EDRSI_Out_skeleton_ipc_method_manager.h"
...
/*!
 * \brief Provided service interface deployment of service interface 'EDRSI_Out'.
...
class EDRSI_OutProvidedIpcServiceInstance final
    : public ::amsr::ipc_binding_core::internal::LocalServerSink,
      public ::edrsi_out::internal::EDRSI_OutSkeletonImplInterface {
 public:
 ...
 /*!
  ...
  /*!
   * \brief         Constructor of ProvidedIpcServiceInstance for service 'EDRSI_Out'.
   * \param[in,out] skeleton                Reference to the skeleton. The reference must be valid for EDRSI_OutProvidedIpcServiceInstance entire life time.
   * \param[in,out] server_binding_manager  Server binding manager. The reference must be valid for EDRSI_OutProvidedIpcServiceInstance entire life time.
   ...
   * \synchronous   TRUE
   */
  EDRSI_OutProvidedIpcServiceInstance(::edrsi_out::internal::EDRSI_OutSkeletonBackendInterface& skeleton,
      ...
      : ::amsr::ipc_binding_core::internal::LocalServerSink{},
        ...
        logger_{::amsr::ipc_binding_core::internal::logging::kIpcLoggerContextId,
                ...
                ::amsr::core::StringView{"EDRSI_OutProvidedIpcServiceInstance"}},
        event_EDR_Bus_EDRInfo_{
            server_binding_manager,
            service_config.GetId(),
            service_config.GetMajorVersion(),
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            EventId{service_config.GetEventOf(ipc_binding_core::internal::runtime_configuration::Shortname{"EDR_Bus_EDRInfo"}).GetId().value},
            instance_id,
            false},
        event_id_set_{  // VCA_IPCB_STD_CONSTRUCTOR_CALLED
            // VCA_IPCB_STD_BASICSTRING_CONSTRUCTOR
            service_config.GetEventOf({"EDR_Bus_EDRInfo"}).GetId()}  {
  ...
  EDRSI_OutProvidedIpcServiceInstance(EDRSI_OutProvidedIpcServiceInstance const& ) noexcept = delete;
  EDRSI_OutProvidedIpcServiceInstance(EDRSI_OutProvidedIpcServiceInstance&& ) noexcept = delete;
  EDRSI_OutProvidedIpcServiceInstance& operator=(EDRSI_OutProvidedIpcServiceInstance const& ) noexcept = delete;
  EDRSI_OutProvidedIpcServiceInstance& operator=(EDRSI_OutProvidedIpcServiceInstance&& ) noexcept = delete;
  ...
  ~EDRSI_OutProvidedIpcServiceInstance() noexcept final {
  ...
  /*!
   * \brief   Get the event manager object for the IPC binding service event 'EDR_Bus_EDRInfo'.
   *
   ...
   * \context App
   */
  EDRSI_OutSkeletonIpcEventManagerEDR_Bus_EDRInfo* GetEventManagerEDR_Bus_EDRInfo() noexcept final;
  // ---- Events --------------------------------------------------------------------------------------------------
 ...
 private:
  ...
  // ---- EventManagers --------------------------------------------------------------------------------------------
  /*!
   * \brief Event manager for skeleton event 'EDR_Bus_EDRInfo'
   */
  EDRSI_OutSkeletonIpcEventManagerEDR_Bus_EDRInfo event_EDR_Bus_EDRInfo_;
...
#endif  // EDREXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_EDRSI_OUT_EDRSI_OUT_SKELETON_IPC_BINDING_H_
