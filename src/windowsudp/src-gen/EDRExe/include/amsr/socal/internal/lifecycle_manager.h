 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/amsr/socal/internal/lifecycle_manager.h
...
#ifndef EDREXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
#define EDREXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
...
class LifecycleManager final {
 public:
  ...
  static void Initialize() noexcept {
    ...
    edrsi_out::skeleton::EDRSI_OutSkeleton::CreateSingletons();

    edrsi_in::proxy::EDRSI_InProxy::CreateSingletons();
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    edrsi_in::proxy::EDRSI_InProxy::RegisterServiceDiscovery(&edrsi_in_proxy_sd_0_);
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    tosoca_infomationsi::proxy::ToSOCA_InfomationSIProxy::RegisterServiceDiscovery(&tosoca_infomationsi_proxy_sd_1_);
    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    utc0si_in::proxy::UTC0SI_InProxy::RegisterServiceDiscovery(&utc0si_in_proxy_sd_2_);

    // VCA_SOCAL_UNDEFINED_REGISTER_SD_FUNCTION
    edrsi_out::skeleton::EDRSI_OutSkeleton::RegisterServiceDiscovery(&edrsi_out_skeleton_sd_0_);
  }
  ...
  void DeInitializeServiceDiscovery() noexcept {
    edrsi_in::proxy::EDRSI_InProxy::DeRegisterServiceDiscovery();
    ...
    edrsi_out::skeleton::EDRSI_OutSkeleton::DeRegisterServiceDiscovery();
  }


  /*!
   * \brief Service discovery instance used on proxy side
   *        for the service interface edrsi_in::EDRSI_In.
   */
  ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      edrsi_in::internal::EDRSI_InProxyBackendInterface> edrsi_in_proxy_sd_0_{edrsi_in::EDRSI_In::kServiceShortNamePath};
   ...
   */
  ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      tosoca_infomationsi::internal::ToSOCA_InfomationSIProxyBackendInterface> tosoca_infomationsi_proxy_sd_1_{tosoca_infomationsi::ToSOCA_InfomationSI::kServiceShortNamePath};
   ...
   */
  ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
      utc0si_in::internal::UTC0SI_InProxyBackendInterface> utc0si_in_proxy_sd_2_{utc0si_in::UTC0SI_In::kServiceShortNamePath};
   ...
   */
  edrsi_out::skeleton::EDRSI_OutSkeleton::ServiceDiscovery edrsi_out_skeleton_sd_0_{edrsi_out::EDRSI_Out::kServiceShortNamePath};
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr

#endif  // EDREXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
