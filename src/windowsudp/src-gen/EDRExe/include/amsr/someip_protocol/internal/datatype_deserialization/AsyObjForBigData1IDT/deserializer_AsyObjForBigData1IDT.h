 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/amsr/someip_protocol/internal/datatype_deserialization/AsyObjForBigData1IDT/deserializer_AsyObjForBigData1IDT.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'AsyObjForBigData1IDT'
 *
 *      \details  /CppImplementationDataTypes/AsyObjForBigData1IDT
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef EDREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ASYOBJFORBIGDATA1IDT_DESERIALIZER_ASYOBJFORBIGDATA1IDT_H_
#define EDREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ASYOBJFORBIGDATA1IDT_DESERIALIZER_ASYOBJFORBIGDATA1IDT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/AsyObjForBigData1IDT.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/AsyObjForBigData1IDT
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::AsyObjForBigData1IDT::AsyObjForBigData1IDT &data) noexcept {
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/AsyObjForBigData1IDT.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::AsyObjForBigData1IDT::AsyObjForBigData1IDT>) noexcept {
  // Namespace alias for static deserialization code
  namespace internal = amsr::someip_protocol::internal;
  namespace deserialization = internal::deserialization;
...
#endif  // EDREXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_ASYOBJFORBIGDATA1IDT_DESERIALIZER_ASYOBJFORBIGDATA1IDT_H_
