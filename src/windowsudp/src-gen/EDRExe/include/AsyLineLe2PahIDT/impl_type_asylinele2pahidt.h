 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/AsyLineLe2PahIDT/impl_type_asylinele2pahidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_ASYLINELE2PAHIDT_IMPL_TYPE_ASYLINELE2PAHIDT_H_
#define EDREXE_INCLUDE_ASYLINELE2PAHIDT_IMPL_TYPE_ASYLINELE2PAHIDT_H_
...
/*!
 * \brief Type AsyLineLe2PahIDT.
 * \remark generated
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/AsyLineLe2PahIDT
 */
struct AsyLineLe2PahIDT {
...
/*!
 * \brief   Compare for equality with another AsyLineLe2PahIDT instance.
 ...
 *          use your own.
 */
inline bool operator==(AsyLineLe2PahIDT const& l,
                       AsyLineLe2PahIDT const& r) noexcept {
...
/*!
 * \brief   Compare for inequality with another AsyLineLe2PahIDT instance.
 * \details The method for comparing floating point members is to check whether they are at most
 *          one machine epsilon apart. This method works best for comparing numbers between
 *          1.0 and 2.0. Larger numbers will only be equal if they match exactly, and smaller
 *          numbers that are relatively far apart will be considered equal.
...
#endif  // EDREXE_INCLUDE_ASYLINELE2PAHIDT_IMPL_TYPE_ASYLINELE2PAHIDT_H_
