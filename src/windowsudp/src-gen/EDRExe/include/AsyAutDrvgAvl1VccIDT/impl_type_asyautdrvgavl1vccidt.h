 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/AsyAutDrvgAvl1VccIDT/impl_type_asyautdrvgavl1vccidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_ASYAUTDRVGAVL1VCCIDT_IMPL_TYPE_ASYAUTDRVGAVL1VCCIDT_H_
#define EDREXE_INCLUDE_ASYAUTDRVGAVL1VCCIDT_IMPL_TYPE_ASYAUTDRVGAVL1VCCIDT_H_
...
#endif  // EDREXE_INCLUDE_ASYAUTDRVGAVL1VCCIDT_IMPL_TYPE_ASYAUTDRVGAVL1VCCIDT_H_
