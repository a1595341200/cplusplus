 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/AmbTRawIDT/impl_type_ambtrawidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_AMBTRAWIDT_IMPL_TYPE_AMBTRAWIDT_H_
#define EDREXE_INCLUDE_AMBTRAWIDT_IMPL_TYPE_AMBTRAWIDT_H_
...
#endif  // EDREXE_INCLUDE_AMBTRAWIDT_IMPL_TYPE_AMBTRAWIDT_H_
