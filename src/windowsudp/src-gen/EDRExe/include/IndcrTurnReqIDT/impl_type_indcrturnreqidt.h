 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EDRExe/include/IndcrTurnReqIDT/impl_type_indcrturnreqidt.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EDREXE_INCLUDE_INDCRTURNREQIDT_IMPL_TYPE_INDCRTURNREQIDT_H_
#define EDREXE_INCLUDE_INDCRTURNREQIDT_IMPL_TYPE_INDCRTURNREQIDT_H_
...
#endif  // EDREXE_INCLUDE_INDCRTURNREQIDT_IMPL_TYPE_INDCRTURNREQIDT_H_
