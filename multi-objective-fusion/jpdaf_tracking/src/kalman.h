 ...
 * @Date: 2023-10-19 15:00:02
 * @LastEditors: yao.xie 1595341200@qq.com
 * @LastEditTime: 2023-10-19 15:14:08
 * @FilePath: /cplusplus/multi-objective-fusion/jpdaf_tracking/src/kalman.h
...
class Kalman {
 ...
 private:
  static constexpr float k = 5.0620;  // n/2 * log(4*PI) where n is the state dimention (x, y, x',
                                      // y') static constexpr float k = 2.1984;
};
}  // namespace JPDAFTracker
