 ...
 * @LastEditTime: 2023-07-25 14:25:54
...
void SpeedConversion::setAttributeToFusionObject(FusionObject &fusionObject, EgoMotion &egoMotion) {
    if (mAttribute != nullptr) {
        mAttribute->setAttributeToFusionObject(fusionObject, egoMotion);
    }
    //do set attribute
    std::cout << "SpeedConversion" << std::endl;
}
