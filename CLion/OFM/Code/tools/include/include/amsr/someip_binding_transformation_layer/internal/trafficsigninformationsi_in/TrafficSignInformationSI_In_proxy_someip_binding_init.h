 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/amsr/someip_binding_transformation_layer/internal/trafficsigninformationsi_in/TrafficSignInformationSI_In_proxy_someip_binding_init.h
 *        \brief  Proxy-side ara::com SOME/IP binding initialization for ServiceInterface 'TrafficSignInformationSI_In'
 *
 *      \details  Full ServiceInterface path: '/JICA/Service/Interface/TrafficSignInformationSI_In'
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_TRAFFICSIGNINFORMATIONSI_IN_TRAFFICSIGNINFORMATIONSI_IN_PROXY_SOMEIP_BINDING_INIT_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_TRAFFICSIGNINFORMATIONSI_IN_TRAFFICSIGNINFORMATIONSI_IN_PROXY_SOMEIP_BINDING_INIT_H_
 ...
 * \synchronous TRUE
 */
void AraComSomeIpBindingInitializeServiceInterfaceProxyFactoriesTrafficSignInformationSI_In(
 ...
 * \synchronous TRUE
 */
void AraComSomeIpBindingInitializeProxySomeIpEventBackendsTrafficSignInformationSI_In(::amsr::someip_binding::internal::ClientManager<>& client_manager,
 ...
 * \synchronous TRUE
 */
void AraComSomeIpBindingDeInitializeProxySomeIpEventBackendsTrafficSignInformationSI_In();
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_TRAFFICSIGNINFORMATIONSI_IN_TRAFFICSIGNINFORMATIONSI_IN_PROXY_SOMEIP_BINDING_INIT_H_
