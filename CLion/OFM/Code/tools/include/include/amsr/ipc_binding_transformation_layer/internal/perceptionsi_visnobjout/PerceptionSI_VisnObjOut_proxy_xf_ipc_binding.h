...
/*!
 * \brief Parameterization of the IPC deployment information for service interface 'PerceptionSI_VisnObjOutProxy'.
 */
using PerceptionSI_VisnObjOutRequiredIpcDeployment =
...
class PerceptionSI_VisnObjOutProxyXf final
    : public ::perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutProxyBackendInterface,
      ...
      public std::enable_shared_from_this< PerceptionSI_VisnObjOutProxyXf> {
 public:
   ...
   PerceptionSI_VisnObjOutProxyXf(
      ...
      , event_backend_FrntCam_Bus_VisnObj_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4492}, timer_manager, runtime_processing_mode}
 {
 ...
 private:
   ...
   */
  static constexpr IpcServiceInterfaceDeployment kDeployment{PerceptionSI_VisnObjOutRequiredIpcDeployment::kDeployment};
