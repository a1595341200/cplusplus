...
#include "perceptionsi_visnobjout/PerceptionSI_VisnObjOut_proxy_update_manager.h"
 ...
 * \trace SPEC-4980344
 */
class PerceptionSI_VisnObjOutProxy : public ::amsr::socal::Proxy<perceptionsi_visnobjout::PerceptionSI_VisnObjOut, perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutProxyBackendInterface, perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutHandleType> {
 public:
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Proxy<perceptionsi_visnobjout::PerceptionSI_VisnObjOut, ProxyBackendInterface, perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutHandleType>;
   ...
   */
  perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutProxyUpdateManager proxy_update_manager_;
