 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/Classification/impl_type_classification.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_CLASSIFICATION_IMPL_TYPE_CLASSIFICATION_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_CLASSIFICATION_IMPL_TYPE_CLASSIFICATION_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_CLASSIFICATION_IMPL_TYPE_CLASSIFICATION_H_
