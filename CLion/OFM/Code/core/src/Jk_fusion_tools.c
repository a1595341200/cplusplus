...
* FileName: Jk_fusion_tools.c
* Author:  ruifeng.ding
* Version: 1.00
* Date:  2021/08/11
* Description: Methods that are used all throughout fusion on different occasions
* Others:
* Function List:
    1.¡­¡­¡­¡­
    2.¡­¡­¡­¡­
...
/*********************************************************************
*
*  definition of fast approximative square root operator	\todo: Delete later on
*
*********************************************************************/
...
FUNC(uint32, ObjFusn_CODE) getNumberOfSetBits(uint32 i)
{
   ...
   i = (i & TWO_BITS_ONE_TWO_BITS_ZERO) + ((i >> BITSHIFT_BY_TWO) & TWO_BITS_ONE_TWO_BITS_ZERO);
   u32Result = (((i + (i >> BITSHIFT_BY_FOUR)) & FOUR_BITS_ONE_FOUR_BITS_ZERO) * ONE_BIT_ONE_SEVEN_BITS_ZERO) >> BITSHIFT_BY_TWENTYFOUR;
   return u32Result;
}
