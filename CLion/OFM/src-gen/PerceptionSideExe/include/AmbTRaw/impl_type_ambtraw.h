 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/AmbTRaw/impl_type_ambtraw.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
#define PERCEPTIONSIDEEXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_AMBTRAW_IMPL_TYPE_AMBTRAW_H_
