 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/VisObj/impl_type_visobj.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_VISOBJ_IMPL_TYPE_VISOBJ_H_
#define PERCEPTIONSIDEEXE_INCLUDE_VISOBJ_IMPL_TYPE_VISOBJ_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_VISOBJ_IMPL_TYPE_VISOBJ_H_
