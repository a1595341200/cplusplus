 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/PinionSteerAgGroup/impl_type_pinionsteeraggroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
#define PERCEPTIONSIDEEXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
