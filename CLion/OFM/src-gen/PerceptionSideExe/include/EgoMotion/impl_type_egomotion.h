 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/EgoMotion/impl_type_egomotion.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
#define PERCEPTIONSIDEEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
