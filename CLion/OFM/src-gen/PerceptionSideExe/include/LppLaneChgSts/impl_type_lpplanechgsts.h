 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/include/LppLaneChgSts/impl_type_lpplanechgsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONSIDEEXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
#define PERCEPTIONSIDEEXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
...
#endif  // PERCEPTIONSIDEEXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
