 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionSideExe/src/amsr/someip_binding/internal/life_cycle_manager.cpp
...
void LifeCycleManager::RegisterServiceInstances() noexcept {
  {
    ...
    {
      // Map R-Port /JICA/SWC/PerceptionSideExe/PerceptionSide/PerceptionInfoSIR to instance /JICA/Service/RequiredSomeipToSOCA_InfomationSI/RequiredSomeipToSOCA_InfomationSI 
      ::ara::core::InstanceSpecifier const instance_specifier{"PerceptionSideExe/PerceptionSide/PerceptionInfoSIR"_sv};
  ...
  }
  {
    ...
    {
      // Map P-Port /JICA/SWC/PerceptionSideExe/PerceptionSide/PerceptionSideSIP to instance /JICA/Service/ProvidedSomeipPerceptionSideSI_Out/ProvidedSomeipPerceptionSideSI_Out
      ::ara::core::InstanceSpecifier const instance_specifier{"PerceptionSideExe/PerceptionSide/PerceptionSideSIP"_sv};
      ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1096"_sv};
...
// VECTOR NC AutosarC++17_10-M9.3.3, VectorC++-V5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-M9.3.3_Method_can_be_declared_const
 void LifeCycleManager::InitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/PerceptionSideSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::perceptionsi_out::
      AraComSomeIpBindingInitializeSkeletonSomeIpEventBackendsPerceptionSideSI_Out(aracom_someip_binding_->GetServerManager());
}
...
void LifeCycleManager::DeInitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/PerceptionSideSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::perceptionsi_out::
      AraComSomeIpBindingDeInitializeSkeletonSomeIpEventBackendsPerceptionSideSI_Out();
}
...
void LifeCycleManager::InitializeProvidedServiceInstances() noexcept {
    // Register provided service for instance /JICA/Service/ProvidedSomeipPerceptionSideSI_Out/ProvidedSomeipPerceptionSideSI_Out
    {
      ::amsr::someip_binding::internal::ProvidedServiceInstanceId const PerceptionSideSI_Out_provided_service_instance_id{ static_cast<::amsr::someip_protocol::internal::ServiceId>(0x75),
                                                                                                                                                        1, 0, 0x448 };
      aracom_someip_binding_->GetServerManager().RegisterProvidedServiceInstance(PerceptionSideSI_Out_provided_service_instance_id);
    }
}
...
void LifeCycleManager::InitializeServiceDiscoverySkeletonXfs() noexcept {
  ...
  // Instantiate ServiceDiscoverySkeletonXfs for instance /JICA/Service/ProvidedSomeipPerceptionSideSI_Out/ProvidedSomeipPerceptionSideSI_Out
  {
    // Types.
    using SkeletonXfType =
        ::amsr::someip_binding_transformation_layer::internal::perceptionsi_out::PerceptionSideSI_OutSkeletonSomeIpBinding;
    ...
    // Variables.
    ::amsr::someip_binding::internal::ProvidedServiceInstanceId const provided_service_instance_id{static_cast<::amsr::someip_protocol::internal::ServiceId>(0x75),
         1, 0, 0x448 };
    ...
    ::amsr::generic::Singleton<::amsr::socal::internal::service_discovery::ServiceDiscovery<
        ::perceptionsi_out::skeleton::PerceptionSideSI_OutSkeleton>*>& service_discovery {
            ::perceptionsi_out::skeleton::PerceptionSideSI_OutSkeleton::GetServiceDiscovery()};
...
void LifeCycleManager::CleanInstanceSpecifierToInstanceIdMapping() noexcept {
  {
    // Remove mapping R-Port /JICA/SWC/PerceptionSideExe/PerceptionSide/PerceptionInfoSIR to instance /JICA/Service/RequiredSomeipToSOCA_InfomationSI/RequiredSomeipToSOCA_InfomationSI 
    ::ara::core::InstanceSpecifier const instance_specifier{"PerceptionSideExe/PerceptionSide/PerceptionInfoSIR"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1132"_sv};
  ...
  {
    // Remove mapping P-Port /JICA/SWC/PerceptionSideExe/PerceptionSide/PerceptionSideSIP to instance /JICA/Service/ProvidedSomeipPerceptionSideSI_Out/ProvidedSomeipPerceptionSideSI_Out
    ::ara::core::InstanceSpecifier const instance_specifier{"PerceptionSideExe/PerceptionSide/PerceptionSideSIP"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1096"_sv};
