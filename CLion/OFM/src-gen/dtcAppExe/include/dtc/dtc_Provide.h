 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  dtcAppExe/include/dtc/dtc_Provide.h
 *        \brief  Header for service 'dtc_Provide'.
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef DTCAPPEXE_INCLUDE_DTC_DTC_PROVIDE_H_
#define DTCAPPEXE_INCLUDE_DTC_DTC_PROVIDE_H_
...
/*!
 * \brief Representation of service 'dtc_Provide'
...
*/
 using CStringView = vac::container::CStringView;
   ...
   */
  static constexpr CStringView kServiceIdentifier{"dtc_Provide"_sv};
 ...
 public:
   ...
   */
  static constexpr CStringView kServiceShortNamePath{"/JICA/Service/Interface/dtc_Provide"_sv};
};

}  // namespace dtc

#endif  // DTCAPPEXE_INCLUDE_DTC_DTC_PROVIDE_H_
