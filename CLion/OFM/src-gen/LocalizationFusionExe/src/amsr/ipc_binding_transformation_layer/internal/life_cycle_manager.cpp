 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/src/amsr/ipc_binding_transformation_layer/internal/life_cycle_manager.cpp
...
void LifeCycleManager<BindingCoreType>::InitializeServiceDiscoveryProxyXfs(
  ...
  {
    using SdProxyXfType = ::amsr::ipc_binding_transformation_layer::internal::ServiceDiscoveryProxyXf<
        ::amsr::ipc_binding_transformation_layer::internal::perceptionsi_laneout::PerceptionSI_LaneOutProxyXf,
        ::amsr::socal::internal::service_discovery::ProxyServiceDiscovery<
            ::perceptionsi_laneout::internal::PerceptionSI_LaneOutProxyBackendInterface>,
        BindingCoreType>;

    sd_proxy_xfs_.emplace_back(std::make_unique<SdProxyXfType>(
        ::amsr::ipc_binding_core::internal::ipc_protocol::ServiceDiscoveryServiceInstanceIdentifier{98, 1085U, 1, 0},
        timer_manager, binding_core,
        ::perceptionsi_laneout::proxy::PerceptionSI_LaneOutProxy::GetServiceDiscovery(),
        runtime_processing_mode));
  }
