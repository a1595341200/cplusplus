 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsi_laneout/events/deserializer_Cam_Bus_LaneEvent.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/LaneEvent/deserializer_LaneEvent.h"
...
deserialization::Result DeserializerCam_Bus_LaneEvent::Deserialize(deserialization::Reader &reader, ::LaneEvent::LaneEvent &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionSI_LaneOut/Cam_Bus_LaneEvent
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::LaneEvent::LaneEvent>{})};
