 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/EgoMotion/impl_type_egomotion.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
