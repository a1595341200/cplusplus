 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/LaneMkrCam1SecClsRi/impl_type_lanemkrcam1secclsri.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_LANEMKRCAM1SECCLSRI_IMPL_TYPE_LANEMKRCAM1SECCLSRI_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_LANEMKRCAM1SECCLSRI_IMPL_TYPE_LANEMKRCAM1SECCLSRI_H_
...
/*!
 * \brief Type LaneMkrCam1SecClsRi.
 * \remark generated
 * \trace SPEC-5951372
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/LaneMkrCam1SecClsRi
 */
struct LaneMkrCam1SecClsRi {
...
/*!
 * \brief Compare for equality with another LaneMkrCam1SecClsRi instance.
 */
inline bool operator==(LaneMkrCam1SecClsRi const& l,
                       LaneMkrCam1SecClsRi const& r) noexcept {
...
/*!
 * \brief Compare for inequality with another LaneMkrCam1SecClsRi instance.
 */
inline bool operator!=(LaneMkrCam1SecClsRi const& l,
                       LaneMkrCam1SecClsRi const& r) noexcept {
  return !(l == r);
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_LANEMKRCAM1SECCLSRI_IMPL_TYPE_LANEMKRCAM1SECCLSRI_H_
