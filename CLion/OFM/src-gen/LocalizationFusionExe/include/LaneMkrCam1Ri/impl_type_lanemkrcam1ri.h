 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  LocalizationFusionExe/include/LaneMkrCam1Ri/impl_type_lanemkrcam1ri.h
 *        \brief
 *
 *      \details
 *
...
#ifndef LOCALIZATIONFUSIONEXE_INCLUDE_LANEMKRCAM1RI_IMPL_TYPE_LANEMKRCAM1RI_H_
#define LOCALIZATIONFUSIONEXE_INCLUDE_LANEMKRCAM1RI_IMPL_TYPE_LANEMKRCAM1RI_H_
...
/*!
 * \brief Type LaneMkrCam1Ri.
 * \remark generated
 * \trace SPEC-5951372
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/LaneMkrCam1Ri
 */
struct LaneMkrCam1Ri {
...
/*!
 * \brief Compare for equality with another LaneMkrCam1Ri instance.
 */
inline bool operator==(LaneMkrCam1Ri const& l,
                       LaneMkrCam1Ri const& r) noexcept {
...
/*!
 * \brief Compare for inequality with another LaneMkrCam1Ri instance.
 */
inline bool operator!=(LaneMkrCam1Ri const& l,
                       LaneMkrCam1Ri const& r) noexcept {
  return !(l == r);
...
#endif  // LOCALIZATIONFUSIONEXE_INCLUDE_LANEMKRCAM1RI_IMPL_TYPE_LANEMKRCAM1RI_H_
