 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/MainType/impl_type_maintype.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_MAINTYPE_IMPL_TYPE_MAINTYPE_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_MAINTYPE_IMPL_TYPE_MAINTYPE_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_MAINTYPE_IMPL_TYPE_MAINTYPE_H_
