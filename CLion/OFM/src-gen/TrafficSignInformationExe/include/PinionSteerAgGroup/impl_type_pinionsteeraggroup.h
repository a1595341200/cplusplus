 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/PinionSteerAgGroup/impl_type_pinionsteeraggroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
