...
class LifecycleManager final {
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton::RegisterServiceDiscovery(&trafficsigninformationsi_out_skeleton_sd_);
  }
   ...
   *        used for the service interface TrafficSignInformationSI_Out.
   */
  using TrafficSignInformationSI_OutSkeletonSdType = trafficsigninformationsi_out::skeleton::TrafficSignInformationSI_OutSkeleton::ServiceDiscovery;

  /*!
   * \brief Service discovery instance used on skeleton side for the service interface TrafficSignInformationSI_Out.
   */
  TrafficSignInformationSI_OutSkeletonSdType trafficsigninformationsi_out_skeleton_sd_;
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr
