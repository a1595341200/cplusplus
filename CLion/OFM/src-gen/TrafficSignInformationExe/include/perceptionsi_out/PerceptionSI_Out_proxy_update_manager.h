 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/perceptionsi_out/PerceptionSI_Out_proxy_update_manager.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_PROXY_UPDATE_MANAGER_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_PROXY_UPDATE_MANAGER_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_OUT_PERCEPTIONSI_OUT_PROXY_UPDATE_MANAGER_H_
