 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/perceptionsi_camstsout/PerceptionSI_CamStsOut_types.h
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_TYPES_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_TYPES_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_TYPES_H_
