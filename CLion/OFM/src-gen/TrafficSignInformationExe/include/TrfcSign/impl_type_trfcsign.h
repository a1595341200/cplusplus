 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/include/TrfcSign/impl_type_trfcsign.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCSIGN_IMPL_TYPE_TRFCSIGN_H_
#define TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCSIGN_IMPL_TYPE_TRFCSIGN_H_
...
#endif  // TRAFFICSIGNINFORMATIONEXE_INCLUDE_TRFCSIGN_IMPL_TYPE_TRFCSIGN_H_
