 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsi_out/events/deserializer_FrntCam_Bus_LsrObj.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/LsrObj/deserializer_LsrObj.h"
...
deserialization::Result DeserializerFrntCam_Bus_LsrObj::Deserialize(deserialization::Reader &reader, ::LsrObj::LsrObj &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionSI_Out/FrntCam_Bus_LsrObj
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::LsrObj::LsrObj>{})};
