 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficSignInformationExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsi_out/events/deserializer_FrntCam_Bus_TrfcSign.cpp
...
#include "amsr/someip_protocol/internal/datatype_deserialization/TrfcSign/deserializer_TrfcSign.h"
...
deserialization::Result DeserializerFrntCam_Bus_TrfcSign::Deserialize(deserialization::Reader &reader, ::TrfcSigns::TrfcSigns &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionSI_Out/FrntCam_Bus_TrfcSign
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::TrfcSigns::TrfcSigns>{})};
