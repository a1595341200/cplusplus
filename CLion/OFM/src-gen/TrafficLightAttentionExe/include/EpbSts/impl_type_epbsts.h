 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/EpbSts/impl_type_epbsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
