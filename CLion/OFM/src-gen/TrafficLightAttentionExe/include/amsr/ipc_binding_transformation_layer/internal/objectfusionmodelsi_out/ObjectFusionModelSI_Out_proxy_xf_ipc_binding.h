 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/amsr/ipc_binding_transformation_layer/internal/objectfusionmodelsi_out/ObjectFusionModelSI_Out_proxy_xf_ipc_binding.h
 *        \brief  Frame for IPC binding service instance class of service 'ObjectFusionModelSI_Out'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_OBJECTFUSIONMODELSI_OUT_OBJECTFUSIONMODELSI_OUT_PROXY_XF_IPC_BINDING_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_OBJECTFUSIONMODELSI_OUT_OBJECTFUSIONMODELSI_OUT_PROXY_XF_IPC_BINDING_H_
...
#include <map>
#include <utility>
#include "amsr/ipc_binding_transformation_layer/internal/objectfusionmodelsi_out/ObjectFusionModelSI_Out_proxy_xf_ipc_events.h"
...
/*!
 * \brief Parameterization of the IPC deployment information for service interface 'ObjectFusionModelSI_OutProxy'.
 */
using ObjectFusionModelSI_OutRequiredIpcDeployment =
    ::amsr::ipc_binding_transformation_layer::internal::IpcServiceInterfaceDeploymentElement<// Abstract service interface reference
                                         ::objectfusionmodelsi_out::proxy::ObjectFusionModelSI_OutProxy,
                                         // Service ID
...
/*!
 * \brief Required service interface deployment of service interface 'ObjectFusionModelSI_Out'.
 */
class ObjectFusionModelSI_OutProxyXf final
    : public ::objectfusionmodelsi_out::internal::ObjectFusionModelSI_OutProxyBackendInterface,
      public ::amsr::ipc_binding_core::internal::LocalClientSink,
      public std::enable_shared_from_this< ObjectFusionModelSI_OutProxyXf> {
 public:

  /*!
   * \brief         Constructor of ProxyXf for service 'ObjectFusionModelSI_Out'.
   ...
   * \context       Init
   */
   ObjectFusionModelSI_OutProxyXf(
      ...
      , event_backend_OFM_Bus_FusedTargets_11_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4789}, timer_manager, runtime_processing_mode}
      , event_backend_OFM_St_SOCFusedSts_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4377}, timer_manager, runtime_processing_mode}
      , event_backend_OFM_Bus_FourDRadarECUSts_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4378}, timer_manager, runtime_processing_mode}
      , event_backend_OFM_Bus_FrontFourDRadarSts_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4379}, timer_manager, runtime_processing_mode}
      , event_backend_OFM_Bus_FusedTargets_22_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4790}, timer_manager, runtime_processing_mode}
      , event_backend_OFM_Bus_FusedTargets_32_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4791}, timer_manager, runtime_processing_mode}
      , event_backend_OFM_St_FrntRdrObjE2Efail_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4838}, timer_manager, runtime_processing_mode}
      , event_backend_OFM_St_FrntRdrObjTO_{
            *this, kDeployment.service_id_, kDeployment.service_interface_version_.major_version_,
            ::amsr::ipc_binding_core::internal::ipc_protocol::EventId{4839}, timer_manager, runtime_processing_mode}
 {
  ...
  */
  ...
  /*!
   * \brief       Getter function for the event 'OFM_Bus_FusedTargets_11'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets_11& GetEventBackendOFM_Bus_FusedTargets_11() noexcept final {
    return event_backend_OFM_Bus_FusedTargets_11_;
  }

  /*!
   * \brief       Getter function for the event 'OFM_St_SOCFusedSts'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_St_SOCFusedSts& GetEventBackendOFM_St_SOCFusedSts() noexcept final {
    return event_backend_OFM_St_SOCFusedSts_;
  }

  /*!
   * \brief       Getter function for the event 'OFM_Bus_FourDRadarECUSts'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FourDRadarECUSts& GetEventBackendOFM_Bus_FourDRadarECUSts() noexcept final {
    return event_backend_OFM_Bus_FourDRadarECUSts_;
  }

  /*!
   * \brief       Getter function for the event 'OFM_Bus_FrontFourDRadarSts'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FrontFourDRadarSts& GetEventBackendOFM_Bus_FrontFourDRadarSts() noexcept final {
    return event_backend_OFM_Bus_FrontFourDRadarSts_;
  }

  /*!
   * \brief       Getter function for the event 'OFM_Bus_FusedTargets_22'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets_22& GetEventBackendOFM_Bus_FusedTargets_22() noexcept final {
    return event_backend_OFM_Bus_FusedTargets_22_;
  }

  /*!
   * \brief       Getter function for the event 'OFM_Bus_FusedTargets_32'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets_32& GetEventBackendOFM_Bus_FusedTargets_32() noexcept final {
    return event_backend_OFM_Bus_FusedTargets_32_;
  }

  /*!
   * \brief       Getter function for the event 'OFM_St_FrntRdrObjE2Efail'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_St_FrntRdrObjE2Efail& GetEventBackendOFM_St_FrntRdrObjE2Efail() noexcept final {
    return event_backend_OFM_St_FrntRdrObjE2Efail_;
  }

  /*!
   * \brief       Getter function for the event 'OFM_St_FrntRdrObjTO'.
   * \return      A reference to a valid event backend.
   *
   * \pre         -
   * \context     App
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_St_FrntRdrObjTO& GetEventBackendOFM_St_FrntRdrObjTO() noexcept final {
    return event_backend_OFM_St_FrntRdrObjTO_;
  }
 ...
 private:
   ...
   */
  static constexpr IpcServiceInterfaceDeployment kDeployment{ObjectFusionModelSI_OutRequiredIpcDeployment::kDeployment};
  ...
  /*!
   * \brief Event backend for proxy event 'OFM_Bus_FusedTargets_11'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets_11 event_backend_OFM_Bus_FusedTargets_11_;

  /*!
   * \brief Event backend for proxy event 'OFM_St_SOCFusedSts'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_St_SOCFusedSts event_backend_OFM_St_SOCFusedSts_;

  /*!
   * \brief Event backend for proxy event 'OFM_Bus_FourDRadarECUSts'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FourDRadarECUSts event_backend_OFM_Bus_FourDRadarECUSts_;

  /*!
   * \brief Event backend for proxy event 'OFM_Bus_FrontFourDRadarSts'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FrontFourDRadarSts event_backend_OFM_Bus_FrontFourDRadarSts_;

  /*!
   * \brief Event backend for proxy event 'OFM_Bus_FusedTargets_22'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets_22 event_backend_OFM_Bus_FusedTargets_22_;

  /*!
   * \brief Event backend for proxy event 'OFM_Bus_FusedTargets_32'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_Bus_FusedTargets_32 event_backend_OFM_Bus_FusedTargets_32_;

  /*!
   * \brief Event backend for proxy event 'OFM_St_FrntRdrObjE2Efail'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_St_FrntRdrObjE2Efail event_backend_OFM_St_FrntRdrObjE2Efail_;

  /*!
   * \brief Event backend for proxy event 'OFM_St_FrntRdrObjTO'.
   */
  ObjectFusionModelSI_OutProxyXfEventBackendOFM_St_FrntRdrObjTO event_backend_OFM_St_FrntRdrObjTO_;
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_AMSR_IPC_BINDING_TRANSFORMATION_LAYER_INTERNAL_OBJECTFUSIONMODELSI_OUT_OBJECTFUSIONMODELSI_OUT_PROXY_XF_IPC_BINDING_H_
