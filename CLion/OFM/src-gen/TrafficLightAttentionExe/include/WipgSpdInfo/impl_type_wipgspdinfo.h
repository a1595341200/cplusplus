 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/WipgSpdInfo/impl_type_wipgspdinfo.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
