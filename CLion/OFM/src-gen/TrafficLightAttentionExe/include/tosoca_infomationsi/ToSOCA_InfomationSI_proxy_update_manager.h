 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_proxy_update_manager.h
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
