 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_proxy_backend_interface.h
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_BACKEND_INTERFACE_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_BACKEND_INTERFACE_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_BACKEND_INTERFACE_H_
