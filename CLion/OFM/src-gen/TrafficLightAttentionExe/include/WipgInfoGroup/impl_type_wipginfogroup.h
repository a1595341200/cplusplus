 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/include/WipgInfoGroup/impl_type_wipginfogroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef TRAFFICLIGHTATTENTIONEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
#define TRAFFICLIGHTATTENTIONEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
...
#endif  // TRAFFICLIGHTATTENTIONEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
