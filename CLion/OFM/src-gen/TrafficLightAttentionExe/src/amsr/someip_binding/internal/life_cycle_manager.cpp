 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/src/amsr/someip_binding/internal/life_cycle_manager.cpp
...
void LifeCycleManager::RegisterServiceInstances() noexcept {
  {
    ...
    {
      // Map R-Port /JICA/SWC/TrafficLightAttentionExe/TrafficLightAttention/TrafficLightAttentionInfoSIR to instance /JICA/Service/RequiredSomeipToSOCA_InfomationSI/RequiredSomeipToSOCA_InfomationSI 
      ::ara::core::InstanceSpecifier const instance_specifier{"TrafficLightAttentionExe/TrafficLightAttention/TrafficLightAttentionInfoSIR"_sv};
  ...
  }
  {
    ...
    {
      // Map P-Port /JICA/SWC/TrafficLightAttentionExe/TrafficLightAttention/TrafficLightAttentionSIP to instance /JICA/Service/ProvidedSomeipTrafficLightAttentionSI_Out/ProvidedSomeipTrafficLightAttentionSI_Out
      ::ara::core::InstanceSpecifier const instance_specifier{"TrafficLightAttentionExe/TrafficLightAttention/TrafficLightAttentionSIP"_sv};
      ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1049"_sv};
...
// VECTOR NC AutosarC++17_10-M9.3.3, VectorC++-V5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-M9.3.3_Method_can_be_declared_const
 void LifeCycleManager::InitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/TrafficLightAttentionSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::trafficlightattentionsi_out::
      AraComSomeIpBindingInitializeSkeletonSomeIpEventBackendsTrafficLightAttentionSI_Out(aracom_someip_binding_->GetServerManager());
}
...
void LifeCycleManager::DeInitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/TrafficLightAttentionSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::trafficlightattentionsi_out::
      AraComSomeIpBindingDeInitializeSkeletonSomeIpEventBackendsTrafficLightAttentionSI_Out();
}
...
void LifeCycleManager::InitializeProvidedServiceInstances() noexcept {
    // Register provided service for instance /JICA/Service/ProvidedSomeipTrafficLightAttentionSI_Out/ProvidedSomeipTrafficLightAttentionSI_Out
    {
      ::amsr::someip_binding::internal::ProvidedServiceInstanceId const TrafficLightAttentionSI_Out_provided_service_instance_id{ static_cast<::amsr::someip_protocol::internal::ServiceId>(0x28),
                                                                                                                                                        1, 0, 0x419 };
      aracom_someip_binding_->GetServerManager().RegisterProvidedServiceInstance(TrafficLightAttentionSI_Out_provided_service_instance_id);
    }
}
...
void LifeCycleManager::InitializeServiceDiscoverySkeletonXfs() noexcept {
  ...
  // Instantiate ServiceDiscoverySkeletonXfs for instance /JICA/Service/ProvidedSomeipTrafficLightAttentionSI_Out/ProvidedSomeipTrafficLightAttentionSI_Out
  {
    // Types.
    using SkeletonXfType =
        ::amsr::someip_binding_transformation_layer::internal::trafficlightattentionsi_out::TrafficLightAttentionSI_OutSkeletonSomeIpBinding;
    ...
    // Variables.
    ::amsr::someip_binding::internal::ProvidedServiceInstanceId const provided_service_instance_id{static_cast<::amsr::someip_protocol::internal::ServiceId>(0x28),
         1, 0, 0x419 };
    ...
    ::amsr::generic::Singleton<::amsr::socal::internal::service_discovery::ServiceDiscovery<
        ::trafficlightattentionsi_out::skeleton::TrafficLightAttentionSI_OutSkeleton>*>& service_discovery {
            ::trafficlightattentionsi_out::skeleton::TrafficLightAttentionSI_OutSkeleton::GetServiceDiscovery()};
...
void LifeCycleManager::CleanInstanceSpecifierToInstanceIdMapping() noexcept {
  {
    // Remove mapping R-Port /JICA/SWC/TrafficLightAttentionExe/TrafficLightAttention/TrafficLightAttentionInfoSIR to instance /JICA/Service/RequiredSomeipToSOCA_InfomationSI/RequiredSomeipToSOCA_InfomationSI 
    ::ara::core::InstanceSpecifier const instance_specifier{"TrafficLightAttentionExe/TrafficLightAttention/TrafficLightAttentionInfoSIR"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1132"_sv};
  ...
  {
    // Remove mapping P-Port /JICA/SWC/TrafficLightAttentionExe/TrafficLightAttention/TrafficLightAttentionSIP to instance /JICA/Service/ProvidedSomeipTrafficLightAttentionSI_Out/ProvidedSomeipTrafficLightAttentionSI_Out
    ::ara::core::InstanceSpecifier const instance_specifier{"TrafficLightAttentionExe/TrafficLightAttention/TrafficLightAttentionSIP"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1049"_sv};
