 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  TrafficLightAttentionExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/objectfusionmodelsi_out/events/deserializer_OFM_Bus_FusedTargets_32.cpp
...
deserialization::Result DeserializerOFM_Bus_FusedTargets_32::Deserialize(deserialization::Reader &reader, ::ObjGroup2Vccs_10::ObjGroup2Vccs_10 &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/ObjectFusionModelSI_Out/OFM_Bus_FusedTargets_32
  ...
  constexpr std::size_t static_size{deserialization::SomeIpProtocolGetStaticSize<
      ...
      >(deserialization::SizeToken<::ObjGroup2Vccs_10::ObjGroup2Vccs_10>{})};
