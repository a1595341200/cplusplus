 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Soc2LidarExe/include/soc2lidarsid_out/Soc2LidarSI_Out.h
 *        \brief  Header for service 'Soc2LidarSI_Out'.
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef SOC2LIDAREXE_INCLUDE_SOC2LIDARSID_OUT_SOC2LIDARSI_OUT_H_
#define SOC2LIDAREXE_INCLUDE_SOC2LIDARSID_OUT_SOC2LIDARSI_OUT_H_
...
/*!
 * \brief Representation of service 'Soc2LidarSI_Out'
...
*/
 using CStringView = vac::container::CStringView;
   ...
   */
  static constexpr CStringView kServiceIdentifier{"Soc2LidarSI_Out"_sv};
 ...
 public:
   ...
   */
  static constexpr CStringView kServiceShortNamePath{"/JICA/Service/Interface/Soc2LidarSI_Out"_sv};
};

}  // namespace soc2lidarsid_out

#endif  // SOC2LIDAREXE_INCLUDE_SOC2LIDARSID_OUT_SOC2LIDARSI_OUT_H_
