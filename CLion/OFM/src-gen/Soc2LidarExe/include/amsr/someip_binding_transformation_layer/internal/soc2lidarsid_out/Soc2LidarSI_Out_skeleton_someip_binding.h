 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Soc2LidarExe/include/amsr/someip_binding_transformation_layer/internal/soc2lidarsid_out/Soc2LidarSI_Out_skeleton_someip_binding.h
 *        \brief  SOME/IP binding of service skeleton for service 'Soc2LidarSI_Out'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef SOC2LIDAREXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_SOC2LIDARSID_OUT_SOC2LIDARSI_OUT_SKELETON_SOMEIP_BINDING_H_
#define SOC2LIDAREXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_SOC2LIDARSID_OUT_SOC2LIDARSI_OUT_SKELETON_SOMEIP_BINDING_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/someip_binding_transformation_layer/internal/soc2lidarsid_out/Soc2LidarSI_Out_skeleton_someip_event_manager.h"
#include "amsr/someip_binding_transformation_layer/internal/soc2lidarsid_out/Soc2LidarSI_Out_skeleton_someip_methods.h"
 ...
 * \remark generated
 */
class Soc2LidarSI_OutSkeletonSomeIpBinding final :
    public ::soc2lidarsid_out::internal::Soc2LidarSI_OutSkeletonImplInterface,
    public ::amsr::someip_binding::internal::ServerInterface {
 public:
  /*!
   * \brief Type alias for used skeleton frontend.
   */
  using SkeletonFrontend = ::soc2lidarsid_out::skeleton::Soc2LidarSI_OutSkeleton;
  /*!
   * \brief Generated SOME/IP related service ID.
   */
  static constexpr ::amsr::someip_protocol::internal::ServiceId kServiceId{0x77U};
  ...
  /*!
   * \brief Constructor of Soc2LidarSI_OutSkeletonSomeIpBinding.
   ...
   * \synchronous TRUE
   */
  Soc2LidarSI_OutSkeletonSomeIpBinding(::amsr::someip_protocol::internal::InstanceId const instance_id,
  ...
  ~Soc2LidarSI_OutSkeletonSomeIpBinding() noexcept override  = default;
  ...
  /*!
   * \brief Get the event manager object for the SOME/IP binding service event 'Soc2L_Bus_VehicleInfo2Lidar'.
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  Soc2LidarSI_OutSkeletonSomeIpEventManagerSoc2L_Bus_VehicleInfo2Lidar* GetEventManagerSoc2L_Bus_VehicleInfo2Lidar() noexcept override;
 ...
 private:
  ...
  ::soc2lidarsid_out::skeleton::Soc2LidarSI_OutSkeleton& skeleton_;

  // ---- Methods ------------------------------------------------------------------------------------------

  // ---- Event manager --------------------------------------------------------------------------------------------

  // Event manager for skeleton event 'Soc2L_Bus_VehicleInfo2Lidar'
  Soc2LidarSI_OutSkeletonSomeIpEventManagerSoc2L_Bus_VehicleInfo2Lidar event_manager_Soc2L_Bus_VehicleInfo2Lidar_;
...
#endif  // SOC2LIDAREXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_SOC2LIDARSID_OUT_SOC2LIDARSI_OUT_SKELETON_SOMEIP_BINDING_H_
