 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  Soc2LidarExe/include/PinionSteerAgGroup/impl_type_pinionsteeraggroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef SOC2LIDAREXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
#define SOC2LIDAREXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
...
#endif  // SOC2LIDAREXE_INCLUDE_PINIONSTEERAGGROUP_IMPL_TYPE_PINIONSTEERAGGROUP_H_
