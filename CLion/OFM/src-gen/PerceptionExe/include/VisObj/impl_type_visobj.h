 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/VisObj/impl_type_visobj.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_VISOBJ_IMPL_TYPE_VISOBJ_H_
#define PERCEPTIONEXE_INCLUDE_VISOBJ_IMPL_TYPE_VISOBJ_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_VISOBJ_IMPL_TYPE_VISOBJ_H_
