...
struct SkeletonIpcEventConfigurationFrntCam_Bus_VisnObj {
   ...
   */
  static vac::container::CStringView constexpr kEventName{"FrntCam_Bus_VisnObj"_sv};

  /*!
   * \brief IPC service ID.
   */
  static ::amsr::ipc_binding_core::internal::ipc_protocol::ServiceId constexpr  kServiceId{94};
   ...
   * \brief IPC event ID.
   */
  static ::amsr::ipc_binding_core::internal::ipc_protocol::EventId constexpr  kEventId{4492};
   ...
   */
  using ProvidedIpcServiceInstance =  PerceptionSI_VisnObjOutProvidedIpcServiceInstance;
};
...
using PerceptionSI_VisnObjOutSkeletonIpcEventManagerFrntCam_Bus_VisnObj =
    ::amsr::ipc_binding_transformation_layer::internal::IpcSkeletonEventManager<SkeletonIpcEventConfigurationFrntCam_Bus_VisnObj>;
