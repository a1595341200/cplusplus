 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_binding_transformation_layer/internal/perceptionsi_visnobjout/PerceptionSI_VisnObjOut_skeleton_someip_binding.h
 *        \brief  SOME/IP binding of service skeleton for service 'PerceptionSI_VisnObjOut'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_SKELETON_SOMEIP_BINDING_H_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_SKELETON_SOMEIP_BINDING_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/someip_binding_transformation_layer/internal/perceptionsi_visnobjout/PerceptionSI_VisnObjOut_skeleton_someip_event_manager.h"
#include "amsr/someip_binding_transformation_layer/internal/perceptionsi_visnobjout/PerceptionSI_VisnObjOut_skeleton_someip_methods.h"
...
/*!
 * \brief SOME/IP skeleton binding of Service 'PerceptionSI_VisnObjOut'.
 * \details Handles serialization and deserialization of all method calls, events, etc.
 * \remark generated
 */
class PerceptionSI_VisnObjOutSkeletonSomeIpBinding final :
 ...
 public:
   ...
   */
  using SkeletonFrontend = ::perceptionsi_visnobjout::skeleton::PerceptionSI_VisnObjOutSkeleton;
  /*!
   * \brief Generated SOME/IP related service ID.
   */
  static constexpr ::amsr::someip_protocol::internal::ServiceId kServiceId{0x5DU};
  ...
  /*!
   * \brief Constructor of PerceptionSI_VisnObjOutSkeletonSomeIpBinding.
   ...
   * \synchronous TRUE
   */
  PerceptionSI_VisnObjOutSkeletonSomeIpBinding(::amsr::someip_protocol::internal::InstanceId const instance_id,
                                                         ::amsr::someip_binding::internal::ServerManagerInterface& someip_binding_server_manager,
                                                         ::perceptionsi_visnobjout::skeleton::PerceptionSI_VisnObjOutSkeleton& skeleton);
  ...
  ~PerceptionSI_VisnObjOutSkeletonSomeIpBinding() noexcept override  = default;
  ...
  /*!
   * \brief Get the event manager object for the SOME/IP binding service event 'FrntCam_Bus_VisnObj'.
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  PerceptionSI_VisnObjOutSkeletonSomeIpEventManagerFrntCam_Bus_VisnObj* GetEventManagerFrntCam_Bus_VisnObj() noexcept override;
 ...
 private:
  ...
  ::perceptionsi_visnobjout::skeleton::PerceptionSI_VisnObjOutSkeleton& skeleton_;

  // ---- Methods ------------------------------------------------------------------------------------------

  // ---- Event manager --------------------------------------------------------------------------------------------

  // Event manager for skeleton event 'FrntCam_Bus_VisnObj'
  PerceptionSI_VisnObjOutSkeletonSomeIpEventManagerFrntCam_Bus_VisnObj event_manager_FrntCam_Bus_VisnObj_;
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_VISNOBJOUT_PERCEPTIONSI_VISNOBJOUT_SKELETON_SOMEIP_BINDING_H_
