 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_binding_transformation_layer/internal/perceptionsi_camstsout/PerceptionSI_CamStsOut_skeleton_someip_binding.h
 *        \brief  SOME/IP binding of service skeleton for service 'PerceptionSI_CamStsOut'
 *
 *      \details
 *
 *********************************************************************************************************************/
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_SKELETON_SOMEIP_BINDING_H_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_SKELETON_SOMEIP_BINDING_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/someip_binding_transformation_layer/internal/perceptionsi_camstsout/PerceptionSI_CamStsOut_skeleton_someip_event_manager.h"
#include "amsr/someip_binding_transformation_layer/internal/perceptionsi_camstsout/PerceptionSI_CamStsOut_skeleton_someip_methods.h"
...
/*!
 * \brief SOME/IP skeleton binding of Service 'PerceptionSI_CamStsOut'.
 * \details Handles serialization and deserialization of all method calls, events, etc.
 * \remark generated
 */
class PerceptionSI_CamStsOutSkeletonSomeIpBinding final :
 ...
 public:
   ...
   */
  using SkeletonFrontend = ::perceptionsi_camstsout::skeleton::PerceptionSI_CamStsOutSkeleton;
  /*!
   * \brief Generated SOME/IP related service ID.
   */
  static constexpr ::amsr::someip_protocol::internal::ServiceId kServiceId{0x63U};
  ...
  /*!
   * \brief Constructor of PerceptionSI_CamStsOutSkeletonSomeIpBinding.
   ...
   * \synchronous TRUE
   */
  PerceptionSI_CamStsOutSkeletonSomeIpBinding(::amsr::someip_protocol::internal::InstanceId const instance_id,
                                                         ::amsr::someip_binding::internal::ServerManagerInterface& someip_binding_server_manager,
                                                         ::perceptionsi_camstsout::skeleton::PerceptionSI_CamStsOutSkeleton& skeleton);
  ...
  ~PerceptionSI_CamStsOutSkeletonSomeIpBinding() noexcept override  = default;
  ...
  /*!
   * \brief Get the event manager object for the SOME/IP binding service event 'FrntCam_Bus_CamSts'.
   ...
   */
  // VECTOR NC AutosarC++17_10-A10.3.3: MD_SOMEIPBINDING_AutosarC++17_10-A10.3.3_no_virtual_functions_in_final_class
  PerceptionSI_CamStsOutSkeletonSomeIpEventManagerFrntCam_Bus_CamSts* GetEventManagerFrntCam_Bus_CamSts() noexcept override;
 ...
 private:
  ...
  ::perceptionsi_camstsout::skeleton::PerceptionSI_CamStsOutSkeleton& skeleton_;

  // ---- Methods ------------------------------------------------------------------------------------------

  // ---- Event manager --------------------------------------------------------------------------------------------

  // Event manager for skeleton event 'FrntCam_Bus_CamSts'
  PerceptionSI_CamStsOutSkeletonSomeIpEventManagerFrntCam_Bus_CamSts event_manager_FrntCam_Bus_CamSts_;
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_SKELETON_SOMEIP_BINDING_H_
