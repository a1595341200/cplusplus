 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_protocol/internal/datatype_serialization/RoadEdge1VccLe/serializer_RoadEdge1VccLe.h
 *        \brief  SOME/IP protocol serializer implementation for datatype 'RoadEdge1VccLe'
 *
 *      \details  /CppImplementationDataTypes/RoadEdge1VccLe
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_ROADEDGE1VCCLE_SERIALIZER_ROADEDGE1VCCLE_H_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_ROADEDGE1VCCLE_SERIALIZER_ROADEDGE1VCCLE_H_
...
/*!
 * \brief Serializer for datatype /CppImplementationDataTypes/RoadEdge1VccLe.
 ...
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/RoadEdge1VccLe to be serialized.
...
void SomeIpProtocolSerialize(amsr::someip_protocol::internal::serialization::Writer& writer, ::RoadEdge1VccLe::RoadEdge1VccLe const &data) noexcept {
...
/*!
 * \brief Calculates the required buffer size for datatype /CppImplementationDataTypes/RoadEdge1VccLe.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/RoadEdge1VccLe.
 ...
 */
template <typename TpPack>
constexpr std::size_t GetRequiredBufferSize(::RoadEdge1VccLe::RoadEdge1VccLe const &data) noexcept {
  // Namespace alias for static serialization code
  namespace serialization = amsr::someip_protocol::internal::serialization;
...
/*!
 * \brief Checks if datatype /CppImplementationDataTypes/RoadEdge1VccLe is of static size.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr bool IsStaticSize(amsr::someip_protocol::internal::serialization::SizeToken<::RoadEdge1VccLe::RoadEdge1VccLe>) noexcept {
  // Namespace alias for static serialization code
  namespace serialization = amsr::someip_protocol::internal::serialization;
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_ROADEDGE1VCCLE_SERIALIZER_ROADEDGE1VCCLE_H_
