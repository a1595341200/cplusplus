 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_protocol/internal/datatype_serialization/LaneMkrCam1Le/serializer_LaneMkrCam1Le.h
 *        \brief  SOME/IP protocol serializer implementation for datatype 'LaneMkrCam1Le'
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1LE_SERIALIZER_LANEMKRCAM1LE_H_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1LE_SERIALIZER_LANEMKRCAM1LE_H_
...
/*!
 * \brief Serializer for datatype /CppImplementationDataTypes/LaneMkrCam1Le.
 ...
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1Le to be serialized.
...
void SomeIpProtocolSerialize(amsr::someip_protocol::internal::serialization::Writer& writer, ::LaneMkrCam1Le::LaneMkrCam1Le const &data) noexcept {
...
/*!
 * \brief Calculates the required buffer size for datatype /CppImplementationDataTypes/LaneMkrCam1Le.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1Le.
 ...
 */
template <typename TpPack>
constexpr std::size_t GetRequiredBufferSize(::LaneMkrCam1Le::LaneMkrCam1Le const &data) noexcept {
  // Namespace alias for static serialization code
  namespace serialization = amsr::someip_protocol::internal::serialization;
...
/*!
 * \brief Checks if datatype /CppImplementationDataTypes/LaneMkrCam1Le is of static size.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr bool IsStaticSize(amsr::someip_protocol::internal::serialization::SizeToken<::LaneMkrCam1Le::LaneMkrCam1Le>) noexcept {
  // Namespace alias for static serialization code
  namespace serialization = amsr::someip_protocol::internal::serialization;
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1LE_SERIALIZER_LANEMKRCAM1LE_H_
