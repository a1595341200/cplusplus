 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_protocol/internal/datatype_serialization/LaneMkrCam1SecClsRi/serializer_LaneMkrCam1SecClsRi.h
 *        \brief  SOME/IP protocol serializer implementation for datatype 'LaneMkrCam1SecClsRi'
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1SECCLSRI_SERIALIZER_LANEMKRCAM1SECCLSRI_H_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1SECCLSRI_SERIALIZER_LANEMKRCAM1SECCLSRI_H_
...
/*!
 * \brief Serializer for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsRi.
 ...
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1SecClsRi to be serialized.
...
void SomeIpProtocolSerialize(amsr::someip_protocol::internal::serialization::Writer& writer, ::LaneMkrCam1SecClsRi::LaneMkrCam1SecClsRi const &data) noexcept {
...
/*!
 * \brief Calculates the required buffer size for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsRi.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1SecClsRi.
 ...
 */
template <typename TpPack>
constexpr std::size_t GetRequiredBufferSize(::LaneMkrCam1SecClsRi::LaneMkrCam1SecClsRi const &data) noexcept {
  // Namespace alias for static serialization code
  namespace serialization = amsr::someip_protocol::internal::serialization;
...
/*!
 * \brief Checks if datatype /CppImplementationDataTypes/LaneMkrCam1SecClsRi is of static size.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr bool IsStaticSize(amsr::someip_protocol::internal::serialization::SizeToken<::LaneMkrCam1SecClsRi::LaneMkrCam1SecClsRi>) noexcept {
  // Namespace alias for static serialization code
  namespace serialization = amsr::someip_protocol::internal::serialization;
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1SECCLSRI_SERIALIZER_LANEMKRCAM1SECCLSRI_H_
