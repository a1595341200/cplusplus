 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_protocol/internal/datatype_serialization/LaneMkrCam1SecClsLe/serializer_LaneMkrCam1SecClsLe.h
 *        \brief  SOME/IP protocol serializer implementation for datatype 'LaneMkrCam1SecClsLe'
 *
 *      \details  /CppImplementationDataTypes/LaneMkrCam1SecClsLe
 *
 *********************************************************************************************************************/
/**********************************************************************************************************************
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1SECCLSLE_SERIALIZER_LANEMKRCAM1SECCLSLE_H_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1SECCLSLE_SERIALIZER_LANEMKRCAM1SECCLSLE_H_
...
namespace LaneMkrCam1SecClsLe {

/*!
 * \brief Serializer for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsLe.
 ...
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1SecClsLe to be serialized.
...
void SomeIpProtocolSerialize(amsr::someip_protocol::internal::serialization::Writer& writer, ::LaneMkrCam1SecClsLe::LaneMkrCam1SecClsLe const &data) noexcept {
...
/*!
 * \brief Calculates the required buffer size for datatype /CppImplementationDataTypes/LaneMkrCam1SecClsLe.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrCam1SecClsLe.
 ...
 */
template <typename TpPack>
constexpr std::size_t GetRequiredBufferSize(::LaneMkrCam1SecClsLe::LaneMkrCam1SecClsLe const &data) noexcept {
  // Namespace alias for static serialization code
  namespace serialization = amsr::someip_protocol::internal::serialization;
...
/*!
 * \brief Checks if datatype /CppImplementationDataTypes/LaneMkrCam1SecClsLe is of static size.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr bool IsStaticSize(amsr::someip_protocol::internal::serialization::SizeToken<::LaneMkrCam1SecClsLe::LaneMkrCam1SecClsLe>) noexcept {
  // Namespace alias for static serialization code
  namespace serialization = amsr::someip_protocol::internal::serialization;
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRCAM1SECCLSLE_SERIALIZER_LANEMKRCAM1SECCLSLE_H_
