 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_protocol/internal/dataprototype_serialization/perceptionsi_staticobjout/events/serializer_FrntCam_Bus_StaticObj.h
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_STATICOBJOUT_EVENTS_serializer_FrntCam_Bus_StaticObj_h_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_STATICOBJOUT_EVENTS_serializer_FrntCam_Bus_StaticObj_h_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "StaticObjs/impl_type_staticobjs.h"
...
/*!
 * \brief Serializer for service event /JICA/Service/Interface/PerceptionSI_StaticObjOut/FrntCam_Bus_StaticObj
 *        of service interface /JICA/Service/Interface/PerceptionSI_StaticObjOut.
 * \details Top-Level data type: /CppImplementationDataTypes/StaticObjs
 ...
 */
class SerializerFrntCam_Bus_StaticObj {
 public:
  /*!
   * \brief Returns the required buffer size for the data prototype service event /JICA/Service/Interface/PerceptionSI_StaticObjOut/FrntCam_Bus_StaticObj.
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/StaticObjs.
   *
   ...
   * \synchronous TRUE
   */
  constexpr static std::size_t GetRequiredBufferSize(::StaticObjs::StaticObjs const &data) noexcept {
  ...
  /*!
   * \brief Serialize the data prototype service event /JICA/Service/Interface/PerceptionSI_StaticObjOut/FrntCam_Bus_StaticObj.
   *
   ...
   * \synchronous TRUE
   */
  static void Serialize(serialization::Writer &writer, ::StaticObjs::StaticObjs const &data);
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATAPROTOTYPE_SERIALIZATION_PERCEPTIONSI_STATICOBJOUT_EVENTS_serializer_FrntCam_Bus_StaticObj_h_
