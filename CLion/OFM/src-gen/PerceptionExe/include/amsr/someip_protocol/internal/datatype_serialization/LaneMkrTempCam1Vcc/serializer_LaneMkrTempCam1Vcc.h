 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/amsr/someip_protocol/internal/datatype_serialization/LaneMkrTempCam1Vcc/serializer_LaneMkrTempCam1Vcc.h
 *        \brief  SOME/IP protocol serializer implementation for datatype 'LaneMkrTempCam1Vcc'
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRTEMPCAM1VCC_SERIALIZER_LANEMKRTEMPCAM1VCC_H_
#define PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRTEMPCAM1VCC_SERIALIZER_LANEMKRTEMPCAM1VCC_H_
...
/*!
 * \brief Serializer for datatype /CppImplementationDataTypes/LaneMkrTempCam1Vcc.
 ...
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrTempCam1Vcc to be serialized.
...
void SomeIpProtocolSerialize(amsr::someip_protocol::internal::serialization::Writer& writer, ::LaneMkrTempCam1Vcc::LaneMkrTempCam1Vcc const &data) noexcept {
...
/*!
 * \brief Calculates the required buffer size for datatype /CppImplementationDataTypes/LaneMkrTempCam1Vcc.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 * \param[in] data Reference to the data object of type /CppImplementationDataTypes/LaneMkrTempCam1Vcc.
 ...
 */
template <typename TpPack>
constexpr std::size_t GetRequiredBufferSize(::LaneMkrTempCam1Vcc::LaneMkrTempCam1Vcc const &data) noexcept {
  // Namespace alias for static serialization code
  namespace serialization = amsr::someip_protocol::internal::serialization;
...
/*!
 * \brief Checks if datatype /CppImplementationDataTypes/LaneMkrTempCam1Vcc is of static size.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for serialization.
 ...
 */
template <typename TpPack>
constexpr bool IsStaticSize(amsr::someip_protocol::internal::serialization::SizeToken<::LaneMkrTempCam1Vcc::LaneMkrTempCam1Vcc>) noexcept {
  // Namespace alias for static serialization code
  namespace serialization = amsr::someip_protocol::internal::serialization;
...
#endif  // PERCEPTIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_SERIALIZATION_LANEMKRTEMPCAM1VCC_SERIALIZER_LANEMKRTEMPCAM1VCC_H_
