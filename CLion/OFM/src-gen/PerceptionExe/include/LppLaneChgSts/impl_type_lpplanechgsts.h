 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/LppLaneChgSts/impl_type_lpplanechgsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
#define PERCEPTIONEXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
