 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionExe/include/EpbSts/impl_type_epbsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
#define PERCEPTIONEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
...
#endif  // PERCEPTIONEXE_INCLUDE_EPBSTS_IMPL_TYPE_EPBSTS_H_
