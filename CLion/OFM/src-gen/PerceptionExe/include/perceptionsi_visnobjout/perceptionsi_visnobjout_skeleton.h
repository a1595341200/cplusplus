...
explicit PerceptionSI_VisnObjOutSkeleton(ConstructionToken&& token) noexcept;
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Skeleton<perceptionsi_visnobjout::PerceptionSI_VisnObjOut, perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonImplInterface>;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_visnobjout::PerceptionSI_VisnObjOut,perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonImplInterface>::DoFieldInitializationChecks()
   */
  void DoFieldInitializationChecks() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_visnobjout::PerceptionSI_VisnObjOut,perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonImplInterface>::SendInitialFieldNotifications()
   */
  void SendInitialFieldNotifications() noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_visnobjout::PerceptionSI_VisnObjOut,perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonImplInterface>::OfferServiceInternal()
   */
  void OfferServiceInternal(::ara::com::InstanceIdentifier const& instance_id) noexcept override;

  /*!
   * \copydoc amsr::socal::Skeleton<perceptionsi_visnobjout::PerceptionSI_VisnObjOut,perceptionsi_visnobjout::internal::PerceptionSI_VisnObjOutSkeletonImplInterface>::StopOfferServiceInternal()
   */
