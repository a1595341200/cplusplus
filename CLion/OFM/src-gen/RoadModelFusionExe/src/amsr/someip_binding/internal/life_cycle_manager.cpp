 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/src/amsr/someip_binding/internal/life_cycle_manager.cpp
...
void LifeCycleManager::RegisterServiceInstances() noexcept {
  ...
  }
  {
    ...
    {
      // Map P-Port /JICA/SWC/RoadModelFusionExe/RoadModelFusion/RoadModelFusionSIP to instance /JICA/Service/ProvidedSomeipRoadModelFusionSI_Out/ProvidedSomeipRoadModelFusionSI_Out
      ::ara::core::InstanceSpecifier const instance_specifier{"RoadModelFusionExe/RoadModelFusion/RoadModelFusionSIP"_sv};
      ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1053"_sv};
      ...
      runtime_->MapProvidedInstanceSpecifierToInstanceId(
            ...
            "/JICA/Service/Interface/RoadModelFusionSI_Out"_sv);
    }
  }
}
...
// VECTOR NC AutosarC++17_10-M9.3.3, VectorC++-V5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-M9.3.3_Method_can_be_declared_const
 void LifeCycleManager::InitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/RoadModelFusionSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::roadmodelfusionsi_out::
      AraComSomeIpBindingInitializeSkeletonSomeIpEventBackendsRoadModelFusionSI_Out(aracom_someip_binding_->GetServerManager());
}
...
void LifeCycleManager::DeInitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/RoadModelFusionSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::roadmodelfusionsi_out::
      AraComSomeIpBindingDeInitializeSkeletonSomeIpEventBackendsRoadModelFusionSI_Out();
}
...
void LifeCycleManager::InitializeProvidedServiceInstances() noexcept {
    // Register provided service for instance /JICA/Service/ProvidedSomeipRoadModelFusionSI_Out/ProvidedSomeipRoadModelFusionSI_Out
    {
      ::amsr::someip_binding::internal::ProvidedServiceInstanceId const RoadModelFusionSI_Out_provided_service_instance_id{ static_cast<::amsr::someip_protocol::internal::ServiceId>(0x30),
                                                                                                                                                        1, 0, 0x41D };
      aracom_someip_binding_->GetServerManager().RegisterProvidedServiceInstance(RoadModelFusionSI_Out_provided_service_instance_id);
    }
}
...
void LifeCycleManager::InitializeServiceDiscoverySkeletonXfs() noexcept {
  ...
  // Instantiate ServiceDiscoverySkeletonXfs for instance /JICA/Service/ProvidedSomeipRoadModelFusionSI_Out/ProvidedSomeipRoadModelFusionSI_Out
  {
    // Types.
    using SkeletonXfType =
        ::amsr::someip_binding_transformation_layer::internal::roadmodelfusionsi_out::RoadModelFusionSI_OutSkeletonSomeIpBinding;
    ...
    // Variables.
    ::amsr::someip_binding::internal::ProvidedServiceInstanceId const provided_service_instance_id{static_cast<::amsr::someip_protocol::internal::ServiceId>(0x30),
         1, 0, 0x41D };
    ...
    ::amsr::generic::Singleton<::amsr::socal::internal::service_discovery::ServiceDiscovery<
        ::roadmodelfusionsi_out::skeleton::RoadModelFusionSI_OutSkeleton>*>& service_discovery {
            ::roadmodelfusionsi_out::skeleton::RoadModelFusionSI_OutSkeleton::GetServiceDiscovery()};
...
void LifeCycleManager::CleanInstanceSpecifierToInstanceIdMapping() noexcept {
  {
    // Remove mapping P-Port /JICA/SWC/RoadModelFusionExe/RoadModelFusion/RoadModelFusionSIP to instance /JICA/Service/ProvidedSomeipRoadModelFusionSI_Out/ProvidedSomeipRoadModelFusionSI_Out
    ::ara::core::InstanceSpecifier const instance_specifier{"RoadModelFusionExe/RoadModelFusion/RoadModelFusionSIP"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1053"_sv};
