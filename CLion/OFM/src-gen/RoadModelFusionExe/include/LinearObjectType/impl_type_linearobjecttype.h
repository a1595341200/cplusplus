 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LinearObjectType/impl_type_linearobjecttype.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTTYPE_IMPL_TYPE_LINEAROBJECTTYPE_H_
#define ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTTYPE_IMPL_TYPE_LINEAROBJECTTYPE_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECTTYPE_IMPL_TYPE_LINEAROBJECTTYPE_H_
