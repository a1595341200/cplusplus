 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/TrafficSignShape/impl_type_trafficsignshape.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_TRAFFICSIGNSHAPE_IMPL_TYPE_TRAFFICSIGNSHAPE_H_
#define ROADMODELFUSIONEXE_INCLUDE_TRAFFICSIGNSHAPE_IMPL_TYPE_TRAFFICSIGNSHAPE_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_TRAFFICSIGNSHAPE_IMPL_TYPE_TRAFFICSIGNSHAPE_H_
