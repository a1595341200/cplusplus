 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/Geofence_judge_type/impl_type_geofence_judge_type.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_GEOFENCE_JUDGE_TYPE_IMPL_TYPE_GEOFENCE_JUDGE_TYPE_H_
#define ROADMODELFUSIONEXE_INCLUDE_GEOFENCE_JUDGE_TYPE_IMPL_TYPE_GEOFENCE_JUDGE_TYPE_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_GEOFENCE_JUDGE_TYPE_IMPL_TYPE_GEOFENCE_JUDGE_TYPE_H_
