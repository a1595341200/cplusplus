...
#include "ehrsi_out/EHRSI_Out_proxy_update_manager.h"
...
using EHR_Bus_NOAInfo =
    ::amsr::socal::events::ProxyEvent<::NOAInfo::NOAInfo>;
...
using EHR_Bus_LaneConnectivitys =
    ::amsr::socal::events::ProxyEvent<::LaneConnectivitys::LaneConnectivitys>;
...
using EHR_Bus_Nodes =
    ::amsr::socal::events::ProxyEvent<::Nodes::Nodes>;
...
using EHR_Bus_TrafficSigns =
    ::amsr::socal::events::ProxyEvent<::TrafficSigns::TrafficSigns>;
...
using EHR_Bus_GeoFences =
    ::amsr::socal::events::ProxyEvent<::GeoFences::GeoFences>;
...
using EHR_Bus_LinkCurvatures =
    ::amsr::socal::events::ProxyEvent<::LinkCurvatures::LinkCurvatures>;
...
using EHR_Bus_LinkSlopes =
    ::amsr::socal::events::ProxyEvent<::LinkSlopes::LinkSlopes>;
...
using EHR_Bus_LaneSpeedLimits =
    ::amsr::socal::events::ProxyEvent<::LaneSpeedLimits::LaneSpeedLimits>;
...
using EHR_Bus_LinkInfos =
    ::amsr::socal::events::ProxyEvent<::LinkInfos::LinkInfos>;

/*!
 * \brief Type alias for service event 'EHR_Bus_MergePoints', that is part of the proxy.
 *
 * \trace SPEC-4980345
 */

using EHR_Bus_MergePoints =
    ::amsr::socal::events::ProxyEvent<::AllMergePoints::AllMergePoints>;

/*!
 * \brief Type alias for service event 'EHR_Bus_GeofennceJudge', that is part of the proxy.
 *
 * \trace SPEC-4980345
 */

using EHR_Bus_GeofennceJudge =
    ::amsr::socal::events::ProxyEvent<::GeofennceJudge::GeofennceJudge>;
 ...
 * \trace SPEC-4980344
 */
class EHRSI_OutProxy : public ::amsr::socal::Proxy<ehrsi_out::EHRSI_Out, ehrsi_out::internal::EHRSI_OutProxyBackendInterface, ehrsi_out::internal::EHRSI_OutHandleType> {
 public:
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Proxy<ehrsi_out::EHRSI_Out, ProxyBackendInterface, ehrsi_out::internal::EHRSI_OutHandleType>;
   ...
   */
  ehrsi_out::internal::EHRSI_OutProxyUpdateManager proxy_update_manager_;
 ...
 public:
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief Event 'EHR_Bus_MergePoints' which can be used by application developer.
   * \details
  ...
  // VECTOR NC VectorC++-V11.0.2: MD_SOCAL_V11-0-2_public_member_in_generated_code
  /*!
   * \brief Event 'EHR_Bus_GeofennceJudge' which can be used by application developer.
   * \details
