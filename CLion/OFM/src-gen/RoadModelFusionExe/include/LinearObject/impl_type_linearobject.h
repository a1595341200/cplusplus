 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LinearObject/impl_type_linearobject.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECT_IMPL_TYPE_LINEAROBJECT_H_
#define ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECT_IMPL_TYPE_LINEAROBJECT_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LINEAROBJECT_IMPL_TYPE_LINEAROBJECT_H_
