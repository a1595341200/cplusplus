 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/LinkSlope/impl_type_linkslope.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_LINKSLOPE_IMPL_TYPE_LINKSLOPE_H_
#define ROADMODELFUSIONEXE_INCLUDE_LINKSLOPE_IMPL_TYPE_LINKSLOPE_H_
...
#include "LaneSlopes/impl_type_laneslopes.h"
...
/*!
 * \brief Type LinkSlope.
 * \remark generated
 * \trace SPEC-5951372
 *
 * IMPLEMENTATION-DATA-TYPE /CppImplementationDataTypes/LinkSlope
 */
struct LinkSlope {
  ...
  using _LaneSlopes_ref_type = LaneSlopes::LaneSlopes;
  ...
  _LaneSlopes_ref_type LaneSlopes_ref;
};
// VECTOR Enable AutosarC++17_10-A12.6.1
// VECTOR Enable AutosarC++17_10-M8.5.1

/*!
 * \brief Compare for equality with another LinkSlope instance.
 */
inline bool operator==(LinkSlope const& l,
                       LinkSlope const& r) noexcept {
  return (&l == &r) || ((l.InstanceId_ref == r.InstanceId_ref)
                         ...
                         && (l.LaneSlopes_ref == r.LaneSlopes_ref)
  );
}

/*!
 * \brief Compare for inequality with another LinkSlope instance.
 */
inline bool operator!=(LinkSlope const& l,
                       LinkSlope const& r) noexcept {
  return !(l == r);
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_LINKSLOPE_IMPL_TYPE_LINKSLOPE_H_
