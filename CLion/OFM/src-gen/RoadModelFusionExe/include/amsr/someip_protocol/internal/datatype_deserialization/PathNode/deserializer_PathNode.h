 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/amsr/someip_protocol/internal/datatype_deserialization/PathNode/deserializer_PathNode.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'PathNode'
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_PATHNODE_DESERIALIZER_PATHNODE_H_
#define ROADMODELFUSIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_PATHNODE_DESERIALIZER_PATHNODE_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/PathNode.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/PathNode
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::PathNode::PathNode &data) noexcept {
  ...
  // Deserialize struct member 'SubPath_ref' of type /CppImplementationDataTypes/uint32_t
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
        ...
        >(reader, data.SubPath_ref);
  }

  // Deserialize struct member 'Probability_ref' of type /CppImplementationDataTypes/float
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
        ...
        >(reader, data.Probability_ref);
  }

  // Deserialize struct member 'TurnAngle_ref' of type /CppImplementationDataTypes/float
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
        ...
        >(reader, data.TurnAngle_ref);
  }

  // Deserialize struct member 'CompIntSec_ref' of type /CppImplementationDataTypes/uint8_t
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
        ...
        >(reader, data.CompIntSec_ref);
  }

  // Deserialize struct member 'RightOfWay_ref' of type /CppImplementationDataTypes/RightOfWay
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/PathNode.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::PathNode::PathNode>) noexcept {
  // Namespace alias for static deserialization code
  namespace deserialization = amsr::someip_protocol::internal::deserialization;
 ...
 constexpr std::size_t static_size{
  ...
  // Accumulate the static size of struct member 'SubPath_ref' of type /CppImplementationDataTypes/uint32_t
   SomeIpProtocolGetStaticSize<TpPack,
                               ...
                               >(deserialization::SizeToken<::SubPath::SubPath>{})  + 
  ...
  // Accumulate the static size of struct member 'Probability_ref' of type /CppImplementationDataTypes/float
   SomeIpProtocolGetStaticSize<TpPack,
                               ...
                               >(deserialization::SizeToken<::Probability::Probability>{})  + 
  ...
  // Accumulate the static size of struct member 'TurnAngle_ref' of type /CppImplementationDataTypes/float
   SomeIpProtocolGetStaticSize<TpPack,
                               ...
                               >(deserialization::SizeToken<::TurnAngle::TurnAngle>{})  + 
  ...
  // Accumulate the static size of struct member 'CompIntSec_ref' of type /CppImplementationDataTypes/uint8_t
   SomeIpProtocolGetStaticSize<TpPack,
                               ...
                               >(deserialization::SizeToken<::CompIntSec::CompIntSec>{})  + 
  ...
  // Accumulate the static size of struct member 'RightOfWay_ref' of type /CppImplementationDataTypes/RightOfWay
   SomeIpProtocolGetStaticSize<TpPack,
                               ...
                               >(deserialization::SizeToken<::RightOfWay::RightOfWay>{}) 
  };
  return static_size;
}
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_PATHNODE_DESERIALIZER_PATHNODE_H_
