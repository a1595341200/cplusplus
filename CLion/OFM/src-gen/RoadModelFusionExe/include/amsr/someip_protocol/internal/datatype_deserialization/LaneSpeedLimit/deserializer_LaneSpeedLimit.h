 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/amsr/someip_protocol/internal/datatype_deserialization/LaneSpeedLimit/deserializer_LaneSpeedLimit.h
 *        \brief  SOME/IP protocol deserializer implementation for datatype 'LaneSpeedLimit'
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANESPEEDLIMIT_DESERIALIZER_LANESPEEDLIMIT_H_
#define ROADMODELFUSIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANESPEEDLIMIT_DESERIALIZER_LANESPEEDLIMIT_H_
...
/*!
 * \brief Deserializer for datatype /CppImplementationDataTypes/LaneSpeedLimit.
 ...
 * \param[out]    data Reference to the data object of type /CppImplementationDataTypes/LaneSpeedLimit
...
amsr::someip_protocol::internal::deserialization::Result SomeIpProtocolDeserialize(amsr::someip_protocol::internal::deserialization::Reader& reader, ::LaneSpeedLimit::LaneSpeedLimit &data) noexcept {
  ...
  // Deserialize struct member 'Value_H_ref' of type /CppImplementationDataTypes/uint8_t
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
        ...
        >(reader, data.Value_H_ref);
  }

  // Deserialize struct member 'Value_L_ref' of type /CppImplementationDataTypes/uint8_t
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
        ...
        >(reader, data.Value_L_ref);
  }

  // Deserialize struct member 'SpeedLimitUnit_ref' of type /CppImplementationDataTypes/SpeedLimitUnit
  // VECTOR NL AutosarC++17_10-M0.1.2: MD_SOMEIPPROTOCOL_AutosarC++17_10-M0.1.2_dead_branch
  if (result) {
    result = deserialization::SomeIpProtocolDeserialize<
        TpPack,
        ...
        >(reader, data.SpeedLimitUnit_ref);
  }
...
/*!
 * \brief Calculates the static size for datatype /CppImplementationDataTypes/LaneSpeedLimit.
 * \details Data type class: DataTypeStruct (CppImplDataTypeStruct).
 *          is TLV struct: false
 *
 * \tparam TpPack Transformation properties to be used for deserialization.
 ...
 */
template <typename TpPack>
constexpr std::size_t SomeIpProtocolGetStaticSize(amsr::someip_protocol::internal::deserialization::SizeToken<::LaneSpeedLimit::LaneSpeedLimit>) noexcept {
  // Namespace alias for static deserialization code
  namespace deserialization = amsr::someip_protocol::internal::deserialization;
 ...
 constexpr std::size_t static_size{
  ...
  // Accumulate the static size of struct member 'Value_H_ref' of type /CppImplementationDataTypes/uint8_t
   SomeIpProtocolGetStaticSize<TpPack,
                               ...
                               >(deserialization::SizeToken<::Value_H::Value_H>{})  + 
  ...
  // Accumulate the static size of struct member 'Value_L_ref' of type /CppImplementationDataTypes/uint8_t
   SomeIpProtocolGetStaticSize<TpPack,
                               ...
                               >(deserialization::SizeToken<::Value_L::Value_L>{})  + 
  ...
  // Accumulate the static size of struct member 'SpeedLimitUnit_ref' of type /CppImplementationDataTypes/SpeedLimitUnit
   SomeIpProtocolGetStaticSize<TpPack,
                               ...
                               >(deserialization::SizeToken<::SpeedLimitUnit::SpeedLimitUnit>{}) 
  };
  return static_size;
}
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_AMSR_SOMEIP_PROTOCOL_INTERNAL_DATATYPE_DESERIALIZATION_LANESPEEDLIMIT_DESERIALIZER_LANESPEEDLIMIT_H_
