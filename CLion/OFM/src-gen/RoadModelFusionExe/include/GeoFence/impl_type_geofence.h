 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RoadModelFusionExe/include/GeoFence/impl_type_geofence.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROADMODELFUSIONEXE_INCLUDE_GEOFENCE_IMPL_TYPE_GEOFENCE_H_
#define ROADMODELFUSIONEXE_INCLUDE_GEOFENCE_IMPL_TYPE_GEOFENCE_H_
...
#endif  // ROADMODELFUSIONEXE_INCLUDE_GEOFENCE_IMPL_TYPE_GEOFENCE_H_
