 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/tosoca_infomationsi/ToSOCA_InfomationSI_proxy_update_manager.h
...
#ifndef PERCEPTIONREAREXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
#define PERCEPTIONREAREXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_PROXY_UPDATE_MANAGER_H_
