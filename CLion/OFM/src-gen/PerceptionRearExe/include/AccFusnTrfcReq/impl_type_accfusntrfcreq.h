 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  PerceptionRearExe/include/AccFusnTrfcReq/impl_type_accfusntrfcreq.h
 *        \brief
 *
 *      \details
 *
...
#ifndef PERCEPTIONREAREXE_INCLUDE_ACCFUSNTRFCREQ_IMPL_TYPE_ACCFUSNTRFCREQ_H_
#define PERCEPTIONREAREXE_INCLUDE_ACCFUSNTRFCREQ_IMPL_TYPE_ACCFUSNTRFCREQ_H_
...
#endif  // PERCEPTIONREAREXE_INCLUDE_ACCFUSNTRFCREQ_IMPL_TYPE_ACCFUSNTRFCREQ_H_
