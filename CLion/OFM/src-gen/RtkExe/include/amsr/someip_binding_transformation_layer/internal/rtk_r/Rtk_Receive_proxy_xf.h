 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RtkExe/include/amsr/someip_binding_transformation_layer/internal/rtk_r/Rtk_Receive_proxy_xf.h
...
#ifndef RTKEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_RTK_R_RTK_RECEIVE_PROXY_XF_H_
#define RTKEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_RTK_R_RTK_RECEIVE_PROXY_XF_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/someip_binding/internal/thread_pool_interface.h"
#include "amsr/someip_binding_transformation_layer/internal/rtk_r/Rtk_Receive_proxy_methods.h"
...
class Rtk_ReceiveProxyXf final :
  ...
  public std::enable_shared_from_this<Rtk_ReceiveProxyXf> {
 public:
  ...
  ~Rtk_ReceiveProxyXf() noexcept override = default;
 ...
 std::atomic<bool> is_active_;
  ...
  ::amsr::someip_binding::internal::logging::AraComLogger logger_{
    ...
    ::amsr::someip_binding::internal::logging::kSomeIpLoggerContextDescription, "Rtk_ReceiveProxyXf"};

  // ---- Methods ------------------------------------------------------------------------------------------

  // ---- Event manager --------------------------------------------------------------------------------------------

  // Event  manager for proxy event 'GgaData_receive'
  Rtk_ReceiveProxySomeIpEventManagerGgaData_receive event_xf_GgaData_receive_{instance_id_};
...
#endif  // RTKEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_RTK_R_RTK_RECEIVE_PROXY_XF_H_
