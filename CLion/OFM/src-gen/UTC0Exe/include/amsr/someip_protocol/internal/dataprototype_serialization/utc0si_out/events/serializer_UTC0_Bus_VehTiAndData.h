...
#include "amsr/someip_protocol/internal/datatype_serialization/DateTi30_2/serializer_DateTi30_2.h"
...
class SerializerUTC0_Bus_VehTiAndData {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/DateTi30_2.
   *
   ...
   * \synchronous TRUE
   */
  constexpr static std::size_t GetRequiredBufferSize(::DateTi30_2::DateTi30_2 const &data) noexcept {
   ...
   * \synchronous TRUE
   */
  static void Serialize(serialization::Writer &writer, ::DateTi30_2::DateTi30_2 const &data);
