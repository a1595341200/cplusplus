 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  UTC0Exe/include/amsr/someip_binding_transformation_layer/internal/utc0si_in/UTC0SI_In_proxy_xf.h
...
#ifndef UTC0EXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_UTC0SI_IN_UTC0SI_IN_PROXY_XF_H_
#define UTC0EXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_UTC0SI_IN_UTC0SI_IN_PROXY_XF_H_

/**********************************************************************************************************************
 *  INCLUDES
 *********************************************************************************************************************/
#include "amsr/someip_binding/internal/thread_pool_interface.h"
#include "amsr/someip_binding_transformation_layer/internal/utc0si_in/UTC0SI_In_proxy_methods.h"
...
class UTC0SI_InProxyXf final :
  ...
  public std::enable_shared_from_this<UTC0SI_InProxyXf> {
 public:
  ...
  ~UTC0SI_InProxyXf() noexcept override = default;
 ...
 std::atomic<bool> is_active_;
  ...
  ::amsr::someip_binding::internal::logging::AraComLogger logger_{
    ...
    ::amsr::someip_binding::internal::logging::kSomeIpLoggerContextDescription, "UTC0SI_InProxyXf"};

  // ---- Methods ------------------------------------------------------------------------------------------

  // ---- Event manager --------------------------------------------------------------------------------------------

  // Event  manager for proxy event 'OSM2_Bus_VehTiAndData'
  UTC0SI_InProxySomeIpEventManagerOSM2_Bus_VehTiAndData event_xf_OSM2_Bus_VehTiAndData_{instance_id_};
...
#endif  // UTC0EXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_UTC0SI_IN_UTC0SI_IN_PROXY_XF_H_
