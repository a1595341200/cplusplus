...
#include "utc0si_in/UTC0SI_In_proxy_update_manager.h"
...
using OSM2_Bus_VehTiAndData =
    ::amsr::socal::events::ProxyEvent<::DateTi30_2::DateTi30_2>;
 ...
 * \trace SPEC-4980344
 */
class UTC0SI_InProxy : public ::amsr::socal::Proxy<utc0si_in::UTC0SI_In, utc0si_in::internal::UTC0SI_InProxyBackendInterface, utc0si_in::internal::UTC0SI_InHandleType> {
 public:
 ...
 private:
   ...
   */
  using Base = ::amsr::socal::Proxy<utc0si_in::UTC0SI_In, ProxyBackendInterface, utc0si_in::internal::UTC0SI_InHandleType>;
   ...
   */
  utc0si_in::internal::UTC0SI_InProxyUpdateManager proxy_update_manager_;
