 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RadarAdaptorExe/src/amsr/someip_binding/internal/life_cycle_manager.cpp
...
void LifeCycleManager::RegisterServiceInstances() noexcept {
  ...
  }
  {
    ...
    {
      // Map P-Port /JICA/SWC/RadarAdaptorExe/RadarAdaptor/RadarAdaptorSIP to instance /JICA/Service/ProvidedSomeipRadarAdaptorSI_Out/ProvidedSomeipRadarAdaptorSI_Out
      ::ara::core::InstanceSpecifier const instance_specifier{"RadarAdaptorExe/RadarAdaptor/RadarAdaptorSIP"_sv};
      ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1059"_sv};
...
// VECTOR NC AutosarC++17_10-M9.3.3, VectorC++-V5.0.1: MD_SOMEIPBINDING_AutosarC++17_10-M9.3.3_Method_can_be_declared_const
 void LifeCycleManager::InitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/RadarAdaptorSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::radaradaptorsi_out::
      AraComSomeIpBindingInitializeSkeletonSomeIpEventBackendsRadarAdaptorSI_Out(aracom_someip_binding_->GetServerManager());
}
...
void LifeCycleManager::DeInitializeSkeletonSomeIpEventBackends() noexcept {
  // Initialize skeleton event backends for ServiceInterface '/JICA/Service/Interface/RadarAdaptorSI_Out'
  ::amsr::someip_binding_transformation_layer::internal::radaradaptorsi_out::
      AraComSomeIpBindingDeInitializeSkeletonSomeIpEventBackendsRadarAdaptorSI_Out();
}
...
void LifeCycleManager::InitializeProvidedServiceInstances() noexcept {
    // Register provided service for instance /JICA/Service/ProvidedSomeipRadarAdaptorSI_Out/ProvidedSomeipRadarAdaptorSI_Out
    {
      ::amsr::someip_binding::internal::ProvidedServiceInstanceId const RadarAdaptorSI_Out_provided_service_instance_id{ static_cast<::amsr::someip_protocol::internal::ServiceId>(0x3C),
                                                                                                                                                        1, 0, 0x423 };
      aracom_someip_binding_->GetServerManager().RegisterProvidedServiceInstance(RadarAdaptorSI_Out_provided_service_instance_id);
    }
}
...
void LifeCycleManager::InitializeServiceDiscoverySkeletonXfs() noexcept {
  ...
  // Instantiate ServiceDiscoverySkeletonXfs for instance /JICA/Service/ProvidedSomeipRadarAdaptorSI_Out/ProvidedSomeipRadarAdaptorSI_Out
  {
    // Types.
    using SkeletonXfType =
        ::amsr::someip_binding_transformation_layer::internal::radaradaptorsi_out::RadarAdaptorSI_OutSkeletonSomeIpBinding;
    ...
    // Variables.
    ::amsr::someip_binding::internal::ProvidedServiceInstanceId const provided_service_instance_id{static_cast<::amsr::someip_protocol::internal::ServiceId>(0x3C),
         1, 0, 0x423 };
    ...
    ::amsr::generic::Singleton<::amsr::socal::internal::service_discovery::ServiceDiscovery<
        ::radaradaptorsi_out::skeleton::RadarAdaptorSI_OutSkeleton>*>& service_discovery {
            ::radaradaptorsi_out::skeleton::RadarAdaptorSI_OutSkeleton::GetServiceDiscovery()};
...
void LifeCycleManager::CleanInstanceSpecifierToInstanceIdMapping() noexcept {
  {
    // Remove mapping P-Port /JICA/SWC/RadarAdaptorExe/RadarAdaptor/RadarAdaptorSIP to instance /JICA/Service/ProvidedSomeipRadarAdaptorSI_Out/ProvidedSomeipRadarAdaptorSI_Out
    ::ara::core::InstanceSpecifier const instance_specifier{"RadarAdaptorExe/RadarAdaptor/RadarAdaptorSIP"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1059"_sv};
