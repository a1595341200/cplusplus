 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RadarAdaptorExe/include/FourDRadarECUStsGrpSts/impl_type_fourdradarecustsgrpsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RADARADAPTOREXE_INCLUDE_FOURDRADARECUSTSGRPSTS_IMPL_TYPE_FOURDRADARECUSTSGRPSTS_H_
#define RADARADAPTOREXE_INCLUDE_FOURDRADARECUSTSGRPSTS_IMPL_TYPE_FOURDRADARECUSTSGRPSTS_H_
...
#endif  // RADARADAPTOREXE_INCLUDE_FOURDRADARECUSTSGRPSTS_IMPL_TYPE_FOURDRADARECUSTSGRPSTS_H_
