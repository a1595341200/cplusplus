 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RadarAdaptorExe/include/FourDRadarObjSt/impl_type_fourdradarobjst.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RADARADAPTOREXE_INCLUDE_FOURDRADAROBJST_IMPL_TYPE_FOURDRADAROBJST_H_
#define RADARADAPTOREXE_INCLUDE_FOURDRADAROBJST_IMPL_TYPE_FOURDRADAROBJST_H_
...
#endif  // RADARADAPTOREXE_INCLUDE_FOURDRADAROBJST_IMPL_TYPE_FOURDRADAROBJST_H_
