 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RadarAdaptorExe/include/RdrStsMisAlign/impl_type_rdrstsmisalign.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RADARADAPTOREXE_INCLUDE_RDRSTSMISALIGN_IMPL_TYPE_RDRSTSMISALIGN_H_
#define RADARADAPTOREXE_INCLUDE_RDRSTSMISALIGN_IMPL_TYPE_RDRSTSMISALIGN_H_
...
#endif  // RADARADAPTOREXE_INCLUDE_RDRSTSMISALIGN_IMPL_TYPE_RDRSTSMISALIGN_H_
