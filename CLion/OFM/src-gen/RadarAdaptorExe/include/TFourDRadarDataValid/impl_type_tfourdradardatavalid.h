 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  RadarAdaptorExe/include/TFourDRadarDataValid/impl_type_tfourdradardatavalid.h
 *        \brief
 *
 *      \details
 *
...
#ifndef RADARADAPTOREXE_INCLUDE_TFOURDRADARDATAVALID_IMPL_TYPE_TFOURDRADARDATAVALID_H_
#define RADARADAPTOREXE_INCLUDE_TFOURDRADARDATAVALID_IMPL_TYPE_TFOURDRADARDATAVALID_H_
...
#endif  // RADARADAPTOREXE_INCLUDE_TFOURDRADARDATAVALID_IMPL_TYPE_TFOURDRADARDATAVALID_H_
