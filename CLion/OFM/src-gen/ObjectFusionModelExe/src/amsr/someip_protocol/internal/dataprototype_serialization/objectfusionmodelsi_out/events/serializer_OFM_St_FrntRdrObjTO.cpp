 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/someip_protocol/internal/dataprototype_serialization/objectfusionmodelsi_out/events/serializer_OFM_St_FrntRdrObjTO.cpp
...
void SerializerOFM_St_FrntRdrObjTO::Serialize(serialization::Writer
&writer, ::FrntRdrObjTO::FrntRdrObjTO const &data) {
