 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsi_out/events/deserializer_RRCam_Bus_CamSts.cpp
...
deserialization::Result DeserializerRRCam_Bus_CamSts::Deserialize(deserialization::Reader &reader, ::CamSts1Vcc::CamSts1Vcc &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionSideSI_Out/RRCam_Bus_CamSts
