 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/src/amsr/someip_protocol/internal/dataprototype_deserialization/perceptionsi_out/events/deserializer_FLCam_Bus_VisnObj.cpp
...
deserialization::Result DeserializerFLCam_Bus_VisnObj::Deserialize(deserialization::Reader &reader, ::VisObjs::VisObjs &data) {
  // Transformation properties parameter pack for data prototype /JICA/Service/Interface/PerceptionSideSI_Out/FLCam_Bus_VisnObj
