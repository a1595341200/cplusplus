...
void PerceptionSI_VisnObjOutProxyXf::EmplaceEventBackends() {
  static_cast<void>(event_backend_table_.emplace(event_backend_FrntCam_Bus_VisnObj_.GetEventId(), &event_backend_FrntCam_Bus_VisnObj_ ));

}

void PerceptionSI_VisnObjOutProxyXf::Start() noexcept { is_active_ = true; }

void PerceptionSI_VisnObjOutProxyXf::Stop() noexcept { is_active_ = false; }
...
::ara::core::Result<void> PerceptionSI_VisnObjOutProxyXf::RequestService() noexcept {
  if(++proxy_count_ == 1) {
...
// VECTOR NC AutosarC++17_10-A15.4.2: MD_IPCBINDING_AutosarC++17_10-A15.4.2_STL_exceptions
// VECTOR NC AutosarC++17_10-A15.5.3: MD_IPCBINDING_AutosarC++17_10-A15.5.3_STL_exceptions
void  PerceptionSI_VisnObjOutProxyXf::ReleaseService() noexcept {
  if(--proxy_count_ == 0) {
    IpcProxyBindingIdentity const proxy_instance_identity{
          kDeployment.service_id_, instance_id_, kDeployment.service_interface_version_.major_version_, client_id_};
...
::amsr::ipc_binding_core::internal::ForwardOutput  PerceptionSI_VisnObjOutProxyXf::RouteRequest(
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::OnResponseReceived(::amsr::ipc_binding_core::internal::ipc_protocol::ResponseMessage&& response) {
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::OnNotificationReceived(::amsr::ipc_binding_core::internal::ipc_protocol::NotificationMessagePtr notification) {
  ::amsr::ipc_binding_core::internal::ForwardOutput forwarded{false};
...
void PerceptionSI_VisnObjOutProxyXf::OnServiceInstanceDown() {
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::OnSubscribeAckReceived(::amsr::ipc_binding_core::internal::ipc_protocol::SubscribeEventAckMessageHeader const& ack_response) {
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::OnSubscribeNAckReceived(::amsr::ipc_binding_core::internal::ipc_protocol::SubscribeEventNAckMessageHeader const& nack_response) {
  ::amsr::ipc_binding_core::internal::ForwardOutput accepted{false};
...
::amsr::ipc_binding_core::internal::ForwardOutput PerceptionSI_VisnObjOutProxyXf::OnApplicationErrorReceived(::amsr::ipc_binding_core::internal::ipc_protocol::ApplicationErrorMessage&& message) {
  ::amsr::ipc_binding_core::internal::ForwardOutput forwarded{false};
  // Get method ID from response header for dispatching.
...
void PerceptionSI_VisnObjOutProxyXf::OnErrorResponseReceived(::amsr::ipc_binding_core::internal::ipc_protocol::ErrorResponseMessage&& message) {
  // Get method ID from response header for dispatching.
  ::amsr::ipc_binding_core::internal::ipc_protocol::MethodId const method_id{message.GetMessageHeader().method_id_};
