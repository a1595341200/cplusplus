 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/EgoMotion/impl_type_egomotion.h
 *        \brief
 *
 *      \details
 *
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_EGOMOTION_IMPL_TYPE_EGOMOTION_H_
