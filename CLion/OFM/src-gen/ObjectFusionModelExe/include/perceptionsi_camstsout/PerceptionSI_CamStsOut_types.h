 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  ObjectFusionModelExe/include/perceptionsi_camstsout/PerceptionSI_CamStsOut_types.h
...
#ifndef OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_TYPES_H_
#define OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_TYPES_H_
...
#endif  // OBJECTFUSIONMODELEXE_INCLUDE_PERCEPTIONSI_CAMSTSOUT_PERCEPTIONSI_CAMSTSOUT_TYPES_H_
