 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/LppLaneChgSts/impl_type_lpplanechgsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
#define ENDOFLINEEXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_LPPLANECHGSTS_IMPL_TYPE_LPPLANECHGSTS_H_
