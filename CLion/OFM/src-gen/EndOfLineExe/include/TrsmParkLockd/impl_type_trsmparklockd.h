 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/TrsmParkLockd/impl_type_trsmparklockd.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_TRSMPARKLOCKD_IMPL_TYPE_TRSMPARKLOCKD_H_
#define ENDOFLINEEXE_INCLUDE_TRSMPARKLOCKD_IMPL_TYPE_TRSMPARKLOCKD_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_TRSMPARKLOCKD_IMPL_TYPE_TRSMPARKLOCKD_H_
