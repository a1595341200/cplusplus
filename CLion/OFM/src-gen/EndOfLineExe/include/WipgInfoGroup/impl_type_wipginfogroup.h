 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/WipgInfoGroup/impl_type_wipginfogroup.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
#define ENDOFLINEEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_WIPGINFOGROUP_IMPL_TYPE_WIPGINFOGROUP_H_
