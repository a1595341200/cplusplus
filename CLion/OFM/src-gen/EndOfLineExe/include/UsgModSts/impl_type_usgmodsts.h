 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/UsgModSts/impl_type_usgmodsts.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_USGMODSTS_IMPL_TYPE_USGMODSTS_H_
#define ENDOFLINEEXE_INCLUDE_USGMODSTS_IMPL_TYPE_USGMODSTS_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_USGMODSTS_IMPL_TYPE_USGMODSTS_H_
