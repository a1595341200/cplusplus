 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/WipgSpdInfo/impl_type_wipgspdinfo.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ENDOFLINEEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
#define ENDOFLINEEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_WIPGSPDINFO_IMPL_TYPE_WIPGSPDINFO_H_
