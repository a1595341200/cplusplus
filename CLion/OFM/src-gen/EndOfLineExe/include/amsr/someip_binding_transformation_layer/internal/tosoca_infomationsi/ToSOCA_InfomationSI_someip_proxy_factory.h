 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/include/amsr/someip_binding_transformation_layer/internal/tosoca_infomationsi/ToSOCA_InfomationSI_someip_proxy_factory.h
...
#ifndef ENDOFLINEEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_SOMEIP_PROXY_FACTORY_H_
#define ENDOFLINEEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_SOMEIP_PROXY_FACTORY_H_
...
#endif  // ENDOFLINEEXE_INCLUDE_AMSR_SOMEIP_BINDING_TRANSFORMATION_LAYER_INTERNAL_TOSOCA_INFOMATIONSI_TOSOCA_INFOMATIONSI_SOMEIP_PROXY_FACTORY_H_
