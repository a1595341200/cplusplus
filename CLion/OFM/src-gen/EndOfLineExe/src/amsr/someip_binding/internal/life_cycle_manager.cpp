 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EndOfLineExe/src/amsr/someip_binding/internal/life_cycle_manager.cpp
...
void LifeCycleManager::RegisterServiceInstances() noexcept {
  {
    ...
    {
      // Map R-Port /JICA/SWC/EndOfLineExe/EndOfLine/EndOfLineSIR to instance /JICA/Service/RequiredSomeipToSOCA_InfomationSI/RequiredSomeipToSOCA_InfomationSI 
      ::ara::core::InstanceSpecifier const instance_specifier{"EndOfLineExe/EndOfLine/EndOfLineSIR"_sv};
...
void LifeCycleManager::CleanInstanceSpecifierToInstanceIdMapping() noexcept {
  {
    // Remove mapping R-Port /JICA/SWC/EndOfLineExe/EndOfLine/EndOfLineSIR to instance /JICA/Service/RequiredSomeipToSOCA_InfomationSI/RequiredSomeipToSOCA_InfomationSI 
    ::ara::core::InstanceSpecifier const instance_specifier{"EndOfLineExe/EndOfLine/EndOfLineSIR"_sv};
    ::ara::com::InstanceIdentifier const instance_identifier{"SomeIp:1132"_sv};
