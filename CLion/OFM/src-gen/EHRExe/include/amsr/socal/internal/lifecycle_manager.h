 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/amsr/socal/internal/lifecycle_manager.h
...
#ifndef EHREXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
#define EHREXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
...
class LifecycleManager final {
 public:
  ...
  static void Initialize() noexcept {
    ...
    ehrsi_out::skeleton::EHRSI_OutSkeleton::CreateSingletons();
  }
  ...
  static void Deinitialize() noexcept {
    ...
    ehrsi_out::skeleton::EHRSI_OutSkeleton::DestroySingletons();
 ...
 private:
  ...
  void InitializeServiceDiscovery() noexcept {
    ...
    ehrsi_out::skeleton::EHRSI_OutSkeleton::RegisterServiceDiscovery(&ehrsi_out_skeleton_sd_);
  }
  ...
  void DeInitializeServiceDiscovery() noexcept {
    ...
    ehrsi_out::skeleton::EHRSI_OutSkeleton::DeRegisterServiceDiscovery();
  }
   ...
   */
  using EHRSI_OutSkeletonSdType = ehrsi_out::skeleton::EHRSI_OutSkeleton::ServiceDiscovery;

  /*!
   * \brief Service discovery instance used on skeleton side for the service interface EHRSI_Out.
   */
  EHRSI_OutSkeletonSdType ehrsi_out_skeleton_sd_;
};
}  // namespace internal
}  // namespace socal
}  // namespace amsr

#endif  // EHREXE_INCLUDE_AMSR_SOCAL_INTERNAL_LIFECYCLE_MANAGER_H_
