 ...
 *  INCLUDES
 *********************************************************************************************************************/
#include "GeoFences/impl_type_geofences.h"
 ...
 * \details Top-Level data type: /CppImplementationDataTypes/GeoFences
...
class SerializerEHR_Bus_GeoFences {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/GeoFences.
   *
   ...
   * \synchronous TRUE
   */
  constexpr static std::size_t GetRequiredBufferSize(::GeoFences::GeoFences const &data) noexcept {
   ...
   * \synchronous TRUE
   */
  static void Serialize(serialization::Writer &writer, ::GeoFences::GeoFences const &data);
