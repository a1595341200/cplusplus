...
#include "amsr/someip_protocol/internal/datatype_serialization/PathTrafficSigns/serializer_PathTrafficSigns.h"
...
class SerializerEHR_Bus_TrafficSigns {
 public:
   ...
   *
   * \param[in]   data Reference to data object of top-level data type /CppImplementationDataTypes/TrafficSigns.
   *
   ...
   * \synchronous TRUE
   */
  constexpr static std::size_t GetRequiredBufferSize(::TrafficSigns::TrafficSigns const &data) noexcept {
    return serialization::GetRequiredBufferSize<
      TpPackDataPrototype,
      // Config of vector length field and max. container size based on 'arraySize=null' model configuration. (/CppImplementationDataTypes/TrafficSigns)
   ...
   * \synchronous TRUE
   */
  static void Serialize(serialization::Writer &writer, ::TrafficSigns::TrafficSigns const &data);
