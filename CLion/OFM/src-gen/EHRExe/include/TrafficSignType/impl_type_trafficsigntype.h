 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/TrafficSignType/impl_type_trafficsigntype.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_TRAFFICSIGNTYPE_IMPL_TYPE_TRAFFICSIGNTYPE_H_
#define EHREXE_INCLUDE_TRAFFICSIGNTYPE_IMPL_TYPE_TRAFFICSIGNTYPE_H_
...
#endif  // EHREXE_INCLUDE_TRAFFICSIGNTYPE_IMPL_TYPE_TRAFFICSIGNTYPE_H_
