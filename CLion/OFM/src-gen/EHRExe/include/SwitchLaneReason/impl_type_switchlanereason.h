 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/SwitchLaneReason/impl_type_switchlanereason.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_SWITCHLANEREASON_IMPL_TYPE_SWITCHLANEREASON_H_
#define EHREXE_INCLUDE_SWITCHLANEREASON_IMPL_TYPE_SWITCHLANEREASON_H_
...
#endif  // EHREXE_INCLUDE_SWITCHLANEREASON_IMPL_TYPE_SWITCHLANEREASON_H_
