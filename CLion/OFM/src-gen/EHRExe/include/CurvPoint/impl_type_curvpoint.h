 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  EHRExe/include/CurvPoint/impl_type_curvpoint.h
 *        \brief
 *
 *      \details
 *
...
#ifndef EHREXE_INCLUDE_CURVPOINT_IMPL_TYPE_CURVPOINT_H_
#define EHREXE_INCLUDE_CURVPOINT_IMPL_TYPE_CURVPOINT_H_
...
#endif  // EHREXE_INCLUDE_CURVPOINT_IMPL_TYPE_CURVPOINT_H_
